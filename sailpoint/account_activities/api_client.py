...
from sailpoint.account_activities.api_response import ApiResponse, T as ApiResponseT
import sailpoint.account_activities.models
from sailpoint.account_activities import rest
from sailpoint.account_activities.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.account_activities.models, klass)
