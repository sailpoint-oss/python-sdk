...
from sailpoint.connectors.api_response import ApiResponse, T as ApiResponseT
import sailpoint.connectors.models
from sailpoint.connectors import rest
from sailpoint.connectors.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.connectors.models, klass)
