...
from sailpoint.auth_users_v1.api_client import ApiClient, RequestSerialized
from sailpoint.auth_users_v1.api_response import ApiResponse
from sailpoint.auth_users_v1.rest import RESTResponseType
...
class AuthUsersV1Api:
    ...
    def get_auth_user_v1(
        ...
        _param = self._get_auth_user_v1_serialize(
            id=id,
    ...
    @validate_call
    def get_auth_user_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Identity ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_auth_user_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Identity ID")],
        _request_timeout: Union[
            None,
    ...
    def _get_auth_user_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/auth-users/v1/{id}',
