...
from sailpoint.tenant.api_response import ApiResponse, T as ApiResponseT
import sailpoint.tenant.models
from sailpoint.tenant import rest
from sailpoint.tenant.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.tenant.models, klass)
