...
from sailpoint.sim_integrations.api_response import ApiResponse, T as ApiResponseT
import sailpoint.sim_integrations.models
from sailpoint.sim_integrations import rest
from sailpoint.sim_integrations.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.sim_integrations.models, klass)
