...
from sailpoint.privilege_criteria_v1.api_client import ApiClient, RequestSerialized
from sailpoint.privilege_criteria_v1.api_response import ApiResponse
from sailpoint.privilege_criteria_v1.rest import RESTResponseType
...
class PrivilegeCriteriaV1Api:
    ...
    def _create_custom_privilege_criteria_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/criteria/v1/privilege',
    ...
    @validate_call
    def delete_custom_privilege_criteria_v1(
        self,
        ...
        _param = self._delete_custom_privilege_criteria_v1_serialize(
    ...
    @validate_call
    def delete_custom_privilege_criteria_v1_with_http_info(
        self,
        criteria_id: Annotated[StrictStr, Field(description="The Id of the custom privilege criteria to delete.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_custom_privilege_criteria_v1_without_preload_content(
        self,
        criteria_id: Annotated[StrictStr, Field(description="The Id of the custom privilege criteria to delete.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_custom_privilege_criteria_v1_serialize(
        self,
        criteria_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/criteria/v1/privilege/{criteriaId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_privilege_criteria_v1(
        ...
        _param = self._get_privilege_criteria_v1_serialize(
            criteria_id=criteria_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_privilege_criteria_v1_with_http_info(
        self,
        criteria_id: Annotated[StrictStr, Field(description="The Id of the privilege criteria record to return.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_privilege_criteria_v1_without_preload_content(
        self,
        criteria_id: Annotated[StrictStr, Field(description="The Id of the privilege criteria record to return.")],
        _request_timeout: Union[
            None,
    ...
    def _get_privilege_criteria_v1_serialize(
        self,
        criteria_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def list_privilege_criteria_v1(
        self,
        ...
        _param = self._list_privilege_criteria_v1_serialize(
            filters=filters,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_privilege_criteria_v1_with_http_info(
        self,
        filters: Annotated[StrictStr, Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **type**: *eq*  **sourceId**: *eq*  **privilegeLevel**: *eq*  **Supported composite operators**: *and*  All filter values are case-sensitive for this API.  For example, the following is valid: `?filters=type eq \"CUSTOM\" and sourceId eq \"2c91809175e6c63f0175fb5570220569\"`")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_privilege_criteria_v1_without_preload_content(
        self,
        filters: Annotated[StrictStr, Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **type**: *eq*  **sourceId**: *eq*  **privilegeLevel**: *eq*  **Supported composite operators**: *and*  All filter values are case-sensitive for this API.  For example, the following is valid: `?filters=type eq \"CUSTOM\" and sourceId eq \"2c91809175e6c63f0175fb5570220569\"`")],
        _request_timeout: Union[
            None,
    ...
    def _list_privilege_criteria_v1_serialize(
        self,
        filters,
        _request_auth,
        _content_type,
