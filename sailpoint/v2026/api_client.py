...
from sailpoint.v2026.api_response import ApiResponse, T as ApiResponseT
import sailpoint.v2026.models
from sailpoint.v2026 import rest
...
class ApiClient:
    ...
    def param_serialize(
        ...
        # request url
        if _host is None:
            url = self.configuration.base_url + '/v2026' + resource_path
        else:
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.v2026.models, klass)
