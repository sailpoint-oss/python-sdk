---
id: v2026-password-policies
title: Password_Policies
pagination_label: Password_Policies
sidebar_label: Password_Policies
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'Password_Policies', 'V2026Password_Policies'] 
slug: /tools/sdk/python/v2026/methods/password-policies
tags: ['SDK', 'Software Development Kit', 'Password_Policies', 'V2026Password_Policies']
---

# sailpoint.v2026.PasswordPoliciesApi
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/create-password-policy)
...
```python
from sailpoint.v2026.api.password_policies_api import PasswordPoliciesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.password_policy_v3_dto import PasswordPolicyV3Dto
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/delete-password-policy)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-password-policy-by-id)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/list-password-policies)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/set-password-policy)
