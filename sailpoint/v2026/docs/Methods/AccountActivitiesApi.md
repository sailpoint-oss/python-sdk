---
id: v2026-account-activities
title: Account_Activities
pagination_label: Account_Activities
sidebar_label: Account_Activities
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'Account_Activities', 'V2026Account_Activities'] 
slug: /tools/sdk/python/v2026/methods/account-activities
tags: ['SDK', 'Software Development Kit', 'Account_Activities', 'V2026Account_Activities']
---

# sailpoint.v2026.AccountActivitiesApi
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-account-activity)
...
```python
from sailpoint.v2026.api.account_activities_api import AccountActivitiesApi
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/list-account-activities)
