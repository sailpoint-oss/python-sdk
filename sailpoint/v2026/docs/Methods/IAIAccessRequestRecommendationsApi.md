---
id: v2026-iai-access-request-recommendations
...
keywords: ['python', 'Python', 'sdk', 'IAI_Access_Request_Recommendations', 'V2026IAI_Access_Request_Recommendations'] 
slug: /tools/sdk/python/v2026/methods/iai-access-request-recommendations
tags: ['SDK', 'Software Development Kit', 'IAI_Access_Request_Recommendations', 'V2026IAI_Access_Request_Recommendations']
---

# sailpoint.v2026.IAIAccessRequestRecommendationsApi
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/add-access-request-recommendations-ignored-item)
...
from sailpoint.v2026.models.access_request_recommendation_action_item_dto import AccessRequestRecommendationActionItemDto
from sailpoint.v2026.models.access_request_recommendation_action_item_response_dto import AccessRequestRecommendationActionItemResponseDto
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/add-access-request-recommendations-requested-item)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/add-access-request-recommendations-viewed-item)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/add-access-request-recommendations-viewed-items)
...
with ApiClient(configuration) as api_client:
    x_sail_point_experimental = 'true' # str | Use this header to enable this experimental API. (default to 'true') # str | Use this header to enable this experimental API. (default to 'true')
    access_request_recommendation_action_item_dto = '''[sailpoint.v2026.AccessRequestRecommendationActionItemDto()]''' # List[AccessRequestRecommendationActionItemDto] | The recommended access items that were viewed for an identity.
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-access-request-recommendations)
...
from sailpoint.v2026.api.iai_access_request_recommendations_api import IAIAccessRequestRecommendationsApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.access_request_recommendation_item_detail import AccessRequestRecommendationItemDetail
from sailpoint.configuration import Configuration
configuration = Configuration()
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-access-request-recommendations-config)
...
from sailpoint.v2026.api.iai_access_request_recommendations_api import IAIAccessRequestRecommendationsApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.access_request_recommendation_config_dto import AccessRequestRecommendationConfigDto
from sailpoint.configuration import Configuration
configuration = Configuration()
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-access-request-recommendations-ignored-items)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-access-request-recommendations-requested-items)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-access-request-recommendations-viewed-items)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/set-access-request-recommendations-config)
