---
id: v2026-service-desk-integration
title: Service_Desk_Integration
pagination_label: Service_Desk_Integration
sidebar_label: Service_Desk_Integration
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'Service_Desk_Integration', 'V2026Service_Desk_Integration'] 
slug: /tools/sdk/python/v2026/methods/service-desk-integration
tags: ['SDK', 'Software Development Kit', 'Service_Desk_Integration', 'V2026Service_Desk_Integration']
---

# sailpoint.v2026.ServiceDeskIntegrationApi
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/create-service-desk-integration)
...
```python
from sailpoint.v2026.api.service_desk_integration_api import ServiceDeskIntegrationApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.service_desk_integration_dto import ServiceDeskIntegrationDto
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/delete-service-desk-integration)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-service-desk-integration)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-service-desk-integration-template)
...
from sailpoint.v2026.api.service_desk_integration_api import ServiceDeskIntegrationApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.service_desk_integration_template_dto import ServiceDeskIntegrationTemplateDto
from sailpoint.configuration import Configuration
configuration = Configuration()
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-service-desk-integration-types)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-service-desk-integrations)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-status-check-details)
...
from sailpoint.v2026.api.service_desk_integration_api import ServiceDeskIntegrationApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.queued_check_config_details import QueuedCheckConfigDetails
from sailpoint.configuration import Configuration
configuration = Configuration()
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/patch-service-desk-integration)
...
with ApiClient(configuration) as api_client:
    ...
    json_patch_operation = '''[sailpoint.v2026.JsonPatchOperation()]''' # List[JsonPatchOperation] | A list of SDIM update operations according to the [JSON Patch](https://tools.ietf.org/html/rfc6902) standard.  Only `replace` operations are accepted by this endpoint.  A 403 Forbidden Error indicates that a PATCH operation was attempted that is not allowed. 
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/put-service-desk-integration)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/update-status-check-details)
