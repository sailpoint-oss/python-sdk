---
id: v2026-access-request-identity-metrics
...
keywords: ['python', 'Python', 'sdk', 'Access_Request_Identity_Metrics', 'V2026Access_Request_Identity_Metrics'] 
slug: /tools/sdk/python/v2026/methods/access-request-identity-metrics
tags: ['SDK', 'Software Development Kit', 'Access_Request_Identity_Metrics', 'V2026Access_Request_Identity_Metrics']
---

# sailpoint.v2026.AccessRequestIdentityMetricsApi
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-access-request-identity-metrics)
...
```python
from sailpoint.v2026.api.access_request_identity_metrics_api import AccessRequestIdentityMetricsApi
