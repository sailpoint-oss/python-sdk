---
id: v2026-machine-classification-config
...
keywords: ['python', 'Python', 'sdk', 'Machine_Classification_Config', 'V2026Machine_Classification_Config'] 
slug: /tools/sdk/python/v2026/methods/machine-classification-config
tags: ['SDK', 'Software Development Kit', 'Machine_Classification_Config', 'V2026Machine_Classification_Config']
---

# sailpoint.v2026.MachineClassificationConfigApi
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/delete-machine-classification-config)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-machine-classification-config)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/set-machine-classification-config)
