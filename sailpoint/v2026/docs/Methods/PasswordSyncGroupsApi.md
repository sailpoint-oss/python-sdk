---
id: v2026-password-sync-groups
title: Password_Sync_Groups
pagination_label: Password_Sync_Groups
sidebar_label: Password_Sync_Groups
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'Password_Sync_Groups', 'V2026Password_Sync_Groups'] 
slug: /tools/sdk/python/v2026/methods/password-sync-groups
tags: ['SDK', 'Software Development Kit', 'Password_Sync_Groups', 'V2026Password_Sync_Groups']
---

# sailpoint.v2026.PasswordSyncGroupsApi
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/create-password-sync-group)
...
```python
from sailpoint.v2026.api.password_sync_groups_api import PasswordSyncGroupsApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.password_sync_group import PasswordSyncGroup
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/delete-password-sync-group)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-password-sync-group)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-password-sync-groups)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/update-password-sync-group)
