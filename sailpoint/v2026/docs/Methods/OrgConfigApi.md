...
keywords: ['python', 'Python', 'sdk', 'Org_Config', 'V2026Org_Config'] 
slug: /tools/sdk/python/v2026/methods/org-config
tags: ['SDK', 'Software Development Kit', 'Org_Config', 'V2026Org_Config']
---

# sailpoint.v2026.OrgConfigApi
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-org-config)
...
```python
from sailpoint.v2026.api.org_config_api import OrgConfigApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.org_config import OrgConfig
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-valid-time-zones)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/patch-org-config)
