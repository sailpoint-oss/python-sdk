...
keywords: ['python', 'Python', 'sdk', 'Sources', 'V2026Sources'] 
slug: /tools/sdk/python/v2026/methods/sources
tags: ['SDK', 'Software Development Kit', 'Sources', 'V2026Sources']
---

# sailpoint.v2026.SourcesApi
...
from sailpoint.v2026.models.provisioning_policy_dto import ProvisioningPolicyDto
...
from sailpoint.v2026.api.sources_api import SourcesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.source import Source
from sailpoint.configuration import Configuration
configuration = Configuration()
...
from sailpoint.v2026.api.sources_api import SourcesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.schedule1 import Schedule1
from sailpoint.configuration import Configuration
configuration = Configuration()
...
with ApiClient(configuration) as api_client:
    ...
    schedule1 = '''sailpoint.v2026.Schedule1()''' # Schedule1 | 
...
with ApiClient(configuration) as api_client:
    source_id = '2c9180835d191a86015d28455b4a2329' # str | Source ID. # str | Source ID.
    model_schema = '''sailpoint.v2026.ModelSchema()''' # ModelSchema | 
...
from sailpoint.v2026.api.sources_api import SourcesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.task_result_dto import TaskResultDto
from sailpoint.configuration import Configuration
configuration = Configuration()
...
from sailpoint.v2026.api.sources_api import SourcesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.usage_type import UsageType
from sailpoint.configuration import Configuration
configuration = Configuration()
...
from sailpoint.v2026.api.sources_api import SourcesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.delete_source202_response import DeleteSource202Response
from sailpoint.configuration import Configuration
configuration = Configuration()
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesApi(api_client).get_account_delete_approval_config(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = SourcesApi(api_client).get_account_delete_approval_config(source_id)
...
from sailpoint.v2026.api.sources_api import SourcesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.correlation_config import CorrelationConfig
from sailpoint.configuration import Configuration
configuration = Configuration()
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesApi(api_client).get_machine_account_deletion_approval_config_by_source(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = SourcesApi(api_client).get_machine_account_deletion_approval_config_by_source(source_id)
...
from sailpoint.v2026.api.sources_api import SourcesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.native_change_detection_config import NativeChangeDetectionConfig
from sailpoint.configuration import Configuration
configuration = Configuration()
...
from sailpoint.v2026.api.sources_api import SourcesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.attr_sync_source_config import AttrSyncSourceConfig
from sailpoint.configuration import Configuration
configuration = Configuration()
...
from sailpoint.v2026.api.sources_api import SourcesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.connector_detail import ConnectorDetail
from sailpoint.configuration import Configuration
configuration = Configuration()
...
from sailpoint.v2026.api.sources_api import SourcesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.source_connections_dto import SourceConnectionsDto
from sailpoint.configuration import Configuration
configuration = Configuration()
...
from sailpoint.v2026.api.sources_api import SourcesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.source_health_dto import SourceHealthDto
from sailpoint.configuration import Configuration
configuration = Configuration()
...
from sailpoint.v2026.api.sources_api import SourcesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.load_accounts_task import LoadAccountsTask
from sailpoint.configuration import Configuration
configuration = Configuration()
...
from sailpoint.v2026.api.sources_api import SourcesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.load_uncorrelated_accounts_task import LoadUncorrelatedAccountsTask
from sailpoint.configuration import Configuration
configuration = Configuration()
...
from sailpoint.v2026.api.sources_api import SourcesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.password_policy_holders_dto_inner import PasswordPolicyHoldersDtoInner
from sailpoint.configuration import Configuration
configuration = Configuration()
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # Below is a request that includes all optional parameters
        # results = SourcesApi(api_client).list_provisioning_policies(source_id, offset, limit)
...
from sailpoint.v2026.api.sources_api import SourcesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.status_response import StatusResponse
from sailpoint.configuration import Configuration
configuration = Configuration()
...
from sailpoint.v2026.api.sources_api import SourcesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.resource_objects_request import ResourceObjectsRequest
from sailpoint.v2026.models.resource_objects_response import ResourceObjectsResponse
from sailpoint.configuration import Configuration
configuration = Configuration()
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesApi(api_client).update_account_deletion_approval_config(source_id=source_id, json_patch_operation=new_json_patch_operation)
        # Below is a request that includes all optional parameters
        # results = SourcesApi(api_client).update_account_deletion_approval_config(source_id, new_json_patch_operation)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Machine Account Deletion Approval Config
        new_json_patch_operation = JsonPatchOperation.from_json(json_patch_operation)
        results = SourcesApi(api_client).update_machine_account_deletion_approval_config(source_id=source_id, json_patch_operation=new_json_patch_operation)
        # Below is a request that includes all optional parameters
        # results = SourcesApi(api_client).update_machine_account_deletion_approval_config(source_id, new_json_patch_operation)
...
with ApiClient(configuration) as api_client:
    source_id = '8c190e6787aa4ed9a90bd9d5344523fb' # str | The Source id # str | The Source id
    password_policy_holders_dto_inner = '''[sailpoint.v2026.PasswordPolicyHoldersDtoInner()]''' # List[PasswordPolicyHoldersDtoInner] | 
...
with ApiClient(configuration) as api_client:
    source_id = '2c9180835d191a86015d28455b4a2329' # str | The Source id. # str | The Source id.
    provisioning_policy_dto = '''[sailpoint.v2026.ProvisioningPolicyDto()]''' # List[ProvisioningPolicyDto] | 
