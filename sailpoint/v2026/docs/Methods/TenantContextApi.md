---
id: v2026-tenant-context
title: Tenant_Context
pagination_label: Tenant_Context
sidebar_label: Tenant_Context
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'Tenant_Context', 'V2026Tenant_Context'] 
slug: /tools/sdk/python/v2026/methods/tenant-context
tags: ['SDK', 'Software Development Kit', 'Tenant_Context', 'V2026Tenant_Context']
---

# sailpoint.v2026.TenantContextApi
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-tenant-context)
...
```python
from sailpoint.v2026.api.tenant_context_api import TenantContextApi
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = TenantContextApi(api_client).get_tenant_context()
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/patch-tenant-context)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        TenantContextApi(api_client).patch_tenant_context(json_patch_operation=new_json_patch_operation)
        # Below is a request that includes all optional parameters
        # TenantContextApi(api_client).patch_tenant_context(new_json_patch_operation)
    except Exception as e:
