---
id: v2026-requestable-objects
title: Requestable_Objects
pagination_label: Requestable_Objects
sidebar_label: Requestable_Objects
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'Requestable_Objects', 'V2026Requestable_Objects'] 
slug: /tools/sdk/python/v2026/methods/requestable-objects
tags: ['SDK', 'Software Development Kit', 'Requestable_Objects', 'V2026Requestable_Objects']
---

# sailpoint.v2026.RequestableObjectsApi
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/list-requestable-objects)
...
```python
from sailpoint.v2026.api.requestable_objects_api import RequestableObjectsApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.requestable_object import RequestableObject
from sailpoint.v2026.models.requestable_object_request_status import RequestableObjectRequestStatus
...
with ApiClient(configuration) as api_client:
    ...
    statuses = '''[sailpoint.v2026.RequestableObjectRequestStatus()]''' # List[RequestableObjectRequestStatus] | Filters the result to the specified status/statuses, where each status is one of `AVAILABLE`, `ASSIGNED`, or `PENDING`. Specifying this parameter without also specifying an `identity-id` parameter results in an error.  SailPoint may add additional statuses in the future without notice. (optional)
