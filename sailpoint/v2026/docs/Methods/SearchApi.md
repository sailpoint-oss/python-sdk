...
keywords: ['python', 'Python', 'sdk', 'Search', 'V2026Search'] 
slug: /tools/sdk/python/v2026/methods/search
tags: ['SDK', 'Software Development Kit', 'Search', 'V2026Search']
---

# sailpoint.v2026.SearchApi
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/search-aggregate)
...
```python
from sailpoint.v2026.api.search_api import SearchApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.aggregation_result import AggregationResult
from sailpoint.v2026.models.search import Search
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/search-count)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/search-get)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/search-post)
