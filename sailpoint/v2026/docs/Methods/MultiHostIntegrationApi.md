---
id: v2026-multi-host-integration
title: Multi_Host_Integration
pagination_label: Multi_Host_Integration
sidebar_label: Multi_Host_Integration
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'Multi_Host_Integration', 'V2026Multi_Host_Integration'] 
slug: /tools/sdk/python/v2026/methods/multi-host-integration
tags: ['SDK', 'Software Development Kit', 'Multi_Host_Integration', 'V2026Multi_Host_Integration']
---

# sailpoint.v2026.MultiHostIntegrationApi
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/create-multi-host-integration)
...
```python
from sailpoint.v2026.api.multi_host_integration_api import MultiHostIntegrationApi
...
from sailpoint.v2026.models.multi_host_integrations_create import MultiHostIntegrationsCreate
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/create-sources-within-multi-host)
...
from sailpoint.v2026.api.multi_host_integration_api import MultiHostIntegrationApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.multi_host_integrations_create_sources import MultiHostIntegrationsCreateSources
from sailpoint.configuration import Configuration
configuration = Configuration()
...
with ApiClient(configuration) as api_client:
    ...
    multi_host_integrations_create_sources = '''[sailpoint.v2026.MultiHostIntegrationsCreateSources()]''' # List[MultiHostIntegrationsCreateSources] | The specifics of the sources to create within Multi-Host Integration.
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/delete-multi-host)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/delete-multi-host-sources)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-acct-aggregation-groups)
...
from sailpoint.v2026.api.multi_host_integration_api import MultiHostIntegrationApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.multi_host_integrations_agg_schedule_update import MultiHostIntegrationsAggScheduleUpdate
from sailpoint.configuration import Configuration
configuration = Configuration()
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-entitlement-aggregation-groups)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-multi-host-integrations)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-multi-host-integrations-list)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-multi-host-source-creation-errors)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-multihost-integration-types)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-sources-within-multi-host)
...
from sailpoint.v2026.api.multi_host_integration_api import MultiHostIntegrationApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.multi_host_sources import MultiHostSources
from sailpoint.configuration import Configuration
configuration = Configuration()
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/test-connection-multi-host-sources)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/test-source-connection-multihost)
...
from sailpoint.v2026.api.multi_host_integration_api import MultiHostIntegrationApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.test_source_connection_multihost200_response import TestSourceConnectionMultihost200Response
from sailpoint.configuration import Configuration
configuration = Configuration()
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/update-multi-host-sources)
