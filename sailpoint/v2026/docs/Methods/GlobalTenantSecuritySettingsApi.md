---
id: v2026-global-tenant-security-settings
...
keywords: ['python', 'Python', 'sdk', 'Global_Tenant_Security_Settings', 'V2026Global_Tenant_Security_Settings'] 
slug: /tools/sdk/python/v2026/methods/global-tenant-security-settings
tags: ['SDK', 'Software Development Kit', 'Global_Tenant_Security_Settings', 'V2026Global_Tenant_Security_Settings']
---

# sailpoint.v2026.GlobalTenantSecuritySettingsApi
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/create-auth-org-network-config)
...
from sailpoint.v2026.models.network_configuration import NetworkConfiguration
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-auth-org-lockout-config)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-auth-org-network-config)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-auth-org-service-provider-config)
...
from sailpoint.v2026.api.global_tenant_security_settings_api import GlobalTenantSecuritySettingsApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.service_provider_configuration import ServiceProviderConfiguration
from sailpoint.configuration import Configuration
configuration = Configuration()
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-auth-org-session-config)
...
from sailpoint.v2026.api.global_tenant_security_settings_api import GlobalTenantSecuritySettingsApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.session_configuration import SessionConfiguration
from sailpoint.configuration import Configuration
configuration = Configuration()
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/patch-auth-org-lockout-config)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/patch-auth-org-network-config)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/patch-auth-org-service-provider-config)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/patch-auth-org-session-config)
