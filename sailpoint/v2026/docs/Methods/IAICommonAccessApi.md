---
id: v2026-iai-common-access
title: IAI_Common_Access
pagination_label: IAI_Common_Access
sidebar_label: IAI_Common_Access
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'IAI_Common_Access', 'V2026IAI_Common_Access'] 
slug: /tools/sdk/python/v2026/methods/iai-common-access
tags: ['SDK', 'Software Development Kit', 'IAI_Common_Access', 'V2026IAI_Common_Access']
---

# sailpoint.v2026.IAICommonAccessApi
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/create-common-access)
...
from sailpoint.v2026.models.common_access_item_response import CommonAccessItemResponse
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-common-access)
...
from sailpoint.v2026.api.iai_common_access_api import IAICommonAccessApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.common_access_response import CommonAccessResponse
from sailpoint.configuration import Configuration
configuration = Configuration()
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/update-common-access-status-in-bulk)
...
with ApiClient(configuration) as api_client:
    x_sail_point_experimental = 'true' # str | Use this header to enable this experimental API. (default to 'true') # str | Use this header to enable this experimental API. (default to 'true')
    common_access_id_status = '''[sailpoint.v2026.CommonAccessIDStatus()]''' # List[CommonAccessIDStatus] | Confirm or deny in bulk the common access ids that are (or aren't) common access
