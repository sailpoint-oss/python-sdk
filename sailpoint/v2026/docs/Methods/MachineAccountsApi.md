...
keywords: ['python', 'Python', 'sdk', 'Machine_Accounts', 'V2026Machine_Accounts'] 
slug: /tools/sdk/python/v2026/methods/machine-accounts
tags: ['SDK', 'Software Development Kit', 'Machine_Accounts', 'V2026Machine_Accounts']
---

# sailpoint.v2026.MachineAccountsApi
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        MachineAccountsApi(api_client).delete_machine_account_subtype_by_technical_name(source_id=source_id, technical_name=technical_name, x_sail_point_experimental=x_sail_point_experimental)
        # Below is a request that includes all optional parameters
        # MachineAccountsApi(api_client).delete_machine_account_subtype_by_technical_name(source_id, technical_name, x_sail_point_experimental)
    except Exception as e:
        print("Exception when calling MachineAccountsApi->delete_machine_account_subtype_by_technical_name: %s\n" % e)
```
...
------------- | ------------- | ------------- | ------------- | ------------- 
   | x_sail_point_experimental | **str** | True  (default to 'true') | Use this header to enable this experimental API.
 Body  | mis_bulk_request | [**MisBulkRequest**](../models/mis-bulk-request) | True  | 
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Bulk disable machine accounts
        new_mis_bulk_request = MisBulkRequest.from_json(mis_bulk_request)
        results = MachineAccountsApi(api_client).disable_machine_accounts_in_bulk(x_sail_point_experimental=x_sail_point_experimental, mis_bulk_request=new_mis_bulk_request)
        # Below is a request that includes all optional parameters
        # results = MachineAccountsApi(api_client).disable_machine_accounts_in_bulk(x_sail_point_experimental, new_mis_bulk_request)
        print("The response of MachineAccountsApi->disable_machine_accounts_in_bulk:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling MachineAccountsApi->disable_machine_accounts_in_bulk: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Bulk enable machine accounts
        new_mis_bulk_request = MisBulkRequest.from_json(mis_bulk_request)
        results = MachineAccountsApi(api_client).enable_machine_accounts_in_bulk(x_sail_point_experimental=x_sail_point_experimental, mis_bulk_request=new_mis_bulk_request)
        # Below is a request that includes all optional parameters
        # results = MachineAccountsApi(api_client).enable_machine_accounts_in_bulk(x_sail_point_experimental, new_mis_bulk_request)
        print("The response of MachineAccountsApi->enable_machine_accounts_in_bulk:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling MachineAccountsApi->enable_machine_accounts_in_bulk: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = MachineAccountsApi(api_client).get_machine_account_subtype_approval_config(x_sail_point_experimental=x_sail_point_experimental, subtype_id=subtype_id)
        # Below is a request that includes all optional parameters
        # results = MachineAccountsApi(api_client).get_machine_account_subtype_approval_config(x_sail_point_experimental, subtype_id)
        print("The response of MachineAccountsApi->get_machine_account_subtype_approval_config:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling MachineAccountsApi->get_machine_account_subtype_approval_config: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = MachineAccountsApi(api_client).load_bulk_source_subtypes(x_sail_point_experimental=x_sail_point_experimental, request_body=new_request_body)
        # Below is a request that includes all optional parameters
        # results = MachineAccountsApi(api_client).load_bulk_source_subtypes(x_sail_point_experimental, new_request_body)
        print("The response of MachineAccountsApi->load_bulk_source_subtypes:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling MachineAccountsApi->load_bulk_source_subtypes: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Patch subtype
        new_request_body = RequestBody.from_json(request_body)
        results = MachineAccountsApi(api_client).patch_machine_account_subtype_by_technical_name(source_id=source_id, technical_name=technical_name, x_sail_point_experimental=x_sail_point_experimental, request_body=new_request_body)
        # Below is a request that includes all optional parameters
        # results = MachineAccountsApi(api_client).patch_machine_account_subtype_by_technical_name(source_id, technical_name, x_sail_point_experimental, new_request_body)
        print("The response of MachineAccountsApi->patch_machine_account_subtype_by_technical_name:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling MachineAccountsApi->patch_machine_account_subtype_by_technical_name: %s\n" % e)
```
...
### Return type
[**List[MisBulkResponse]**](../models/mis-bulk-response)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Bulk reload machine accounts
        new_mis_bulk_request = MisBulkRequest.from_json(mis_bulk_request)
        results = MachineAccountsApi(api_client).reload_machine_accounts_in_bulk(x_sail_point_experimental=x_sail_point_experimental, mis_bulk_request=new_mis_bulk_request)
        # Below is a request that includes all optional parameters
        # results = MachineAccountsApi(api_client).reload_machine_accounts_in_bulk(x_sail_point_experimental, new_mis_bulk_request)
        print("The response of MachineAccountsApi->reload_machine_accounts_in_bulk:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling MachineAccountsApi->reload_machine_accounts_in_bulk: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = MachineAccountsApi(api_client).update_machine_account_subtype_approval_config(x_sail_point_experimental=x_sail_point_experimental, subtype_id=subtype_id, json_patch_operation=new_json_patch_operation)
        # Below is a request that includes all optional parameters
        # results = MachineAccountsApi(api_client).update_machine_account_subtype_approval_config(x_sail_point_experimental, subtype_id, new_json_patch_operation)
        print("The response of MachineAccountsApi->update_machine_account_subtype_approval_config:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling MachineAccountsApi->update_machine_account_subtype_approval_config: %s\n" % e)
```
...
------------- | ------------- | ------------- | ------------- | ------------- 
   | x_sail_point_experimental | **str** | True  (default to 'true') | Use this header to enable this experimental API.
 Body  | mis_bulk_update_request | [**MisBulkUpdateRequest**](../models/mis-bulk-update-request) | True  | 
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Bulk update machine accounts
        new_mis_bulk_update_request = MisBulkUpdateRequest.from_json(mis_bulk_update_request)
        results = MachineAccountsApi(api_client).update_machine_accounts_in_bulk(x_sail_point_experimental=x_sail_point_experimental, mis_bulk_update_request=new_mis_bulk_update_request)
        # Below is a request that includes all optional parameters
        # results = MachineAccountsApi(api_client).update_machine_accounts_in_bulk(x_sail_point_experimental, new_mis_bulk_update_request)
        print("The response of MachineAccountsApi->update_machine_accounts_in_bulk:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling MachineAccountsApi->update_machine_accounts_in_bulk: %s\n" % e)
```
