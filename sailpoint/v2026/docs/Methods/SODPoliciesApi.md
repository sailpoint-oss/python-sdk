---
id: v2026-sod-policies
title: SOD_Policies
pagination_label: SOD_Policies
sidebar_label: SOD_Policies
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'SOD_Policies', 'V2026SOD_Policies'] 
slug: /tools/sdk/python/v2026/methods/sod-policies
tags: ['SDK', 'Software Development Kit', 'SOD_Policies', 'V2026SOD_Policies']
---

# sailpoint.v2026.SODPoliciesApi
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/create-sod-policy)
...
```python
from sailpoint.v2026.api.sod_policies_api import SODPoliciesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.sod_policy import SodPolicy
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/delete-sod-policy)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/delete-sod-policy-schedule)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-custom-violation-report)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-default-violation-report)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-sod-all-report-run-status)
...
from sailpoint.v2026.api.sod_policies_api import SODPoliciesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.report_result_reference import ReportResultReference
from sailpoint.configuration import Configuration
configuration = Configuration()
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-sod-policy)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-sod-policy-schedule)
...
from sailpoint.v2026.api.sod_policies_api import SODPoliciesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.sod_policy_schedule import SodPolicySchedule
from sailpoint.configuration import Configuration
configuration = Configuration()
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-sod-violation-report-run-status)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-sod-violation-report-status)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/list-sod-policies)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/patch-sod-policy)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/put-policy-schedule)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/put-sod-policy)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/start-evaluate-sod-policy)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/start-sod-all-policies-for-org)
...
from sailpoint.v2026.api.sod_policies_api import SODPoliciesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.multi_policy_request import MultiPolicyRequest
from sailpoint.v2026.models.report_result_reference import ReportResultReference
from sailpoint.configuration import Configuration
configuration = Configuration()
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/start-sod-policy)
