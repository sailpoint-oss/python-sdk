...
keywords: ['python', 'Python', 'sdk', 'Intelligence_Package', 'V2026Intelligence_Package'] 
slug: /tools/sdk/python/v2026/methods/intelligence-package
tags: ['SDK', 'Software Development Kit', 'Intelligence_Package', 'V2026Intelligence_Package']
---

# sailpoint.v2026.IntelligencePackageApi
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = IntelligencePackageApi(api_client).get_intel_identity_access(identity_id=identity_id)
        # Below is a request that includes all optional parameters
        # results = IntelligencePackageApi(api_client).get_intel_identity_access(identity_id)
        print("The response of IntelligencePackageApi->get_intel_identity_access:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling IntelligencePackageApi->get_intel_identity_access: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = IntelligencePackageApi(api_client).get_intel_identity_access_history(identity_id=identity_id)
        # Below is a request that includes all optional parameters
        # results = IntelligencePackageApi(api_client).get_intel_identity_access_history(identity_id, limit, offset, count)
        print("The response of IntelligencePackageApi->get_intel_identity_access_history:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = IntelligencePackageApi(api_client).search_intel_identities(filters=filters)
        # Below is a request that includes all optional parameters
        # results = IntelligencePackageApi(api_client).search_intel_identities(filters)
        print("The response of IntelligencePackageApi->search_intel_identities:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling IntelligencePackageApi->search_intel_identities: %s\n" % e)
```
