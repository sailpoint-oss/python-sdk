---
id: v2026-access-profiles
title: Access_Profiles
pagination_label: Access_Profiles
sidebar_label: Access_Profiles
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'Access_Profiles', 'V2026Access_Profiles'] 
slug: /tools/sdk/python/v2026/methods/access-profiles
tags: ['SDK', 'Software Development Kit', 'Access_Profiles', 'V2026Access_Profiles']
---

# sailpoint.v2026.AccessProfilesApi
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/create-access-profile)
...
```python
from sailpoint.v2026.api.access_profiles_api import AccessProfilesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.access_profile import AccessProfile
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/delete-access-profile)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/delete-access-profiles-in-bulk)
...
from sailpoint.v2026.api.access_profiles_api import AccessProfilesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.access_profile_bulk_delete_request import AccessProfileBulkDeleteRequest
from sailpoint.v2026.models.access_profile_bulk_delete_response import AccessProfileBulkDeleteResponse
from sailpoint.configuration import Configuration
configuration = Configuration()
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-access-profile)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/get-access-profile-entitlements)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/list-access-profiles)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/patch-access-profile)
...
[API Spec](https://developer.sailpoint.com/docs/api/v2026/update-access-profiles-in-bulk)
...
from sailpoint.v2026.api.access_profiles_api import AccessProfilesApi
from sailpoint.v2026.api_client import ApiClient
from sailpoint.v2026.models.access_profile_bulk_update_request_inner import AccessProfileBulkUpdateRequestInner
from sailpoint.v2026.models.access_profile_update_item import AccessProfileUpdateItem
from sailpoint.configuration import Configuration
configuration = Configuration()
