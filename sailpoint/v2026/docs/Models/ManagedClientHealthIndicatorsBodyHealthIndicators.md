...
keywords: ['python', 'Python', 'sdk', 'ManagedClientHealthIndicatorsBodyHealthIndicators', 'V2026ManagedClientHealthIndicatorsBodyHealthIndicators'] 
slug: /tools/sdk/python/v2026/models/managed-client-health-indicators-body-health-indicators
...
```python
from sailpoint.v2026.models.managed_client_health_indicators_body_health_indicators import ManagedClientHealthIndicatorsBodyHealthIndicators
...
cpu=sailpoint.v2026.models.health_indicator_category.HealthIndicatorCategory(
                    errors = [
                        sailpoint.v2026.models.health_event.HealthEvent(
                            detailed_message = 'CPU utilization is high', 
                            uuid = '5', 
