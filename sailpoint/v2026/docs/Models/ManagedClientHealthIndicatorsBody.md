---
id: v2026-managed-client-health-indicators-body
...
keywords: ['python', 'Python', 'sdk', 'ManagedClientHealthIndicatorsBody', 'V2026ManagedClientHealthIndicatorsBody'] 
slug: /tools/sdk/python/v2026/models/managed-client-health-indicators-body
tags: ['SDK', 'Software Development Kit', 'ManagedClientHealthIndicatorsBody', 'V2026ManagedClientHealthIndicatorsBody']
---
...
```python
from sailpoint.v2026.models.managed_client_health_indicators_body import ManagedClientHealthIndicatorsBody
...
deployed_processes='',
health_indicators=sailpoint.v2026.models.managed_client_health_indicators_body_health_indicators.ManagedClientHealthIndicators_body_health_indicators(
                    container = sailpoint.v2026.models.health_indicator_category.HealthIndicatorCategory(
                        errors = [
                            sailpoint.v2026.models.health_event.HealthEvent(
                    ...
                    memory = sailpoint.v2026.models.health_indicator_category.HealthIndicatorCategory(), 
                    cpu = , )
)
