...
keywords: ['python', 'Python', 'sdk', 'SpConfigRule', 'V2026SpConfigRule'] 
slug: /tools/sdk/python/v2026/models/sp-config-rule
...
```python
from sailpoint.v2026.models.sp_config_rule import SpConfigRule
