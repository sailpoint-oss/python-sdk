...
keywords: ['python', 'Python', 'sdk', 'JsonPatch', 'V2026JsonPatch'] 
slug: /tools/sdk/python/v2026/models/json-patch
...
operations=[
                    sailpoint.v2026.models.json_patch_operation.Json Patch Operation(
                        op = 'replace', 
                        path = '/description', 
