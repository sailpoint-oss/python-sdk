...
keywords: ['python', 'Python', 'sdk', 'PutConnectorSourceTemplateRequest', 'V2026PutConnectorSourceTemplateRequest'] 
slug: /tools/sdk/python/v2026/models/put-connector-source-template-request
...
```python
from sailpoint.v2026.models.put_connector_source_template_request import PutConnectorSourceTemplateRequest
