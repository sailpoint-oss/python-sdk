---
id: v2026-entitlement-attribute-bulk-update-query-request
...
keywords: ['python', 'Python', 'sdk', 'EntitlementAttributeBulkUpdateQueryRequest', 'V2026EntitlementAttributeBulkUpdateQueryRequest'] 
slug: /tools/sdk/python/v2026/models/entitlement-attribute-bulk-update-query-request
tags: ['SDK', 'Software Development Kit', 'EntitlementAttributeBulkUpdateQueryRequest', 'V2026EntitlementAttributeBulkUpdateQueryRequest']
---
...
query=sailpoint.v2026.models.search.Search(
                    indices = [identities], 
                    query_type = 'SAILPOINT', 
                    query_version = null, 
                    query = sailpoint.v2026.models.query.Query(
                        fields = '[firstName,lastName,email]', 
                        time_zone = 'America/Chicago', 
                        inner_hit = sailpoint.v2026.models.inner_hit.InnerHit(
                            query = 'source.name:\"Active Directory\"', 
                            type = 'access', ), ), 
                    query_dsl = {match={name=john.doe}}, 
                    text_query = sailpoint.v2026.models.text_query.TextQuery(
                        terms = [The quick brown fox, 3141592, 7], 
                        fields = [displayName, employeeNumber, roleCount], 
                        match_any = False, 
                        contains = True, ), 
                    type_ahead_query = sailpoint.v2026.models.type_ahead_query.TypeAheadQuery(
                        query = 'Work', 
                        field = 'source.name', 
                        nested_type = 'access', 
                        max_expansions = 10, 
                        ...
                        sort_by_value = True, ), 
                    include_nested = True, 
                    query_result_filter = sailpoint.v2026.models.query_result_filter.QueryResultFilter(
