---
id: v2026-account-activity-searched-item
...
keywords: ['python', 'Python', 'sdk', 'AccountActivitySearchedItem', 'V2026AccountActivitySearchedItem'] 
slug: /tools/sdk/python/v2026/models/account-activity-searched-item
tags: ['SDK', 'Software Development Kit', 'AccountActivitySearchedItem', 'V2026AccountActivitySearchedItem']
---
...
```python
from sailpoint.v2026.models.account_activity_searched_item import AccountActivitySearchedItem
...
approvals=[
                    sailpoint.v2026.models.approval_1.Approval_1(
                        comments = [
                            sailpoint.v2026.models.approval_comment_2.ApprovalComment_2(
                        ...
                        owner = null, 
                        result = 'Finished', 
                        attribute_request = sailpoint.v2026.models.attribute_request.AttributeRequest(
                            name = 'groups', 
                            op = 'Add', 
                            value = null, ), 
                        source = null, )
...
original_requests=[
                    sailpoint.v2026.models.original_request.OriginalRequest(
                        account_id = 'CN=Abby Smith,OU=Austin,OU=Americas,OU=Demo,DC=seri,DC=acme,DC=com', 
                        result = sailpoint.v2026.models.result.Result(
                            status = 'Manual Task Created', ), 
                        attribute_requests = [
                            sailpoint.v2026.models.attribute_request.AttributeRequest(
                                name = 'groups', 
                                op = 'Add', 
                                value = null, )
                            ], 
...
expansion_items=[
                    sailpoint.v2026.models.expansion_item.ExpansionItem(
...
account_requests=[
                    sailpoint.v2026.models.account_request.AccountRequest(
                        account_id = 'John.Doe', 
                        attribute_requests = [
                            sailpoint.v2026.models.attribute_request.AttributeRequest(
                                name = 'groups', 
                        ...
                        result = sailpoint.v2026.models.account_request_result.AccountRequest_result(
                            errors = [
                                '[ConnectorError] [
  {
