...
keywords: ['python', 'Python', 'sdk', 'IdentitySyncPayload', 'V2026IdentitySyncPayload'] 
slug: /tools/sdk/python/v2026/models/identity-sync-payload
...
```python
from sailpoint.v2026.models.identity_sync_payload import IdentitySyncPayload
