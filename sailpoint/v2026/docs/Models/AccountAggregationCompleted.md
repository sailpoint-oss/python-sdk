---
id: v2026-account-aggregation-completed
...
keywords: ['python', 'Python', 'sdk', 'AccountAggregationCompleted', 'V2026AccountAggregationCompleted'] 
slug: /tools/sdk/python/v2026/models/account-aggregation-completed
tags: ['SDK', 'Software Development Kit', 'AccountAggregationCompleted', 'V2026AccountAggregationCompleted']
---
...
```python
from sailpoint.v2026.models.account_aggregation_completed import AccountAggregationCompleted

account_aggregation_completed = AccountAggregationCompleted(
source=sailpoint.v2026.models.account_aggregation_completed_source.AccountAggregationCompleted_source(
                    type = 'SOURCE', 
...
stats=sailpoint.v2026.models.account_aggregation_completed_stats.AccountAggregationCompleted_stats(
                    scanned = 200, 
                    unchanged = 190, 
                    changed = 6, 
                    added = 4, 
