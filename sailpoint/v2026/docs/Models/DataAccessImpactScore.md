...
keywords: ['python', 'Python', 'sdk', 'DataAccessImpactScore', 'V2026DataAccessImpactScore'] 
slug: /tools/sdk/python/v2026/models/data-access-impact-score
...
```python
from sailpoint.v2026.models.data_access_impact_score import DataAccessImpactScore
