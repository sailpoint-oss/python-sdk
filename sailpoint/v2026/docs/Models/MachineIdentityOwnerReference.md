...
keywords: ['python', 'Python', 'sdk', 'MachineIdentityOwnerReference', 'V2026MachineIdentityOwnerReference'] 
slug: /tools/sdk/python/v2026/models/machine-identity-owner-reference
...
```python
from sailpoint.v2026.models.machine_identity_owner_reference import MachineIdentityOwnerReference
