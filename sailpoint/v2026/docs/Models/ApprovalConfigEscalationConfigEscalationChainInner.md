---
id: v2026-approval-config-escalation-config-escalation-chain-inner
...
keywords: ['python', 'Python', 'sdk', 'ApprovalConfigEscalationConfigEscalationChainInner', 'V2026ApprovalConfigEscalationConfigEscalationChainInner'] 
slug: /tools/sdk/python/v2026/models/approval-config-escalation-config-escalation-chain-inner
tags: ['SDK', 'Software Development Kit', 'ApprovalConfigEscalationConfigEscalationChainInner', 'V2026ApprovalConfigEscalationConfigEscalationChainInner']
---
...
```python
from sailpoint.v2026.models.approval_config_escalation_config_escalation_chain_inner import ApprovalConfigEscalationConfigEscalationChainInner
