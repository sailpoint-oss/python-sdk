...
keywords: ['python', 'Python', 'sdk', 'Schedule', 'V2026Schedule'] 
slug: /tools/sdk/python/v2026/models/schedule
tags: ['SDK', 'Software Development Kit', 'Schedule', 'V2026Schedule']
---
...
schedule = Schedule(
type='WEEKLY',
months=sailpoint.v2026.models.schedule_months.Schedule_months(
                    type = 'LIST', 
                    values = [1], 
                    interval = 2, ),
days=sailpoint.v2026.models.schedule_days.Schedule_days(
                    type = 'LIST', 
                    values = [1], 
                    interval = 2, ),
hours=sailpoint.v2026.models.schedule_hours.Schedule_hours(
                    type = 'LIST', 
                    values = [1], 
                    interval = 2, ),
