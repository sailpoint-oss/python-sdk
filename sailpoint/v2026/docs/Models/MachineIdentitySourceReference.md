...
keywords: ['python', 'Python', 'sdk', 'MachineIdentitySourceReference', 'V2026MachineIdentitySourceReference'] 
slug: /tools/sdk/python/v2026/models/machine-identity-source-reference
...
```python
from sailpoint.v2026.models.machine_identity_source_reference import MachineIdentitySourceReference
