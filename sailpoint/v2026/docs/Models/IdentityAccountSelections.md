---
id: v2026-identity-account-selections
title: IdentityAccountSelections
pagination_label: IdentityAccountSelections
sidebar_label: IdentityAccountSelections
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'IdentityAccountSelections', 'V2026IdentityAccountSelections'] 
slug: /tools/sdk/python/v2026/models/identity-account-selections
tags: ['SDK', 'Software Development Kit', 'IdentityAccountSelections', 'V2026IdentityAccountSelections']
---
...
```python
from sailpoint.v2026.models.identity_account_selections import IdentityAccountSelections

identity_account_selections = IdentityAccountSelections(
requested_items=[
                    sailpoint.v2026.models.requested_item_account_selections.RequestedItemAccountSelections(
                        ...
                        sources = [
                            sailpoint.v2026.models.source_account_selections.SourceAccountSelections(
                                type = 'IDENTITY', 
                                id = '3ac3c43785a845fa9820b0c1ac767cd5', 
                                name = 'Test Source_Name', 
                                accounts = [
                                    sailpoint.v2026.models.account_info_ref.AccountInfoRef(
