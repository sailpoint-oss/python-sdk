...
keywords: ['python', 'Python', 'sdk', 'NestedConfig', 'V2026NestedConfig'] 
slug: /tools/sdk/python/v2026/models/nested-config
...
```python
from sailpoint.v2026.models.nested_config import NestedConfig
