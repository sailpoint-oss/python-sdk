...
keywords: ['python', 'Python', 'sdk', 'ManagedClusterQueue', 'V2026ManagedClusterQueue'] 
slug: /tools/sdk/python/v2026/models/managed-cluster-queue
...
```python
from sailpoint.v2026.models.managed_cluster_queue import ManagedClusterQueue
