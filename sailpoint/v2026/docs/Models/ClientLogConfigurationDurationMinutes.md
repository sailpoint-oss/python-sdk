---
id: v2026-client-log-configuration-duration-minutes
...
keywords: ['python', 'Python', 'sdk', 'ClientLogConfigurationDurationMinutes', 'V2026ClientLogConfigurationDurationMinutes'] 
slug: /tools/sdk/python/v2026/models/client-log-configuration-duration-minutes
tags: ['SDK', 'Software Development Kit', 'ClientLogConfigurationDurationMinutes', 'V2026ClientLogConfigurationDurationMinutes']
---
...
```python
from sailpoint.v2026.models.client_log_configuration_duration_minutes import ClientLogConfigurationDurationMinutes
