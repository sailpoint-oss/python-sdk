...
keywords: ['python', 'Python', 'sdk', 'RolePropagationStatusResponseLaunchedBy', 'V2026RolePropagationStatusResponseLaunchedBy'] 
slug: /tools/sdk/python/v2026/models/role-propagation-status-response-launched-by
...
```python
from sailpoint.v2026.models.role_propagation_status_response_launched_by import RolePropagationStatusResponseLaunchedBy
