---
id: v2026-machine-identity-aggregation-response
...
keywords: ['python', 'Python', 'sdk', 'MachineIdentityAggregationResponse', 'V2026MachineIdentityAggregationResponse'] 
slug: /tools/sdk/python/v2026/models/machine-identity-aggregation-response
tags: ['SDK', 'Software Development Kit', 'MachineIdentityAggregationResponse', 'V2026MachineIdentityAggregationResponse']
---
...
```python
from sailpoint.v2026.models.machine_identity_aggregation_response import MachineIdentityAggregationResponse
...
task_definition_summary=sailpoint.v2026.models.task_definition_summary.Task Definition Summary(
...
messages=[
                    sailpoint.v2026.models.task_status_message.Task Status Message(
                        type = 'INFO', 
                        localized_text = sailpoint.v2026.models.localized_message.Localized Message(
...
returns=[
                    sailpoint.v2026.models.task_return_details.Task Return Details(
                        name = 'label', 
