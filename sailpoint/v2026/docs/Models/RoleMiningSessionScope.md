---
id: v2026-role-mining-session-scope
title: RoleMiningSessionScope
pagination_label: RoleMiningSessionScope
sidebar_label: RoleMiningSessionScope
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'RoleMiningSessionScope', 'V2026RoleMiningSessionScope'] 
slug: /tools/sdk/python/v2026/models/role-mining-session-scope
tags: ['SDK', 'Software Development Kit', 'RoleMiningSessionScope', 'V2026RoleMiningSessionScope']
---
...
```python
from sailpoint.v2026.models.role_mining_session_scope import RoleMiningSessionScope
