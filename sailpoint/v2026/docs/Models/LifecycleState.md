---
id: v2026-lifecycle-state
title: LifecycleState
pagination_label: LifecycleState
sidebar_label: LifecycleState
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'LifecycleState', 'V2026LifecycleState'] 
slug: /tools/sdk/python/v2026/models/lifecycle-state
tags: ['SDK', 'Software Development Kit', 'LifecycleState', 'V2026LifecycleState']
---
...
identity_count=42,
email_notification_option=sailpoint.v2026.models.email_notification_option.Email Notification Option(
                    notify_managers = True, 
                    notify_all_admins = True, 
                    notify_specific_users = True, 
                    email_address_list = [test@test.com, test2@test.com], ),
account_actions=[
                    sailpoint.v2026.models.account_action.Account Action(
                        action = 'ENABLE', 
...
access_action_configuration=sailpoint.v2026.models.access_action_configuration.Access Action Configuration(
