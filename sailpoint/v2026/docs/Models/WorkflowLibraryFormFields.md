---
id: v2026-workflow-library-form-fields
title: WorkflowLibraryFormFields
pagination_label: WorkflowLibraryFormFields
sidebar_label: WorkflowLibraryFormFields
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'WorkflowLibraryFormFields', 'V2026WorkflowLibraryFormFields'] 
slug: /tools/sdk/python/v2026/models/workflow-library-form-fields
tags: ['SDK', 'Software Development Kit', 'WorkflowLibraryFormFields', 'V2026WorkflowLibraryFormFields']
---
...
```python
from sailpoint.v2026.models.workflow_library_form_fields import WorkflowLibraryFormFields
