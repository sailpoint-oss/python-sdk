---
id: v2026-account-all-of-source-owner
title: AccountAllOfSourceOwner
pagination_label: AccountAllOfSourceOwner
sidebar_label: AccountAllOfSourceOwner
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'AccountAllOfSourceOwner', 'V2026AccountAllOfSourceOwner'] 
slug: /tools/sdk/python/v2026/models/account-all-of-source-owner
tags: ['SDK', 'Software Development Kit', 'AccountAllOfSourceOwner', 'V2026AccountAllOfSourceOwner']
---
...
```python
from sailpoint.v2026.models.account_all_of_source_owner import AccountAllOfSourceOwner
