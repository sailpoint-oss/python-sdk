...
keywords: ['python', 'Python', 'sdk', 'RoleAssignmentDtoAssigner', 'V2026RoleAssignmentDtoAssigner'] 
slug: /tools/sdk/python/v2026/models/role-assignment-dto-assigner
...
```python
from sailpoint.v2026.models.role_assignment_dto_assigner import RoleAssignmentDtoAssigner
