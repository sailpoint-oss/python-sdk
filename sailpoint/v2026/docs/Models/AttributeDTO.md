---
id: v2026-attribute-dto
title: AttributeDTO
pagination_label: AttributeDTO
sidebar_label: AttributeDTO
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'AttributeDTO', 'V2026AttributeDTO'] 
slug: /tools/sdk/python/v2026/models/attribute-dto
tags: ['SDK', 'Software Development Kit', 'AttributeDTO', 'V2026AttributeDTO']
---
...
values=[
                    sailpoint.v2026.models.attribute_value_dto.AttributeValueDTO(
                        value = 'public', 
                        name = 'Public', 
                        status = 'active', )
                    ]
