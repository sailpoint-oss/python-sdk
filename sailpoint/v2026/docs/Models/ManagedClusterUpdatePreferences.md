...
keywords: ['python', 'Python', 'sdk', 'ManagedClusterUpdatePreferences', 'V2026ManagedClusterUpdatePreferences'] 
slug: /tools/sdk/python/v2026/models/managed-cluster-update-preferences
...
```python
from sailpoint.v2026.models.managed_cluster_update_preferences import ManagedClusterUpdatePreferences
