---
id: v2026-trigger-example-output
title: TriggerExampleOutput
pagination_label: TriggerExampleOutput
sidebar_label: TriggerExampleOutput
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'TriggerExampleOutput', 'V2026TriggerExampleOutput'] 
slug: /tools/sdk/python/v2026/models/trigger-example-output
tags: ['SDK', 'Software Development Kit', 'TriggerExampleOutput', 'V2026TriggerExampleOutput']
---
...
```python
from sailpoint.v2026.models.trigger_example_output import TriggerExampleOutput
