...
keywords: ['python', 'Python', 'sdk', 'MachineIdentityUpdatedUserEntitlementChanges', 'V2026MachineIdentityUpdatedUserEntitlementChanges'] 
slug: /tools/sdk/python/v2026/models/machine-identity-updated-user-entitlement-changes
...
```python
from sailpoint.v2026.models.machine_identity_updated_user_entitlement_changes import MachineIdentityUpdatedUserEntitlementChanges
