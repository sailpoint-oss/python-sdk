---
id: v2026-role-document-all-of-dimensions
...
keywords: ['python', 'Python', 'sdk', 'RoleDocumentAllOfDimensions', 'V2026RoleDocumentAllOfDimensions'] 
slug: /tools/sdk/python/v2026/models/role-document-all-of-dimensions
tags: ['SDK', 'Software Development Kit', 'RoleDocumentAllOfDimensions', 'V2026RoleDocumentAllOfDimensions']
---
...
```python
from sailpoint.v2026.models.role_document_all_of_dimensions import RoleDocumentAllOfDimensions
