---
id: v2026-sub-search-aggregation-specification
...
keywords: ['python', 'Python', 'sdk', 'SubSearchAggregationSpecification', 'V2026SubSearchAggregationSpecification'] 
slug: /tools/sdk/python/v2026/models/sub-search-aggregation-specification
tags: ['SDK', 'Software Development Kit', 'SubSearchAggregationSpecification', 'V2026SubSearchAggregationSpecification']
---
...
```python
from sailpoint.v2026.models.sub_search_aggregation_specification import SubSearchAggregationSpecification
...
bucket=sailpoint.v2026.models.bucket_aggregation.BucketAggregation(
                    ...
                    size = 100, 
                    min_doc_count = 2, ),
sub_aggregation=sailpoint.v2026.models.aggregations.Aggregations(
                    nested = sailpoint.v2026.models.nested_aggregation.NestedAggregation(
                        name = 'id', 
                        type = 'access', ), 
                    metric = sailpoint.v2026.models.metric_aggregation.MetricAggregation(
