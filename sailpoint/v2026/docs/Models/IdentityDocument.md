---
id: v2026-identity-document
title: IdentityDocument
pagination_label: IdentityDocument
sidebar_label: IdentityDocument
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'IdentityDocument', 'V2026IdentityDocument'] 
slug: /tools/sdk/python/v2026/models/identity-document
tags: ['SDK', 'Software Development Kit', 'IdentityDocument', 'V2026IdentityDocument']
---
...
```python
from sailpoint.v2026.models.identity_document import IdentityDocument
...
manager=sailpoint.v2026.models.identity_document_all_of_manager.IdentityDocument_allOf_manager(
                    id = '2c9180867dfe694b017e208e27c05799', 
                    name = 'Amanda.Ross', 
                    display_name = 'Amanda.Ross', ),
is_manager=False,
identity_profile=sailpoint.v2026.models.identity_document_all_of_identity_profile.IdentityDocument_allOf_identityProfile(
                    id = '3bc8ad26b8664945866b31339d1ff7d2', 
                    name = 'HR Employees', ),
source=sailpoint.v2026.models.identity_document_all_of_source.IdentityDocument_allOf_source(
...
processing_details=sailpoint.v2026.models.processing_details.ProcessingDetails(
...
owns=[
                    sailpoint.v2026.models.owns.Owns(
                        sources = [
                            sailpoint.v2026.models.reference.Reference(
                                id = '2c91808568c529c60168cca6f90c1313', 
                                name = 'John Doe', )
                            ], 
                        entitlements = [
