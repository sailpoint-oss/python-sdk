---
id: v2026-non-employee-source-with-cloud-external-id
...
keywords: ['python', 'Python', 'sdk', 'NonEmployeeSourceWithCloudExternalId', 'V2026NonEmployeeSourceWithCloudExternalId'] 
slug: /tools/sdk/python/v2026/models/non-employee-source-with-cloud-external-id
tags: ['SDK', 'Software Development Kit', 'NonEmployeeSourceWithCloudExternalId', 'V2026NonEmployeeSourceWithCloudExternalId']
---
...
approvers=[
                    sailpoint.v2026.models.non_employee_identity_reference_with_id.NonEmployeeIdentityReferenceWithId(
                        type = 'IDENTITY', 
