---
id: v2026-accounts-selection-response
title: AccountsSelectionResponse
pagination_label: AccountsSelectionResponse
sidebar_label: AccountsSelectionResponse
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'AccountsSelectionResponse', 'V2026AccountsSelectionResponse'] 
slug: /tools/sdk/python/v2026/models/accounts-selection-response
tags: ['SDK', 'Software Development Kit', 'AccountsSelectionResponse', 'V2026AccountsSelectionResponse']
---
...
identities=[
                    sailpoint.v2026.models.identity_account_selections.IdentityAccountSelections(
                        requested_items = [
