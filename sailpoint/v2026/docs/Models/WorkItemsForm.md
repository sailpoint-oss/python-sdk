---
id: v2026-work-items-form
title: WorkItemsForm
pagination_label: WorkItemsForm
sidebar_label: WorkItemsForm
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'WorkItemsForm', 'V2026WorkItemsForm'] 
slug: /tools/sdk/python/v2026/models/work-items-form
tags: ['SDK', 'Software Development Kit', 'WorkItemsForm', 'V2026WorkItemsForm']
---
...
```python
from sailpoint.v2026.models.work_items_form import WorkItemsForm
...
sections=[
                    sailpoint.v2026.models.section_details.Section Details()
                    ]
)
