...
keywords: ['python', 'Python', 'sdk', 'ApprovalConfigTimeoutConfig', 'V2026ApprovalConfigTimeoutConfig'] 
slug: /tools/sdk/python/v2026/models/approval-config-timeout-config
...
```python
from sailpoint.v2026.models.approval_config_timeout_config import ApprovalConfigTimeoutConfig
