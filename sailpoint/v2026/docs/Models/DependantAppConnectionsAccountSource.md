---
id: v2026-dependant-app-connections-account-source
...
keywords: ['python', 'Python', 'sdk', 'DependantAppConnectionsAccountSource', 'V2026DependantAppConnectionsAccountSource'] 
slug: /tools/sdk/python/v2026/models/dependant-app-connections-account-source
tags: ['SDK', 'Software Development Kit', 'DependantAppConnectionsAccountSource', 'V2026DependantAppConnectionsAccountSource']
---
...
```python
from sailpoint.v2026.models.dependant_app_connections_account_source import DependantAppConnectionsAccountSource
