...
keywords: ['python', 'Python', 'sdk', 'BearerTokenAuthConfig', 'V2026BearerTokenAuthConfig'] 
slug: /tools/sdk/python/v2026/models/bearer-token-auth-config
...
```python
from sailpoint.v2026.models.bearer_token_auth_config import BearerTokenAuthConfig
