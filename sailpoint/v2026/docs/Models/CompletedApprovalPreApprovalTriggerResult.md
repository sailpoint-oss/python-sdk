---
id: v2026-completed-approval-pre-approval-trigger-result
...
keywords: ['python', 'Python', 'sdk', 'CompletedApprovalPreApprovalTriggerResult', 'V2026CompletedApprovalPreApprovalTriggerResult'] 
slug: /tools/sdk/python/v2026/models/completed-approval-pre-approval-trigger-result
tags: ['SDK', 'Software Development Kit', 'CompletedApprovalPreApprovalTriggerResult', 'V2026CompletedApprovalPreApprovalTriggerResult']
---
...
```python
from sailpoint.v2026.models.completed_approval_pre_approval_trigger_result import CompletedApprovalPreApprovalTriggerResult
