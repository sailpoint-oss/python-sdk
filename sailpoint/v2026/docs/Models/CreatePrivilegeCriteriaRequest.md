...
keywords: ['python', 'Python', 'sdk', 'CreatePrivilegeCriteriaRequest', 'V2026CreatePrivilegeCriteriaRequest'] 
slug: /tools/sdk/python/v2026/models/create-privilege-criteria-request
...
operator='AND',
groups=[
                    sailpoint.v2026.models.create_privilege_criteria_request_groups_inner.CreatePrivilegeCriteriaRequest_groups_inner(
                        operator = 'AND', 
                        criteria_items = [
