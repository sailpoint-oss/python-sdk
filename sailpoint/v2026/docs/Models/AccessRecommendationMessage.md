...
keywords: ['python', 'Python', 'sdk', 'AccessRecommendationMessage', 'V2026AccessRecommendationMessage'] 
slug: /tools/sdk/python/v2026/models/access-recommendation-message
...
```python
from sailpoint.v2026.models.access_recommendation_message import AccessRecommendationMessage
