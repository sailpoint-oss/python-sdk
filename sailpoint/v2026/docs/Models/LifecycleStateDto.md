...
keywords: ['python', 'Python', 'sdk', 'LifecycleStateDto', 'V2026LifecycleStateDto'] 
slug: /tools/sdk/python/v2026/models/lifecycle-state-dto
...
```python
from sailpoint.v2026.models.lifecycle_state_dto import LifecycleStateDto
