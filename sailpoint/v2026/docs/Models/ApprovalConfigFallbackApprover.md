...
keywords: ['python', 'Python', 'sdk', 'ApprovalConfigFallbackApprover', 'V2026ApprovalConfigFallbackApprover'] 
slug: /tools/sdk/python/v2026/models/approval-config-fallback-approver
...
```python
from sailpoint.v2026.models.approval_config_fallback_approver import ApprovalConfigFallbackApprover

approval_config_fallback_approver = ApprovalConfigFallbackApprover(
