...
keywords: ['python', 'Python', 'sdk', 'TemplateSlackCustomFields', 'V2026TemplateSlackCustomFields'] 
slug: /tools/sdk/python/v2026/models/template-slack-custom-fields
...
```python
from sailpoint.v2026.models.template_slack_custom_fields import TemplateSlackCustomFields
