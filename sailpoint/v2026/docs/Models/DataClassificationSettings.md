...
keywords: ['python', 'Python', 'sdk', 'DataClassificationSettings', 'V2026DataClassificationSettings'] 
slug: /tools/sdk/python/v2026/models/data-classification-settings
...
```python
from sailpoint.v2026.models.data_classification_settings import DataClassificationSettings
