...
keywords: ['python', 'Python', 'sdk', 'QueryResultFilter', 'V2026QueryResultFilter'] 
slug: /tools/sdk/python/v2026/models/query-result-filter
...
```python
from sailpoint.v2026.models.query_result_filter import QueryResultFilter
