...
keywords: ['python', 'Python', 'sdk', 'TemplateSlackAutoApprovalData', 'V2026TemplateSlackAutoApprovalData'] 
slug: /tools/sdk/python/v2026/models/template-slack-auto-approval-data
...
```python
from sailpoint.v2026.models.template_slack_auto_approval_data import TemplateSlackAutoApprovalData
