...
keywords: ['python', 'Python', 'sdk', 'Scope', 'V2026Scope'] 
slug: /tools/sdk/python/v2026/models/scope
...
```python
from sailpoint.v2026.models.scope import Scope

scope = Scope(
scope='ALL',
visibility='ALL',
scope_filter=sailpoint.v2026.models.visibility_criteria.Visibility Criteria(
