---
id: v2026-sp-config-export-results
title: SpConfigExportResults
pagination_label: SpConfigExportResults
sidebar_label: SpConfigExportResults
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'SpConfigExportResults', 'V2026SpConfigExportResults'] 
slug: /tools/sdk/python/v2026/models/sp-config-export-results
tags: ['SDK', 'Software Development Kit', 'SpConfigExportResults', 'V2026SpConfigExportResults']
---
...
options=sailpoint.v2026.models.export_options.Export Options(
                    exclude_types = [
                        'SOURCE'
                        ], 
                    include_types = [
...
objects=[
                    sailpoint.v2026.models.config_object_for_export_and_import.Config Object for Export and Import(
                        version = 1, 
                        self = sailpoint.v2026.models.self_import_export_dto.Self Import Export Dto(
                            type = 'SOURCE', 
