---
id: v2026-machine-identity-created-machine-identity
...
keywords: ['python', 'Python', 'sdk', 'MachineIdentityCreatedMachineIdentity', 'V2026MachineIdentityCreatedMachineIdentity'] 
slug: /tools/sdk/python/v2026/models/machine-identity-created-machine-identity
tags: ['SDK', 'Software Development Kit', 'MachineIdentityCreatedMachineIdentity', 'V2026MachineIdentityCreatedMachineIdentity']
---
...
```python
from sailpoint.v2026.models.machine_identity_created_machine_identity import MachineIdentityCreatedMachineIdentity

machine_identity_created_machine_identity = MachineIdentityCreatedMachineIdentity(
