...
class TestSourceDatasetResource(unittest.TestCase):
    """SourceDatasetResource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SourceDatasetResource:
        """Test SourceDatasetResource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SourceDatasetResource`
        """
        model = SourceDatasetResource()
        if include_optional:
            return SourceDatasetResource(
                id = 'aws:iam-role',
                name = 'Account',
    ...
    def testSourceDatasetResource(self):
        """Test SourceDatasetResource"""
