...
class TestHumanAccountDeletionApprovalConfigApi(unittest.TestCase):
    """HumanAccountDeletionApprovalConfigApi unit test stubs"""

    def setUp(self) -> None:
        self.api = HumanAccountDeletionApprovalConfigApi()
