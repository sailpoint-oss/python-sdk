...
class TestCreateScheduledSearchRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateScheduledSearchRequest:
        """Test CreateScheduledSearchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateScheduledSearchRequest`
        """
        model = CreateScheduledSearchRequest()
        if include_optional:
    ...
    def testCreateScheduledSearchRequest(self):
        """Test CreateScheduledSearchRequest"""
