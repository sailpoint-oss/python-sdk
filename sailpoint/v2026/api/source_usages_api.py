...
class SourceUsagesApi:
    ...
    def get_status_by_source_id(
        ...
        _param = self._get_status_by_source_id_serialize(
            source_id=source_id,
    ...
    @validate_call
    def get_status_by_source_id_without_preload_content(
        self,
        source_id: Annotated[StrictStr, Field(description="ID of IDN source")],
        _request_timeout: Union[
            None,
    ...
    def _get_status_by_source_id_serialize(
        self,
        source_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/source-usages/{sourceId}/status',
    ...
    def get_usages_by_source_id(
        ...
        _param = self._get_usages_by_source_id_serialize(
            source_id=source_id,
            limit=limit,
            offset=offset,
            count=count,
    ...
    @validate_call
    def get_usages_by_source_id_without_preload_content(
        self,
        source_id: Annotated[StrictStr, Field(description="ID of IDN source")],
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _get_usages_by_source_id_serialize(
        self,
        source_id,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/source-usages/{sourceId}/summaries',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
