...
class AuthUsersApi:
    ...
    def get_auth_user(
        ...
        _param = self._get_auth_user_serialize(
            id=id,
    ...
    @validate_call
    def get_auth_user_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Identity ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_auth_user_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Identity ID")],
        _request_timeout: Union[
            None,
    ...
    def patch_auth_user(
        ...
        _param = self._patch_auth_user_serialize(
            id=id,
    ...
    @validate_call
    def patch_auth_user_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Identity ID")],
        json_patch_operation: Annotated[List[JsonPatchOperation], Field(description="A list of auth user update operations according to the [JSON Patch](https://tools.ietf.org/html/rfc6902) standard.")],
        _request_timeout: Union[
    ...
    @validate_call
    def patch_auth_user_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Identity ID")],
        json_patch_operation: Annotated[List[JsonPatchOperation], Field(description="A list of auth user update operations according to the [JSON Patch](https://tools.ietf.org/html/rfc6902) standard.")],
        _request_timeout: Union[
    ...
    def _patch_auth_user_serialize(
        self,
        id,
