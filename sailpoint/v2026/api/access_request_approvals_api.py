...
class AccessRequestApprovalsApi:
    ...
    @validate_call
    def list_access_request_approvers(
        self,
        ...
        _param = self._list_access_request_approvers_serialize(
    ...
    @validate_call
    def list_access_request_approvers_with_http_info(
        self,
        access_request_id: Annotated[StrictStr, Field(description="Access Request ID.")],
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. Defaults to 0 if not specified.")] = None,
    ...
    @validate_call
    def list_access_request_approvers_without_preload_content(
        self,
        access_request_id: Annotated[StrictStr, Field(description="Access Request ID.")],
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. Defaults to 0 if not specified.")] = None,
    ...
    def _list_access_request_approvers_serialize(
        self,
        access_request_id,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/access-request-approvals/{accessRequestId}/approvers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
