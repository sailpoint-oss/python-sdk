...
class MachineAccountSubtypesApi:
    ...
    def create_source_subtype(
        ...
        :param create_source_subtype_request: (required)
        :type create_source_subtype_request: CreateSourceSubtypeRequest
        ...
        _param = self._create_source_subtype_serialize(
            x_sail_point_experimental=x_sail_point_experimental,
            create_source_subtype_request=create_source_subtype_request,
    ...
    @validate_call
    def create_source_subtype_with_http_info(
        self,
        create_source_subtype_request: CreateSourceSubtypeRequest,
        x_sail_point_experimental: Annotated[StrictStr, Field(description="Use this header to enable this experimental API.")] = 'true',
        _request_timeout: Union[
    ...
    @validate_call
    def create_source_subtype_without_preload_content(
        self,
        create_source_subtype_request: CreateSourceSubtypeRequest,
        x_sail_point_experimental: Annotated[StrictStr, Field(description="Use this header to enable this experimental API.")] = 'true',
        _request_timeout: Union[
    ...
    def _create_source_subtype_serialize(
        self,
        x_sail_point_experimental,
        create_source_subtype_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if create_source_subtype_request is not None:
            _body_params = create_source_subtype_request
    ...
    def _delete_machine_account_subtype_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/source-subtypes/{subtypeId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_source_subtype_by_id(
        ...
        _param = self._get_source_subtype_by_id_serialize(
            subtype_id=subtype_id,
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_source_subtype_by_id_with_http_info(
        self,
        subtype_id: Annotated[StrictStr, Field(description="The ID of the subtype.")],
        x_sail_point_experimental: Annotated[StrictStr, Field(description="Use this header to enable this experimental API.")] = 'true',
        _request_timeout: Union[
    ...
    @validate_call
    def get_source_subtype_by_id_without_preload_content(
        self,
        subtype_id: Annotated[StrictStr, Field(description="The ID of the subtype.")],
        x_sail_point_experimental: Annotated[StrictStr, Field(description="Use this header to enable this experimental API.")] = 'true',
        _request_timeout: Union[
    ...
    def _get_source_subtype_by_id_serialize(
        self,
        subtype_id,
        x_sail_point_experimental,
        _request_auth,
    ...
    def list_source_subtypes(
        ...
        _param = self._list_source_subtypes_serialize(
            x_sail_point_experimental=x_sail_point_experimental,
            filters=filters,
            sorters=sorters,
            count=count,
    ...
    @validate_call
    def list_source_subtypes_with_http_info(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **id**: *eq, in, sw*  **displayName**: *eq, sw*  **technicalName**: *eq, sw*  **source.id**: *eq, in*")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **displayName, technicalName**")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def list_source_subtypes_without_preload_content(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **id**: *eq, in, sw*  **displayName**: *eq, sw*  **technicalName**: *eq, sw*  **source.id**: *eq, in*")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **displayName, technicalName**")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _list_source_subtypes_serialize(
        self,
        x_sail_point_experimental,
        filters,
        sorters,
