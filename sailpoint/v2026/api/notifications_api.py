...
class NotificationsApi:
    ...
    def get_notification_template_variables(
        ...
        _param = self._get_notification_template_variables_serialize(
            key=key,
            medium=medium,
            sorters=sorters,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_notification_template_variables_with_http_info(
        self,
        key: Annotated[StrictStr, Field(description="The notification template key. Valid keys (and key/medium pairs) are available from the list notification templates operation. ")],
        medium: Annotated[StrictStr, Field(description="The notification template medium (e.g. EMAIL, SLACK, TEAMS). Valid key/medium pairs are available from the list notification templates operation. ")],
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **key, type, description**")] = None,
    ...
    @validate_call
    def get_notification_template_variables_without_preload_content(
        self,
        key: Annotated[StrictStr, Field(description="The notification template key. Valid keys (and key/medium pairs) are available from the list notification templates operation. ")],
        medium: Annotated[StrictStr, Field(description="The notification template medium (e.g. EMAIL, SLACK, TEAMS). Valid key/medium pairs are available from the list notification templates operation. ")],
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **key, type, description**")] = None,
    ...
    def _get_notification_template_variables_serialize(
        self,
        key,
        medium,
        sorters,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/notification-template-variables/{key}/{medium}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
