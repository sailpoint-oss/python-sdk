...
class IAIAccessRequestRecommendationsApi:
    ...
    @validate_call
    def get_access_request_recommendations_config(
        self,
        x_sail_point_experimental: Annotated[StrictStr, Field(description="Use this header to enable this experimental API.")] = 'true',
        _request_timeout: Union[
            None,
        ...
        _param = self._get_access_request_recommendations_config_serialize(
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_access_request_recommendations_config_with_http_info(
        self,
        x_sail_point_experimental: Annotated[StrictStr, Field(description="Use this header to enable this experimental API.")] = 'true',
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_access_request_recommendations_config_without_preload_content(
        self,
        x_sail_point_experimental: Annotated[StrictStr, Field(description="Use this header to enable this experimental API.")] = 'true',
        _request_timeout: Union[
            None,
    ...
    def _get_access_request_recommendations_config_serialize(
        self,
        x_sail_point_experimental,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ai-access-request-recommendations/config',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def set_access_request_recommendations_config(
        self,
        ...
        _param = self._set_access_request_recommendations_config_serialize(
            x_sail_point_experimental=x_sail_point_experimental,
    ...
    @validate_call
    def set_access_request_recommendations_config_with_http_info(
        self,
        access_request_recommendation_config_dto: Annotated[AccessRequestRecommendationConfigDto, Field(description="The desired configurations for Access Request Recommender for the tenant.")],
        x_sail_point_experimental: Annotated[StrictStr, Field(description="Use this header to enable this experimental API.")] = 'true',
        _request_timeout: Union[
    ...
    @validate_call
    def set_access_request_recommendations_config_without_preload_content(
        self,
        access_request_recommendation_config_dto: Annotated[AccessRequestRecommendationConfigDto, Field(description="The desired configurations for Access Request Recommender for the tenant.")],
        x_sail_point_experimental: Annotated[StrictStr, Field(description="Use this header to enable this experimental API.")] = 'true',
        _request_timeout: Union[
    ...
    def _set_access_request_recommendations_config_serialize(
        self,
        x_sail_point_experimental,
