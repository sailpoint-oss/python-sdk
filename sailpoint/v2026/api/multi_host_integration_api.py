...
class MultiHostIntegrationApi:
    ...
    def delete_multi_host_sources(
        ...
        _param = self._delete_multi_host_sources_serialize(
    ...
    @validate_call
    def delete_multi_host_sources_with_http_info(
        self,
        multi_host_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration")],
        request_body: Annotated[List[StrictStr], Field(description="The delete bulk sources within multi-host integration request body")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_multi_host_sources_without_preload_content(
        self,
        multi_host_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration")],
        request_body: Annotated[List[StrictStr], Field(description="The delete bulk sources within multi-host integration request body")],
        _request_timeout: Union[
    ...
    def _delete_multi_host_sources_serialize(
        self,
        multi_host_id,
        request_body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/multihosts/{multiHostId}/sources/bulk-delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
