...
class PrivilegeCriteriaApi:
    ...
    @validate_call
    def create_custom_privilege_criteria(
        self,
        ...
        _param = self._create_custom_privilege_criteria_serialize(
    ...
    @validate_call
    def create_custom_privilege_criteria_with_http_info(
        self,
        create_privilege_criteria_request: Annotated[CreatePrivilegeCriteriaRequest, Field(description="Create custom privilege criteria request body.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_custom_privilege_criteria_without_preload_content(
        self,
        create_privilege_criteria_request: Annotated[CreatePrivilegeCriteriaRequest, Field(description="Create custom privilege criteria request body.")],
        _request_timeout: Union[
            None,
    ...
    def _create_custom_privilege_criteria_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/criteria/privilege',
    ...
    @validate_call
    def delete_custom_privilege_criteria(
        self,
        criteria_id: Annotated[StrictStr, Field(description="The Id of the custom privilege criteria to delete.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param criteria_id: The Id of the custom privilege criteria to delete. (required)
        ...
        _param = self._delete_custom_privilege_criteria_serialize(
    ...
    @validate_call
    def delete_custom_privilege_criteria_with_http_info(
        self,
        criteria_id: Annotated[StrictStr, Field(description="The Id of the custom privilege criteria to delete.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_custom_privilege_criteria_without_preload_content(
        self,
        criteria_id: Annotated[StrictStr, Field(description="The Id of the custom privilege criteria to delete.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_custom_privilege_criteria_serialize(
        self,
        criteria_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/criteria/privilege/{criteriaId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_privilege_criteria(
        ...
        _param = self._get_privilege_criteria_serialize(
            criteria_id=criteria_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_privilege_criteria_with_http_info(
        self,
        criteria_id: Annotated[StrictStr, Field(description="The Id of the privilege criteria record to return.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_privilege_criteria_without_preload_content(
        self,
        criteria_id: Annotated[StrictStr, Field(description="The Id of the privilege criteria record to return.")],
        _request_timeout: Union[
            None,
    ...
    def _get_privilege_criteria_serialize(
        self,
        criteria_id,
        _request_auth,
        _content_type,
    ...
    def list_privilege_criteria(
        ...
        :param filters: Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **type**: *eq*  **sourceId**: *eq*  **privilegeLevel**: *eq*  **Supported composite operators**: *and*  All filter values are case-sensitive for this API.  For example, the following is valid: `?filters=type eq \"CUSTOM\" and sourceId eq \"2c91809175e6c63f0175fb5570220569\"` (required)
        :type filters: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._list_privilege_criteria_serialize(
            filters=filters,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_privilege_criteria_with_http_info(
        self,
        filters: Annotated[StrictStr, Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **type**: *eq*  **sourceId**: *eq*  **privilegeLevel**: *eq*  **Supported composite operators**: *and*  All filter values are case-sensitive for this API.  For example, the following is valid: `?filters=type eq \"CUSTOM\" and sourceId eq \"2c91809175e6c63f0175fb5570220569\"`")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_privilege_criteria_without_preload_content(
        self,
        filters: Annotated[StrictStr, Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **type**: *eq*  **sourceId**: *eq*  **privilegeLevel**: *eq*  **Supported composite operators**: *and*  All filter values are case-sensitive for this API.  For example, the following is valid: `?filters=type eq \"CUSTOM\" and sourceId eq \"2c91809175e6c63f0175fb5570220569\"`")],
        _request_timeout: Union[
            None,
    ...
    def _list_privilege_criteria_serialize(
        self,
        filters,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def put_custom_privilege_criteria_value(
        self,
        criteria_id: Annotated[StrictStr, Field(description="The Id of the privilege criteria record to return.")],
        ...
        _param = self._put_custom_privilege_criteria_value_serialize(
            criteria_id=criteria_id,
    ...
    @validate_call
    def put_custom_privilege_criteria_value_with_http_info(
        self,
        criteria_id: Annotated[StrictStr, Field(description="The Id of the privilege criteria record to return.")],
        privilege_criteria_dto: Annotated[PrivilegeCriteriaDTO, Field(description="The new version of the custom privilege criteria. This overwrites the existing privilege criteria.")],
        _request_timeout: Union[
    ...
    @validate_call
    def put_custom_privilege_criteria_value_without_preload_content(
        self,
        criteria_id: Annotated[StrictStr, Field(description="The Id of the privilege criteria record to return.")],
        privilege_criteria_dto: Annotated[PrivilegeCriteriaDTO, Field(description="The new version of the custom privilege criteria. This overwrites the existing privilege criteria.")],
        _request_timeout: Union[
    ...
    def _put_custom_privilege_criteria_value_serialize(
        self,
        criteria_id,
