...
class PromptInsightsApi:
    ...
    @validate_call
    def get_prompt_insights_metrics(
        self,
        ...
        _param = self._get_prompt_insights_metrics_serialize(
            interval=interval,
    ...
    @validate_call
    def get_prompt_insights_metrics_with_http_info(
        self,
        interval: Annotated[StrictStr, Field(description="Relative lookback window for metrics aggregation.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_prompt_insights_metrics_without_preload_content(
        self,
        interval: Annotated[StrictStr, Field(description="Relative lookback window for metrics aggregation.")],
        _request_timeout: Union[
            None,
    ...
    def _get_prompt_insights_metrics_serialize(
        self,
        interval,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/prompt-insights/metrics',
    ...
    def list_prompt_insights(
        ...
        _param = self._list_prompt_insights_serialize(
            interval=interval,
            limit=limit,
            offset=offset,
            filters=filters,
    ...
    @validate_call
    def list_prompt_insights_with_http_info(
        self,
        interval: Annotated[StrictStr, Field(description="Relative lookback window for prompt insights.")],
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def list_prompt_insights_without_preload_content(
        self,
        interval: Annotated[StrictStr, Field(description="Relative lookback window for prompt insights.")],
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _list_prompt_insights_serialize(
        self,
        interval,
        limit,
        offset,
