...
class MachineAccountMappingsApi:
    ...
    @validate_call
    def create_machine_account_mappings(
        self,
        ...
        _param = self._create_machine_account_mappings_serialize(
            id=id,
    ...
    @validate_call
    def create_machine_account_mappings_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Source ID.")],
        attribute_mappings: AttributeMappings,
        _request_timeout: Union[
    ...
    @validate_call
    def create_machine_account_mappings_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Source ID.")],
        attribute_mappings: AttributeMappings,
        _request_timeout: Union[
    ...
    def _create_machine_account_mappings_serialize(
        self,
        id,
        attribute_mappings,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/sources/{sourceId}/machine-account-mappings',
    ...
    @validate_call
    def delete_machine_account_mappings(
        self,
        id: Annotated[StrictStr, Field(description="source ID.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._delete_machine_account_mappings_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_machine_account_mappings_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="source ID.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_machine_account_mappings_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="source ID.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_machine_account_mappings_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def list_machine_account_mappings(
        self,
        id: Annotated[StrictStr, Field(description="Source ID")],
        ...
        _param = self._list_machine_account_mappings_serialize(
            id=id,
            limit=limit,
            offset=offset,
            _request_auth=_request_auth,
    ...
    @validate_call
    def list_machine_account_mappings_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Source ID")],
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def list_machine_account_mappings_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Source ID")],
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _list_machine_account_mappings_serialize(
        self,
        id,
        limit,
        offset,
    ...
    @validate_call
    def set_machine_account_mappings(
        self,
        id: Annotated[StrictStr, Field(description="Source ID.")],
        attribute_mappings: AttributeMappings,
        _request_timeout: Union[
        ...
        _param = self._set_machine_account_mappings_serialize(
            id=id,
            attribute_mappings=attribute_mappings,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def set_machine_account_mappings_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Source ID.")],
        attribute_mappings: AttributeMappings,
        _request_timeout: Union[
    ...
    @validate_call
    def set_machine_account_mappings_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Source ID.")],
        attribute_mappings: AttributeMappings,
        _request_timeout: Union[
    ...
    def _set_machine_account_mappings_serialize(
        self,
        id,
        attribute_mappings,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/sources/{sourceId}/machine-mappings',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
