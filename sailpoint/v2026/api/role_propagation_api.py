...
class RolePropagationApi:
    ...
    @validate_call
    def get_role_propagation_config(
        self,
        x_sail_point_experimental: Annotated[StrictStr, Field(description="Use this header to enable this experimental API.")] = 'true',
        _request_timeout: Union[
            None,
        ...
        _param = self._get_role_propagation_config_serialize(
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_role_propagation_config_with_http_info(
        self,
        x_sail_point_experimental: Annotated[StrictStr, Field(description="Use this header to enable this experimental API.")] = 'true',
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_role_propagation_config_without_preload_content(
        self,
        x_sail_point_experimental: Annotated[StrictStr, Field(description="Use this header to enable this experimental API.")] = 'true',
        _request_timeout: Union[
            None,
    ...
    def _get_role_propagation_config_serialize(
        self,
        x_sail_point_experimental,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/role-propagation-config',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def set_role_propagation_config(
        self,
        ...
        _param = self._set_role_propagation_config_serialize(
            x_sail_point_experimental=x_sail_point_experimental,
    ...
    @validate_call
    def set_role_propagation_config_with_http_info(
        self,
        role_propagation_config_input: RolePropagationConfigInput,
        x_sail_point_experimental: Annotated[StrictStr, Field(description="Use this header to enable this experimental API.")] = 'true',
        _request_timeout: Union[
    ...
    @validate_call
    def set_role_propagation_config_without_preload_content(
        self,
        role_propagation_config_input: RolePropagationConfigInput,
        x_sail_point_experimental: Annotated[StrictStr, Field(description="Use this header to enable this experimental API.")] = 'true',
        _request_timeout: Union[
    ...
    def _set_role_propagation_config_serialize(
        self,
        x_sail_point_experimental,
