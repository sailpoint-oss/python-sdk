...
class DeclassifySourceApi:
    ...
    @validate_call
    def send_declassify_machine_account_from_source(
        self,
        ...
        _param = self._send_declassify_machine_account_from_source_serialize(
            source_id=source_id,
    ...
    @validate_call
    def send_declassify_machine_account_from_source_with_http_info(
        self,
        source_id: Annotated[StrictStr, Field(description="Source ID.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def send_declassify_machine_account_from_source_without_preload_content(
        self,
        source_id: Annotated[StrictStr, Field(description="Source ID.")],
        _request_timeout: Union[
            None,
    ...
    def _send_declassify_machine_account_from_source_serialize(
        self,
        source_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/sources/{sourceId}/declassify',
