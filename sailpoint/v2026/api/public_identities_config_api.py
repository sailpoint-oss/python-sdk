...
class PublicIdentitiesConfigApi:
    ...
    @validate_call
    def get_public_identity_config_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_public_identity_config_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/public-identities-config',
    ...
    @validate_call
    def update_public_identity_config_without_preload_content(
        self,
        public_identity_config: PublicIdentityConfig,
        _request_timeout: Union[
            None,
    ...
    def _update_public_identity_config_serialize(
        self,
