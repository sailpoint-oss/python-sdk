...
class AccountRequest(BaseModel):
    ...
    AccountRequest
    """ # noqa: E501
    account_id: Optional[StrictStr] = Field(default=None, description="Unique ID of the account", alias="accountId")
    attribute_requests: Optional[List[AttributeRequest]] = Field(default=None, alias="attributeRequests")
    op: Optional[StrictStr] = Field(default=None, description="The operation that was performed")
    provisioning_target: Optional[AccountSource] = Field(default=None, alias="provisioningTarget")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.provisioning_target:
            _dict['provisioningTarget'] = self.provisioning_target.to_dict()
