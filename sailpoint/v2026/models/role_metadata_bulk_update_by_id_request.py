...
class RoleMetadataBulkUpdateByIdRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    roles: List[StrictStr] = Field(description="Roles' Id to be updated")
    ...
    values: List[RoleMetadataBulkUpdateByIdRequestValuesInner] = Field(description="The metadata to be updated, including attribute key and value.")
    __properties: ClassVar[List[str]] = ["roles", "operation", "replaceScope", "values"]
