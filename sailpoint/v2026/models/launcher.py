...
class Launcher(BaseModel):
    ...
    Launcher
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the Launcher")
    created: datetime = Field(description="Date the Launcher was created")
    modified: datetime = Field(description="Date the Launcher was last modified")
    owner: LauncherOwner
    ...
    reference: Optional[LauncherReference] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "created", "modified", "owner", "name", "description", "type", "disabled", "reference", "config"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "owner": LauncherOwner.from_dict(obj["owner"]) if obj.get("owner") is not None else None,
            "name": obj.get("name"),
            "description": obj.get("description"),
            "type": obj.get("type"),
            "disabled": obj.get("disabled"),
            "reference": LauncherReference.from_dict(obj["reference"]) if obj.get("reference") is not None else None,
