...
class AuditDetails(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "createdBy": Identity1.from_dict(obj["createdBy"]) if obj.get("createdBy") is not None else None,
            "modified": obj.get("modified"),
            "modifiedBy": Identity1.from_dict(obj["modifiedBy"]) if obj.get("modifiedBy") is not None else None
        })
        return _obj
