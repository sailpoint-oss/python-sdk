...
class RevocabilityForRole(BaseModel):
    """
    RevocabilityForRole
    """ # noqa: E501
    ...
    approval_schemes: Optional[List[ApprovalSchemeForRole]] = Field(default=None, description="List describing the steps in approving the revocation request", alias="approvalSchemes")
