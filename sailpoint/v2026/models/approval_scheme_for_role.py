...
class ApprovalSchemeForRole(BaseModel):
    ...
    def approver_type_validate_enum(cls, value):
        ...
        if value not in set(['OWNER', 'MANAGER', 'GOVERNANCE_GROUP', 'WORKFLOW', 'ALL_OWNERS', 'ADDITIONAL_OWNER', 'ADDITIONAL_GOVERNANCE_GROUP']):
            warnings.warn(f"must be one of enum values ('OWNER', 'MANAGER', 'GOVERNANCE_GROUP', 'WORKFLOW', 'ALL_OWNERS', 'ADDITIONAL_OWNER', 'ADDITIONAL_GOVERNANCE_GROUP') unknown value: {value}")
        return value
