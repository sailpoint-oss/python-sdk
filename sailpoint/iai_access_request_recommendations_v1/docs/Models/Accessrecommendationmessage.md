...
slug: /tools/sdk/python/v1/models/accessrecommendationmessage
...
```python
from sailpoint.iai_access_request_recommendations_v1.models.accessrecommendationmessage import Accessrecommendationmessage

accessrecommendationmessage = Accessrecommendationmessage(
