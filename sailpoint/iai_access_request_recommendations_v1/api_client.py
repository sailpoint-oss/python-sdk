...
from sailpoint.iai_access_request_recommendations_v1.api_response import ApiResponse, T as ApiResponseT
import sailpoint.iai_access_request_recommendations_v1.models
from sailpoint.iai_access_request_recommendations_v1 import rest
from sailpoint.iai_access_request_recommendations_v1.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'SailPoint-SDK-Python/1.0.0'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.iai_access_request_recommendations_v1.models, klass)
