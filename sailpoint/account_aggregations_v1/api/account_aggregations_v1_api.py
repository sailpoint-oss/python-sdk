...
from sailpoint.account_aggregations_v1.api_client import ApiClient, RequestSerialized
from sailpoint.account_aggregations_v1.api_response import ApiResponse
from sailpoint.account_aggregations_v1.rest import RESTResponseType
...
class AccountAggregationsV1Api:
    ...
    @validate_call
    def get_account_aggregation_status_v1(
        self,
        ...
        _param = self._get_account_aggregation_status_v1_serialize(
            id=id,
    ...
    @validate_call
    def get_account_aggregation_status_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The account aggregation id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_account_aggregation_status_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The account aggregation id")],
        _request_timeout: Union[
            None,
    ...
    def _get_account_aggregation_status_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/account-aggregations/v1/{id}/status',
