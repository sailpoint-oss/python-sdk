...
slug: /tools/sdk/python/v1/methods/account-aggregations
tags: ['SDK', 'Software Development Kit', 'Account_Aggregations', 'Account_Aggregations']
---

# sailpoint.account_aggregations_v1.AccountAggregationsV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AccountAggregationsV1Api(api_client).get_account_aggregation_status_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = AccountAggregationsV1Api(api_client).get_account_aggregation_status_v1(id)
