...
from sailpoint.source_usages.api_response import ApiResponse, T as ApiResponseT
import sailpoint.source_usages.models
from sailpoint.source_usages import rest
from sailpoint.source_usages.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.source_usages.models, klass)
