...
from sailpoint.classify_source_v1.api_client import ApiClient, RequestSerialized
from sailpoint.classify_source_v1.api_response import ApiResponse
from sailpoint.classify_source_v1.rest import RESTResponseType
...
class ClassifySourceV1Api:
    ...
    def _delete_classify_machine_account_from_source_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/sources/v1/{sourceId}/classify',
    ...
    def send_classify_machine_account_from_source_v1_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SendClassifyMachineAccountFromSourceV1200Response]:
        """Classify source's all accounts
