...
class Campaign2(BaseModel):
    ...
    source_owner_campaign_info: Optional[Campaign2AllOfSourceOwnerCampaignInfo] = Field(default=None, alias="sourceOwnerCampaignInfo")
    search_campaign_info: Optional[Campaign2AllOfSearchCampaignInfo] = Field(default=None, alias="searchCampaignInfo")
    role_composition_campaign_info: Optional[Campaign2AllOfRoleCompositionCampaignInfo] = Field(default=None, alias="roleCompositionCampaignInfo")
    machine_account_campaign_info: Optional[Campaign2AllOfMachineAccountCampaignInfo] = Field(default=None, alias="machineAccountCampaignInfo")
    sources_with_orphan_entitlements: Optional[List[Campaign2AllOfSourcesWithOrphanEntitlements]] = Field(default=None, description="A list of sources in the campaign that contain \\\"orphan entitlements\\\" (entitlements without a corresponding Managed Attribute). An empty list indicates the campaign has no orphan entitlements. Null indicates there may be unknown orphan entitlements in the campaign (the campaign was created before this feature was implemented).", alias="sourcesWithOrphanEntitlements")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Campaign2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Campaign2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "sourceOwnerCampaignInfo": Campaign2AllOfSourceOwnerCampaignInfo.from_dict(obj["sourceOwnerCampaignInfo"]) if obj.get("sourceOwnerCampaignInfo") is not None else None,
            "searchCampaignInfo": Campaign2AllOfSearchCampaignInfo.from_dict(obj["searchCampaignInfo"]) if obj.get("searchCampaignInfo") is not None else None,
            "roleCompositionCampaignInfo": Campaign2AllOfRoleCompositionCampaignInfo.from_dict(obj["roleCompositionCampaignInfo"]) if obj.get("roleCompositionCampaignInfo") is not None else None,
            "machineAccountCampaignInfo": Campaign2AllOfMachineAccountCampaignInfo.from_dict(obj["machineAccountCampaignInfo"]) if obj.get("machineAccountCampaignInfo") is not None else None,
            "sourcesWithOrphanEntitlements": [Campaign2AllOfSourcesWithOrphanEntitlements.from_dict(_item) for _item in obj["sourcesWithOrphanEntitlements"]] if obj.get("sourcesWithOrphanEntitlements") is not None else None,
