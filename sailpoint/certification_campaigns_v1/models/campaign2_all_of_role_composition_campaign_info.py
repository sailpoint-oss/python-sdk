...
class Campaign2AllOfRoleCompositionCampaignInfo(BaseModel):
    """
    ...
    reviewer: Optional[Campaign2AllOfRoleCompositionCampaignInfoReviewer] = None
    ...
    remediator_ref: Campaign2AllOfRoleCompositionCampaignInfoRemediatorRef = Field(alias="remediatorRef")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Campaign2AllOfRoleCompositionCampaignInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Campaign2AllOfRoleCompositionCampaignInfo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "reviewer": Campaign2AllOfRoleCompositionCampaignInfoReviewer.from_dict(obj["reviewer"]) if obj.get("reviewer") is not None else None,
            "roleIds": obj.get("roleIds"),
            "remediatorRef": Campaign2AllOfRoleCompositionCampaignInfoRemediatorRef.from_dict(obj["remediatorRef"]) if obj.get("remediatorRef") is not None else None,
            "query": obj.get("query"),
