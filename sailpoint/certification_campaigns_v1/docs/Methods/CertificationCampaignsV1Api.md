...
slug: /tools/sdk/python/v1/methods/certification-campaigns
tags: ['SDK', 'Software Development Kit', 'Certification_Campaigns', 'Certification_Campaigns']
---

# sailpoint.certification_campaigns_v1.CertificationCampaignsV1Api
...
from sailpoint.certification_campaigns_v1.api_client import ApiClient
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CertificationCampaignsV1Api(api_client).complete_campaign_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).complete_campaign_v1(id, new_campaigncompleteoptions)
...
with ApiClient(configuration) as api_client:
    campaigntemplate = '''sailpoint.certification_campaigns_v1.Campaigntemplate()''' # Campaigntemplate | 

    try:
        # Create a campaign template
        new_campaigntemplate = Campaigntemplate.from_json(campaigntemplate)
        results = CertificationCampaignsV1Api(api_client).create_campaign_template_v1(campaigntemplate=new_campaigntemplate)
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).create_campaign_template_v1(new_campaigntemplate)
        print("The response of CertificationCampaignsV1Api->create_campaign_template_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->create_campaign_template_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    campaign2 = '''sailpoint.certification_campaigns_v1.Campaign2()''' # Campaign2 | 

    try:
        # Create a campaign
        new_campaign2 = Campaign2.from_json(campaign2)
        results = CertificationCampaignsV1Api(api_client).create_campaign_v1(campaign2=new_campaign2)
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).create_campaign_v1(new_campaign2)
        print("The response of CertificationCampaignsV1Api->create_campaign_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->create_campaign_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        CertificationCampaignsV1Api(api_client).delete_campaign_template_schedule_v1(id=id)
        # Below is a request that includes all optional parameters
        # CertificationCampaignsV1Api(api_client).delete_campaign_template_schedule_v1(id)
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->delete_campaign_template_schedule_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        CertificationCampaignsV1Api(api_client).delete_campaign_template_v1(id=id)
        # Below is a request that includes all optional parameters
        # CertificationCampaignsV1Api(api_client).delete_campaign_template_v1(id)
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->delete_campaign_template_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    campaignsdeleterequest = '''sailpoint.certification_campaigns_v1.Campaignsdeleterequest()''' # Campaignsdeleterequest | IDs of the campaigns to delete.

    try:
        # Delete campaigns
        new_campaignsdeleterequest = Campaignsdeleterequest.from_json(campaignsdeleterequest)
        results = CertificationCampaignsV1Api(api_client).delete_campaigns_v1(campaignsdeleterequest=new_campaignsdeleterequest)
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).delete_campaigns_v1(new_campaignsdeleterequest)
        print("The response of CertificationCampaignsV1Api->delete_campaigns_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->delete_campaigns_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CertificationCampaignsV1Api(api_client).get_active_campaigns_v1()
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).get_active_campaigns_v1(detail, limit, offset, count, filters, sorters)
        print("The response of CertificationCampaignsV1Api->get_active_campaigns_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->get_active_campaigns_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CertificationCampaignsV1Api(api_client).get_campaign_reports_config_v1()
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).get_campaign_reports_config_v1()
        print("The response of CertificationCampaignsV1Api->get_campaign_reports_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->get_campaign_reports_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CertificationCampaignsV1Api(api_client).get_campaign_reports_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).get_campaign_reports_v1(id)
        print("The response of CertificationCampaignsV1Api->get_campaign_reports_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->get_campaign_reports_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CertificationCampaignsV1Api(api_client).get_campaign_template_schedule_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).get_campaign_template_schedule_v1(id)
        print("The response of CertificationCampaignsV1Api->get_campaign_template_schedule_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->get_campaign_template_schedule_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CertificationCampaignsV1Api(api_client).get_campaign_template_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).get_campaign_template_v1(id)
        print("The response of CertificationCampaignsV1Api->get_campaign_template_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->get_campaign_template_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CertificationCampaignsV1Api(api_client).get_campaign_templates_v1()
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).get_campaign_templates_v1(limit, offset, count, sorters, filters)
        print("The response of CertificationCampaignsV1Api->get_campaign_templates_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->get_campaign_templates_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CertificationCampaignsV1Api(api_client).get_campaign_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).get_campaign_v1(id, detail)
        print("The response of CertificationCampaignsV1Api->get_campaign_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->get_campaign_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    adminreviewreassign = '''sailpoint.certification_campaigns_v1.Adminreviewreassign()''' # Adminreviewreassign | 

    try:
        # Reassign certifications
        new_adminreviewreassign = Adminreviewreassign.from_json(adminreviewreassign)
        results = CertificationCampaignsV1Api(api_client).move_v1(id=id, adminreviewreassign=new_adminreviewreassign)
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).move_v1(id, new_adminreviewreassign)
        print("The response of CertificationCampaignsV1Api->move_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->move_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CertificationCampaignsV1Api(api_client).patch_campaign_template_v1(id=id, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).patch_campaign_template_v1(id, new_jsonpatchoperation)
        print("The response of CertificationCampaignsV1Api->patch_campaign_template_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->patch_campaign_template_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    campaignreportsconfig = '''sailpoint.certification_campaigns_v1.Campaignreportsconfig()''' # Campaignreportsconfig | Campaign report configuration.

    try:
        # Set campaign reports configuration
        new_campaignreportsconfig = Campaignreportsconfig.from_json(campaignreportsconfig)
        results = CertificationCampaignsV1Api(api_client).set_campaign_reports_config_v1(campaignreportsconfig=new_campaignreportsconfig)
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).set_campaign_reports_config_v1(new_campaignreportsconfig)
        print("The response of CertificationCampaignsV1Api->set_campaign_reports_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->set_campaign_reports_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        CertificationCampaignsV1Api(api_client).set_campaign_template_schedule_v1(id=id)
        # Below is a request that includes all optional parameters
        # CertificationCampaignsV1Api(api_client).set_campaign_template_schedule_v1(id, new_schedule2)
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->set_campaign_template_schedule_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CertificationCampaignsV1Api(api_client).start_campaign_remediation_scan_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).start_campaign_remediation_scan_v1(id)
        print("The response of CertificationCampaignsV1Api->start_campaign_remediation_scan_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->start_campaign_remediation_scan_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    type = sailpoint.certification_campaigns_v1.Reporttype() # Reporttype | Type of the report to run. # Reporttype | Type of the report to run.

    try:
        # Run campaign report
        
        results = CertificationCampaignsV1Api(api_client).start_campaign_report_v1(id=id, type=type)
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).start_campaign_report_v1(id, type)
        print("The response of CertificationCampaignsV1Api->start_campaign_report_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->start_campaign_report_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    id = 'ef38f94347e94562b5bb8424a56397d8' # str | Campaign ID. # str | Campaign ID.
    activatecampaignoptions = '''sailpoint.certification_campaigns_v1.Activatecampaignoptions()''' # Activatecampaignoptions | Optional. If no timezone is specified, the standard UTC timezone is used (i.e. UTC+00:00). Although this can take any timezone, the intended value is the caller's timezone. The activation time calculated from the given timezone may cause the campaign deadline time to be modified, but it will remain within the original date. The timezone must be in a valid ISO 8601 format. (optional)

    try:
        # Activate a campaign
        
        results = CertificationCampaignsV1Api(api_client).start_campaign_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).start_campaign_v1(id, new_activatecampaignoptions)
        print("The response of CertificationCampaignsV1Api->start_campaign_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->start_campaign_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CertificationCampaignsV1Api(api_client).start_generate_campaign_template_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).start_generate_campaign_template_v1(id)
        print("The response of CertificationCampaignsV1Api->start_generate_campaign_template_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->start_generate_campaign_template_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Update a campaign
        new_jsonpatchoperation = Jsonpatchoperation.from_json(jsonpatchoperation)
        results = CertificationCampaignsV1Api(api_client).update_campaign_v1(id=id, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = CertificationCampaignsV1Api(api_client).update_campaign_v1(id, new_jsonpatchoperation)
        print("The response of CertificationCampaignsV1Api->update_campaign_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationCampaignsV1Api->update_campaign_v1: %s\n" % e)
```
