...
slug: /tools/sdk/python/v1/models/schedule2
...
schedule2 = Schedule2(
type='WEEKLY',
months=sailpoint.certification_campaigns_v1.models.schedule_2_months.schedule_2_months(
                    type = 'LIST', 
                    values = ["1"], 
                    interval = 2, ),
days=sailpoint.certification_campaigns_v1.models.schedule_2_days.schedule_2_days(
                    type = 'LIST', 
                    values = ["1"], 
                    interval = 2, ),
hours=sailpoint.certification_campaigns_v1.models.schedule_2_hours.schedule_2_hours(
                    type = 'LIST', 
                    values = ["1"], 
                    interval = 2, ),
