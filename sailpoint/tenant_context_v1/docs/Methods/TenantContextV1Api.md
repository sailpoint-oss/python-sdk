...
slug: /tools/sdk/python/v1/methods/tenant-context
tags: ['SDK', 'Software Development Kit', 'Tenant_Context', 'Tenant_Context']
---

# sailpoint.tenant_context_v1.TenantContextV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        TenantContextV1Api(api_client).patch_tenant_context_v1(jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # TenantContextV1Api(api_client).patch_tenant_context_v1(new_jsonpatchoperation)
    except Exception as e:
        print("Exception when calling TenantContextV1Api->patch_tenant_context_v1: %s\n" % e)
```
