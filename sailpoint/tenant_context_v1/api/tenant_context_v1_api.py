...
from sailpoint.tenant_context_v1.api_client import ApiClient, RequestSerialized
from sailpoint.tenant_context_v1.api_response import ApiResponse
from sailpoint.tenant_context_v1.rest import RESTResponseType
...
class TenantContextV1Api:
    ...
    def get_tenant_context_v1(
    ...
    ) -> List[GetTenantContextV1200ResponseInner]:
        ...
        _param = self._get_tenant_context_v1_serialize(
    ...
    @validate_call
    def get_tenant_context_v1_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetTenantContextV1200ResponseInner]]:
        """Retrieve tenant context
    ...
    @validate_call
    def get_tenant_context_v1_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_tenant_context_v1_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/tenant-context/v1',
