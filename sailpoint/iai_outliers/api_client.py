...
from sailpoint.iai_outliers.api_response import ApiResponse, T as ApiResponseT
import sailpoint.iai_outliers.models
from sailpoint.iai_outliers import rest
from sailpoint.iai_outliers.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.iai_outliers.models, klass)
