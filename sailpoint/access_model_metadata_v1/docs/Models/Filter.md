...
slug: /tools/sdk/python/v1/models/filter
...
filter = Filter(
type='RANGE',
range=sailpoint.access_model_metadata_v1.models.range.range(
                    lower = sailpoint.access_model_metadata_v1.models.bound.bound(
                        value = '1', 
                        inclusive = False, ), 
                    upper = sailpoint.access_model_metadata_v1.models.bound.bound(
                        value = '1', 
                        inclusive = False, ), ),
terms=[
                    'account_count'
