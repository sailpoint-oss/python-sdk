...
slug: /tools/sdk/python/v1/models/entitlementattributebulkupdatequeryrequest
...
query=sailpoint.access_model_metadata_v1.models.search.search(
                    indices = ["identities"], 
                    query_type = 'SAILPOINT', 
                    query_version = null, 
                    query = sailpoint.access_model_metadata_v1.models.query.query(
                        fields = '["firstName,lastName,email"]', 
                        time_zone = 'America/Chicago', 
                        inner_hit = sailpoint.access_model_metadata_v1.models.innerhit.innerhit(
                            query = 'source.name:\"Active Directory\"', 
                            type = 'access', ), ), 
                    query_dsl = {"match":{"name":"john.doe"}}, 
                    text_query = sailpoint.access_model_metadata_v1.models.textquery.textquery(
                        terms = ["The quick brown fox","3141592","7"], 
                        fields = ["displayName","employeeNumber","roleCount"], 
                        match_any = False, 
                        contains = True, ), 
                    type_ahead_query = sailpoint.access_model_metadata_v1.models.typeaheadquery.typeaheadquery(
                        query = 'Work', 
                        field = 'source.name', 
                        nested_type = 'access', 
                        max_expansions = 10, 
                        ...
                        sort_by_value = True, ), 
                    include_nested = True, 
                    query_result_filter = sailpoint.access_model_metadata_v1.models.queryresultfilter.queryresultfilter(
