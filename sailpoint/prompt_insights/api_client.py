...
from sailpoint.prompt_insights.api_response import ApiResponse, T as ApiResponseT
import sailpoint.prompt_insights.models
from sailpoint.prompt_insights import rest
from sailpoint.prompt_insights.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.prompt_insights.models, klass)
