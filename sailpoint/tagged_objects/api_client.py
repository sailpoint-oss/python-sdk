...
from sailpoint.tagged_objects.api_response import ApiResponse, T as ApiResponseT
import sailpoint.tagged_objects.models
from sailpoint.tagged_objects import rest
from sailpoint.tagged_objects.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.tagged_objects.models, klass)
