...
from sailpoint.iai_peer_group_strategies_v1.api_client import ApiClient, RequestSerialized
from sailpoint.iai_peer_group_strategies_v1.api_response import ApiResponse
from sailpoint.iai_peer_group_strategies_v1.rest import RESTResponseType
...
class IAIPeerGroupStrategiesV1Api:
    ...
    @validate_call
    def get_peer_group_outliers_v1(
        self,
        ...
        """ # noqa: E501
        warnings.warn("GET /peer-group-strategies/v1/{strategy}/identity-outliers is deprecated.", DeprecationWarning)

        _param = self._get_peer_group_outliers_v1_serialize(
            strategy=strategy,
            limit=limit,
            offset=offset,
            count=count,
    ...
    @validate_call
    def get_peer_group_outliers_v1_with_http_info(
        self,
        strategy: Annotated[StrictStr, Field(description="The strategy used to create peer groups. Currently, 'entitlement' is supported.")],
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def get_peer_group_outliers_v1_without_preload_content(
        self,
        strategy: Annotated[StrictStr, Field(description="The strategy used to create peer groups. Currently, 'entitlement' is supported.")],
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _get_peer_group_outliers_v1_serialize(
        self,
        strategy,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/peer-group-strategies/v1/{strategy}/identity-outliers',
