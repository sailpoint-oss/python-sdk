...
slug: /tools/sdk/python/v1/methods/password-sync-groups
tags: ['SDK', 'Software Development Kit', 'Password_Sync_Groups', 'Password_Sync_Groups']
---

# sailpoint.password_sync_groups_v1.PasswordSyncGroupsV1Api
...
from sailpoint.password_sync_groups_v1.api_client import ApiClient
from sailpoint.password_sync_groups_v1.models.passwordsyncgroup import Passwordsyncgroup
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = PasswordSyncGroupsV1Api(api_client).create_password_sync_group_v1(passwordsyncgroup=new_passwordsyncgroup)
        # Below is a request that includes all optional parameters
        # results = PasswordSyncGroupsV1Api(api_client).create_password_sync_group_v1(new_passwordsyncgroup)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        PasswordSyncGroupsV1Api(api_client).delete_password_sync_group_v1(id=id)
        # Below is a request that includes all optional parameters
        # PasswordSyncGroupsV1Api(api_client).delete_password_sync_group_v1(id)
    except Exception as e:
        print("Exception when calling PasswordSyncGroupsV1Api->delete_password_sync_group_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = PasswordSyncGroupsV1Api(api_client).get_password_sync_group_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = PasswordSyncGroupsV1Api(api_client).get_password_sync_group_v1(id)
        print("The response of PasswordSyncGroupsV1Api->get_password_sync_group_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling PasswordSyncGroupsV1Api->get_password_sync_group_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = PasswordSyncGroupsV1Api(api_client).get_password_sync_groups_v1()
        # Below is a request that includes all optional parameters
        # results = PasswordSyncGroupsV1Api(api_client).get_password_sync_groups_v1(limit, offset, count)
        print("The response of PasswordSyncGroupsV1Api->get_password_sync_groups_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling PasswordSyncGroupsV1Api->get_password_sync_groups_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Update password sync group by id
        new_passwordsyncgroup = Passwordsyncgroup.from_json(passwordsyncgroup)
        results = PasswordSyncGroupsV1Api(api_client).update_password_sync_group_v1(id=id, passwordsyncgroup=new_passwordsyncgroup)
        # Below is a request that includes all optional parameters
        # results = PasswordSyncGroupsV1Api(api_client).update_password_sync_group_v1(id, new_passwordsyncgroup)
        print("The response of PasswordSyncGroupsV1Api->update_password_sync_group_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling PasswordSyncGroupsV1Api->update_password_sync_group_v1: %s\n" % e)
```
