# sailpoint.task-management
Use these APIs to interact with the Identity Security Cloud platform to achieve repeatable, automated processes with greater scalability. We encourage you to join the SailPoint Developer Community forum at https://developer.sailpoint.com/discuss to connect with other developers using our APIs.

The `sailpoint.task_management` package is automatically generated by the [OpenAPI Generator](https://openapi-generator.tech) project:
...
In your own code, to use this library to connect and interact with sailpoint.task-management,
you can run the following:

```python

import sailpoint.task_management
from sailpoint.task_management.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to https://sailpoint.api.identitynow.com
# See configuration.py for a list of all supported configuration parameters.
configuration = sailpoint.task_management.Configuration(
...
with sailpoint.task_management.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = sailpoint.task_management.TaskManagementApi(api_client)
...
------------ | ------------- | ------------- | -------------
*TaskManagementApi* | [**get_task_status_list_v1**](sailpoint/task_management/docs/TaskManagementApi.md#get_task_status_list_v1) | **GET** /task-status/v1 | Retrieve task status list
*TaskManagementApi* | [**get_task_status_v1**](sailpoint/task_management/docs/TaskManagementApi.md#get_task_status_v1) | **GET** /task-status/v1/{id} | Get task status by id
*TaskManagementApi* | [**update_task_status_v1**](sailpoint/task_management/docs/TaskManagementApi.md#update_task_status_v1) | **PATCH** /task-status/v1/{id} | Update task status by id
