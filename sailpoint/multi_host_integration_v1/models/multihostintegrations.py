...
class Multihostintegrations(BaseModel):
    ...
    account_correlation_config: Optional[MultihostintegrationsAccountCorrelationConfig] = Field(default=None, alias="accountCorrelationConfig")
    account_correlation_rule: Optional[MultihostintegrationsAccountCorrelationRule] = Field(default=None, alias="accountCorrelationRule")
    manager_correlation_mapping: Optional[MultihostintegrationsManagerCorrelationMapping] = Field(default=None, alias="managerCorrelationMapping")
    manager_correlation_rule: Optional[MultihostintegrationsManagerCorrelationRule] = Field(default=None, alias="managerCorrelationRule")
    before_provisioning_rule: Optional[MultihostintegrationsBeforeProvisioningRule] = Field(default=None, alias="beforeProvisioningRule")
    schemas: Optional[List[MultihostintegrationsSchemasInner]] = Field(default=None, description="List of references to schema objects.")
    password_policies: Optional[List[MultihostintegrationsPasswordPoliciesInner]] = Field(default=None, description="List of references to the associated PasswordPolicy objects.", alias="passwordPolicies")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of accounts_file
        if self.accounts_file:
            _dict['accountsFile'] = self.accounts_file.to_dict()
        ...
        # set to None if accounts_file (nullable) is None
        # and model_fields_set contains the field
        if self.accounts_file is None and "accounts_file" in self.model_fields_set:
            _dict['accountsFile'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "accountCorrelationConfig": MultihostintegrationsAccountCorrelationConfig.from_dict(obj["accountCorrelationConfig"]) if obj.get("accountCorrelationConfig") is not None else None,
            "accountCorrelationRule": MultihostintegrationsAccountCorrelationRule.from_dict(obj["accountCorrelationRule"]) if obj.get("accountCorrelationRule") is not None else None,
            "managerCorrelationMapping": MultihostintegrationsManagerCorrelationMapping.from_dict(obj["managerCorrelationMapping"]) if obj.get("managerCorrelationMapping") is not None else None,
            "managerCorrelationRule": MultihostintegrationsManagerCorrelationRule.from_dict(obj["managerCorrelationRule"]) if obj.get("managerCorrelationRule") is not None else None,
            "beforeProvisioningRule": MultihostintegrationsBeforeProvisioningRule.from_dict(obj["beforeProvisioningRule"]) if obj.get("beforeProvisioningRule") is not None else None,
            "schemas": [MultihostintegrationsSchemasInner.from_dict(_item) for _item in obj["schemas"]] if obj.get("schemas") is not None else None,
            "passwordPolicies": [MultihostintegrationsPasswordPoliciesInner.from_dict(_item) for _item in obj["passwordPolicies"]] if obj.get("passwordPolicies") is not None else None,
            ...
            "accountsFile": MultihostintegrationsAccountsFile.from_dict(obj["accountsFile"]) if obj.get("accountsFile") is not None else None
        })
        return _obj
