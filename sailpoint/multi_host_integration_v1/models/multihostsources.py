...
class Multihostsources(BaseModel):
    ...
    before_provisioning_rule: Optional[MultihostsourcesBeforeProvisioningRule] = Field(default=None, alias="beforeProvisioningRule")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "beforeProvisioningRule": MultihostsourcesBeforeProvisioningRule.from_dict(obj["beforeProvisioningRule"]) if obj.get("beforeProvisioningRule") is not None else None,
