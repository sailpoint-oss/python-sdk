...
from sailpoint.multi_host_integration_v1.api_client import ApiClient, RequestSerialized
from sailpoint.multi_host_integration_v1.api_response import ApiResponse
from sailpoint.multi_host_integration_v1.rest import RESTResponseType
...
class MultiHostIntegrationV1Api:
    ...
    def _create_sources_within_multi_host_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/multihosts/v1/{multihostId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_multi_host_sources_v1(
        self,
        multi_host_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration")],
        request_body: Annotated[List[StrictStr], Field(description="The delete bulk sources within multi-host integration request body")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param request_body: The delete bulk sources within multi-host integration request body (required)
        ...
        _param = self._delete_multi_host_sources_v1_serialize(
    ...
    @validate_call
    def delete_multi_host_sources_v1_with_http_info(
        self,
        multi_host_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration")],
        request_body: Annotated[List[StrictStr], Field(description="The delete bulk sources within multi-host integration request body")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_multi_host_sources_v1_without_preload_content(
        self,
        multi_host_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration")],
        request_body: Annotated[List[StrictStr], Field(description="The delete bulk sources within multi-host integration request body")],
        _request_timeout: Union[
    ...
    def _delete_multi_host_sources_v1_serialize(
        self,
        multi_host_id,
        request_body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/multihosts/v1/{multiHostId}/sources/bulk-delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_multi_host_v1(
        ...
        _param = self._delete_multi_host_v1_serialize(
            multihost_id=multihost_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_multi_host_v1_with_http_info(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of Multi-Host Integration to delete.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_multi_host_v1_without_preload_content(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of Multi-Host Integration to delete.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_multi_host_v1_serialize(
        self,
        multihost_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def get_acct_aggregation_groups_v1(
        self,
        ...
        _param = self._get_acct_aggregation_groups_v1_serialize(
            multihost_id=multihost_id,
            offset=offset,
            limit=limit,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_acct_aggregation_groups_v1_with_http_info(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration to update")],
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def get_acct_aggregation_groups_v1_without_preload_content(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration to update")],
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _get_acct_aggregation_groups_v1_serialize(
        self,
        multihost_id,
        offset,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/multihosts/v1/{multihostId}/acctAggregationGroups',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_entitlement_aggregation_groups_v1(
        self,
        ...
        _param = self._get_entitlement_aggregation_groups_v1_serialize(
            multi_host_id=multi_host_id,
            offset=offset,
            limit=limit,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_entitlement_aggregation_groups_v1_with_http_info(
        self,
        multi_host_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration to update")],
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def get_entitlement_aggregation_groups_v1_without_preload_content(
        self,
        multi_host_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration to update")],
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _get_entitlement_aggregation_groups_v1_serialize(
        self,
        multi_host_id,
        offset,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/multihosts/v1/{multiHostId}/entitlementAggregationGroups',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_multi_host_integrations_list_v1(
        self,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        ...
        _param = self._get_multi_host_integrations_list_v1_serialize(
            offset=offset,
            limit=limit,
            sorters=sorters,
            filters=filters,
    ...
    @validate_call
    def get_multi_host_integrations_list_v1_with_http_info(
        self,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **name**")] = None,
    ...
    @validate_call
    def get_multi_host_integrations_list_v1_without_preload_content(
        self,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **name**")] = None,
    ...
    def _get_multi_host_integrations_list_v1_serialize(
        self,
        offset,
        limit,
        sorters,
    ...
    @validate_call
    def get_multi_host_integrations_v1(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_multi_host_integrations_v1_serialize(
            multihost_id=multihost_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_multi_host_integrations_v1_with_http_info(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_multi_host_integrations_v1_without_preload_content(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration.")],
        _request_timeout: Union[
            None,
    ...
    def _get_multi_host_integrations_v1_serialize(
        self,
        multihost_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def get_multi_host_source_creation_errors_v1(
        self,
        multi_host_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration")],
        _request_timeout: Union[
            None,
        ...
        _param = self._get_multi_host_source_creation_errors_v1_serialize(
            multi_host_id=multi_host_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_multi_host_source_creation_errors_v1_with_http_info(
        self,
        multi_host_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_multi_host_source_creation_errors_v1_without_preload_content(
        self,
        multi_host_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration")],
        _request_timeout: Union[
            None,
    ...
    def _get_multi_host_source_creation_errors_v1_serialize(
        self,
        multi_host_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/multihosts/v1/{multiHostId}/sources/errors',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_multihost_integration_types_v1(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._get_multihost_integration_types_v1_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_multihost_integration_types_v1_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_multihost_integration_types_v1_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_multihost_integration_types_v1_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/multihosts/v1/types',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_sources_within_multi_host_v1(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration to update")],
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        ...
        _param = self._get_sources_within_multi_host_v1_serialize(
            multihost_id=multihost_id,
            offset=offset,
            limit=limit,
            sorters=sorters,
    ...
    @validate_call
    def get_sources_within_multi_host_v1_with_http_info(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration to update")],
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def get_sources_within_multi_host_v1_without_preload_content(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration to update")],
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _get_sources_within_multi_host_v1_serialize(
        self,
        multihost_id,
        offset,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/multihosts/v1/{multihostId}/sources',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def test_connection_multi_host_sources_v1(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration")],
        _request_timeout: Union[
            None,
        ...
        _param = self._test_connection_multi_host_sources_v1_serialize(
            multihost_id=multihost_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def test_connection_multi_host_sources_v1_with_http_info(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def test_connection_multi_host_sources_v1_without_preload_content(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration")],
        _request_timeout: Union[
            None,
    ...
    def _test_connection_multi_host_sources_v1_serialize(
        self,
        multihost_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/multihosts/v1/{multihostId}/sources/testConnection',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def test_source_connection_multihost_v1(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration")],
        ...
        _param = self._test_source_connection_multihost_v1_serialize(
            multihost_id=multihost_id,
            source_id=source_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def test_source_connection_multihost_v1_with_http_info(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration")],
        source_id: Annotated[StrictStr, Field(description="ID of the source within the Multi-Host Integration")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TestSourceConnectionMultihostV1200Response]:
        """Test configuration for multi-host integration's single source
    ...
    @validate_call
    def test_source_connection_multihost_v1_without_preload_content(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration")],
        source_id: Annotated[StrictStr, Field(description="ID of the source within the Multi-Host Integration")],
        _request_timeout: Union[
    ...
    def _test_source_connection_multihost_v1_serialize(
        self,
        multihost_id,
        source_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/multihosts/v1/{multihostId}/sources/{sourceId}/testConnection',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def update_multi_host_sources_v1(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration to update.")],
        update_multi_host_sources_v1_request_inner: Annotated[List[UpdateMultiHostSourcesV1RequestInner], Field(description="This endpoint allows you to update a Multi-Host Integration. ")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param multihost_id: ID of the Multi-Host Integration to update. (required)
        :type multihost_id: str
        :param update_multi_host_sources_v1_request_inner: This endpoint allows you to update a Multi-Host Integration.  (required)
        :type update_multi_host_sources_v1_request_inner: List[UpdateMultiHostSourcesV1RequestInner]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_multi_host_sources_v1_serialize(
            multihost_id=multihost_id,
            update_multi_host_sources_v1_request_inner=update_multi_host_sources_v1_request_inner,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_multi_host_sources_v1_with_http_info(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration to update.")],
        update_multi_host_sources_v1_request_inner: Annotated[List[UpdateMultiHostSourcesV1RequestInner], Field(description="This endpoint allows you to update a Multi-Host Integration. ")],
        _request_timeout: Union[
    ...
    @validate_call
    def update_multi_host_sources_v1_without_preload_content(
        self,
        multihost_id: Annotated[StrictStr, Field(description="ID of the Multi-Host Integration to update.")],
        update_multi_host_sources_v1_request_inner: Annotated[List[UpdateMultiHostSourcesV1RequestInner], Field(description="This endpoint allows you to update a Multi-Host Integration. ")],
        _request_timeout: Union[
    ...
    def _update_multi_host_sources_v1_serialize(
        self,
        multihost_id,
        update_multi_host_sources_v1_request_inner,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_multi_host_sources_v1_request_inner is not None:
            _body_params = update_multi_host_sources_v1_request_inner
