...
class Accessreviewitem(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accessSummary": Accesssummary.from_dict(obj["accessSummary"]) if obj.get("accessSummary") is not None else None,
            "identitySummary": Certificationidentitysummary.from_dict(obj["identitySummary"]) if obj.get("identitySummary") is not None else None,
            "id": obj.get("id"),
