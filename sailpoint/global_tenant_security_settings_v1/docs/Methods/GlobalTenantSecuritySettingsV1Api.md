...
slug: /tools/sdk/python/v1/methods/global-tenant-security-settings
tags: ['SDK', 'Software Development Kit', 'Global_Tenant_Security_Settings', 'Global_Tenant_Security_Settings']
---

# sailpoint.global_tenant_security_settings_v1.GlobalTenantSecuritySettingsV1Api
...
from sailpoint.global_tenant_security_settings_v1.api_client import ApiClient
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = GlobalTenantSecuritySettingsV1Api(api_client).create_auth_org_network_config_v1(networkconfiguration=new_networkconfiguration)
        # Below is a request that includes all optional parameters
        # results = GlobalTenantSecuritySettingsV1Api(api_client).create_auth_org_network_config_v1(new_networkconfiguration)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = GlobalTenantSecuritySettingsV1Api(api_client).get_auth_org_lockout_config_v1()
        # Below is a request that includes all optional parameters
        # results = GlobalTenantSecuritySettingsV1Api(api_client).get_auth_org_lockout_config_v1()
        print("The response of GlobalTenantSecuritySettingsV1Api->get_auth_org_lockout_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling GlobalTenantSecuritySettingsV1Api->get_auth_org_lockout_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = GlobalTenantSecuritySettingsV1Api(api_client).get_auth_org_network_config_v1()
        # Below is a request that includes all optional parameters
        # results = GlobalTenantSecuritySettingsV1Api(api_client).get_auth_org_network_config_v1()
        print("The response of GlobalTenantSecuritySettingsV1Api->get_auth_org_network_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling GlobalTenantSecuritySettingsV1Api->get_auth_org_network_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = GlobalTenantSecuritySettingsV1Api(api_client).get_auth_org_service_provider_config_v1()
        # Below is a request that includes all optional parameters
        # results = GlobalTenantSecuritySettingsV1Api(api_client).get_auth_org_service_provider_config_v1()
        print("The response of GlobalTenantSecuritySettingsV1Api->get_auth_org_service_provider_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling GlobalTenantSecuritySettingsV1Api->get_auth_org_service_provider_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = GlobalTenantSecuritySettingsV1Api(api_client).get_auth_org_session_config_v1()
        # Below is a request that includes all optional parameters
        # results = GlobalTenantSecuritySettingsV1Api(api_client).get_auth_org_session_config_v1()
        print("The response of GlobalTenantSecuritySettingsV1Api->get_auth_org_session_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling GlobalTenantSecuritySettingsV1Api->get_auth_org_session_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = GlobalTenantSecuritySettingsV1Api(api_client).patch_auth_org_lockout_config_v1(jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = GlobalTenantSecuritySettingsV1Api(api_client).patch_auth_org_lockout_config_v1(new_jsonpatchoperation)
        print("The response of GlobalTenantSecuritySettingsV1Api->patch_auth_org_lockout_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling GlobalTenantSecuritySettingsV1Api->patch_auth_org_lockout_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Update security network configuration.
        new_jsonpatchoperation = Jsonpatchoperation.from_json(jsonpatchoperation)
        results = GlobalTenantSecuritySettingsV1Api(api_client).patch_auth_org_network_config_v1(jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = GlobalTenantSecuritySettingsV1Api(api_client).patch_auth_org_network_config_v1(new_jsonpatchoperation)
        print("The response of GlobalTenantSecuritySettingsV1Api->patch_auth_org_network_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling GlobalTenantSecuritySettingsV1Api->patch_auth_org_network_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Update service provider configuration
        new_jsonpatchoperation = Jsonpatchoperation.from_json(jsonpatchoperation)
        results = GlobalTenantSecuritySettingsV1Api(api_client).patch_auth_org_service_provider_config_v1(jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = GlobalTenantSecuritySettingsV1Api(api_client).patch_auth_org_service_provider_config_v1(new_jsonpatchoperation)
        print("The response of GlobalTenantSecuritySettingsV1Api->patch_auth_org_service_provider_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling GlobalTenantSecuritySettingsV1Api->patch_auth_org_service_provider_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Update auth org session configuration
        new_jsonpatchoperation = Jsonpatchoperation.from_json(jsonpatchoperation)
        results = GlobalTenantSecuritySettingsV1Api(api_client).patch_auth_org_session_config_v1(jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = GlobalTenantSecuritySettingsV1Api(api_client).patch_auth_org_session_config_v1(new_jsonpatchoperation)
        print("The response of GlobalTenantSecuritySettingsV1Api->patch_auth_org_session_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling GlobalTenantSecuritySettingsV1Api->patch_auth_org_session_config_v1: %s\n" % e)
```
