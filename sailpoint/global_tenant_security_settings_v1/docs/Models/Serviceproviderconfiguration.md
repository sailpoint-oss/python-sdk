...
slug: /tools/sdk/python/v1/models/serviceproviderconfiguration
...
**federation_protocol_details** | [**[]ServiceproviderconfigurationFederationProtocolDetailsInner**](serviceproviderconfiguration-federation-protocol-details-inner) | A list of the abstract implementations of the Federation Protocol details. Typically, this will include on SpDetails object and one IdpDetails object used in tandem to define a SAML integration between a customer's identity provider and a customer's SailPoint instance (i.e., the service provider). | [optional] 
}
