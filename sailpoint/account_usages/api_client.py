...
from sailpoint.account_usages.api_response import ApiResponse, T as ApiResponseT
import sailpoint.account_usages.models
from sailpoint.account_usages import rest
from sailpoint.account_usages.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.account_usages.models, klass)
