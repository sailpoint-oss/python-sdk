...
import sailpoint.cc.models
from sailpoint.cc import rest
from sailpoint.cc.exceptions import (ApiValueError, ApiException,
                                     BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.cc.models, klass)
