...
class SourcesAccountsApi:
    ...
    def export_account_feed(
        ...
        _param = self._export_account_feed_serialize(
            id=id,
    ...
    @validate_call
    def export_account_feed_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[None, Annotated[StrictFloat,
                                                Field(gt=0)],
    ...
    def _export_account_feed_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/cc/api/source/exportAccountFeed/{id}',
