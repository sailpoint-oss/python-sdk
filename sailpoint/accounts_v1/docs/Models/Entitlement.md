...
cloud_governed=True,
requestable=True,
owner=sailpoint.accounts_v1.models.entitlement_owner.entitlement_owner(
                    id = '2c9180827ca885d7017ca8ce28a000eb', 
                    type = 'IDENTITY', 
                    name = 'john.doe', ),
additional_owners=[
                    sailpoint.accounts_v1.models.additionalownerref.additionalownerref(
                        type = 'IDENTITY', 
                        id = '2c9180a46faadee4016fb4e018c20639', 
                        name = 'support', )
                    ],
manually_updated_fields={"DISPLAY_NAME":true,"DESCRIPTION":true},
access_model_metadata=sailpoint.accounts_v1.models.entitlement_access_model_metadata.entitlement_accessModelMetadata(
                    attributes = [
                        sailpoint.accounts_v1.models.access_model_metadata.Access Model Metadata(
                            key = 'iscCsp', 
                            name = 'CSP', 
                            multiselect = True, 
                            status = 'active', 
                            ...
                            values = [
                                sailpoint.accounts_v1.models.accessmodelmetadata_values_inner.accessmodelmetadata_values_inner(
                                    value = 'development', 
                                    name = 'Development', 
                                    status = 'active', )
                                ], )
...
source=sailpoint.accounts_v1.models.entitlement_source.entitlement_source(
                    id = '2c9180827ca885d7017ca8ce28a000eb', 
                    type = 'SOURCE', 
...
direct_permissions=[
                    sailpoint.accounts_v1.models.permission_dto.Permission DTO(
                        rights = HereIsRight1, 
