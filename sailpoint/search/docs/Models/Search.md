...
slug: /tools/sdk/python/search/models/search
...
query_version=,
query=sailpoint.search.models.query.Query(
                    query = 'name:a*', 
...
text_query=sailpoint.search.models.text_query.TextQuery(
                    terms = ["The quick brown fox","3141592","7"], 
                    fields = ["displayName","employeeNumber","roleCount"], 
                    match_any = False, 
                    contains = True, ),
type_ahead_query=sailpoint.search.models.type_ahead_query.TypeAheadQuery(
                    query = 'Work', 
                    field = 'source.name', 
                    nested_type = 'access', 
                    max_expansions = 10, 
                    ...
                    sort_by_value = True, ),
include_nested=True,
query_result_filter=sailpoint.search.models.query_result_filter.QueryResultFilter(
