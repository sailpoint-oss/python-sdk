...
from sailpoint.search.api_response import ApiResponse, T as ApiResponseT
import sailpoint.search.models
from sailpoint.search import rest
from sailpoint.search.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.search.models, klass)
