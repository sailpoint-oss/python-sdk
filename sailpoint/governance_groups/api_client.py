...
from sailpoint.governance_groups.api_response import ApiResponse, T as ApiResponseT
import sailpoint.governance_groups.models
from sailpoint.governance_groups import rest
from sailpoint.governance_groups.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.governance_groups.models, klass)
