...
class Formdefinitiondynamicschemaresponse(BaseModel):
    ...
    """ # noqa: E501
    output_schema: Optional[Dict[str, Any]] = Field(default=None, description="OutputSchema holds a JSON schema generated dynamically", alias="outputSchema")
    __properties: ClassVar[List[str]] = ["outputSchema"]
