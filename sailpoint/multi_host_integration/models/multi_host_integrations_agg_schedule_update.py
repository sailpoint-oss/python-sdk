...
class MultiHostIntegrationsAggScheduleUpdate(BaseModel):
    """
    ...
    enable_schedule: StrictBool = Field(description="Boolean value for Multi-Host Integration aggregation schedule.  This specifies if scheduled aggregation is enabled or disabled.", alias="enableSchedule")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "enableSchedule": obj.get("enableSchedule") if obj.get("enableSchedule") is not None else False,
            "source_id_list": obj.get("source_id_list"),
