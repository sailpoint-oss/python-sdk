...
class MultiHostIntegrationsAccountCorrelationRule(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['RULE']):
            warnings.warn(f"must be one of enum values ('RULE') unknown value: {value}")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MultiHostIntegrationsAccountCorrelationRule from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MultiHostIntegrationsAccountCorrelationRule from a dict"""
        if obj is None:
            return None
