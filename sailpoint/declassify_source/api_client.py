...
from sailpoint.declassify_source.api_response import ApiResponse, T as ApiResponseT
import sailpoint.declassify_source.models
from sailpoint.declassify_source import rest
from sailpoint.declassify_source.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.declassify_source.models, klass)
