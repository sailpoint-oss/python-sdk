...
slug: /tools/sdk/python/dimensions/models/access-profile
...
owner=sailpoint.dimensions.models.owner_reference.OwnerReference(
                    ...
                    name = 'support', ),
source=sailpoint.dimensions.models.access_profile_source_ref.AccessProfileSourceRef(
...
access_model_metadata=sailpoint.dimensions.models.attribute_dto_list.AttributeDTOList(
...
provisioning_criteria=sailpoint.dimensions.models.provisioning_criteria_level1.ProvisioningCriteriaLevel1(
                    operation = 'EQUALS', 
                    attribute = 'email', 
                    value = 'carlee.cert1c9f9b6fd@mailinator.com', 
                    children = [
                        sailpoint.dimensions.models.provisioning_criteria_level2.ProvisioningCriteriaLevel2(
                            attribute = 'email', 
                            value = 'carlee.cert1c9f9b6fd@mailinator.com', )
                        ], ),
additional_owners=[
                    sailpoint.dimensions.models.additional_owner_ref.AdditionalOwnerRef(
                        type = 'IDENTITY', 
                        id = '2c9180a46faadee4016fb4e018c20639', 
                        name = 'support', )
                    ]
