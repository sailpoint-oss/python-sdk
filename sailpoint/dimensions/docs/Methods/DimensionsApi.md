...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DimensionsApi(api_client).delete_bulk_dimensions_v1(role_id=role_id, dimension_bulk_delete_request=new_dimension_bulk_delete_request)
        # Below is a request that includes all optional parameters
        # results = DimensionsApi(api_client).delete_bulk_dimensions_v1(role_id, new_dimension_bulk_delete_request)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DimensionsApi(api_client).patch_dimension_v1(role_id=role_id, dimension_id=dimension_id, json_patch_operation=new_json_patch_operation)
        # Below is a request that includes all optional parameters
        # results = DimensionsApi(api_client).patch_dimension_v1(role_id, dimension_id, new_json_patch_operation)
