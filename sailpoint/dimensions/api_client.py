...
from sailpoint.dimensions.api_response import ApiResponse, T as ApiResponseT
import sailpoint.dimensions.models
from sailpoint.dimensions import rest
from sailpoint.dimensions.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.dimensions.models, klass)
