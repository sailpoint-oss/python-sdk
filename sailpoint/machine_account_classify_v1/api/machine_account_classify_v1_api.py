...
from sailpoint.machine_account_classify_v1.api_client import ApiClient, RequestSerialized
from sailpoint.machine_account_classify_v1.api_response import ApiResponse
from sailpoint.machine_account_classify_v1.rest import RESTResponseType
...
class MachineAccountClassifyV1Api:
    ...
    @validate_call
    def send_classify_machine_account_v1(
        self,
    ...
    @validate_call
    def send_classify_machine_account_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Account ID.")],
        classification_mode: Annotated[Optional[StrictStr], Field(description="Specifies how the accounts should be classified.        default - uses criteria to classify account as machine or human, excludes accounts that were manually classified.       ignoreManual - like default, but includes accounts that were manually classified.       forceMachine - forces account to be classified as machine.       forceHuman - forces account to be classified as human.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SendClassifyMachineAccountV1200Response]:
        """Classify single machine account
    ...
    @validate_call
    def send_classify_machine_account_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Account ID.")],
        classification_mode: Annotated[Optional[StrictStr], Field(description="Specifies how the accounts should be classified.        default - uses criteria to classify account as machine or human, excludes accounts that were manually classified.       ignoreManual - like default, but includes accounts that were manually classified.       forceMachine - forces account to be classified as machine.       forceHuman - forces account to be classified as human.")] = None,
        _request_timeout: Union[
    ...
    def _send_classify_machine_account_v1_serialize(
        self,
        id,
        classification_mode,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/accounts/v1/{id}/classify',
