...
from sailpoint.auth_users.api_response import ApiResponse, T as ApiResponseT
import sailpoint.auth_users.models
from sailpoint.auth_users import rest
from sailpoint.auth_users.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.auth_users.models, klass)
