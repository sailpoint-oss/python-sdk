...
from sailpoint.business_applications.api_response import ApiResponse, T as ApiResponseT
import sailpoint.business_applications.models
from sailpoint.business_applications import rest
from sailpoint.business_applications.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.business_applications.models, klass)
