...
from sailpoint.iai_recommendations_v1.api_client import ApiClient, RequestSerialized
from sailpoint.iai_recommendations_v1.api_response import ApiResponse
from sailpoint.iai_recommendations_v1.rest import RESTResponseType
...
class IAIRecommendationsV1Api:
    ...
    @validate_call
    def get_recommendations_config_v1(
        self,
        ...
        _param = self._get_recommendations_config_v1_serialize(
    ...
    @validate_call
    def get_recommendations_config_v1_with_http_info(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_recommendations_config_v1_without_preload_content(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_recommendations_config_v1_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/recommendations/v1/config',
    ...
    def _get_recommendations_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/recommendations/v1/request',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
