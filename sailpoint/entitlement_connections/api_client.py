...
from sailpoint.entitlement_connections.api_response import ApiResponse, T as ApiResponseT
import sailpoint.entitlement_connections.models
from sailpoint.entitlement_connections import rest
from sailpoint.entitlement_connections.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.entitlement_connections.models, klass)
