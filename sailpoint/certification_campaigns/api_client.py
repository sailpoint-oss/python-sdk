...
from sailpoint.certification_campaigns.api_response import ApiResponse, T as ApiResponseT
import sailpoint.certification_campaigns.models
from sailpoint.certification_campaigns import rest
from sailpoint.certification_campaigns.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.certification_campaigns.models, klass)
