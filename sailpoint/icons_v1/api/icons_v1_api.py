...
from sailpoint.icons_v1.api_client import ApiClient, RequestSerialized
from sailpoint.icons_v1.api_response import ApiResponse
from sailpoint.icons_v1.rest import RESTResponseType
...
class IconsV1Api:
    ...
    def delete_icon_v1(
        ...
        _param = self._delete_icon_v1_serialize(
    ...
    @validate_call
    def delete_icon_v1_with_http_info(
        self,
        object_type: Annotated[StrictStr, Field(description="Object type. Available options ['application']")],
        object_id: Annotated[StrictStr, Field(description="Object id.")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
    ...
    @validate_call
    def delete_icon_v1_without_preload_content(
        self,
        object_type: Annotated[StrictStr, Field(description="Object type. Available options ['application']")],
        object_id: Annotated[StrictStr, Field(description="Object id.")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
    ...
    def _delete_icon_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/icons/v1/{objectType}/{objectId}',
    ...
    def set_icon_v1(
        ...
        _param = self._set_icon_v1_serialize(
            object_type=object_type,
            object_id=object_id,
            image=image,
            x_sail_point_experimental=x_sail_point_experimental,
    ...
    @validate_call
    def set_icon_v1_with_http_info(
        self,
        object_type: Annotated[StrictStr, Field(description="Object type. Available options ['application']")],
        object_id: Annotated[StrictStr, Field(description="Object id.")],
        image: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="file with icon. Allowed mime-types ['image/png', 'image/jpeg']")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SetIconV1200Response]:
        """Update an icon
    ...
    @validate_call
    def set_icon_v1_without_preload_content(
        self,
        object_type: Annotated[StrictStr, Field(description="Object type. Available options ['application']")],
        object_id: Annotated[StrictStr, Field(description="Object id.")],
        image: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="file with icon. Allowed mime-types ['image/png', 'image/jpeg']")],
