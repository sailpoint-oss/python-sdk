...
from sailpoint.tags.api_response import ApiResponse, T as ApiResponseT
import sailpoint.tags.models
from sailpoint.tags import rest
from sailpoint.tags.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.tags.models, klass)
