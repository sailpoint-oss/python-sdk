...
from sailpoint.sod_controls.api_response import ApiResponse, T as ApiResponseT
import sailpoint.sod_controls.models
from sailpoint.sod_controls import rest
from sailpoint.sod_controls.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.sod_controls.models, klass)
