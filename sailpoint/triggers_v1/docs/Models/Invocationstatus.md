...
slug: /tools/sdk/python/v1/models/invocationstatus
...
start_invocation_input=sailpoint.triggers_v1.models.start_invocation_input.Start Invocation Input(
                    trigger_id = 'idn:access-requested', 
                    input = {"identityId":"201327fda1c44704ac01181e963d463c"}, 
                    content_json = {"workflowId":1234}, ),
complete_invocation_input=sailpoint.triggers_v1.models.complete_invocation_input.Complete Invocation Input(
                    localized_error = sailpoint.triggers_v1.models.localized_message.Localized Message(
