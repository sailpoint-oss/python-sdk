...
class ProvisioningcompletedAccountRequestsInner(BaseModel):
    ...
    provisioning_result: StrictStr = Field(description="The overall result of the provisioning transaction; this could be success, pending, failed, etc.", alias="provisioningResult")
