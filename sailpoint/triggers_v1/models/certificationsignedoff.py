...
class Certificationsignedoff(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["certification"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "certification": CertificationsignedoffCertification.from_dict(obj["certification"]) if obj.get("certification") is not None else None
        })
        return _obj
