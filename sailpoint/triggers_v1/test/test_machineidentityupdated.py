...
class TestMachineidentityupdated(unittest.TestCase):
    """Machineidentityupdated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Machineidentityupdated:
        """Test Machineidentityupdated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Machineidentityupdated`
        """
        model = Machineidentityupdated()
        if include_optional:
            return Machineidentityupdated(
    ...
    def testMachineidentityupdated(self):
        """Test Machineidentityupdated"""
