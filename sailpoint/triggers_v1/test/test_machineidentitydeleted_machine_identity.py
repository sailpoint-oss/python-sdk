...
class TestMachineidentitydeletedMachineIdentity(unittest.TestCase):
    """MachineidentitydeletedMachineIdentity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MachineidentitydeletedMachineIdentity:
        """Test MachineidentitydeletedMachineIdentity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MachineidentitydeletedMachineIdentity`
        """
        model = MachineidentitydeletedMachineIdentity()
        if include_optional:
            return MachineidentitydeletedMachineIdentity(
    ...
    def testMachineidentitydeletedMachineIdentity(self):
        """Test MachineidentitydeletedMachineIdentity"""
