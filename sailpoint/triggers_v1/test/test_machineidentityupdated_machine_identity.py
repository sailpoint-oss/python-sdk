...
class TestMachineidentityupdatedMachineIdentity(unittest.TestCase):
    """MachineidentityupdatedMachineIdentity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MachineidentityupdatedMachineIdentity:
        """Test MachineidentityupdatedMachineIdentity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MachineidentityupdatedMachineIdentity`
        """
        model = MachineidentityupdatedMachineIdentity()
        if include_optional:
            return MachineidentityupdatedMachineIdentity(
    ...
    def testMachineidentityupdatedMachineIdentity(self):
        """Test MachineidentityupdatedMachineIdentity"""
