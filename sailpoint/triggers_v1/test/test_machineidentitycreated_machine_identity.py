...
class TestMachineidentitycreatedMachineIdentity(unittest.TestCase):
    """MachineidentitycreatedMachineIdentity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MachineidentitycreatedMachineIdentity:
        """Test MachineidentitycreatedMachineIdentity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MachineidentitycreatedMachineIdentity`
        """
        model = MachineidentitycreatedMachineIdentity()
        if include_optional:
            return MachineidentitycreatedMachineIdentity(
    ...
    def testMachineidentitycreatedMachineIdentity(self):
        """Test MachineidentitycreatedMachineIdentity"""
