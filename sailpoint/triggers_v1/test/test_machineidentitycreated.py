...
class TestMachineidentitycreated(unittest.TestCase):
    """Machineidentitycreated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Machineidentitycreated:
        """Test Machineidentitycreated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Machineidentitycreated`
        """
        model = Machineidentitycreated()
        if include_optional:
            return Machineidentitycreated(
    ...
    def testMachineidentitycreated(self):
        """Test Machineidentitycreated"""
