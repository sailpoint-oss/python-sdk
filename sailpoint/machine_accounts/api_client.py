...
from sailpoint.machine_accounts.api_response import ApiResponse, T as ApiResponseT
import sailpoint.machine_accounts.models
from sailpoint.machine_accounts import rest
from sailpoint.machine_accounts.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.machine_accounts.models, klass)
