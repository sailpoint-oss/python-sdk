...
class MachineAccount(BaseModel):
    ...
    machine_identity: Optional[Any] = Field(default=None, description="The machine identity this account is associated with", alias="machineIdentity")
    owner_identity: Optional[Any] = Field(default=None, description="The identity who owns this account.", alias="ownerIdentity")
