...
from sailpoint.certification_campaign_filters.api_response import ApiResponse, T as ApiResponseT
import sailpoint.certification_campaign_filters.models
from sailpoint.certification_campaign_filters import rest
from sailpoint.certification_campaign_filters.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.certification_campaign_filters.models, klass)
