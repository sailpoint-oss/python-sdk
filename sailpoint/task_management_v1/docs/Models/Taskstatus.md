...
keywords: ['python', 'Python', 'sdk', 'Taskstatus', 'Taskstatus'] 
slug: /tools/sdk/python/v1/models/taskstatus
...
launcher='sweep',
target=sailpoint.task_management_v1.models.target.Target(
...
messages=[
                    sailpoint.task_management_v1.models.task_status_message.Task Status Message(
                        type = 'INFO', 
                        localized_text = sailpoint.task_management_v1.models.localized_message.Localized Message(
...
returns=[
                    sailpoint.task_management_v1.models.task_return_details.Task Return Details(
                        name = 'label', 
...
task_definition_summary=sailpoint.task_management_v1.models.task_definition_summary.Task Definition Summary(
