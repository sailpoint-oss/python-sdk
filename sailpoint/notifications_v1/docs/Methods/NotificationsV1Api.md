...
slug: /tools/sdk/python/v1/methods/notifications
tags: ['SDK', 'Software Development Kit', 'Notifications', 'Notifications']
---

# sailpoint.notifications_v1.NotificationsV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NotificationsV1Api(api_client).create_domain_dkim_v1(domainaddress=new_domainaddress)
        # Below is a request that includes all optional parameters
        # results = NotificationsV1Api(api_client).create_domain_dkim_v1(new_domainaddress)
...
with ApiClient(configuration) as api_client:
    templatedto = '''sailpoint.notifications_v1.Templatedto()''' # Templatedto | 

    try:
        # Create notification template
        new_templatedto = Templatedto.from_json(templatedto)
        results = NotificationsV1Api(api_client).create_notification_template_v1(templatedto=new_templatedto)
        # Below is a request that includes all optional parameters
        # results = NotificationsV1Api(api_client).create_notification_template_v1(new_templatedto)
        print("The response of NotificationsV1Api->create_notification_template_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NotificationsV1Api->create_notification_template_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NotificationsV1Api(api_client).create_verified_from_address_v1(emailstatusdto=new_emailstatusdto)
        # Below is a request that includes all optional parameters
        # results = NotificationsV1Api(api_client).create_verified_from_address_v1(new_emailstatusdto)
        print("The response of NotificationsV1Api->create_verified_from_address_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NotificationsV1Api->create_verified_from_address_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    templatebulkdeletedto = '''[sailpoint.notifications_v1.Templatebulkdeletedto()]''' # List[Templatebulkdeletedto] | 

    try:
        # Bulk delete notification templates
        new_templatebulkdeletedto = Templatebulkdeletedto.from_json(templatebulkdeletedto)
        NotificationsV1Api(api_client).delete_notification_templates_in_bulk_v1(templatebulkdeletedto=new_templatebulkdeletedto)
        # Below is a request that includes all optional parameters
        # NotificationsV1Api(api_client).delete_notification_templates_in_bulk_v1(new_templatebulkdeletedto)
    except Exception as e:
        print("Exception when calling NotificationsV1Api->delete_notification_templates_in_bulk_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        NotificationsV1Api(api_client).delete_verified_from_address_v1(id=id)
        # Below is a request that includes all optional parameters
        # NotificationsV1Api(api_client).delete_verified_from_address_v1(id)
    except Exception as e:
        print("Exception when calling NotificationsV1Api->delete_verified_from_address_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NotificationsV1Api(api_client).get_dkim_attributes_v1()
        # Below is a request that includes all optional parameters
        # results = NotificationsV1Api(api_client).get_dkim_attributes_v1(limit, offset)
        print("The response of NotificationsV1Api->get_dkim_attributes_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NotificationsV1Api->get_dkim_attributes_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NotificationsV1Api(api_client).get_mail_from_attributes_v1(identity=identity)
        # Below is a request that includes all optional parameters
        # results = NotificationsV1Api(api_client).get_mail_from_attributes_v1(identity)
        print("The response of NotificationsV1Api->get_mail_from_attributes_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NotificationsV1Api->get_mail_from_attributes_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NotificationsV1Api(api_client).get_notification_preferences_v1(key=key)
        # Below is a request that includes all optional parameters
        # results = NotificationsV1Api(api_client).get_notification_preferences_v1(key)
        print("The response of NotificationsV1Api->get_notification_preferences_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NotificationsV1Api->get_notification_preferences_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NotificationsV1Api(api_client).get_notification_template_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = NotificationsV1Api(api_client).get_notification_template_v1(id)
        print("The response of NotificationsV1Api->get_notification_template_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NotificationsV1Api->get_notification_template_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NotificationsV1Api(api_client).get_notification_template_variables_v1(key=key, medium=medium)
        # Below is a request that includes all optional parameters
        # results = NotificationsV1Api(api_client).get_notification_template_variables_v1(key, medium, sorters)
        print("The response of NotificationsV1Api->get_notification_template_variables_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NotificationsV1Api->get_notification_template_variables_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NotificationsV1Api(api_client).get_notifications_template_context_v1()
        # Below is a request that includes all optional parameters
        # results = NotificationsV1Api(api_client).get_notifications_template_context_v1()
        print("The response of NotificationsV1Api->get_notifications_template_context_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NotificationsV1Api->get_notifications_template_context_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NotificationsV1Api(api_client).list_from_addresses_v1()
        # Below is a request that includes all optional parameters
        # results = NotificationsV1Api(api_client).list_from_addresses_v1(limit, offset, count, filters, sorters)
        print("The response of NotificationsV1Api->list_from_addresses_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NotificationsV1Api->list_from_addresses_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NotificationsV1Api(api_client).list_notification_template_defaults_v1()
        # Below is a request that includes all optional parameters
        # results = NotificationsV1Api(api_client).list_notification_template_defaults_v1(limit, offset, filters)
        print("The response of NotificationsV1Api->list_notification_template_defaults_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NotificationsV1Api->list_notification_template_defaults_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NotificationsV1Api(api_client).list_notification_templates_v1()
        # Below is a request that includes all optional parameters
        # results = NotificationsV1Api(api_client).list_notification_templates_v1(limit, offset, filters, sorters)
        print("The response of NotificationsV1Api->list_notification_templates_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NotificationsV1Api->list_notification_templates_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NotificationsV1Api(api_client).put_mail_from_attributes_v1(mailfromattributesdto=new_mailfromattributesdto)
        # Below is a request that includes all optional parameters
        # results = NotificationsV1Api(api_client).put_mail_from_attributes_v1(new_mailfromattributesdto)
        print("The response of NotificationsV1Api->put_mail_from_attributes_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NotificationsV1Api->put_mail_from_attributes_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        NotificationsV1Api(api_client).send_test_notification_v1(sendtestnotificationrequestdto=new_sendtestnotificationrequestdto)
        # Below is a request that includes all optional parameters
        # NotificationsV1Api(api_client).send_test_notification_v1(new_sendtestnotificationrequestdto)
    except Exception as e:
        print("Exception when calling NotificationsV1Api->send_test_notification_v1: %s\n" % e)
```
