...
slug: /tools/sdk/python/v1/methods/declassify-source
tags: ['SDK', 'Software Development Kit', 'Declassify_Source', 'Declassify_Source']
---

# sailpoint.declassify_source_v1.DeclassifySourceV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        DeclassifySourceV1Api(api_client).send_declassify_machine_account_from_source_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # DeclassifySourceV1Api(api_client).send_declassify_machine_account_from_source_v1(source_id)
    except Exception as e:
        print("Exception when calling DeclassifySourceV1Api->send_declassify_machine_account_from_source_v1: %s\n" % e)
```
