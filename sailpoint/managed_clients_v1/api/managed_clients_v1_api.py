...
from sailpoint.managed_clients_v1.api_client import ApiClient, RequestSerialized
from sailpoint.managed_clients_v1.api_response import ApiResponse
from sailpoint.managed_clients_v1.rest import RESTResponseType
...
class ManagedClientsV1Api:
    ...
    def _create_managed_client_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/managed-clients/v1',
    ...
    def delete_managed_client_v1(
        ...
        _param = self._delete_managed_client_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_managed_client_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Managed client ID.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_managed_client_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Managed client ID.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_managed_client_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/managed-clients/v1/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_managed_client_health_indicators_v1(
        self,
        id: Annotated[StrictStr, Field(description="Managed client ID to get health indicators for.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Managed client ID to get health indicators for. (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_managed_client_health_indicators_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_managed_client_health_indicators_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Managed client ID to get health indicators for.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_managed_client_health_indicators_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Managed client ID to get health indicators for.")],
        _request_timeout: Union[
            None,
    ...
    def _get_managed_client_health_indicators_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/managed-clients/v1/{id}/health-indicators',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_managed_client_status_v1(
        ...
        _param = self._get_managed_client_status_v1_serialize(
            id=id,
            type=type,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _get_managed_client_status_v1_serialize(
        self,
        id,
        type,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/managed-clients/v1/{id}/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_managed_client_v1(
        ...
        _param = self._get_managed_client_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_managed_client_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Managed client ID.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_managed_client_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Managed client ID.")],
        _request_timeout: Union[
            None,
    ...
    def _get_managed_client_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_managed_clients_v1(
        ...
        _param = self._get_managed_clients_v1_serialize(
            offset=offset,
            limit=limit,
            count=count,
            filters=filters,
    ...
    @validate_call
    def get_managed_clients_v1_with_http_info(
        self,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def get_managed_clients_v1_without_preload_content(
        self,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _get_managed_clients_v1_serialize(
        self,
        offset,
        limit,
        count,
