...
slug: /tools/sdk/python/v1/methods/managed-clients
tags: ['SDK', 'Software Development Kit', 'Managed_Clients', 'Managed_Clients']
---

# sailpoint.managed_clients_v1.ManagedClientsV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ManagedClientsV1Api(api_client).create_managed_client_v1(managedclientrequest=new_managedclientrequest)
        # Below is a request that includes all optional parameters
        # results = ManagedClientsV1Api(api_client).create_managed_client_v1(new_managedclientrequest)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        ManagedClientsV1Api(api_client).delete_managed_client_v1(id=id)
        # Below is a request that includes all optional parameters
        # ManagedClientsV1Api(api_client).delete_managed_client_v1(id)
    except Exception as e:
        print("Exception when calling ManagedClientsV1Api->delete_managed_client_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ManagedClientsV1Api(api_client).get_managed_client_health_indicators_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = ManagedClientsV1Api(api_client).get_managed_client_health_indicators_v1(id)
        print("The response of ManagedClientsV1Api->get_managed_client_health_indicators_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ManagedClientsV1Api->get_managed_client_health_indicators_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    type = sailpoint.managed_clients_v1.Managedclienttype() # Managedclienttype | Managed client type to get status for. # Managedclienttype | Managed client type to get status for.

    try:
        # Get managed client status
        
        results = ManagedClientsV1Api(api_client).get_managed_client_status_v1(id=id, type=type)
        # Below is a request that includes all optional parameters
        # results = ManagedClientsV1Api(api_client).get_managed_client_status_v1(id, type)
        print("The response of ManagedClientsV1Api->get_managed_client_status_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ManagedClientsV1Api->get_managed_client_status_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ManagedClientsV1Api(api_client).get_managed_client_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = ManagedClientsV1Api(api_client).get_managed_client_v1(id)
        print("The response of ManagedClientsV1Api->get_managed_client_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ManagedClientsV1Api->get_managed_client_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ManagedClientsV1Api(api_client).get_managed_clients_v1()
        # Below is a request that includes all optional parameters
        # results = ManagedClientsV1Api(api_client).get_managed_clients_v1(offset, limit, count, filters)
        print("The response of ManagedClientsV1Api->get_managed_clients_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ManagedClientsV1Api->get_managed_clients_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    id = '4440278c-0ce2-41ee-a0a9-f5cfd5e8d3b7' # str | Managed client ID. # str | Managed client ID.
    jsonpatchoperation = '''[sailpoint.managed_clients_v1.Jsonpatchoperation()]''' # List[Jsonpatchoperation] | JSONPatch payload used to update the object.

    try:
        # Update managed client
        new_jsonpatchoperation = Jsonpatchoperation.from_json(jsonpatchoperation)
        results = ManagedClientsV1Api(api_client).update_managed_client_v1(id=id, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = ManagedClientsV1Api(api_client).update_managed_client_v1(id, new_jsonpatchoperation)
        print("The response of ManagedClientsV1Api->update_managed_client_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ManagedClientsV1Api->update_managed_client_v1: %s\n" % e)
```
