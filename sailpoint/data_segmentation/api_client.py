...
from sailpoint.data_segmentation.api_response import ApiResponse, T as ApiResponseT
import sailpoint.data_segmentation.models
from sailpoint.data_segmentation import rest
from sailpoint.data_segmentation.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.data_segmentation.models, klass)
