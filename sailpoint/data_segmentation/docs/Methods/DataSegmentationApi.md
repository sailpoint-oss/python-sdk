...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # results = DataSegmentationApi(api_client).create_data_segment_v1(new_data_segment, x_sail_point_experimental)
...
### Return type
[**List[SegmentMembership]**](../models/segment-membership)
