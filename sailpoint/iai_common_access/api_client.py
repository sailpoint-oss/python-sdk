...
from sailpoint.iai_common_access.api_response import ApiResponse, T as ApiResponseT
import sailpoint.iai_common_access.models
from sailpoint.iai_common_access import rest
from sailpoint.iai_common_access.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.iai_common_access.models, klass)
