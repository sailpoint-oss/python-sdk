...
from sailpoint.ui_metadata_v1.api_client import ApiClient, RequestSerialized
from sailpoint.ui_metadata_v1.api_response import ApiResponse
from sailpoint.ui_metadata_v1.rest import RESTResponseType
...
class UIMetadataV1Api:
    ...
    def get_tenant_ui_metadata_v1(
        ...
        _param = self._get_tenant_ui_metadata_v1_serialize(
    ...
    @validate_call
    def get_tenant_ui_metadata_v1_with_http_info(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_tenant_ui_metadata_v1_without_preload_content(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_tenant_ui_metadata_v1_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ui-metadata/v1/tenant',
