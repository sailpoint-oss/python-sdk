# sailpoint.account-usages
Use these APIs to interact with the Identity Security Cloud platform to achieve repeatable, automated processes with greater scalability. We encourage you to join the SailPoint Developer Community forum at https://developer.sailpoint.com/discuss to connect with other developers using our APIs.

The `sailpoint.account_usages` package is automatically generated by the [OpenAPI Generator](https://openapi-generator.tech) project:
...
In your own code, to use this library to connect and interact with sailpoint.account-usages,
you can run the following:

```python

import sailpoint.account_usages
from sailpoint.account_usages.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to https://sailpoint.api.identitynow.com
# See configuration.py for a list of all supported configuration parameters.
configuration = sailpoint.account_usages.Configuration(
...
with sailpoint.account_usages.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = sailpoint.account_usages.AccountUsagesApi(api_client)
...
------------ | ------------- | ------------- | -------------
*AccountUsagesApi* | [**get_usages_by_account_id_v1**](sailpoint/account_usages/docs/AccountUsagesApi.md#get_usages_by_account_id_v1) | **GET** /account-usages/v1/{accountId}/summaries | Returns account usage insights
