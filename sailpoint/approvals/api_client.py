...
from sailpoint.approvals.api_response import ApiResponse, T as ApiResponseT
import sailpoint.approvals.models
from sailpoint.approvals import rest
from sailpoint.approvals.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.approvals.models, klass)
