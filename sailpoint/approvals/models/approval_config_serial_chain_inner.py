...
class ApprovalConfigSerialChainInner(BaseModel):
    ...
    identity_type: Optional[StrictStr] = Field(default=None, description="Type of identityId in the serial chain.", alias="identityType")
    __properties: ClassVar[List[str]] = ["identityId", "identityType"]
