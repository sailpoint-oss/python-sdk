...
from sailpoint.jit_activations_v1.api_response import ApiResponse, T as ApiResponseT
import sailpoint.jit_activations_v1.models
from sailpoint.jit_activations_v1 import rest
from sailpoint.jit_activations_v1.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.jit_activations_v1.models, klass)
