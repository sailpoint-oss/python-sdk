...
slug: /tools/sdk/python/non-employee-lifecycle-management/models/error-response-dto
...
messages=[
                    sailpoint.non_employee_lifecycle_management.models.error_message_dto.Error Message Dto(
                        locale = 'en-US', 
