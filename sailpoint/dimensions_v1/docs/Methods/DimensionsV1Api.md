...
slug: /tools/sdk/python/v1/methods/dimensions
tags: ['SDK', 'Software Development Kit', 'Dimensions', 'Dimensions']
---

# sailpoint.dimensions_v1.DimensionsV1Api
...
from sailpoint.dimensions_v1.api_client import ApiClient
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DimensionsV1Api(api_client).create_dimension_v1(role_id=role_id, dimension=new_dimension)
        # Below is a request that includes all optional parameters
        # results = DimensionsV1Api(api_client).create_dimension_v1(role_id, new_dimension)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DimensionsV1Api(api_client).delete_bulk_dimensions_v1(role_id=role_id, dimensionbulkdeleterequest=new_dimensionbulkdeleterequest)
        # Below is a request that includes all optional parameters
        # results = DimensionsV1Api(api_client).delete_bulk_dimensions_v1(role_id, new_dimensionbulkdeleterequest)
        print("The response of DimensionsV1Api->delete_bulk_dimensions_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DimensionsV1Api->delete_bulk_dimensions_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        DimensionsV1Api(api_client).delete_dimension_v1(role_id=role_id, dimension_id=dimension_id)
        # Below is a request that includes all optional parameters
        # DimensionsV1Api(api_client).delete_dimension_v1(role_id, dimension_id)
    except Exception as e:
        print("Exception when calling DimensionsV1Api->delete_dimension_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DimensionsV1Api(api_client).get_dimension_entitlements_v1(role_id=role_id, dimension_id=dimension_id)
        # Below is a request that includes all optional parameters
        # results = DimensionsV1Api(api_client).get_dimension_entitlements_v1(role_id, dimension_id, limit, offset, count, filters, sorters)
        print("The response of DimensionsV1Api->get_dimension_entitlements_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DimensionsV1Api->get_dimension_entitlements_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DimensionsV1Api(api_client).get_dimension_v1(role_id=role_id, dimension_id=dimension_id)
        # Below is a request that includes all optional parameters
        # results = DimensionsV1Api(api_client).get_dimension_v1(role_id, dimension_id)
        print("The response of DimensionsV1Api->get_dimension_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DimensionsV1Api->get_dimension_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DimensionsV1Api(api_client).list_dimension_access_profiles_v1(role_id=role_id, dimension_id=dimension_id)
        # Below is a request that includes all optional parameters
        # results = DimensionsV1Api(api_client).list_dimension_access_profiles_v1(role_id, dimension_id, limit, offset, count, filters, sorters)
        print("The response of DimensionsV1Api->list_dimension_access_profiles_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DimensionsV1Api->list_dimension_access_profiles_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DimensionsV1Api(api_client).list_dimensions_v1(role_id=role_id)
        # Below is a request that includes all optional parameters
        # results = DimensionsV1Api(api_client).list_dimensions_v1(role_id, for_subadmin, limit, offset, count, filters, sorters)
        print("The response of DimensionsV1Api->list_dimensions_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DimensionsV1Api->list_dimensions_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DimensionsV1Api(api_client).patch_dimension_v1(role_id=role_id, dimension_id=dimension_id, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = DimensionsV1Api(api_client).patch_dimension_v1(role_id, dimension_id, new_jsonpatchoperation)
        print("The response of DimensionsV1Api->patch_dimension_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DimensionsV1Api->patch_dimension_v1: %s\n" % e)
```
