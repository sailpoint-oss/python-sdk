...
cloud_governed=True,
requestable=True,
owner=sailpoint.dimensions_v1.models.entitlement_owner.entitlement_owner(
...
access_model_metadata=sailpoint.dimensions_v1.models.entitlement_access_model_metadata.entitlement_accessModelMetadata(
                    attributes = [
                        sailpoint.dimensions_v1.models.access_model_metadata.Access Model Metadata(
                            key = 'iscCsp', 
                            name = 'CSP', 
                            multiselect = True, 
                            status = 'active', 
                            ...
                            values = [
                                sailpoint.dimensions_v1.models.accessmodelmetadata_values_inner.accessmodelmetadata_values_inner(
                                    value = 'development', 
                                    name = 'Development', 
                                    status = 'active', )
                                ], )
...
source=sailpoint.dimensions_v1.models.entitlement_source.entitlement_source(
                    id = '2c9180827ca885d7017ca8ce28a000eb', 
                    type = 'SOURCE', 
...
direct_permissions=[
                    sailpoint.dimensions_v1.models.permission_dto.Permission DTO(
                        rights = HereIsRight1, 
