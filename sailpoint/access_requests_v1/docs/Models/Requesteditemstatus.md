...
slug: /tools/sdk/python/v1/models/requesteditemstatus
...
state='EXECUTING',
approval_details=[
                    sailpoint.access_requests_v1.models.approval_status_dto.Approval Status Dto(
                        forwarded = False, 
                        original_owner = sailpoint.access_requests_v1.models.approvalstatusdto_original_owner.approvalstatusdto_originalOwner(
                            type = 'IDENTITY', 
                        ...
                        scheme = 'MANAGER', 
                        error_messages = [
                            sailpoint.access_requests_v1.models.error_message_dto.Error Message Dto(
                                locale = 'en-US', 
...
manual_work_item_details=[
                    sailpoint.access_requests_v1.models.manual_work_item_details.Manual Work Item Details(
                        forwarded = True, 
                        original_owner = sailpoint.access_requests_v1.models.manualworkitemdetails_original_owner.manualworkitemdetails_originalOwner(
                            type = 'IDENTITY', 
                            id = '2c7180a46faadee4016fb4e018c20642', 
                            name = 'Michael Michaels', ), 
                        current_owner = sailpoint.access_requests_v1.models.manualworkitemdetails_current_owner.manualworkitemdetails_currentOwner(
                            type = 'IDENTITY', 
                        ...
                        status = 'PENDING', 
                        forward_history = [
                            sailpoint.access_requests_v1.models.approval_forward_history.Approval Forward History(
...
requester=sailpoint.access_requests_v1.models.access_item_requester.Access Item Requester(
                    type = 'IDENTITY', 
                    id = '2c7180a46faadee4016fb4e018c20648', 
                    name = 'William Wilson', ),
requested_for=sailpoint.access_requests_v1.models.requesteditemstatus_requested_for.requesteditemstatus_requestedFor(
                    type = 'IDENTITY', 
...
access_request_phases=[
                    sailpoint.access_requests_v1.models.access_request_phases.Access Request Phases(
...
requested_accounts=[
                    sailpoint.access_requests_v1.models.requested_account_ref.Requested Account Ref(
