...
keywords: ['python', 'Python', 'sdk', 'Identityaccountselections', 'Identityaccountselections'] 
slug: /tools/sdk/python/v1/models/identityaccountselections
...
------------ | ------------- | ------------- | -------------
**requested_items** | [**[]Requesteditemaccountselections**](requesteditemaccountselections) | Available account selections for the identity, per requested item | [optional] 
...
identityaccountselections = Identityaccountselections(
requested_items=[
                    sailpoint.access_requests_v1.models.requesteditemaccountselections.requesteditemaccountselections(
                        ...
                        sources = [
                            sailpoint.access_requests_v1.models.sourceaccountselections.sourceaccountselections(
                                type = 'IDENTITY', 
                                id = '3ac3c43785a845fa9820b0c1ac767cd5', 
                                name = 'Test Source_Name', 
                                accounts = [
                                    sailpoint.access_requests_v1.models.accountinforef.accountinforef(
