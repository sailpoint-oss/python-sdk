...
slug: /tools/sdk/python/v1/models/requesteditemdtoref
...
**account_selection** | [**[]Sourceitemref**](sourceitemref) | The accounts where the access item will be provisioned to * Includes selections performed by the user in the event of multiple accounts existing on the same source * Also includes details for sources where user only has one account  | [optional] 
}
...
requesteditemdtoref = Requesteditemdtoref(
type='ACCESS_PROFILE',
...
account_selection=[
                    sailpoint.access_requests_v1.models.sourceitemref.sourceitemref(
                        source_id = 'cb89bc2f1ee6445fbea12224c526ba3a', 
                        accounts = [
                            sailpoint.access_requests_v1.models.accountitemref.accountitemref(
