...
class Requesteditemstatus(BaseModel):
    ...
    Requesteditemstatus
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The ID of the access request. As of 2025, this is a new property. Older access requests might not have an ID.")
