...
from sailpoint.machine_identities.rest import RESTResponseType
...
class MachineIdentitiesApi:
    ...
    def _create_machine_identity_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/machine-identities/v1',
    ...
    def _create_machine_identity_v2_serialize(
        ...
        if machineidentityv2 is not None:
            _body_params = machineidentityv2
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/machine-identities/v2',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_machine_identity_v1(
        self,
        ...
        _param = self._delete_machine_identity_v1_serialize(
            id=id,
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_machine_identity_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Machine Identity ID")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def delete_machine_identity_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Machine Identity ID")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    def _delete_machine_identity_v1_serialize(
        self,
        id,
        x_sail_point_experimental,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/machine-identities/v1/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_machine_identity_v2_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/machine-identities/v2/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_ownership_correlation_config_v1(
        self,
        ...
        :type source_id: str
        :param resource_id: The source resource ID (for example, account or aws:iam-role). (required)
        ...
        _param = self._delete_ownership_correlation_config_v1_serialize(
            source_id=source_id,
    ...
    @validate_call
    def delete_ownership_correlation_config_v1_with_http_info(
        self,
        source_id: Annotated[StrictStr, Field(description="The Source ID.")],
        resource_id: Annotated[StrictStr, Field(description="The source resource ID (for example, account or aws:iam-role).")],
        config_id: Annotated[StrictStr, Field(description="The correlation config ID.")],
    ...
    @validate_call
    def delete_ownership_correlation_config_v1_without_preload_content(
        self,
        source_id: Annotated[StrictStr, Field(description="The Source ID.")],
        resource_id: Annotated[StrictStr, Field(description="The source resource ID (for example, account or aws:iam-role).")],
        config_id: Annotated[StrictStr, Field(description="The correlation config ID.")],
    ...
    def _delete_ownership_correlation_config_v1_serialize(
        self,
        source_id,
        resource_id,
        config_id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/sources/v1/{sourceId}/resources/{resourceId}/correlation-configs/{configId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_machine_identity_v1(
        ...
        _param = self._get_machine_identity_v1_serialize(
            id=id,
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_machine_identity_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Machine Identity ID")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_machine_identity_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Machine Identity ID")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    def _get_machine_identity_v1_serialize(
        self,
        id,
        x_sail_point_experimental,
        _request_auth,
    ...
    @validate_call
    def get_ownership_correlation_config_v1(
        self,
        source_id: Annotated[StrictStr, Field(description="The Source ID.")],
        resource_id: Annotated[StrictStr, Field(description="The source resource ID (for example, account or aws:iam-role).")],
        config_id: Annotated[StrictStr, Field(description="The correlation config ID.")],
        ...
        _param = self._get_ownership_correlation_config_v1_serialize(
            source_id=source_id,
            resource_id=resource_id,
            config_id=config_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_ownership_correlation_config_v1_with_http_info(
        self,
        source_id: Annotated[StrictStr, Field(description="The Source ID.")],
        resource_id: Annotated[StrictStr, Field(description="The source resource ID (for example, account or aws:iam-role).")],
        config_id: Annotated[StrictStr, Field(description="The correlation config ID.")],
    ...
    @validate_call
    def get_ownership_correlation_config_v1_without_preload_content(
        self,
        source_id: Annotated[StrictStr, Field(description="The Source ID.")],
        resource_id: Annotated[StrictStr, Field(description="The source resource ID (for example, account or aws:iam-role).")],
        config_id: Annotated[StrictStr, Field(description="The correlation config ID.")],
    ...
    def _get_ownership_correlation_config_v1_serialize(
        self,
        source_id,
        resource_id,
        config_id,
    ...
    @validate_call
    def get_unsanctioned_anomaly_summary_v1(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_unsanctioned_anomaly_summary_v1_serialize(
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UnsanctionedApplicationAnomalySummary",
            '400': "ErrorResponseDto",
            '401': "ListMachineIdentitiesV1401Response",
            '403': "ErrorResponseDto",
            '404': "ErrorResponseDto",
    ...
    @validate_call
    def get_unsanctioned_anomaly_summary_v1_with_http_info(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UnsanctionedApplicationAnomalySummary]:
        """Get unsanctioned application anomaly summary
    ...
    @validate_call
    def get_unsanctioned_anomaly_summary_v1_without_preload_content(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_unsanctioned_anomaly_summary_v1_serialize(
        self,
        x_sail_point_experimental,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/machine-identities/v1/anomaly-summaries/unsanctioned',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_machine_identities_v1(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **id**: *eq, in, sw*  **displayName**: *eq, in, sw*  **cisIdentityId**: *eq, in, sw*  **nativeIdentity**: *eq, in, sw*  **attributes**: *eq*  **manuallyEdited**: *eq*  **subtype**: *eq, in*  **owners.primaryIdentity.id**: *eq, in, sw*  **owners.primaryIdentity.name**: *eq, in, isnull, pr*  **owners.secondaryIdentity.id**: *eq, in, sw*  **owners.secondaryIdentity.name**: *eq, in, isnull, pr*  **source.name**: *eq, in, sw*  **source.id**: *eq, in*  **entitlement.id**: *eq, in*  **entitlement.name**: *eq, in, sw*")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **nativeIdentity, name, owners.primaryIdentity.name, source.name, created, modified**")] = None,
        ...
        _param = self._list_machine_identities_v1_serialize(
            filters=filters,
            sorters=sorters,
            x_sail_point_experimental=x_sail_point_experimental,
            count=count,
    ...
    @validate_call
    def list_machine_identities_v1_with_http_info(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **id**: *eq, in, sw*  **displayName**: *eq, in, sw*  **cisIdentityId**: *eq, in, sw*  **nativeIdentity**: *eq, in, sw*  **attributes**: *eq*  **manuallyEdited**: *eq*  **subtype**: *eq, in*  **owners.primaryIdentity.id**: *eq, in, sw*  **owners.primaryIdentity.name**: *eq, in, isnull, pr*  **owners.secondaryIdentity.id**: *eq, in, sw*  **owners.secondaryIdentity.name**: *eq, in, isnull, pr*  **source.name**: *eq, in, sw*  **source.id**: *eq, in*  **entitlement.id**: *eq, in*  **entitlement.name**: *eq, in, sw*")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **nativeIdentity, name, owners.primaryIdentity.name, source.name, created, modified**")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def list_machine_identities_v1_without_preload_content(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **id**: *eq, in, sw*  **displayName**: *eq, in, sw*  **cisIdentityId**: *eq, in, sw*  **nativeIdentity**: *eq, in, sw*  **attributes**: *eq*  **manuallyEdited**: *eq*  **subtype**: *eq, in*  **owners.primaryIdentity.id**: *eq, in, sw*  **owners.primaryIdentity.name**: *eq, in, isnull, pr*  **owners.secondaryIdentity.id**: *eq, in, sw*  **owners.secondaryIdentity.name**: *eq, in, isnull, pr*  **source.name**: *eq, in, sw*  **source.id**: *eq, in*  **entitlement.id**: *eq, in*  **entitlement.name**: *eq, in, sw*")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **nativeIdentity, name, owners.primaryIdentity.name, source.name, created, modified**")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _list_machine_identities_v1_serialize(
        self,
        filters,
        sorters,
        x_sail_point_experimental,
    ...
    @validate_call
    def list_machine_identities_v2(
        self,
        ...
        _param = self._list_machine_identities_v2_serialize(
            filters=filters,
            sorters=sorters,
            count=count,
            limit=limit,
    ...
    @validate_call
    def list_machine_identities_v2_with_http_info(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **id**: *eq, in, sw*  **displayName**: *eq, in, sw*  **nativeIdentity**: *eq, in, sw*  **attributes**: *eq*  **manuallyEdited**: *eq*  **subtype**: *eq, in*  **owners.primaryIdentity.id**: *eq, in, sw*  **owners.primaryIdentity.name**: *eq, in, isnull, pr*  **owners.secondaryIdentity.id**: *eq, in, sw*  **owners.secondaryIdentity.name**: *eq, in, isnull, pr*  **owners.secondaryGovernanceGroup.id**: *eq, in*  **owners.secondaryGovernanceGroup.name**: *eq, in, isnull, pr*  **source.id**: *eq, in*  **source.name**: *eq, in, sw*  **entitlement.id**: *eq, in*  **entitlement.name**: *eq, in, sw*  **risk.severity**: *eq, in*  **businessApplicationRefs.id**: *eq*  **effectiveSanctionedStatus**: *eq*  Business Application filters require Business Applications to be enabled for the tenant. Filter values are case-sensitive. When Business Applications is not enabled, these filters are not allowed and return `400`.")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **nativeIdentity, name, owners.primaryIdentity.name, source.name, created, modified**")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[Machineidentityv2]]:
        """List machine identities
    ...
    @validate_call
    def list_machine_identities_v2_without_preload_content(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **id**: *eq, in, sw*  **displayName**: *eq, in, sw*  **nativeIdentity**: *eq, in, sw*  **attributes**: *eq*  **manuallyEdited**: *eq*  **subtype**: *eq, in*  **owners.primaryIdentity.id**: *eq, in, sw*  **owners.primaryIdentity.name**: *eq, in, isnull, pr*  **owners.secondaryIdentity.id**: *eq, in, sw*  **owners.secondaryIdentity.name**: *eq, in, isnull, pr*  **owners.secondaryGovernanceGroup.id**: *eq, in*  **owners.secondaryGovernanceGroup.name**: *eq, in, isnull, pr*  **source.id**: *eq, in*  **source.name**: *eq, in, sw*  **entitlement.id**: *eq, in*  **entitlement.name**: *eq, in, sw*  **risk.severity**: *eq, in*  **businessApplicationRefs.id**: *eq*  **effectiveSanctionedStatus**: *eq*  Business Application filters require Business Applications to be enabled for the tenant. Filter values are case-sensitive. When Business Applications is not enabled, these filters are not allowed and return `400`.")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **nativeIdentity, name, owners.primaryIdentity.name, source.name, created, modified**")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _list_machine_identities_v2_serialize(
        self,
        filters,
        sorters,
        count,
    ...
    @validate_call
    def list_machine_identity_anomalies_v1(
        self,
        id: Annotated[StrictStr, Field(description="Machine identity (agent) ID.")],
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **detectedAt**  The default sort is **-detectedAt** (most recent first).")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        ...
        :param id: Machine identity (agent) ID. (required)
        :type id: str
        :param sorters: Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **detectedAt**  The default sort is **-detectedAt** (most recent first).
        :type sorters: str
        :param x_sail_point_experimental: Use this header to enable this experimental API.
        :type x_sail_point_experimental: str
        :param count: If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.
        ...
        _param = self._list_machine_identity_anomalies_v1_serialize(
            id=id,
            sorters=sorters,
            x_sail_point_experimental=x_sail_point_experimental,
            count=count,
    ...
    @validate_call
    def list_machine_identity_anomalies_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Machine identity (agent) ID.")],
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **detectedAt**  The default sort is **-detectedAt** (most recent first).")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def list_machine_identity_anomalies_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Machine identity (agent) ID.")],
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **detectedAt**  The default sort is **-detectedAt** (most recent first).")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _list_machine_identity_anomalies_v1_serialize(
        self,
        id,
        sorters,
        x_sail_point_experimental,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/machine-identities/v1/{id}/anomalies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_machine_identity_user_entitlements_v1(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **machineIdentityId**: *eq, in*  **machineIdentityName**: *eq, in, sw*  **entitlement.id**: *eq, in*  **entitlement.name**: *eq, in, sw*  **source.id**: *eq, in*  **source.name**: *eq, in, sw*")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **machineIdentityName, entitlement.name, source.name**")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        ...
        :type filters: str
        :param sorters: Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **machineIdentityName, entitlement.name, source.name**
        :type sorters: str
        :param x_sail_point_experimental: Use this header to enable this experimental API.
        :type x_sail_point_experimental: str
        :param count: If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.
        ...
        _param = self._list_machine_identity_user_entitlements_v1_serialize(
            filters=filters,
            sorters=sorters,
            x_sail_point_experimental=x_sail_point_experimental,
            count=count,
    ...
    @validate_call
    def list_machine_identity_user_entitlements_v1_with_http_info(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **machineIdentityId**: *eq, in*  **machineIdentityName**: *eq, in, sw*  **entitlement.id**: *eq, in*  **entitlement.name**: *eq, in, sw*  **source.id**: *eq, in*  **source.name**: *eq, in, sw*")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **machineIdentityName, entitlement.name, source.name**")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def list_machine_identity_user_entitlements_v1_without_preload_content(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **machineIdentityId**: *eq, in*  **machineIdentityName**: *eq, in, sw*  **entitlement.id**: *eq, in*  **entitlement.name**: *eq, in, sw*  **source.id**: *eq, in*  **source.name**: *eq, in, sw*")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **machineIdentityName, entitlement.name, source.name**")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _list_machine_identity_user_entitlements_v1_serialize(
        self,
        filters,
        sorters,
        x_sail_point_experimental,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/machine-identity-user-entitlements/v1',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_ownership_correlation_configs_v1(
        self,
        source_id: Annotated[StrictStr, Field(description="The Source ID.")],
        resource_id: Annotated[StrictStr, Field(description="The source resource ID (for example, account or aws:iam-role).")],
        type: Annotated[Optional[StrictStr], Field(description="When set, filters to the given config type.")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        _request_timeout: Union[
        ...
        :param resource_id: The source resource ID (for example, account or aws:iam-role). (required)
        :type resource_id: str
        :param type: When set, filters to the given config type.
        :type type: str
        :param count: If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.
        :type count: bool
        :param limit: Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.
        ...
        _param = self._list_ownership_correlation_configs_v1_serialize(
            source_id=source_id,
            resource_id=resource_id,
            type=type,
            count=count,
    ...
    @validate_call
    def list_ownership_correlation_configs_v1_with_http_info(
        self,
        source_id: Annotated[StrictStr, Field(description="The Source ID.")],
        resource_id: Annotated[StrictStr, Field(description="The source resource ID (for example, account or aws:iam-role).")],
        type: Annotated[Optional[StrictStr], Field(description="When set, filters to the given config type.")] = None,
    ...
    @validate_call
    def list_ownership_correlation_configs_v1_without_preload_content(
        self,
        source_id: Annotated[StrictStr, Field(description="The Source ID.")],
        resource_id: Annotated[StrictStr, Field(description="The source resource ID (for example, account or aws:iam-role).")],
        type: Annotated[Optional[StrictStr], Field(description="When set, filters to the given config type.")] = None,
    ...
    def _list_ownership_correlation_configs_v1_serialize(
        self,
        source_id,
        resource_id,
        type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/sources/v1/{sourceId}/resources/{resourceId}/correlation-configs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def patch_ownership_correlation_config_v1(
        self,
        source_id: Annotated[StrictStr, Field(description="The Source ID.")],
        resource_id: Annotated[StrictStr, Field(description="The source resource ID (for example, account or aws:iam-role).")],
        config_id: Annotated[StrictStr, Field(description="The correlation config ID.")],
        ...
        _param = self._patch_ownership_correlation_config_v1_serialize(
            source_id=source_id,
            resource_id=resource_id,
            config_id=config_id,
    ...
    @validate_call
    def patch_ownership_correlation_config_v1_with_http_info(
        self,
        source_id: Annotated[StrictStr, Field(description="The Source ID.")],
        resource_id: Annotated[StrictStr, Field(description="The source resource ID (for example, account or aws:iam-role).")],
        config_id: Annotated[StrictStr, Field(description="The correlation config ID.")],
    ...
    @validate_call
    def patch_ownership_correlation_config_v1_without_preload_content(
        self,
        source_id: Annotated[StrictStr, Field(description="The Source ID.")],
        resource_id: Annotated[StrictStr, Field(description="The source resource ID (for example, account or aws:iam-role).")],
        config_id: Annotated[StrictStr, Field(description="The correlation config ID.")],
    ...
    def _patch_ownership_correlation_config_v1_serialize(
        self,
        source_id,
        resource_id,
        config_id,
    ...
    def _start_machine_identity_aggregation_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/sources/v1/{sourceId}/aggregate-agents',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def update_machine_identity_v1(
        self,
        id: Annotated[StrictStr, Field(description="Machine Identity ID.")],
        ...
        _param = self._update_machine_identity_v1_serialize(
            id=id,
    ...
    @validate_call
    def update_machine_identity_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Machine Identity ID.")],
        request_body: Annotated[List[Dict[str, Any]], Field(description="A JSON of updated values [JSON Patch](https://tools.ietf.org/html/rfc6902) standard.")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
    ...
    @validate_call
    def update_machine_identity_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Machine Identity ID.")],
        request_body: Annotated[List[Dict[str, Any]], Field(description="A JSON of updated values [JSON Patch](https://tools.ietf.org/html/rfc6902) standard.")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
    ...
    def _update_machine_identity_v1_serialize(
        self,
        id,
        request_body,
        x_sail_point_experimental,
