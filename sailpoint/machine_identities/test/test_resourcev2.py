...
class TestResourcev2(unittest.TestCase):
    """Resourcev2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Resourcev2:
        """Test Resourcev2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Resourcev2`
        """
        model = Resourcev2()
        if include_optional:
            return Resourcev2(
