...
from sailpoint.parameter_storage.api_response import ApiResponse, T as ApiResponseT
import sailpoint.parameter_storage.models
from sailpoint.parameter_storage import rest
from sailpoint.parameter_storage.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.parameter_storage.models, klass)
