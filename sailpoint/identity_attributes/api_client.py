...
from sailpoint.identity_attributes.api_response import ApiResponse, T as ApiResponseT
import sailpoint.identity_attributes.models
from sailpoint.identity_attributes import rest
from sailpoint.identity_attributes.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.identity_attributes.models, klass)
