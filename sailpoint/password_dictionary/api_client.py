...
from sailpoint.password_dictionary.api_response import ApiResponse, T as ApiResponseT
import sailpoint.password_dictionary.models
from sailpoint.password_dictionary import rest
from sailpoint.password_dictionary.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.password_dictionary.models, klass)
