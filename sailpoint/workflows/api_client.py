...
from sailpoint.workflows.api_response import ApiResponse, T as ApiResponseT
import sailpoint.workflows.models
from sailpoint.workflows import rest
from sailpoint.workflows.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.workflows.models, klass)
