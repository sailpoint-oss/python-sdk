...
slug: /tools/sdk/python/v1/methods/governance-groups
tags: ['SDK', 'Software Development Kit', 'Governance_Groups', 'Governance_Groups']
---

# sailpoint.governance_groups_v1.GovernanceGroupsV1Api
...
```python
from sailpoint.governance_groups_v1.api.governance_groups_v1_api import GovernanceGroupsV1Api
from sailpoint.governance_groups_v1.api_client import ApiClient
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = GovernanceGroupsV1Api(api_client).create_workgroup_v1(workgroupdto=new_workgroupdto)
        # Below is a request that includes all optional parameters
        # results = GovernanceGroupsV1Api(api_client).create_workgroup_v1(new_workgroupdto)
...
with ApiClient(configuration) as api_client:
    ...
    bulkworkgroupmembersrequest_inner = '''[sailpoint.governance_groups_v1.BulkworkgroupmembersrequestInner()]''' # List[BulkworkgroupmembersrequestInner] | List of identities to be removed from  a Governance Group members list.

    try:
        # Remove members from governance group
        new_bulkworkgroupmembersrequest_inner = BulkworkgroupmembersrequestInner.from_json(bulkworkgroupmembersrequest_inner)
        results = GovernanceGroupsV1Api(api_client).delete_workgroup_members_v1(workgroup_id=workgroup_id, bulkworkgroupmembersrequest_inner=new_bulkworkgroupmembersrequest_inner)
        # Below is a request that includes all optional parameters
        # results = GovernanceGroupsV1Api(api_client).delete_workgroup_members_v1(workgroup_id, new_bulkworkgroupmembersrequest_inner)
        print("The response of GovernanceGroupsV1Api->delete_workgroup_members_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling GovernanceGroupsV1Api->delete_workgroup_members_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        GovernanceGroupsV1Api(api_client).delete_workgroup_v1(id=id)
        # Below is a request that includes all optional parameters
        # GovernanceGroupsV1Api(api_client).delete_workgroup_v1(id)
    except Exception as e:
        print("Exception when calling GovernanceGroupsV1Api->delete_workgroup_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = GovernanceGroupsV1Api(api_client).delete_workgroups_in_bulk_v1(workgroupbulkdeleterequest=new_workgroupbulkdeleterequest)
        # Below is a request that includes all optional parameters
        # results = GovernanceGroupsV1Api(api_client).delete_workgroups_in_bulk_v1(new_workgroupbulkdeleterequest)
        print("The response of GovernanceGroupsV1Api->delete_workgroups_in_bulk_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling GovernanceGroupsV1Api->delete_workgroups_in_bulk_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = GovernanceGroupsV1Api(api_client).get_workgroup_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = GovernanceGroupsV1Api(api_client).get_workgroup_v1(id)
        print("The response of GovernanceGroupsV1Api->get_workgroup_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling GovernanceGroupsV1Api->get_workgroup_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = GovernanceGroupsV1Api(api_client).list_connections_v1(workgroup_id=workgroup_id)
        # Below is a request that includes all optional parameters
        # results = GovernanceGroupsV1Api(api_client).list_connections_v1(workgroup_id, offset, limit, count, sorters)
        print("The response of GovernanceGroupsV1Api->list_connections_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling GovernanceGroupsV1Api->list_connections_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = GovernanceGroupsV1Api(api_client).list_workgroup_members_v1(workgroup_id=workgroup_id)
        # Below is a request that includes all optional parameters
        # results = GovernanceGroupsV1Api(api_client).list_workgroup_members_v1(workgroup_id, offset, limit, count, sorters)
        print("The response of GovernanceGroupsV1Api->list_workgroup_members_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling GovernanceGroupsV1Api->list_workgroup_members_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = GovernanceGroupsV1Api(api_client).list_workgroups_v1()
        # Below is a request that includes all optional parameters
        # results = GovernanceGroupsV1Api(api_client).list_workgroups_v1(offset, limit, count, filters, sorters)
        print("The response of GovernanceGroupsV1Api->list_workgroups_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling GovernanceGroupsV1Api->list_workgroups_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = GovernanceGroupsV1Api(api_client).patch_workgroup_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = GovernanceGroupsV1Api(api_client).patch_workgroup_v1(id, new_jsonpatchoperation)
        print("The response of GovernanceGroupsV1Api->patch_workgroup_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling GovernanceGroupsV1Api->patch_workgroup_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    workgroup_id = '2c91808a7813090a017814121919ecca' # str | ID of the Governance Group. # str | ID of the Governance Group.
    bulkworkgroupmembersrequest_inner = '''[sailpoint.governance_groups_v1.BulkworkgroupmembersrequestInner()]''' # List[BulkworkgroupmembersrequestInner] | List of identities to be added to a Governance Group members list.

    try:
        # Add members to governance group
        new_bulkworkgroupmembersrequest_inner = BulkworkgroupmembersrequestInner.from_json(bulkworkgroupmembersrequest_inner)
        results = GovernanceGroupsV1Api(api_client).update_workgroup_members_v1(workgroup_id=workgroup_id, bulkworkgroupmembersrequest_inner=new_bulkworkgroupmembersrequest_inner)
        # Below is a request that includes all optional parameters
        # results = GovernanceGroupsV1Api(api_client).update_workgroup_members_v1(workgroup_id, new_bulkworkgroupmembersrequest_inner)
        print("The response of GovernanceGroupsV1Api->update_workgroup_members_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling GovernanceGroupsV1Api->update_workgroup_members_v1: %s\n" % e)
```
