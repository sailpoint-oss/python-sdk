...
from sailpoint.governance_groups_v1.api_client import ApiClient, RequestSerialized
from sailpoint.governance_groups_v1.api_response import ApiResponse
from sailpoint.governance_groups_v1.rest import RESTResponseType
...
class GovernanceGroupsV1Api:
    ...
    def _delete_workgroup_members_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/workgroups/v1/{workgroupId}/members/bulk-delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_workgroup_v1(
        ...
        _param = self._delete_workgroup_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_workgroup_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the Governance Group")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_workgroup_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the Governance Group")],
        _request_timeout: Union[
            None,
    ...
    def _delete_workgroup_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/workgroups/v1/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_workgroups_in_bulk_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/workgroups/v1/bulk-delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_workgroup_v1(
        ...
        _param = self._get_workgroup_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_workgroup_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the Governance Group")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_workgroup_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the Governance Group")],
        _request_timeout: Union[
            None,
    ...
    def _get_workgroup_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_connections_v1(
        ...
        _param = self._list_connections_v1_serialize(
            workgroup_id=workgroup_id,
            offset=offset,
            limit=limit,
            count=count,
    ...
    @validate_call
    def list_connections_v1_with_http_info(
        self,
        workgroup_id: Annotated[StrictStr, Field(description="ID of the Governance Group.")],
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=0)]], Field(description="Note that for this API the maximum value for limit is 50. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def list_connections_v1_without_preload_content(
        self,
        workgroup_id: Annotated[StrictStr, Field(description="ID of the Governance Group.")],
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=0)]], Field(description="Note that for this API the maximum value for limit is 50. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _list_connections_v1_serialize(
        self,
        workgroup_id,
        offset,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/workgroups/v1/{workgroupId}/connections',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_workgroup_members_v1(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[ListWorkgroupMembersV1200ResponseInner]:
        ...
        _param = self._list_workgroup_members_v1_serialize(
            workgroup_id=workgroup_id,
            offset=offset,
            limit=limit,
            count=count,
    ...
    @validate_call
    def list_workgroup_members_v1_with_http_info(
        self,
        workgroup_id: Annotated[StrictStr, Field(description="ID of the Governance Group.")],
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=0)]], Field(description="Note that for this API the maximum value for limit is 50. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ListWorkgroupMembersV1200ResponseInner]]:
        """List governance group members
    ...
    @validate_call
    def list_workgroup_members_v1_without_preload_content(
        self,
        workgroup_id: Annotated[StrictStr, Field(description="ID of the Governance Group.")],
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=0)]], Field(description="Note that for this API the maximum value for limit is 50. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _list_workgroup_members_v1_serialize(
        self,
        workgroup_id,
        offset,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/workgroups/v1/{workgroupId}/members',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_workgroups_v1(
        ...
        _param = self._list_workgroups_v1_serialize(
            offset=offset,
            limit=limit,
            count=count,
            filters=filters,
    ...
    @validate_call
    def list_workgroups_v1_with_http_info(
        self,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def list_workgroups_v1_without_preload_content(
        self,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _list_workgroups_v1_serialize(
        self,
        offset,
        limit,
        count,
    ...
    def _update_workgroup_members_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/workgroups/v1/{workgroupId}/members/bulk-add',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
