...
class Workgroupconnectiondto(BaseModel):
    ...
    def connection_type_validate_enum(cls, value):
        ...
        if value not in set(['AccessRequestReviewer', 'Owner', 'ManagementWorkgroup']):
            warnings.warn(f"must be one of enum values ('AccessRequestReviewer', 'Owner', 'ManagementWorkgroup') unknown value: {value}")
        return value
