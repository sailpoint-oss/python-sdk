...
from sailpoint.task_management.api_response import ApiResponse, T as ApiResponseT
import sailpoint.task_management.models
from sailpoint.task_management import rest
from sailpoint.task_management.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.task_management.models, klass)
