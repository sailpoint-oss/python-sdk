...
from sailpoint.transforms_v1.api_client import ApiClient, RequestSerialized
from sailpoint.transforms_v1.api_response import ApiResponse
from sailpoint.transforms_v1.rest import RESTResponseType
...
class TransformsV1Api:
    ...
    def create_transform_v1(
        ...
        _param = self._create_transform_v1_serialize(
            transform=transform,
    ...
    @validate_call
    def create_transform_v1_with_http_info(
        self,
        transform: Annotated[Transform, Field(description="The transform to be created.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_transform_v1_without_preload_content(
        self,
        transform: Annotated[Transform, Field(description="The transform to be created.")],
        _request_timeout: Union[
            None,
    ...
    def _create_transform_v1_serialize(
        self,
        transform,
        _request_auth,
        _content_type,
    ...
    def delete_transform_v1(
        ...
        _param = self._delete_transform_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_transform_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the transform to delete")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_transform_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the transform to delete")],
        _request_timeout: Union[
            None,
    ...
    def _delete_transform_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/transforms/v1/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_transform_v1(
        ...
        _param = self._get_transform_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_transform_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the transform to retrieve")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_transform_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the transform to retrieve")],
        _request_timeout: Union[
            None,
    ...
    def _get_transform_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_transforms_v1(
        ...
        _param = self._list_transforms_v1_serialize(
            offset=offset,
            limit=limit,
            count=count,
            name=name,
    ...
    @validate_call
    def list_transforms_v1_with_http_info(
        self,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def list_transforms_v1_without_preload_content(
        self,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _list_transforms_v1_serialize(
        self,
        offset,
        limit,
        count,
    ...
    def update_transform_v1(
        ...
        _param = self._update_transform_v1_serialize(
            id=id,
            transform=transform,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def update_transform_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the transform to update")],
        transform: Annotated[Optional[Transform], Field(description="The updated transform object. Must include \"name\", \"type\", and \"attributes\" fields, but \"name\" and \"type\" must not be modified.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_transform_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the transform to update")],
        transform: Annotated[Optional[Transform], Field(description="The updated transform object. Must include \"name\", \"type\", and \"attributes\" fields, but \"name\" and \"type\" must not be modified.")] = None,
        _request_timeout: Union[
    ...
    def _update_transform_v1_serialize(
        self,
        id,
        transform,
        _request_auth,
