...
slug: /tools/sdk/python/v1/methods/work-items
tags: ['SDK', 'Software Development Kit', 'Work_Items', 'Work_Items']
---

# sailpoint.work_items_v1.WorkItemsV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = WorkItemsV1Api(api_client).approve_approval_item_v1(id=id, approval_item_id=approval_item_id)
        # Below is a request that includes all optional parameters
        # results = WorkItemsV1Api(api_client).approve_approval_item_v1(id, approval_item_id)
        print("The response of WorkItemsV1Api->approve_approval_item_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkItemsV1Api->approve_approval_item_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = WorkItemsV1Api(api_client).approve_approval_items_in_bulk_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = WorkItemsV1Api(api_client).approve_approval_items_in_bulk_v1(id)
        print("The response of WorkItemsV1Api->approve_approval_items_in_bulk_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkItemsV1Api->approve_approval_items_in_bulk_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = WorkItemsV1Api(api_client).complete_work_item_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = WorkItemsV1Api(api_client).complete_work_item_v1(id, new_body)
        print("The response of WorkItemsV1Api->complete_work_item_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkItemsV1Api->complete_work_item_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    id = 'ef38f94347e94562b5bb8424a56397d8' # str | The ID of the work item # str | The ID of the work item
    workitemforward = '''sailpoint.work_items_v1.Workitemforward()''' # Workitemforward | 

    try:
        # Forward a work item
        new_workitemforward = Workitemforward.from_json(workitemforward)
        WorkItemsV1Api(api_client).forward_work_item_v1(id=id, workitemforward=new_workitemforward)
        # Below is a request that includes all optional parameters
        # WorkItemsV1Api(api_client).forward_work_item_v1(id, new_workitemforward)
    except Exception as e:
        print("Exception when calling WorkItemsV1Api->forward_work_item_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = WorkItemsV1Api(api_client).get_completed_work_items_v1()
        # Below is a request that includes all optional parameters
        # results = WorkItemsV1Api(api_client).get_completed_work_items_v1(owner_id, limit, offset, count)
        print("The response of WorkItemsV1Api->get_completed_work_items_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkItemsV1Api->get_completed_work_items_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = WorkItemsV1Api(api_client).get_count_completed_work_items_v1()
        # Below is a request that includes all optional parameters
        # results = WorkItemsV1Api(api_client).get_count_completed_work_items_v1(owner_id)
        print("The response of WorkItemsV1Api->get_count_completed_work_items_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkItemsV1Api->get_count_completed_work_items_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = WorkItemsV1Api(api_client).get_count_work_items_v1()
        # Below is a request that includes all optional parameters
        # results = WorkItemsV1Api(api_client).get_count_work_items_v1(owner_id)
        print("The response of WorkItemsV1Api->get_count_work_items_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkItemsV1Api->get_count_work_items_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = WorkItemsV1Api(api_client).get_work_item_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = WorkItemsV1Api(api_client).get_work_item_v1(id)
        print("The response of WorkItemsV1Api->get_work_item_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkItemsV1Api->get_work_item_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = WorkItemsV1Api(api_client).get_work_items_summary_v1()
        # Below is a request that includes all optional parameters
        # results = WorkItemsV1Api(api_client).get_work_items_summary_v1(owner_id)
        print("The response of WorkItemsV1Api->get_work_items_summary_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkItemsV1Api->get_work_items_summary_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = WorkItemsV1Api(api_client).list_work_items_v1()
        # Below is a request that includes all optional parameters
        # results = WorkItemsV1Api(api_client).list_work_items_v1(limit, offset, count, owner_id)
        print("The response of WorkItemsV1Api->list_work_items_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkItemsV1Api->list_work_items_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = WorkItemsV1Api(api_client).reject_approval_item_v1(id=id, approval_item_id=approval_item_id)
        # Below is a request that includes all optional parameters
        # results = WorkItemsV1Api(api_client).reject_approval_item_v1(id, approval_item_id)
        print("The response of WorkItemsV1Api->reject_approval_item_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkItemsV1Api->reject_approval_item_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = WorkItemsV1Api(api_client).reject_approval_items_in_bulk_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = WorkItemsV1Api(api_client).reject_approval_items_in_bulk_v1(id)
        print("The response of WorkItemsV1Api->reject_approval_items_in_bulk_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkItemsV1Api->reject_approval_items_in_bulk_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = WorkItemsV1Api(api_client).submit_account_selection_v1(id=id, request_body=new_request_body)
        # Below is a request that includes all optional parameters
        # results = WorkItemsV1Api(api_client).submit_account_selection_v1(id, new_request_body)
        print("The response of WorkItemsV1Api->submit_account_selection_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkItemsV1Api->submit_account_selection_v1: %s\n" % e)
```
