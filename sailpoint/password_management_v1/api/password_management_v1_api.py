...
from sailpoint.password_management_v1.api_client import ApiClient, RequestSerialized
from sailpoint.password_management_v1.api_response import ApiResponse
from sailpoint.password_management_v1.rest import RESTResponseType
...
class PasswordManagementV1Api:
    ...
    def _create_digit_token_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/generate-password-reset-token/v1/digit',
    ...
    @validate_call
    def get_password_change_status_v1(
        self,
        ...
        _param = self._get_password_change_status_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_password_change_status_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Password change request ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_password_change_status_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Password change request ID")],
        _request_timeout: Union[
            None,
    ...
    def _get_password_change_status_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/password-change-status/v1/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _query_password_info_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/query-password-info/v1',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
