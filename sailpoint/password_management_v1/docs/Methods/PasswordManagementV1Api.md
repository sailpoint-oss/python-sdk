...
slug: /tools/sdk/python/v1/methods/password-management
tags: ['SDK', 'Software Development Kit', 'Password_Management', 'Password_Management']
---

# sailpoint.password_management_v1.PasswordManagementV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = PasswordManagementV1Api(api_client).create_digit_token_v1(passworddigittokenreset=new_passworddigittokenreset)
        # Below is a request that includes all optional parameters
        # results = PasswordManagementV1Api(api_client).create_digit_token_v1(new_passworddigittokenreset, x_sail_point_experimental)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = PasswordManagementV1Api(api_client).get_password_change_status_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = PasswordManagementV1Api(api_client).get_password_change_status_v1(id)
        print("The response of PasswordManagementV1Api->get_password_change_status_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling PasswordManagementV1Api->get_password_change_status_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    passwordchangerequest = '''sailpoint.password_management_v1.Passwordchangerequest()''' # Passwordchangerequest | 

    try:
        # Set identity's password
        new_passwordchangerequest = Passwordchangerequest.from_json(passwordchangerequest)
        results = PasswordManagementV1Api(api_client).set_password_v1(passwordchangerequest=new_passwordchangerequest)
        # Below is a request that includes all optional parameters
        # results = PasswordManagementV1Api(api_client).set_password_v1(new_passwordchangerequest)
        print("The response of PasswordManagementV1Api->set_password_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling PasswordManagementV1Api->set_password_v1: %s\n" % e)
```
