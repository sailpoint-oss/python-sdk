...
slug: /tools/sdk/python/saved-search/models/savedsearchdetail
...
**indices** | **[]Index** | The names of the Elasticsearch indices in which to search.  | [required]
**columns** | **map[string]List[Column]** | The columns to be returned (specifies the order in which they will be presented) for each document type.  The currently supported document types are: _accessprofile_, _accountactivity_, _account_, _aggregation_, _entitlement_, _event_, _identity_, and _role_.  | [optional] 
