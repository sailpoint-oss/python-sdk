...
from sailpoint.saved_search.api_response import ApiResponse, T as ApiResponseT
import sailpoint.saved_search.models
from sailpoint.saved_search import rest
from sailpoint.saved_search.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.saved_search.models, klass)
