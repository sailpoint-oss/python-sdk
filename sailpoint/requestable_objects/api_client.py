...
from sailpoint.requestable_objects.api_response import ApiResponse, T as ApiResponseT
import sailpoint.requestable_objects.models
from sailpoint.requestable_objects import rest
from sailpoint.requestable_objects.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.requestable_objects.models, klass)
