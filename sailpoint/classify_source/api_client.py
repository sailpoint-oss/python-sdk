...
from sailpoint.classify_source.api_response import ApiResponse, T as ApiResponseT
import sailpoint.classify_source.models
from sailpoint.classify_source import rest
from sailpoint.classify_source.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.classify_source.models, klass)
