...
from sailpoint.jit_activations.api_response import ApiResponse, T as ApiResponseT
import sailpoint.jit_activations.models
from sailpoint.jit_activations import rest
from sailpoint.jit_activations.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.jit_activations.models, klass)
