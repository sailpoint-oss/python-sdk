...
slug: /tools/sdk/python/v1/methods/data-access-security
tags: ['SDK', 'Software Development Kit', 'Data_Access_Security', 'Data_Access_Security']
---

# sailpoint.data_access_security_v1.DataAccessSecurityV1Api
...
```python
from sailpoint.data_access_security_v1.api.data_access_security_v1_api import DataAccessSecurityV1Api
from sailpoint.data_access_security_v1.api_client import ApiClient
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        DataAccessSecurityV1Api(api_client).cancel_task_v1(id=id)
        # Below is a request that includes all optional parameters
        # DataAccessSecurityV1Api(api_client).cancel_task_v1(id)
...
with ApiClient(configuration) as api_client:
    basecreateapplicationrequest = '''sailpoint.data_access_security_v1.Basecreateapplicationrequest()''' # Basecreateapplicationrequest | Request body containing the details required to create a new application.

    try:
        # Create application
        new_basecreateapplicationrequest = Basecreateapplicationrequest.from_json(basecreateapplicationrequest)
        DataAccessSecurityV1Api(api_client).create_application_v1(basecreateapplicationrequest=new_basecreateapplicationrequest)
        # Below is a request that includes all optional parameters
        # DataAccessSecurityV1Api(api_client).create_application_v1(new_basecreateapplicationrequest)
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->create_application_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    createschedulerequest = '''sailpoint.data_access_security_v1.Createschedulerequest()''' # Createschedulerequest | 

    try:
        # Create a new schedule.
        new_createschedulerequest = Createschedulerequest.from_json(createschedulerequest)
        results = DataAccessSecurityV1Api(api_client).create_schedule_v1(createschedulerequest=new_createschedulerequest)
        # Below is a request that includes all optional parameters
        # results = DataAccessSecurityV1Api(api_client).create_schedule_v1(new_createschedulerequest)
        print("The response of DataAccessSecurityV1Api->create_schedule_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->create_schedule_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    assignresourceownerrequest = '''sailpoint.data_access_security_v1.Assignresourceownerrequest()''' # Assignresourceownerrequest | The request body must contain the application ID, resource path, and identity ID to be assigned as the resource owner.

    try:
        # Assign owner to application resource.
        new_assignresourceownerrequest = Assignresourceownerrequest.from_json(assignresourceownerrequest)
        results = DataAccessSecurityV1Api(api_client).das_v1_owners_assign_post(assignresourceownerrequest=new_assignresourceownerrequest)
        # Below is a request that includes all optional parameters
        # results = DataAccessSecurityV1Api(api_client).das_v1_owners_assign_post(new_assignresourceownerrequest)
        print("The response of DataAccessSecurityV1Api->das_v1_owners_assign_post:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->das_v1_owners_assign_post: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DataAccessSecurityV1Api(api_client).das_v1_owners_owner_identity_id_resources_get(owner_identity_id=owner_identity_id)
        # Below is a request that includes all optional parameters
        # results = DataAccessSecurityV1Api(api_client).das_v1_owners_owner_identity_id_resources_get(owner_identity_id, limit, offset)
        print("The response of DataAccessSecurityV1Api->das_v1_owners_owner_identity_id_resources_get:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->das_v1_owners_owner_identity_id_resources_get: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    reelectrequest = '''sailpoint.data_access_security_v1.Reelectrequest()''' # Reelectrequest | The request body must contain details for re-electing a resource owner. Date/time fields should use epoch format in seconds.

    try:
        # Re-elect resource owner.
        new_reelectrequest = Reelectrequest.from_json(reelectrequest)
        results = DataAccessSecurityV1Api(api_client).das_v1_owners_reelect_post(reelectrequest=new_reelectrequest)
        # Below is a request that includes all optional parameters
        # results = DataAccessSecurityV1Api(api_client).das_v1_owners_reelect_post(new_reelectrequest)
        print("The response of DataAccessSecurityV1Api->das_v1_owners_reelect_post:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->das_v1_owners_reelect_post: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DataAccessSecurityV1Api(api_client).das_v1_owners_resources_resource_id_get(resource_id=resource_id)
        # Below is a request that includes all optional parameters
        # results = DataAccessSecurityV1Api(api_client).das_v1_owners_resources_resource_id_get(resource_id, limit, offset)
        print("The response of DataAccessSecurityV1Api->das_v1_owners_resources_resource_id_get:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->das_v1_owners_resources_resource_id_get: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DataAccessSecurityV1Api(api_client).das_v1_owners_source_identity_id_reassign_destination_identity_id_post(source_identity_id=source_identity_id, destination_identity_id=destination_identity_id)
        # Below is a request that includes all optional parameters
        # results = DataAccessSecurityV1Api(api_client).das_v1_owners_source_identity_id_reassign_destination_identity_id_post(source_identity_id, destination_identity_id)
        print("The response of DataAccessSecurityV1Api->das_v1_owners_source_identity_id_reassign_destination_identity_id_post:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->das_v1_owners_source_identity_id_reassign_destination_identity_id_post: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        DataAccessSecurityV1Api(api_client).delete_application_v1(id=id)
        # Below is a request that includes all optional parameters
        # DataAccessSecurityV1Api(api_client).delete_application_v1(id)
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->delete_application_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        DataAccessSecurityV1Api(api_client).delete_schedule_v1(id=id)
        # Below is a request that includes all optional parameters
        # DataAccessSecurityV1Api(api_client).delete_schedule_v1(id)
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->delete_schedule_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        DataAccessSecurityV1Api(api_client).delete_task_v1(id=id)
        # Below is a request that includes all optional parameters
        # DataAccessSecurityV1Api(api_client).delete_task_v1(id)
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->delete_task_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DataAccessSecurityV1Api(api_client).get_application_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = DataAccessSecurityV1Api(api_client).get_application_v1(id)
        print("The response of DataAccessSecurityV1Api->get_application_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->get_application_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DataAccessSecurityV1Api(api_client).get_applications_v1()
        # Below is a request that includes all optional parameters
        # results = DataAccessSecurityV1Api(api_client).get_applications_v1(filters, limit, offset, count)
        print("The response of DataAccessSecurityV1Api->get_applications_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->get_applications_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DataAccessSecurityV1Api(api_client).get_owners_v1(app_id=app_id)
        # Below is a request that includes all optional parameters
        # results = DataAccessSecurityV1Api(api_client).get_owners_v1(app_id, limit, offset)
        print("The response of DataAccessSecurityV1Api->get_owners_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->get_owners_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DataAccessSecurityV1Api(api_client).get_schedule_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = DataAccessSecurityV1Api(api_client).get_schedule_v1(id)
        print("The response of DataAccessSecurityV1Api->get_schedule_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->get_schedule_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DataAccessSecurityV1Api(api_client).get_schedules_v1()
        # Below is a request that includes all optional parameters
        # results = DataAccessSecurityV1Api(api_client).get_schedules_v1(filters, limit, offset, count)
        print("The response of DataAccessSecurityV1Api->get_schedules_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->get_schedules_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DataAccessSecurityV1Api(api_client).get_task_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = DataAccessSecurityV1Api(api_client).get_task_v1(id)
        print("The response of DataAccessSecurityV1Api->get_task_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->get_task_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = DataAccessSecurityV1Api(api_client).get_tasks_v1()
        # Below is a request that includes all optional parameters
        # results = DataAccessSecurityV1Api(api_client).get_tasks_v1(filters, limit, offset, count)
        print("The response of DataAccessSecurityV1Api->get_tasks_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->get_tasks_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    basecreateapplicationrequest = '''sailpoint.data_access_security_v1.Basecreateapplicationrequest()''' # Basecreateapplicationrequest | Request body containing the updated details for the application.

    try:
        # Update application by identifier.
        new_basecreateapplicationrequest = Basecreateapplicationrequest.from_json(basecreateapplicationrequest)
        DataAccessSecurityV1Api(api_client).put_application_v1(id=id, basecreateapplicationrequest=new_basecreateapplicationrequest)
        # Below is a request that includes all optional parameters
        # DataAccessSecurityV1Api(api_client).put_application_v1(id, new_basecreateapplicationrequest)
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->put_application_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    updateschedulerequest = '''sailpoint.data_access_security_v1.Updateschedulerequest()''' # Updateschedulerequest | 

    try:
        # Update a schedule.
        new_updateschedulerequest = Updateschedulerequest.from_json(updateschedulerequest)
        DataAccessSecurityV1Api(api_client).put_schedule_v1(id=id, updateschedulerequest=new_updateschedulerequest)
        # Below is a request that includes all optional parameters
        # DataAccessSecurityV1Api(api_client).put_schedule_v1(id, new_updateschedulerequest)
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->put_schedule_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        DataAccessSecurityV1Api(api_client).start_task_rerun_v1(id=id)
        # Below is a request that includes all optional parameters
        # DataAccessSecurityV1Api(api_client).start_task_rerun_v1(id)
    except Exception as e:
        print("Exception when calling DataAccessSecurityV1Api->start_task_rerun_v1: %s\n" % e)
```
