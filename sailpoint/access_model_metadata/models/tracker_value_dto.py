...
class TrackerValueDTO(BaseModel):
    """
    TrackerValueDTO
    """ # noqa: E501
    ...
    value: Optional[StrictStr] = Field(default=None, description="Technical name of the deleted Attribute value.")
    __properties: ClassVar[List[str]] = ["id", "type", "status", "errors", "created", "value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TrackerValueDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TrackerValueDTO from a dict"""
        if obj is None:
            return None
