...
from sailpoint.access_model_metadata.api_response import ApiResponse, T as ApiResponseT
import sailpoint.access_model_metadata.models
from sailpoint.access_model_metadata import rest
from sailpoint.access_model_metadata.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.access_model_metadata.models, klass)
