    ...
    def make_instance(self, include_optional) -> SourceConnectionsDto:
        ...
        if include_optional:
            return SourceConnectionsDto(
                identity_profiles = [
                    sailpoint.v2025.models.identity_profiles_connections.Identity Profiles Connections(
                ...
                dependent_apps = [
                    sailpoint.v2025.models.dependant_app_connections.Dependant App Connections(
                ...
                missing_dependents = [
                    sailpoint.v2025.models.dependant_connections_missing_dto.Dependant Connections Missing Dto(
