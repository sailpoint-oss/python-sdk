...
class AccessModelMetadataBulkUpdateResponse(BaseModel):
    """
    AccessModelMetadataBulkUpdateResponse
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the task which is executing the bulk update.")
    type: Optional[StrictStr] = Field(default=None, description="Type of the bulk update object.")
    status: Optional[StrictStr] = Field(default=None, description="The status of the bulk update request, only list unfinished request's status.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessModelMetadataBulkUpdateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessModelMetadataBulkUpdateResponse from a dict"""
        if obj is None:
            return None
