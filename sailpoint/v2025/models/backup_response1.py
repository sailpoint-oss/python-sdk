...
class BackupResponse1(BaseModel):
    """
    BackupResponse1
    """ # noqa: E501
    ...
    options: Optional[BackupOptions1] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BackupResponse1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BackupResponse1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "options": BackupOptions1.from_dict(obj["options"]) if obj.get("options") is not None else None,
