...
class BulkCancelAccessRequest(BaseModel):
    """
    Request body payload for bulk cancel access request endpoint.
    """ # noqa: E501
    access_request_ids: List[StrictStr] = Field(description="List of access requests ids to cancel the pending requests", alias="accessRequestIds")
    comment: StrictStr = Field(description="Reason for cancelling the pending access request.")
    __properties: ClassVar[List[str]] = ["accessRequestIds", "comment"]
