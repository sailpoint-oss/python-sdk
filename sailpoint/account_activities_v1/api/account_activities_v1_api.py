...
from sailpoint.account_activities_v1.api_client import ApiClient, RequestSerialized
from sailpoint.account_activities_v1.api_response import ApiResponse
from sailpoint.account_activities_v1.rest import RESTResponseType
...
class AccountActivitiesV1Api:
    ...
    def get_account_activity_v1(
        ...
        _param = self._get_account_activity_v1_serialize(
            id=id,
    ...
    @validate_call
    def get_account_activity_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The account activity id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_account_activity_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The account activity id")],
        _request_timeout: Union[
            None,
    ...
    def _get_account_activity_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/account-activities/v1/{id}',
    ...
    @validate_call
    def list_account_activities_v1(
        self,
        ...
        _param = self._list_account_activities_v1_serialize(
    ...
    @validate_call
    def list_account_activities_v1_with_http_info(
        self,
        requested_for: Annotated[Optional[StrictStr], Field(description="The identity that the activity was requested for. *me* indicates the current user. Mutually exclusive with *regarding-identity*.")] = None,
        requested_by: Annotated[Optional[StrictStr], Field(description="The identity that requested the activity. *me* indicates the current user. Mutually exclusive with *regarding-identity*.")] = None,
        regarding_identity: Annotated[Optional[StrictStr], Field(description="The specified identity will be either the requester or target of the account activity. *me* indicates the current user. Mutually exclusive with *requested-for* and *requested-by*.")] = None,
    ...
    @validate_call
    def list_account_activities_v1_without_preload_content(
        self,
        requested_for: Annotated[Optional[StrictStr], Field(description="The identity that the activity was requested for. *me* indicates the current user. Mutually exclusive with *regarding-identity*.")] = None,
        requested_by: Annotated[Optional[StrictStr], Field(description="The identity that requested the activity. *me* indicates the current user. Mutually exclusive with *regarding-identity*.")] = None,
        regarding_identity: Annotated[Optional[StrictStr], Field(description="The specified identity will be either the requester or target of the account activity. *me* indicates the current user. Mutually exclusive with *requested-for* and *requested-by*.")] = None,
    ...
    def _list_account_activities_v1_serialize(
        self,
        requested_for,
        requested_by,
        regarding_identity,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/account-activities/v1',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
