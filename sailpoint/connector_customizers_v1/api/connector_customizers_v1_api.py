...
from sailpoint.connector_customizers_v1.api_client import ApiClient, RequestSerialized
from sailpoint.connector_customizers_v1.api_response import ApiResponse
from sailpoint.connector_customizers_v1.rest import RESTResponseType
...
class ConnectorCustomizersV1Api:
    ...
    def _create_connector_customizer_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/connector-customizers/v1',
    ...
    @validate_call
    def create_connector_customizer_version_v1(
        self,
        ...
        _param = self._create_connector_customizer_version_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def create_connector_customizer_version_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The id of the connector customizer.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_connector_customizer_version_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The id of the connector customizer.")],
        _request_timeout: Union[
            None,
    ...
    def _create_connector_customizer_version_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/connector-customizers/v1/{id}/versions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_connector_customizer_v1(
        self,
        ...
        _param = self._delete_connector_customizer_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_connector_customizer_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the connector customizer to delete.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_connector_customizer_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the connector customizer to delete.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_connector_customizer_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/connector-customizers/v1/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_connector_customizer_v1(
        self,
        ...
        _param = self._get_connector_customizer_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_connector_customizer_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the connector customizer to get.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_connector_customizer_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the connector customizer to get.")],
        _request_timeout: Union[
            None,
    ...
    def _get_connector_customizer_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def list_connector_customizers_v1(
        self,
        ...
        _param = self._list_connector_customizers_v1_serialize(
            offset=offset,
            limit=limit,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def list_connector_customizers_v1_with_http_info(
        self,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def list_connector_customizers_v1_without_preload_content(
        self,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        _request_timeout: Union[
    ...
    def _list_connector_customizers_v1_serialize(
        self,
        offset,
        limit,
        _request_auth,
