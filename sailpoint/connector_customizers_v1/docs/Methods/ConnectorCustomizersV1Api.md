...
slug: /tools/sdk/python/v1/methods/connector-customizers
tags: ['SDK', 'Software Development Kit', 'Connector_Customizers', 'Connector_Customizers']
---

# sailpoint.connector_customizers_v1.ConnectorCustomizersV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConnectorCustomizersV1Api(api_client).create_connector_customizer_v1(connectorcustomizercreaterequest=new_connectorcustomizercreaterequest)
        # Below is a request that includes all optional parameters
        # results = ConnectorCustomizersV1Api(api_client).create_connector_customizer_v1(new_connectorcustomizercreaterequest)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConnectorCustomizersV1Api(api_client).create_connector_customizer_version_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = ConnectorCustomizersV1Api(api_client).create_connector_customizer_version_v1(id)
        print("The response of ConnectorCustomizersV1Api->create_connector_customizer_version_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConnectorCustomizersV1Api->create_connector_customizer_version_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        ConnectorCustomizersV1Api(api_client).delete_connector_customizer_v1(id=id)
        # Below is a request that includes all optional parameters
        # ConnectorCustomizersV1Api(api_client).delete_connector_customizer_v1(id)
    except Exception as e:
        print("Exception when calling ConnectorCustomizersV1Api->delete_connector_customizer_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConnectorCustomizersV1Api(api_client).get_connector_customizer_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = ConnectorCustomizersV1Api(api_client).get_connector_customizer_v1(id)
        print("The response of ConnectorCustomizersV1Api->get_connector_customizer_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConnectorCustomizersV1Api->get_connector_customizer_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConnectorCustomizersV1Api(api_client).list_connector_customizers_v1()
        # Below is a request that includes all optional parameters
        # results = ConnectorCustomizersV1Api(api_client).list_connector_customizers_v1(offset, limit)
        print("The response of ConnectorCustomizersV1Api->list_connector_customizers_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConnectorCustomizersV1Api->list_connector_customizers_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    connectorcustomizerupdaterequest = '''sailpoint.connector_customizers_v1.Connectorcustomizerupdaterequest()''' # Connectorcustomizerupdaterequest | Connector rule with updated data. (optional)

    try:
        # Update connector customizer
        
        results = ConnectorCustomizersV1Api(api_client).put_connector_customizer_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = ConnectorCustomizersV1Api(api_client).put_connector_customizer_v1(id, new_connectorcustomizerupdaterequest)
        print("The response of ConnectorCustomizersV1Api->put_connector_customizer_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConnectorCustomizersV1Api->put_connector_customizer_v1: %s\n" % e)
```
