...
class OrgApi:
    ...
    def get_org_settings(
        ...
        _param = self._get_org_settings_serialize(_request_auth=_request_auth,
    ...
    def get_org_settings_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetOrgSettings200Response]:
        """Retrieves your org settings.
    ...
    def update_org_settings(
        self,
        update_org_settings_request: Annotated[
    ...
    def _update_org_settings_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_org_settings_request is not None:
            _body_params = update_org_settings_request
