...
class BulkDeleteWorkGroups200Response(BaseModel):
  ...
  # noqa: E501
    deleted: Optional[List[StrictStr]] = None
    in_use: Optional[List[StrictStr]] = Field(default=None, alias="inUse")
    not_found: Optional[List[StrictStr]] = Field(default=None,
                                                 alias="notFound")
    __properties: ClassVar[List[str]] = ["deleted", "inUse", "notFound"]
