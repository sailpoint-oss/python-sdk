...
class GetOrgSettings200ResponseSystemNotificationConfigNotificationsInner(BaseModel):
    """
    ...
    thresholds: Optional[GetOrgSettings200ResponseSystemNotificationConfigNotificationsInnerThresholds] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetOrgSettings200ResponseSystemNotificationConfigNotificationsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetOrgSettings200ResponseSystemNotificationConfigNotificationsInner:
        """Create an instance of GetOrgSettings200ResponseSystemNotificationConfigNotificationsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetOrgSettings200ResponseSystemNotificationConfigNotificationsInner.parse_obj(obj)

        _obj = GetOrgSettings200ResponseSystemNotificationConfigNotificationsInner.parse_obj({
            "type": obj.get("type"),
            "by_email": obj.get("byEmail"),
            "thresholds": GetOrgSettings200ResponseSystemNotificationConfigNotificationsInnerThresholds.from_dict(obj.get("thresholds")) if obj.get("thresholds") is not None else None
        })
        return _obj
