...
from sailpoint.org_config.api_response import ApiResponse, T as ApiResponseT
import sailpoint.org_config.models
from sailpoint.org_config import rest
from sailpoint.org_config.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.org_config.models, klass)
