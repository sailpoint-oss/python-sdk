...
from sailpoint.icons.api_response import ApiResponse, T as ApiResponseT
import sailpoint.icons.models
from sailpoint.icons import rest
from sailpoint.icons.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.icons.models, klass)
