...
from sailpoint.transforms.api_response import ApiResponse, T as ApiResponseT
import sailpoint.transforms.models
from sailpoint.transforms import rest
from sailpoint.transforms.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.transforms.models, klass)
