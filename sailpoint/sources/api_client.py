...
from sailpoint.sources.api_response import ApiResponse, T as ApiResponseT
import sailpoint.sources.models
from sailpoint.sources import rest
from sailpoint.sources.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.sources.models, klass)
