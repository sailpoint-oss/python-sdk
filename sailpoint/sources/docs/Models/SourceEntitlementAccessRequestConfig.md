...
keywords: ['python', 'Python', 'sdk', 'SourceEntitlementAccessRequestConfig', 'SourceEntitlementAccessRequestConfig'] 
slug: /tools/sdk/python/sources/models/source-entitlement-access-request-config
...
------------ | ------------- | ------------- | -------------
**approval_schemes** | [**[]SourceEntitlementApprovalScheme**](source-entitlement-approval-scheme) | Ordered list of approval steps for the access request. Empty when no approval is required. | [optional] 
...
**max_permitted_access_duration** | [**SourceEntitlementAccessRequestConfigMaxPermittedAccessDuration**](source-entitlement-access-request-config-max-permitted-access-duration) |  | [optional] 
...
source_entitlement_access_request_config = SourceEntitlementAccessRequestConfig(
approval_schemes=[
