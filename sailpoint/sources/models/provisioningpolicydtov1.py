...
class Provisioningpolicydtov1(BaseModel):
    """
    ...
    fields: Optional[List[Fielddetailsdtov1]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Provisioningpolicydtov1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Provisioningpolicydtov1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "fields": [Fielddetailsdtov1.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None
        })
        return _obj
