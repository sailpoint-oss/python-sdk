...
class TaskResultDetails(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="System-generated unique ID of the task.")
    type: Optional[StrictStr] = Field(default=None, description="Type of task this result represents.")
    ...
    parent_name: Optional[StrictStr] = Field(default=None, description="Name of the parent task if one exists.", alias="parentName")
    progress: Optional[StrictStr] = Field(default=None, description="Current task state.")
    __properties: ClassVar[List[str]] = ["id", "type", "name", "description", "launcher", "created", "launched", "completed", "completionStatus", "parentName", "progress"]
