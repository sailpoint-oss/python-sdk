...
slug: /tools/sdk/python/v1/methods/personal-access-tokens
tags: ['SDK', 'Software Development Kit', 'Personal_Access_Tokens', 'Personal_Access_Tokens']
---

# sailpoint.personal_access_tokens_v1.PersonalAccessTokensV1Api
...
with ApiClient(configuration) as api_client:
    createpersonalaccesstokenrequest = '''sailpoint.personal_access_tokens_v1.Createpersonalaccesstokenrequest()''' # Createpersonalaccesstokenrequest | Configuration for creating a personal access token, including name, scope, expiration settings, and user acknowledgment of never-expiring tokens. **Important:** See the endpoint description for validation rules regarding the relationship between `expirationDate` and `userAwareTokenNeverExpires`.

    try:
        # Create personal access token
        new_createpersonalaccesstokenrequest = Createpersonalaccesstokenrequest.from_json(createpersonalaccesstokenrequest)
        results = PersonalAccessTokensV1Api(api_client).create_personal_access_token_v1(createpersonalaccesstokenrequest=new_createpersonalaccesstokenrequest)
        # Below is a request that includes all optional parameters
        # results = PersonalAccessTokensV1Api(api_client).create_personal_access_token_v1(new_createpersonalaccesstokenrequest)
        print("The response of PersonalAccessTokensV1Api->create_personal_access_token_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling PersonalAccessTokensV1Api->create_personal_access_token_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        PersonalAccessTokensV1Api(api_client).delete_personal_access_token_v1(id=id)
        # Below is a request that includes all optional parameters
        # PersonalAccessTokensV1Api(api_client).delete_personal_access_token_v1(id)
    except Exception as e:
        print("Exception when calling PersonalAccessTokensV1Api->delete_personal_access_token_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = PersonalAccessTokensV1Api(api_client).list_personal_access_tokens_v1()
        # Below is a request that includes all optional parameters
        # results = PersonalAccessTokensV1Api(api_client).list_personal_access_tokens_v1(owner_id, filters)
        print("The response of PersonalAccessTokensV1Api->list_personal_access_tokens_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling PersonalAccessTokensV1Api->list_personal_access_tokens_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = PersonalAccessTokensV1Api(api_client).patch_personal_access_token_v1(id=id, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = PersonalAccessTokensV1Api(api_client).patch_personal_access_token_v1(id, new_jsonpatchoperation)
        print("The response of PersonalAccessTokensV1Api->patch_personal_access_token_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling PersonalAccessTokensV1Api->patch_personal_access_token_v1: %s\n" % e)
```
