...
from sailpoint.personal_access_tokens_v1.api_response import ApiResponse, T as ApiResponseT
import sailpoint.personal_access_tokens_v1.models
from sailpoint.personal_access_tokens_v1 import rest
from sailpoint.personal_access_tokens_v1.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.personal_access_tokens_v1.models, klass)
