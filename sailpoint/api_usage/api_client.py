...
from sailpoint.api_usage.api_response import ApiResponse, T as ApiResponseT
import sailpoint.api_usage.models
from sailpoint.api_usage import rest
from sailpoint.api_usage.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.api_usage.models, klass)
