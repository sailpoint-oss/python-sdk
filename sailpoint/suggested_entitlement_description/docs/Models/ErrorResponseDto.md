...
slug: /tools/sdk/python/suggested-entitlement-description/models/error-response-dto
...
messages=[
                    sailpoint.suggested_entitlement_description.models.error_message_dto.Error Message Dto(
                        locale = 'en-US', 
