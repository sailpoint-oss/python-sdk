...
from sailpoint.suggested_entitlement_description.api_response import ApiResponse, T as ApiResponseT
import sailpoint.suggested_entitlement_description.models
from sailpoint.suggested_entitlement_description import rest
from sailpoint.suggested_entitlement_description.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.suggested_entitlement_description.models, klass)
