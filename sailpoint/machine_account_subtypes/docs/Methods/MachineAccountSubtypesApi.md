...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # MachineAccountSubtypesApi(api_client).delete_machine_account_subtype_v1(subtype_id)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # Below is a request that includes all optional parameters
        # results = MachineAccountSubtypesApi(api_client).get_source_subtype_by_id_v1(subtype_id)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        # Below is a request that includes all optional parameters
        # results = MachineAccountSubtypesApi(api_client).patch_machine_account_subtype_v1(subtype_id, new_request_body)
