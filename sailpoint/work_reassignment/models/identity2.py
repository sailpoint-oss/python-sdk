...
class Identity2(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="Human-readable display name of the object")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Identity2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Identity2 from a dict"""
        if obj is None:
            return None
