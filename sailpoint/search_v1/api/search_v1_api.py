...
from sailpoint.search_v1.api_client import ApiClient, RequestSerialized
from sailpoint.search_v1.api_response import ApiResponse
from sailpoint.search_v1.rest import RESTResponseType
...
class SearchV1Api:
    ...
    def search_aggregate_v1(
        ...
        _param = self._search_aggregate_v1_serialize(
            search=search,
            offset=offset,
            limit=limit,
            count=count,
    ...
    @validate_call
    def search_aggregate_v1_with_http_info(
        self,
        search: Search,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def search_aggregate_v1_without_preload_content(
        self,
        search: Search,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _search_aggregate_v1_serialize(
        self,
        search,
        offset,
        limit,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/search/v1/aggregate',
    ...
    def search_count_v1(
        ...
        _param = self._search_count_v1_serialize(
            search=search,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def search_count_v1_with_http_info(
        self,
        search: Search,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def search_count_v1_without_preload_content(
        self,
        search: Search,
        _request_timeout: Union[
            None,
    ...
    def _search_count_v1_serialize(
        self,
        search,
        _request_auth,
        _content_type,
    ...
    def search_get_v1(
        ...
        _param = self._search_get_v1_serialize(
            index=index,
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def search_get_v1_with_http_info(
        self,
        index: Annotated[StrictStr, Field(description="The index from which to fetch the specified document.  The currently supported index names are: *accessprofiles*, *accountactivities*, *entitlements*, *events*, *identities*, and *roles*. ")],
        id: Annotated[StrictStr, Field(description="ID of the requested document.")],
        _request_timeout: Union[
    ...
    @validate_call
    def search_get_v1_without_preload_content(
        self,
        index: Annotated[StrictStr, Field(description="The index from which to fetch the specified document.  The currently supported index names are: *accessprofiles*, *accountactivities*, *entitlements*, *events*, *identities*, and *roles*. ")],
        id: Annotated[StrictStr, Field(description="ID of the requested document.")],
        _request_timeout: Union[
    ...
    def _search_get_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/search/v1/{index}/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def search_post_v1(
        ...
        _param = self._search_post_v1_serialize(
            search=search,
            offset=offset,
            limit=limit,
            count=count,
    ...
    @validate_call
    def search_post_v1_with_http_info(
        self,
        search: Search,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=10000, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def search_post_v1_without_preload_content(
        self,
        search: Search,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=10000, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
