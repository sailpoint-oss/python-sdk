...
class FormDefinitionSelfImportExportDto(BaseModel):
    """
    Self block for imported/exported object.
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Imported/exported object's DTO type.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['FORM_DEFINITION']):
            warnings.warn(f"must be one of enum values ('FORM_DEFINITION') unknown value: {value}")
        return value
