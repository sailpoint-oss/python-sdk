...
slug: /tools/sdk/python/custom-forms/models/list-form-definitions-by-tenant-response
...
count=1,
results=[
                    sailpoint.custom_forms.models.form_definition_response.FormDefinitionResponse(
