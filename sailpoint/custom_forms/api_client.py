...
from sailpoint.custom_forms.api_response import ApiResponse, T as ApiResponseT
import sailpoint.custom_forms.models
from sailpoint.custom_forms import rest
from sailpoint.custom_forms.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.custom_forms.models, klass)
