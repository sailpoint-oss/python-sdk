...
from sailpoint.access_request_approvals.api_response import ApiResponse, T as ApiResponseT
import sailpoint.access_request_approvals.models
from sailpoint.access_request_approvals import rest
from sailpoint.access_request_approvals.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.access_request_approvals.models, klass)
