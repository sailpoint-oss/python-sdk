...
keywords: ['python', 'Python', 'sdk', 'PendingApprovalForm', 'PendingApprovalForm'] 
slug: /tools/sdk/python/access-request-approvals/models/pending-approval-form
...
pending_approval_form = PendingApprovalForm(
