...
class TestPendingApprovalForm(unittest.TestCase):
    """PendingApprovalForm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PendingApprovalForm:
        """Test PendingApprovalForm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PendingApprovalForm`
        """
        model = PendingApprovalForm()
        if include_optional:
            return PendingApprovalForm(
    ...
    def testPendingApprovalForm(self):
        """Test PendingApprovalForm"""
