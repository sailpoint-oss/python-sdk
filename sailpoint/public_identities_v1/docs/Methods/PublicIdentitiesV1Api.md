...
slug: /tools/sdk/python/v1/methods/public-identities
tags: ['SDK', 'Software Development Kit', 'Public_Identities', 'Public_Identities']
---

# sailpoint.public_identities_v1.PublicIdentitiesV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = PublicIdentitiesV1Api(api_client).get_public_identities_v1()
        # Below is a request that includes all optional parameters
        # results = PublicIdentitiesV1Api(api_client).get_public_identities_v1(limit, offset, count, filters, add_core_filters, sorters)
        print("The response of PublicIdentitiesV1Api->get_public_identities_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling PublicIdentitiesV1Api->get_public_identities_v1: %s\n" % e)
```
