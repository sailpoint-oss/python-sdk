...
class Accessprofilebulkdeleteresponse(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.in_use:
            for _item_in_use in self.in_use:
                if _item_in_use:
                    _items.append(_item_in_use.to_dict())
            _dict['inUse'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inUse": [Accessprofileusage.from_dict(_item) for _item in obj["inUse"]] if obj.get("inUse") is not None else None
        })
        return _obj
