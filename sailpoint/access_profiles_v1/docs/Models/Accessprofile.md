...
slug: /tools/sdk/python/v1/models/accessprofile
...
enabled=True,
owner=sailpoint.access_profiles_v1.models.ownerreference.ownerreference(
                    type = 'IDENTITY', 
                    id = '2c9180a46faadee4016fb4e018c20639', 
                    name = 'support', ),
source=sailpoint.access_profiles_v1.models.accessprofilesourceref.accessprofilesourceref(
                    id = '2c91809773dee3610173fdb0b6061ef4', 
                    type = 'SOURCE', 
                    name = 'ODS-AD-SOURCE', ),
entitlements=[
                    sailpoint.access_profiles_v1.models.entitlementref.entitlementref(
                        type = 'ENTITLEMENT', 
                        id = '2c91809773dee32014e13e122092014e', 
                        name = 'CN=entitlement.490efde5,OU=OrgCo,OU=ServiceDept,DC=HQAD,DC=local', )
                    ],
requestable=True,
access_request_config=sailpoint.access_profiles_v1.models.requestability.requestability(
                    comments_required = True, 
                    denial_comments_required = True, 
                    reauthorization_required = True, 
                    require_end_date = True, 
                    max_permitted_access_duration = sailpoint.access_profiles_v1.models.accessduration.accessduration(
                        value = 6, 
                        time_unit = 'MONTHS', ), 
                    approval_schemes = [
                        sailpoint.access_profiles_v1.models.accessprofileapprovalscheme.accessprofileapprovalscheme(
                            approver_type = 'GOVERNANCE_GROUP', 
                            approver_id = '46c79819-a69f-49a2-becb-12c971ae66c6', )
                        ], ),
revocation_request_config=sailpoint.access_profiles_v1.models.revocability.revocability(
                    approval_schemes = [
                        sailpoint.access_profiles_v1.models.accessprofileapprovalscheme.accessprofileapprovalscheme(
                            approver_type = 'GOVERNANCE_GROUP', 
                            approver_id = '46c79819-a69f-49a2-becb-12c971ae66c6', )
...
access_model_metadata=sailpoint.access_profiles_v1.models.attributedtolist.attributedtolist(
...
provisioning_criteria=sailpoint.access_profiles_v1.models.provisioningcriterialevel1.provisioningcriterialevel1(
                    operation = 'EQUALS', 
                    attribute = 'email', 
                    value = 'carlee.cert1c9f9b6fd@mailinator.com', 
                    children = [
                        sailpoint.access_profiles_v1.models.provisioningcriterialevel2.provisioningcriterialevel2(
                            attribute = 'email', 
                            value = 'carlee.cert1c9f9b6fd@mailinator.com', )
                        ], ),
additional_owners=[
                    sailpoint.access_profiles_v1.models.additionalownerref.additionalownerref(
                        type = 'IDENTITY', 
                        id = '2c9180a46faadee4016fb4e018c20639', 
                        name = 'support', )
                    ]
