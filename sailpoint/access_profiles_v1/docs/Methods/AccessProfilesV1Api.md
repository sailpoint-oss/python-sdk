...
slug: /tools/sdk/python/v1/methods/access-profiles
tags: ['SDK', 'Software Development Kit', 'Access_Profiles', 'Access_Profiles']
---

# sailpoint.access_profiles_v1.AccessProfilesV1Api
...
```python
from sailpoint.access_profiles_v1.api.access_profiles_v1_api import AccessProfilesV1Api
from sailpoint.access_profiles_v1.api_client import ApiClient
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AccessProfilesV1Api(api_client).create_access_profile_v1(accessprofile=new_accessprofile)
        # Below is a request that includes all optional parameters
        # results = AccessProfilesV1Api(api_client).create_access_profile_v1(new_accessprofile)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        AccessProfilesV1Api(api_client).delete_access_profile_v1(id=id)
        # Below is a request that includes all optional parameters
        # AccessProfilesV1Api(api_client).delete_access_profile_v1(id)
    except Exception as e:
        print("Exception when calling AccessProfilesV1Api->delete_access_profile_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AccessProfilesV1Api(api_client).delete_access_profiles_in_bulk_v1(accessprofilebulkdeleterequest=new_accessprofilebulkdeleterequest)
        # Below is a request that includes all optional parameters
        # results = AccessProfilesV1Api(api_client).delete_access_profiles_in_bulk_v1(new_accessprofilebulkdeleterequest)
        print("The response of AccessProfilesV1Api->delete_access_profiles_in_bulk_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling AccessProfilesV1Api->delete_access_profiles_in_bulk_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AccessProfilesV1Api(api_client).get_access_profile_entitlements_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = AccessProfilesV1Api(api_client).get_access_profile_entitlements_v1(id, limit, offset, count, filters, sorters)
        print("The response of AccessProfilesV1Api->get_access_profile_entitlements_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling AccessProfilesV1Api->get_access_profile_entitlements_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AccessProfilesV1Api(api_client).get_access_profile_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = AccessProfilesV1Api(api_client).get_access_profile_v1(id)
        print("The response of AccessProfilesV1Api->get_access_profile_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling AccessProfilesV1Api->get_access_profile_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AccessProfilesV1Api(api_client).list_access_profiles_v1()
        # Below is a request that includes all optional parameters
        # results = AccessProfilesV1Api(api_client).list_access_profiles_v1(for_subadmin, limit, offset, count, filters, sorters, for_segment_ids, include_unsegmented)
        print("The response of AccessProfilesV1Api->list_access_profiles_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling AccessProfilesV1Api->list_access_profiles_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AccessProfilesV1Api(api_client).patch_access_profile_v1(id=id, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = AccessProfilesV1Api(api_client).patch_access_profile_v1(id, new_jsonpatchoperation)
        print("The response of AccessProfilesV1Api->patch_access_profile_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling AccessProfilesV1Api->patch_access_profile_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AccessProfilesV1Api(api_client).update_access_profiles_in_bulk_v1(accessprofilebulkupdaterequest_inner=new_accessprofilebulkupdaterequest_inner)
        # Below is a request that includes all optional parameters
        # results = AccessProfilesV1Api(api_client).update_access_profiles_in_bulk_v1(new_accessprofilebulkupdaterequest_inner, x_sail_point_experimental)
        print("The response of AccessProfilesV1Api->update_access_profiles_in_bulk_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling AccessProfilesV1Api->update_access_profiles_in_bulk_v1: %s\n" % e)
```
