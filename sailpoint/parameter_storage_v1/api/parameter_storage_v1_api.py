...
from sailpoint.parameter_storage_v1.api_client import ApiClient, RequestSerialized
from sailpoint.parameter_storage_v1.api_response import ApiResponse
from sailpoint.parameter_storage_v1.rest import RESTResponseType
...
class ParameterStorageV1Api:
    ...
    def _create_parameter_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/parameter-storage/v1/parameters',
    ...
    def delete_parameter_v1(
        ...
        _param = self._delete_parameter_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_parameter_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the parameter to be deleted.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_parameter_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the parameter to be deleted.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_parameter_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/parameter-storage/v1/parameters/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_attestation_document_v1(
        self,
        ...
        _param = self._get_attestation_document_v1_serialize(
            key=key,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_attestation_document_v1_with_http_info(
        self,
        key: Annotated[StrictStr, Field(description="Base64Url encoded NIST P-384 public key")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_attestation_document_v1_without_preload_content(
        self,
        key: Annotated[StrictStr, Field(description="Base64Url encoded NIST P-384 public key")],
        _request_timeout: Union[
            None,
    ...
    def _get_attestation_document_v1_serialize(
        self,
        key,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/parameter-storage/v1/attestation',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_parameter_references_v1(
        self,
        ...
        _param = self._get_parameter_references_v1_serialize(
            id=id,
            sorters=sorters,
            limit=limit,
            offset=offset,
    ...
    @validate_call
    def get_parameter_references_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the parameter which you want to fetch the references for.")],
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **id, consumerId, parameterId, name, usageHint**")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def get_parameter_references_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the parameter which you want to fetch the references for.")],
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **id, consumerId, parameterId, name, usageHint**")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _get_parameter_references_v1_serialize(
        self,
        id,
        sorters,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/parameter-storage/v1/parameters/{id}/references',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_parameter_storage_specification_v1(
        self,
        ...
        _param = self._get_parameter_storage_specification_v1_serialize(
    ...
    @validate_call
    def get_parameter_storage_specification_v1_with_http_info(
        self,
        accept_language: Annotated[Optional[StrictStr], Field(description="The i18n internationalization code for the language that the spec is in. Defaults to english.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_parameter_storage_specification_v1_without_preload_content(
        self,
        accept_language: Annotated[Optional[StrictStr], Field(description="The i18n internationalization code for the language that the spec is in. Defaults to english.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_parameter_storage_specification_v1_serialize(
        self,
        accept_language,
        _request_auth,
        _content_type,
    ...
    def get_parameter_v1(
        ...
        _param = self._get_parameter_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_parameter_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the parameter to be fetched")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_parameter_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the parameter to be fetched")],
        _request_timeout: Union[
            None,
    ...
    def _get_parameter_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def search_parameters_v1(
        ...
        _param = self._search_parameters_v1_serialize(
            filters=filters,
            sorters=sorters,
            offset=offset,
            limit=limit,
    ...
    @validate_call
    def search_parameters_v1_with_http_info(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **id**: *eq, ne*  **name**: *eq, in, co*  **description**: *co*  **ownerId**: *eq*  **type**: *eq, sw*")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **id, name, ownerId, type, description, lastModifiedAt, lastModifiedBy, privateFieldsLastModifiedAt, privateFieldsLastModifiedAt**")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def search_parameters_v1_without_preload_content(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **id**: *eq, ne*  **name**: *eq, in, co*  **description**: *co*  **ownerId**: *eq*  **type**: *eq, sw*")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **id, name, ownerId, type, description, lastModifiedAt, lastModifiedBy, privateFieldsLastModifiedAt, privateFieldsLastModifiedAt**")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _search_parameters_v1_serialize(
        self,
        filters,
        sorters,
        offset,
