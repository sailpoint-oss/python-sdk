...
class IdentityPreviewResponseIdentity(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Identity's DTO type.")
    id: Optional[StrictStr] = Field(default=None, description="Identity ID.")
    name: Optional[StrictStr] = Field(default=None, description="Identity's display name.")
