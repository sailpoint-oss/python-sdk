...
slug: /tools/sdk/python/access-request-identity-metrics/models/error-response-dto
...
messages=[
                    sailpoint.access_request_identity_metrics.models.error_message_dto.Error Message Dto(
                        locale = 'en-US', 
