...
from sailpoint.data_access_security.api_response import ApiResponse, T as ApiResponseT
import sailpoint.data_access_security.models
from sailpoint.data_access_security import rest
from sailpoint.data_access_security.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.data_access_security.models, klass)
