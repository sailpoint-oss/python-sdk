...
from sailpoint.machine_account_creation_request_v1.api_client import ApiClient, RequestSerialized
from sailpoint.machine_account_creation_request_v1.api_response import ApiResponse
from sailpoint.machine_account_creation_request_v1.rest import RESTResponseType
...
class MachineAccountCreationRequestV1Api:
    ...
    def _create_machine_account_request_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/account-requests/v1/machine-account-create',
    ...
    @validate_call
    def get_create_machine_account_request_v1(
        self,
        ...
        _param = self._get_create_machine_account_request_v1_serialize(
            x_sail_point_experimental=x_sail_point_experimental,
    ...
    @validate_call
    def get_create_machine_account_request_v1_with_http_info(
        self,
        account_request_id: Annotated[StrictStr, Field(description="Account Request ID")],
        x_sail_point_experimental: Annotated[StrictStr, Field(description="Use this header to enable this experimental API.")] = 'true',
        _request_timeout: Union[
    ...
    @validate_call
    def get_create_machine_account_request_v1_without_preload_content(
        self,
        account_request_id: Annotated[StrictStr, Field(description="Account Request ID")],
        x_sail_point_experimental: Annotated[StrictStr, Field(description="Use this header to enable this experimental API.")] = 'true',
        _request_timeout: Union[
    ...
    def _get_create_machine_account_request_v1_serialize(
        self,
        x_sail_point_experimental,
        account_request_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/account-requests/v1/machine-account-create/{accountRequestId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_machine_account_create_access_info_v1(
        self,
        ...
        _param = self._get_machine_account_create_access_info_v1_serialize(
            x_sail_point_experimental=x_sail_point_experimental,
            offset=offset,
            limit=limit,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_machine_account_create_access_info_v1_with_http_info(
        self,
        offset: Annotated[Optional[StrictInt], Field(description="Offset  Integer specifying the offset of the first result from the beginning of the collection. The standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#paginating-results). The offset value is record-based, not page-based, and the index starts at 0.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Limit  Integer specifying the maximum number of records to return in a single API call. The standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#paginating-results). If it is not specified, a default limit is used.")] = None,
        x_sail_point_experimental: Annotated[StrictStr, Field(description="Use this header to enable this experimental API.")] = 'true',
    ...
    @validate_call
    def get_machine_account_create_access_info_v1_without_preload_content(
        self,
        offset: Annotated[Optional[StrictInt], Field(description="Offset  Integer specifying the offset of the first result from the beginning of the collection. The standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#paginating-results). The offset value is record-based, not page-based, and the index starts at 0.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Limit  Integer specifying the maximum number of records to return in a single API call. The standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#paginating-results). If it is not specified, a default limit is used.")] = None,
        x_sail_point_experimental: Annotated[StrictStr, Field(description="Use this header to enable this experimental API.")] = 'true',
    ...
    def _get_machine_account_create_access_info_v1_serialize(
        self,
        x_sail_point_experimental,
        offset,
        limit,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/source-subtypes/v1/machine-account-create-access',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
