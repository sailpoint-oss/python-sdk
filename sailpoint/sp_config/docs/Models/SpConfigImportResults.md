...
slug: /tools/sdk/python/sp-config/models/sp-config-import-results
...
------------ | ------------- | ------------- | -------------
**results** | [**map[string]ObjectImportResult2**](object-import-result2) | The results of an object configuration import job. | [required]
