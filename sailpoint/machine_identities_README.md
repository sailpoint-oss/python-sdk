...
with sailpoint.machine_identities.ApiClient(configuration) as api_client:
    ...
    machine_identity_request = sailpoint.machine_identities.MachineIdentityRequest() # MachineIdentityRequest | 
    x_sail_point_experimental = 'true' # str | Use this header to enable this experimental API. (optional) (default to 'true')

    try:
        # Create machine identity
        api_response = api_instance.create_machine_identity_v1(machine_identity_request, x_sail_point_experimental=x_sail_point_experimental)
