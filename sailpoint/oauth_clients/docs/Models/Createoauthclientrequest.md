...
slug: /tools/sdk/python/oauth-clients/models/createoauthclientrequest
...
**grant_types** | **[]Granttype** | A list of OAuth 2.0 grant types this API Client can be used with | [required]
**access_type** | **Accesstype** |  | [required]
