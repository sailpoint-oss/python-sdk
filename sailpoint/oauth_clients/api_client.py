...
from sailpoint.oauth_clients.api_response import ApiResponse, T as ApiResponseT
import sailpoint.oauth_clients.models
from sailpoint.oauth_clients import rest
from sailpoint.oauth_clients.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.oauth_clients.models, klass)
