...
from sailpoint.password_configuration.api_response import ApiResponse, T as ApiResponseT
import sailpoint.password_configuration.models
from sailpoint.password_configuration import rest
from sailpoint.password_configuration.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.password_configuration.models, klass)
