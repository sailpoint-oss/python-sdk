...
slug: /tools/sdk/python/v1/methods/sources
tags: ['SDK', 'Software Development Kit', 'Sources', 'Sources']
---

# sailpoint.sources_v1.SourcesV1Api
...
```python
from sailpoint.sources_v1.api.sources_v1_api import SourcesV1Api
from sailpoint.sources_v1.api_client import ApiClient
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).create_provisioning_policy_v1(source_id=source_id, provisioningpolicydto=new_provisioningpolicydto)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).create_provisioning_policy_v1(source_id, new_provisioningpolicydto)
...
with ApiClient(configuration) as api_client:
    ...
    schedule3 = '''sailpoint.sources_v1.Schedule3()''' # Schedule3 | 

    try:
        # Create schedule on source
        new_schedule3 = Schedule3.from_json(schedule3)
        results = SourcesV1Api(api_client).create_source_schedule_v1(source_id=source_id, schedule3=new_schedule3)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).create_source_schedule_v1(source_id, new_schedule3)
        print("The response of SourcesV1Api->create_source_schedule_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->create_source_schedule_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    source_id = '2c9180835d191a86015d28455b4a2329' # str | Source ID. # str | Source ID.
    model_schema = '''sailpoint.sources_v1.ModelSchema()''' # ModelSchema | 

    try:
        # Create schema on source
        new_model_schema = ModelSchema.from_json(model_schema)
        results = SourcesV1Api(api_client).create_source_schema_v1(source_id=source_id, model_schema=new_model_schema)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).create_source_schema_v1(source_id, new_model_schema)
        print("The response of SourcesV1Api->create_source_schema_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->create_source_schema_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    source = '''sailpoint.sources_v1.Source()''' # Source | 
    ...
    try:
        ...
        results = SourcesV1Api(api_client).create_source_v1(source=new_source)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).create_source_v1(new_source, provision_as_csv)
        print("The response of SourcesV1Api->create_source_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->create_source_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).delete_accounts_async_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).delete_accounts_async_v1(id)
        print("The response of SourcesV1Api->delete_accounts_async_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->delete_accounts_async_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        SourcesV1Api(api_client).delete_native_change_detection_config_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # SourcesV1Api(api_client).delete_native_change_detection_config_v1(source_id)
    except Exception as e:
        print("Exception when calling SourcesV1Api->delete_native_change_detection_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    source_id = '2c9180835d191a86015d28455b4a2329' # str | The Source ID. # str | The Source ID.
    usage_type = sailpoint.sources_v1.Usagetype() # Usagetype | The type of provisioning policy usage.  In IdentityNow, a source can support various provisioning operations. For example, when a joiner is added to a source, this may trigger both CREATE and UPDATE provisioning operations.  Each usage type is considered a provisioning policy.  A source can have any number of these provisioning policies defined.  These are the common usage types:  CREATE - This usage type relates to 'Create Account Profile', the provisioning template for the account to be created. For example, this would be used for a joiner on a source.   UPDATE - This usage type relates to 'Update Account Profile', the provisioning template for the 'Update' connector operations. For example, this would be used for an attribute sync on a source. ENABLE - This usage type relates to 'Enable Account Profile', the provisioning template for the account to be enabled. For example, this could be used for a joiner on a source once the joiner's account is created.  DISABLE - This usage type relates to 'Disable Account Profile', the provisioning template for the account to be disabled. For example, this could be used when a leaver is removed temporarily from a source.  You can use these four usage types for all your provisioning policy needs. # Usagetype | The type of provisioning policy usage.  In IdentityNow, a source can support various provisioning operations. For example, when a joiner is added to a source, this may trigger both CREATE and UPDATE provisioning operations.  Each usage type is considered a provisioning policy.  A source can have any number of these provisioning policies defined.  These are the common usage types:  CREATE - This usage type relates to 'Create Account Profile', the provisioning template for the account to be created. For example, this would be used for a joiner on a source.   UPDATE - This usage type relates to 'Update Account Profile', the provisioning template for the 'Update' connector operations. For example, this would be used for an attribute sync on a source. ENABLE - This usage type relates to 'Enable Account Profile', the provisioning template for the account to be enabled. For example, this could be used for a joiner on a source once the joiner's account is created.  DISABLE - This usage type relates to 'Disable Account Profile', the provisioning template for the account to be disabled. For example, this could be used when a leaver is removed temporarily from a source.  You can use these four usage types for all your provisioning policy needs.

    try:
        # Delete provisioning policy by usagetype
        
        SourcesV1Api(api_client).delete_provisioning_policy_v1(source_id=source_id, usage_type=usage_type)
        # Below is a request that includes all optional parameters
        # SourcesV1Api(api_client).delete_provisioning_policy_v1(source_id, usage_type)
    except Exception as e:
        print("Exception when calling SourcesV1Api->delete_provisioning_policy_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        SourcesV1Api(api_client).delete_source_schedule_v1(source_id=source_id, schedule_type=schedule_type)
        # Below is a request that includes all optional parameters
        # SourcesV1Api(api_client).delete_source_schedule_v1(source_id, schedule_type)
    except Exception as e:
        print("Exception when calling SourcesV1Api->delete_source_schedule_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        SourcesV1Api(api_client).delete_source_schema_v1(source_id=source_id, schema_id=schema_id)
        # Below is a request that includes all optional parameters
        # SourcesV1Api(api_client).delete_source_schema_v1(source_id, schema_id)
    except Exception as e:
        print("Exception when calling SourcesV1Api->delete_source_schema_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).delete_source_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).delete_source_v1(id)
        print("The response of SourcesV1Api->delete_source_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->delete_source_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).get_account_delete_approval_config_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).get_account_delete_approval_config_v1(source_id)
        print("The response of SourcesV1Api->get_account_delete_approval_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->get_account_delete_approval_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        SourcesV1Api(api_client).get_accounts_schema_v1(id=id)
        # Below is a request that includes all optional parameters
        # SourcesV1Api(api_client).get_accounts_schema_v1(id)
    except Exception as e:
        print("Exception when calling SourcesV1Api->get_accounts_schema_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).get_correlation_config_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).get_correlation_config_v1(id)
        print("The response of SourcesV1Api->get_correlation_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->get_correlation_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        SourcesV1Api(api_client).get_entitlements_schema_v1(id=id)
        # Below is a request that includes all optional parameters
        # SourcesV1Api(api_client).get_entitlements_schema_v1(id, schema_name)
    except Exception as e:
        print("Exception when calling SourcesV1Api->get_entitlements_schema_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).get_machine_account_deletion_approval_config_by_source_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).get_machine_account_deletion_approval_config_by_source_v1(source_id)
        print("The response of SourcesV1Api->get_machine_account_deletion_approval_config_by_source_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->get_machine_account_deletion_approval_config_by_source_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).get_native_change_detection_config_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).get_native_change_detection_config_v1(source_id)
        print("The response of SourcesV1Api->get_native_change_detection_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->get_native_change_detection_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).get_provisioning_policy_v1(source_id=source_id, usage_type=usage_type)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).get_provisioning_policy_v1(source_id, usage_type)
        print("The response of SourcesV1Api->get_provisioning_policy_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->get_provisioning_policy_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).get_source_attr_sync_config_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).get_source_attr_sync_config_v1(id, x_sail_point_experimental)
        print("The response of SourcesV1Api->get_source_attr_sync_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->get_source_attr_sync_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).get_source_config_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).get_source_config_v1(id, locale)
        print("The response of SourcesV1Api->get_source_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->get_source_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).get_source_connections_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).get_source_connections_v1(source_id)
        print("The response of SourcesV1Api->get_source_connections_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->get_source_connections_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).get_source_entitlement_request_config_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).get_source_entitlement_request_config_v1(id, x_sail_point_experimental)
        print("The response of SourcesV1Api->get_source_entitlement_request_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->get_source_entitlement_request_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).get_source_health_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).get_source_health_v1(source_id)
        print("The response of SourcesV1Api->get_source_health_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->get_source_health_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).get_source_schedule_v1(source_id=source_id, schedule_type=schedule_type)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).get_source_schedule_v1(source_id, schedule_type)
        print("The response of SourcesV1Api->get_source_schedule_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->get_source_schedule_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).get_source_schedules_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).get_source_schedules_v1(source_id)
        print("The response of SourcesV1Api->get_source_schedules_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->get_source_schedules_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).get_source_schema_v1(source_id=source_id, schema_id=schema_id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).get_source_schema_v1(source_id, schema_id)
        print("The response of SourcesV1Api->get_source_schema_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->get_source_schema_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).get_source_schemas_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).get_source_schemas_v1(source_id, include_types, include_names)
        print("The response of SourcesV1Api->get_source_schemas_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->get_source_schemas_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).get_source_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).get_source_v1(id)
        print("The response of SourcesV1Api->get_source_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->get_source_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).import_accounts_schema_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).import_accounts_schema_v1(id, file)
        print("The response of SourcesV1Api->import_accounts_schema_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->import_accounts_schema_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).import_accounts_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).import_accounts_v1(id, file, disable_optimization)
        print("The response of SourcesV1Api->import_accounts_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->import_accounts_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).import_connector_file_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).import_connector_file_v1(source_id, file)
        print("The response of SourcesV1Api->import_connector_file_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->import_connector_file_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).import_entitlements_schema_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).import_entitlements_schema_v1(id, schema_name, file)
        print("The response of SourcesV1Api->import_entitlements_schema_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->import_entitlements_schema_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).import_entitlements_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).import_entitlements_v1(source_id, file)
        print("The response of SourcesV1Api->import_entitlements_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->import_entitlements_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).import_uncorrelated_accounts_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).import_uncorrelated_accounts_v1(id, file)
        print("The response of SourcesV1Api->import_uncorrelated_accounts_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->import_uncorrelated_accounts_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).list_password_policy_holders_on_source_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).list_password_policy_holders_on_source_v1(source_id, offset, limit, count)
        print("The response of SourcesV1Api->list_password_policy_holders_on_source_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->list_password_policy_holders_on_source_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).list_provisioning_policies_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).list_provisioning_policies_v1(source_id, offset, limit)
        print("The response of SourcesV1Api->list_provisioning_policies_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->list_provisioning_policies_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).list_sources_v1()
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).list_sources_v1(limit, offset, count, filters, sorters, for_subadmin, include_idn_source)
        print("The response of SourcesV1Api->list_sources_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->list_sources_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).ping_cluster_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).ping_cluster_v1(source_id)
        print("The response of SourcesV1Api->ping_cluster_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->ping_cluster_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    id = '2c9180835d191a86015d28455b4a2329' # str | The source id # str | The source id
    correlationconfig = '''sailpoint.sources_v1.Correlationconfig()''' # Correlationconfig | 

    try:
        # Update source correlation configuration
        new_correlationconfig = Correlationconfig.from_json(correlationconfig)
        results = SourcesV1Api(api_client).put_correlation_config_v1(id=id, correlationconfig=new_correlationconfig)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).put_correlation_config_v1(id, new_correlationconfig)
        print("The response of SourcesV1Api->put_correlation_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->put_correlation_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    source_id = '2c9180835d191a86015d28455b4a2329' # str | The source id # str | The source id
    nativechangedetectionconfig = '''sailpoint.sources_v1.Nativechangedetectionconfig()''' # Nativechangedetectionconfig | 

    try:
        # Update native change detection configuration
        new_nativechangedetectionconfig = Nativechangedetectionconfig.from_json(nativechangedetectionconfig)
        results = SourcesV1Api(api_client).put_native_change_detection_config_v1(source_id=source_id, nativechangedetectionconfig=new_nativechangedetectionconfig)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).put_native_change_detection_config_v1(source_id, new_nativechangedetectionconfig)
        print("The response of SourcesV1Api->put_native_change_detection_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->put_native_change_detection_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    source_id = '2c9180835d191a86015d28455b4a2329' # str | The Source ID. # str | The Source ID.
    usage_type = sailpoint.sources_v1.Usagetype() # Usagetype | The type of provisioning policy usage.  In IdentityNow, a source can support various provisioning operations. For example, when a joiner is added to a source, this may trigger both CREATE and UPDATE provisioning operations.  Each usage type is considered a provisioning policy.  A source can have any number of these provisioning policies defined.  These are the common usage types:  CREATE - This usage type relates to 'Create Account Profile', the provisioning template for the account to be created. For example, this would be used for a joiner on a source.   UPDATE - This usage type relates to 'Update Account Profile', the provisioning template for the 'Update' connector operations. For example, this would be used for an attribute sync on a source. ENABLE - This usage type relates to 'Enable Account Profile', the provisioning template for the account to be enabled. For example, this could be used for a joiner on a source once the joiner's account is created.  DISABLE - This usage type relates to 'Disable Account Profile', the provisioning template for the account to be disabled. For example, this could be used when a leaver is removed temporarily from a source.  You can use these four usage types for all your provisioning policy needs. # Usagetype | The type of provisioning policy usage.  In IdentityNow, a source can support various provisioning operations. For example, when a joiner is added to a source, this may trigger both CREATE and UPDATE provisioning operations.  Each usage type is considered a provisioning policy.  A source can have any number of these provisioning policies defined.  These are the common usage types:  CREATE - This usage type relates to 'Create Account Profile', the provisioning template for the account to be created. For example, this would be used for a joiner on a source.   UPDATE - This usage type relates to 'Update Account Profile', the provisioning template for the 'Update' connector operations. For example, this would be used for an attribute sync on a source. ENABLE - This usage type relates to 'Enable Account Profile', the provisioning template for the account to be enabled. For example, this could be used for a joiner on a source once the joiner's account is created.  DISABLE - This usage type relates to 'Disable Account Profile', the provisioning template for the account to be disabled. For example, this could be used when a leaver is removed temporarily from a source.  You can use these four usage types for all your provisioning policy needs.
    provisioningpolicydto = '''sailpoint.sources_v1.Provisioningpolicydto()''' # Provisioningpolicydto | 

    try:
        # Update provisioning policy by usagetype
        new_provisioningpolicydto = Provisioningpolicydto.from_json(provisioningpolicydto)
        results = SourcesV1Api(api_client).put_provisioning_policy_v1(source_id=source_id, usage_type=usage_type, provisioningpolicydto=new_provisioningpolicydto)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).put_provisioning_policy_v1(source_id, usage_type, new_provisioningpolicydto)
        print("The response of SourcesV1Api->put_provisioning_policy_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->put_provisioning_policy_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    id = '2c9180835d191a86015d28455b4a2329' # str | The source id # str | The source id
    attrsyncsourceconfig = '''sailpoint.sources_v1.Attrsyncsourceconfig()''' # Attrsyncsourceconfig | 
    x_sail_point_experimental = 'true' # str | Use this header to enable this experimental API. (optional) (default to 'true') # str | Use this header to enable this experimental API. (optional) (default to 'true')

    try:
        # Update attribute sync config
        new_attrsyncsourceconfig = Attrsyncsourceconfig.from_json(attrsyncsourceconfig)
        results = SourcesV1Api(api_client).put_source_attr_sync_config_v1(id=id, attrsyncsourceconfig=new_attrsyncsourceconfig)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).put_source_attr_sync_config_v1(id, new_attrsyncsourceconfig, x_sail_point_experimental)
        print("The response of SourcesV1Api->put_source_attr_sync_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->put_source_attr_sync_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Update source schema (full)
        new_model_schema = ModelSchema.from_json(model_schema)
        results = SourcesV1Api(api_client).put_source_schema_v1(source_id=source_id, schema_id=schema_id, model_schema=new_model_schema)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).put_source_schema_v1(source_id, schema_id, new_model_schema)
        print("The response of SourcesV1Api->put_source_schema_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->put_source_schema_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Update source (full)
        new_source = Source.from_json(source)
        results = SourcesV1Api(api_client).put_source_v1(id=id, source=new_source)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).put_source_v1(id, new_source)
        print("The response of SourcesV1Api->put_source_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->put_source_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    source_id = 'cef3ee201db947c5912551015ba0c679' # str | The ID of the Source # str | The ID of the Source
    resourceobjectsrequest = '''sailpoint.sources_v1.Resourceobjectsrequest()''' # Resourceobjectsrequest | 

    try:
        # Peek source connector's resource objects
        new_resourceobjectsrequest = Resourceobjectsrequest.from_json(resourceobjectsrequest)
        results = SourcesV1Api(api_client).search_resource_objects_v1(source_id=source_id, resourceobjectsrequest=new_resourceobjectsrequest)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).search_resource_objects_v1(source_id, new_resourceobjectsrequest)
        print("The response of SourcesV1Api->search_resource_objects_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->search_resource_objects_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).sync_attributes_for_source_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).sync_attributes_for_source_v1(id, x_sail_point_experimental)
        print("The response of SourcesV1Api->sync_attributes_for_source_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->sync_attributes_for_source_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).test_source_configuration_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).test_source_configuration_v1(source_id)
        print("The response of SourcesV1Api->test_source_configuration_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->test_source_configuration_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).test_source_connection_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).test_source_connection_v1(source_id)
        print("The response of SourcesV1Api->test_source_connection_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->test_source_connection_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    jsonpatchoperation = '''[sailpoint.sources_v1.Jsonpatchoperation()]''' # List[Jsonpatchoperation] | The JSONPatch payload used to update the object.

    try:
        # Human Account Deletion Approval Config
        new_jsonpatchoperation = Jsonpatchoperation.from_json(jsonpatchoperation)
        results = SourcesV1Api(api_client).update_account_deletion_approval_config_v1(source_id=source_id, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).update_account_deletion_approval_config_v1(source_id, new_jsonpatchoperation)
        print("The response of SourcesV1Api->update_account_deletion_approval_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->update_account_deletion_approval_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Machine Account Deletion Approval Config
        new_jsonpatchoperation = Jsonpatchoperation.from_json(jsonpatchoperation)
        results = SourcesV1Api(api_client).update_machine_account_deletion_approval_config_v1(source_id=source_id, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).update_machine_account_deletion_approval_config_v1(source_id, new_jsonpatchoperation)
        print("The response of SourcesV1Api->update_machine_account_deletion_approval_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->update_machine_account_deletion_approval_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    source_id = '8c190e6787aa4ed9a90bd9d5344523fb' # str | The Source id # str | The Source id
    passwordpolicyholdersdto_inner = '''[sailpoint.sources_v1.PasswordpolicyholdersdtoInner()]''' # List[PasswordpolicyholdersdtoInner] | 

    try:
        # Update password policy
        new_passwordpolicyholdersdto_inner = PasswordpolicyholdersdtoInner.from_json(passwordpolicyholdersdto_inner)
        results = SourcesV1Api(api_client).update_password_policy_holders_v1(source_id=source_id, passwordpolicyholdersdto_inner=new_passwordpolicyholdersdto_inner)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).update_password_policy_holders_v1(source_id, new_passwordpolicyholdersdto_inner)
        print("The response of SourcesV1Api->update_password_policy_holders_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->update_password_policy_holders_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    source_id = '2c9180835d191a86015d28455b4a2329' # str | The Source id. # str | The Source id.
    provisioningpolicydto = '''[sailpoint.sources_v1.Provisioningpolicydto()]''' # List[Provisioningpolicydto] | 

    try:
        # Bulk update provisioning policies
        new_provisioningpolicydto = Provisioningpolicydto.from_json(provisioningpolicydto)
        results = SourcesV1Api(api_client).update_provisioning_policies_in_bulk_v1(source_id=source_id, provisioningpolicydto=new_provisioningpolicydto)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).update_provisioning_policies_in_bulk_v1(source_id, new_provisioningpolicydto)
        print("The response of SourcesV1Api->update_provisioning_policies_in_bulk_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->update_provisioning_policies_in_bulk_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Partial update of provisioning policy
        new_jsonpatchoperation = Jsonpatchoperation.from_json(jsonpatchoperation)
        results = SourcesV1Api(api_client).update_provisioning_policy_v1(source_id=source_id, usage_type=usage_type, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).update_provisioning_policy_v1(source_id, usage_type, new_jsonpatchoperation)
        print("The response of SourcesV1Api->update_provisioning_policy_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->update_provisioning_policy_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourcesV1Api(api_client).update_source_entitlement_request_config_v1(id=id, sourceentitlementrequestconfig=new_sourceentitlementrequestconfig)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).update_source_entitlement_request_config_v1(id, new_sourceentitlementrequestconfig, x_sail_point_experimental)
        print("The response of SourcesV1Api->update_source_entitlement_request_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->update_source_entitlement_request_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Update source schedule (partial)
        new_jsonpatchoperation = Jsonpatchoperation.from_json(jsonpatchoperation)
        results = SourcesV1Api(api_client).update_source_schedule_v1(source_id=source_id, schedule_type=schedule_type, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).update_source_schedule_v1(source_id, schedule_type, new_jsonpatchoperation)
        print("The response of SourcesV1Api->update_source_schedule_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->update_source_schedule_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Update source schema (partial)
        new_jsonpatchoperation = Jsonpatchoperation.from_json(jsonpatchoperation)
        results = SourcesV1Api(api_client).update_source_schema_v1(source_id=source_id, schema_id=schema_id, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).update_source_schema_v1(source_id, schema_id, new_jsonpatchoperation)
        print("The response of SourcesV1Api->update_source_schema_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->update_source_schema_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Update source (partial)
        new_jsonpatchoperation = Jsonpatchoperation.from_json(jsonpatchoperation)
        results = SourcesV1Api(api_client).update_source_v1(id=id, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = SourcesV1Api(api_client).update_source_v1(id, new_jsonpatchoperation)
        print("The response of SourcesV1Api->update_source_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourcesV1Api->update_source_v1: %s\n" % e)
```
