...
class DeleteSourceV1202Response(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['TASK_RESULT']):
            warnings.warn(f"must be one of enum values ('TASK_RESULT') unknown value: {value}")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteSourceV1202Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteSourceV1202Response from a dict"""
        if obj is None:
            return None
