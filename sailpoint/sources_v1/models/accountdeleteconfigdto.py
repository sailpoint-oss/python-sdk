...
class Accountdeleteconfigdto(BaseModel):
    """
    detailed information about account delete approval config
    """ # noqa: E501
    approval_required: Optional[StrictBool] = Field(default=False, description="Specifies if an account deletion request requires approval.", alias="approvalRequired")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Accountdeleteconfigdto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Accountdeleteconfigdto from a dict"""
        if obj is None:
            return None
