...
class ModelSchema(BaseModel):
    ...
    include_permissions: Optional[StrictBool] = Field(default=False, description="Flag indicating whether or not the include permissions with the object data when aggregating the schema.", alias="includePermissions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "includePermissions": obj.get("includePermissions") if obj.get("includePermissions") is not None else False,
