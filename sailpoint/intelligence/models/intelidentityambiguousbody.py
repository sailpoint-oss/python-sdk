...
class Intelidentityambiguousbody(BaseModel):
    ...
    candidates: List[Intelidentityambiguouscandidate] = Field(description="Identities that matched the ambiguous filter expression.")
    __properties: ClassVar[List[str]] = ["detailCode", "trackingId", "messages", "causes", "candidates"]
