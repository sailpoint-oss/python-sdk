...
class Intelprivilegelevel(BaseModel):
    """
    ...
    """ # noqa: E501
    effective: Optional[StrictStr] = Field(default=None, description="Effective privilege level for the privileged access item. ")
    ...
    def effective_validate_enum(cls, value):
        ...
        if value not in set(['HIGH', 'MEDIUM', 'LOW', 'NONE']):
            warnings.warn(f"must be one of enum values ('HIGH', 'MEDIUM', 'LOW', 'NONE') unknown value: {value}")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Intelprivilegelevel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Intelprivilegelevel from a dict"""
        if obj is None:
            return None
