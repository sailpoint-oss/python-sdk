...
class TestIntelrareaccessslice(unittest.TestCase):
    """Intelrareaccessslice unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Intelrareaccessslice:
        """Test Intelrareaccessslice
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Intelrareaccessslice`
        """
        model = Intelrareaccessslice()
        if include_optional:
    ...
    def testIntelrareaccessslice(self):
        """Test Intelrareaccessslice"""
