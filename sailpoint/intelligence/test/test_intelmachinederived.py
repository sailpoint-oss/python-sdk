...
class TestIntelmachinederived(unittest.TestCase):
    """Intelmachinederived unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Intelmachinederived:
        """Test Intelmachinederived
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Intelmachinederived`
        """
        model = Intelmachinederived()
        if include_optional:
            return Intelmachinederived(
                is_orphaned = False,
    ...
    def testIntelmachinederived(self):
        """Test Intelmachinederived"""
