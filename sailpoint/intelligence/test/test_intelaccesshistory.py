...
class TestIntelaccesshistory(unittest.TestCase):
    """Intelaccesshistory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Intelaccesshistory:
        """Test Intelaccesshistory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Intelaccesshistory`
        """
        model = Intelaccesshistory()
        if include_optional:
            return Intelaccesshistory(
    ...
    def testIntelaccesshistory(self):
        """Test Intelaccesshistory"""
