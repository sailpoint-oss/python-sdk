...
from sailpoint.intelligence.api_response import ApiResponse, T as ApiResponseT
import sailpoint.intelligence.models
from sailpoint.intelligence import rest
from sailpoint.intelligence.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.intelligence.models, klass)
