...
class AccountToggleRequest(BaseModel):
    ...
    force_provisioning: Optional[StrictBool] = Field(default=None, description="If set, provisioning updates the account attribute at the source.   This option is used when the account is not synced to ensure the attribute is updated. Providing 'true' for an unlocked account will add and process 'Unlock' operation by the workflow.", alias="forceProvisioning")
    __properties: ClassVar[List[str]] = ["externalVerificationId", "forceProvisioning"]
