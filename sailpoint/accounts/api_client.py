...
from sailpoint.accounts.api_response import ApiResponse, T as ApiResponseT
import sailpoint.accounts.models
from sailpoint.accounts import rest
from sailpoint.accounts.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.accounts.models, klass)
