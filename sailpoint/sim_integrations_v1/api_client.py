...
from sailpoint.sim_integrations_v1.api_response import ApiResponse, T as ApiResponseT
import sailpoint.sim_integrations_v1.models
from sailpoint.sim_integrations_v1 import rest
from sailpoint.sim_integrations_v1.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.sim_integrations_v1.models, klass)
