...
from sailpoint.sim_integrations_v1.api_client import ApiClient, RequestSerialized
from sailpoint.sim_integrations_v1.api_response import ApiResponse
from sailpoint.sim_integrations_v1.rest import RESTResponseType
...
class SIMIntegrationsV1Api:
    ...
    def _create_sim_integration_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/sim-integrations/v1',
    ...
    def delete_sim_integration_v1(
        ...
        _param = self._delete_sim_integration_v1_serialize(
            id=id,
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_sim_integration_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The id of the integration to delete.")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def delete_sim_integration_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The id of the integration to delete.")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    def _delete_sim_integration_v1_serialize(
        self,
        id,
        x_sail_point_experimental,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/sim-integrations/v1/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_sim_integration_v1(
        ...
        _param = self._get_sim_integration_v1_serialize(
            id=id,
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_sim_integration_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The id of the integration.")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_sim_integration_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The id of the integration.")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    def _get_sim_integration_v1_serialize(
        self,
        id,
        x_sail_point_experimental,
        _request_auth,
    ...
    def get_sim_integrations_v1(
        ...
        _param = self._get_sim_integrations_v1_serialize(
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_sim_integrations_v1_with_http_info(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_sim_integrations_v1_without_preload_content(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_sim_integrations_v1_serialize(
        self,
        x_sail_point_experimental,
        _request_auth,
        _content_type,
    ...
    def _patch_before_provisioning_rule_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/sim-integrations/v1/{id}/beforeProvisioningRule',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
