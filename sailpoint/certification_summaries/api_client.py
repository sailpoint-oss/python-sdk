...
from sailpoint.certification_summaries.api_response import ApiResponse, T as ApiResponseT
import sailpoint.certification_summaries.models
from sailpoint.certification_summaries import rest
from sailpoint.certification_summaries.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.certification_summaries.models, klass)
