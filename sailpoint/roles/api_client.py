...
from sailpoint.roles.api_response import ApiResponse, T as ApiResponseT
import sailpoint.roles.models
from sailpoint.roles import rest
from sailpoint.roles.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.roles.models, klass)
