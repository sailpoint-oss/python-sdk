...
from sailpoint.roles_v1.api_client import ApiClient, RequestSerialized
from sailpoint.roles_v1.api_response import ApiResponse
from sailpoint.roles_v1.rest import RESTResponseType
...
class RolesV1Api:
    ...
    def _delete_bulk_roles_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/roles/v1/bulk-delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def delete_metadata_from_role_by_key_and_value_v1(
        self,
        ...
        _param = self._delete_metadata_from_role_by_key_and_value_v1_serialize(
            id=id,
    ...
    @validate_call
    def delete_metadata_from_role_by_key_and_value_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The role's id.")],
        attribute_key: Annotated[StrictStr, Field(description="Technical name of the Attribute.")],
        attribute_value: Annotated[StrictStr, Field(description="Technical name of the Attribute Value.")],
    ...
    @validate_call
    def delete_metadata_from_role_by_key_and_value_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The role's id.")],
        attribute_key: Annotated[StrictStr, Field(description="Technical name of the Attribute.")],
        attribute_value: Annotated[StrictStr, Field(description="Technical name of the Attribute Value.")],
    ...
    def _delete_metadata_from_role_by_key_and_value_v1_serialize(
        self,
        id,
        attribute_key,
        attribute_value,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/roles/v1/{id}/access-model-metadata/{attributeKey}/values/{attributeValue}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_role_v1(
        ...
        _param = self._delete_role_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_role_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the Role")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_role_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the Role")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_bulk_update_status_by_id_v1(
        self,
        ...
        _param = self._get_bulk_update_status_by_id_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_bulk_update_status_by_id_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The Id of the bulk update task.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_bulk_update_status_by_id_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The Id of the bulk update task.")],
        _request_timeout: Union[
            None,
    ...
    def _get_bulk_update_status_by_id_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/roles/v1/access-model-metadata/bulk-update/id',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_bulk_update_status_v1(
        ...
        _param = self._get_bulk_update_status_v1_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_bulk_update_status_v1_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_bulk_update_status_v1_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_bulk_update_status_v1_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/roles/v1/access-model-metadata/bulk-update',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_role_assigned_identities_v1(
        self,
        ...
        _param = self._get_role_assigned_identities_v1_serialize(
            id=id,
            limit=limit,
            offset=offset,
            count=count,
    ...
    @validate_call
    def get_role_assigned_identities_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the Role for which the assigned Identities are to be listed")],
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def get_role_assigned_identities_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the Role for which the assigned Identities are to be listed")],
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _get_role_assigned_identities_v1_serialize(
        self,
        id,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/roles/v1/{id}/assigned-identities',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_role_entitlements_v1(
        self,
        id: Annotated[StrictStr, Field(description="Containing role's ID.")],
        ...
        :param id: Containing role's ID. (required)
        :type id: str
        ...
        _param = self._get_role_entitlements_v1_serialize(
            id=id,
            limit=limit,
            offset=offset,
            count=count,
    ...
    @validate_call
    def get_role_entitlements_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Containing role's ID.")],
        limit: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=0)]], Field(description="Note that for this API the maximum value for limit is 50. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def get_role_entitlements_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Containing role's ID.")],
        limit: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=0)]], Field(description="Note that for this API the maximum value for limit is 50. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _get_role_entitlements_v1_serialize(
        self,
        id,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/roles/v1/{id}/entitlements',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_role_v1(
        ...
        _param = self._get_role_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_role_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="ID of the Role")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_role_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="ID of the Role")],
        _request_timeout: Union[
            None,
    ...
    def list_roles_v1(
        ...
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **id**: *eq, in*  **name**: *eq, sw*  **created**: *gt, ge, le*  **modified**: *lt, ge, le*  **owner.id**: *eq, in*  **requestable**: *eq*  **dimensional**: *eq*")] = None,
        ...
        _param = self._list_roles_v1_serialize(
    ...
    @validate_call
    def list_roles_v1_with_http_info(
        self,
        for_subadmin: Annotated[Optional[StrictStr], Field(description="If provided, filters the returned list according to what is visible to the indicated ROLE_SUBADMIN Identity. The value of the parameter is either an Identity ID, or the special value **me**, which is shorthand for the calling Identity's ID. A 400 Bad Request error is returned if the **for-subadmin** parameter is specified for an Identity that is not a subadmin.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=0)]], Field(description="Note that for this API the maximum value for limit is 50. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def list_roles_v1_without_preload_content(
        self,
        for_subadmin: Annotated[Optional[StrictStr], Field(description="If provided, filters the returned list according to what is visible to the indicated ROLE_SUBADMIN Identity. The value of the parameter is either an Identity ID, or the special value **me**, which is shorthand for the calling Identity's ID. A 400 Bad Request error is returned if the **for-subadmin** parameter is specified for an Identity that is not a subadmin.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=0)]], Field(description="Note that for this API the maximum value for limit is 50. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def search_roles_by_filter_v1(
        self,
        for_subadmin: Annotated[Optional[StrictStr], Field(description="If provided, filters the returned list according to what is visible to the indicated ROLE_SUBADMIN Identity. The value of the parameter is either an Identity ID, or the special value **me**, which is shorthand for the calling Identity's ID. A 400 Bad Request error is returned if the **for-subadmin** parameter is specified for an Identity that is not a subadmin.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        count: Annotated[Optional[StrictBool], Field(description="Boolean indicating whether a total count is returned, factoring in any filter parameters, in the X-Total-Count response header. The value is the total size of the collection that would be returned if limit and offset were ignored.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **name, created, modified**")] = None,
        for_segment_ids: Annotated[Optional[StrictStr], Field(description="If present and not empty, additionally filters Roles to those which are assigned to the Segment(s) with the specified IDs. If segmentation is currently unavailable, specifying this parameter results in an error.")] = None,
        include_unsegmented: Annotated[Optional[StrictBool], Field(description="Whether or not the response list should contain unsegmented Roles. If *for-segment-ids* is absent or empty, specifying *include-unsegmented* as false results in an error.")] = None,
        ...
        :param offset: Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.
        :type offset: int
        :param count: Boolean indicating whether a total count is returned, factoring in any filter parameters, in the X-Total-Count response header. The value is the total size of the collection that would be returned if limit and offset were ignored.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.
        :type count: bool
        :param sorters: Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **name, created, modified**
        :type sorters: str
        :param for_segment_ids: If present and not empty, additionally filters Roles to those which are assigned to the Segment(s) with the specified IDs. If segmentation is currently unavailable, specifying this parameter results in an error.
        ...
        _param = self._search_roles_by_filter_v1_serialize(
            for_subadmin=for_subadmin,
            limit=limit,
            offset=offset,
            count=count,
    ...
    @validate_call
    def search_roles_by_filter_v1_with_http_info(
        self,
        for_subadmin: Annotated[Optional[StrictStr], Field(description="If provided, filters the returned list according to what is visible to the indicated ROLE_SUBADMIN Identity. The value of the parameter is either an Identity ID, or the special value **me**, which is shorthand for the calling Identity's ID. A 400 Bad Request error is returned if the **for-subadmin** parameter is specified for an Identity that is not a subadmin.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def search_roles_by_filter_v1_without_preload_content(
        self,
        for_subadmin: Annotated[Optional[StrictStr], Field(description="If provided, filters the returned list according to what is visible to the indicated ROLE_SUBADMIN Identity. The value of the parameter is either an Identity ID, or the special value **me**, which is shorthand for the calling Identity's ID. A 400 Bad Request error is returned if the **for-subadmin** parameter is specified for an Identity that is not a subadmin.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _search_roles_by_filter_v1_serialize(
        self,
        for_subadmin,
        limit,
        offset,
    ...
    @validate_call
    def update_attribute_key_and_value_to_role_v1(
        self,
        ...
        _param = self._update_attribute_key_and_value_to_role_v1_serialize(
            id=id,
            attribute_key=attribute_key,
            attribute_value=attribute_value,
            _request_auth=_request_auth,
    ...
    @validate_call
    def update_attribute_key_and_value_to_role_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The Id of a role")],
        attribute_key: Annotated[StrictStr, Field(description="Technical name of the Attribute.")],
        attribute_value: Annotated[StrictStr, Field(description="Technical name of the Attribute Value.")],
    ...
    @validate_call
    def update_attribute_key_and_value_to_role_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The Id of a role")],
        attribute_key: Annotated[StrictStr, Field(description="Technical name of the Attribute.")],
        attribute_value: Annotated[StrictStr, Field(description="Technical name of the Attribute Value.")],
    ...
    def _update_attribute_key_and_value_to_role_v1_serialize(
        self,
        id,
        attribute_key,
        attribute_value,
    ...
    def _update_roles_metadata_by_filter_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/roles/v1/access-model-metadata/bulk-update/filter',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _update_roles_metadata_by_ids_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/roles/v1/access-model-metadata/bulk-update/ids',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _update_roles_metadata_by_query_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/roles/v1/access-model-metadata/bulk-update/query',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
