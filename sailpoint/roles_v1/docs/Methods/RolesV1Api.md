...
slug: /tools/sdk/python/v1/methods/roles
tags: ['SDK', 'Software Development Kit', 'Roles', 'Roles']
---

# sailpoint.roles_v1.RolesV1Api
...
from sailpoint.roles_v1.api_client import ApiClient
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = RolesV1Api(api_client).create_role_v1(role=new_role)
        # Below is a request that includes all optional parameters
        # results = RolesV1Api(api_client).create_role_v1(new_role)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = RolesV1Api(api_client).delete_bulk_roles_v1(rolebulkdeleterequest=new_rolebulkdeleterequest)
        # Below is a request that includes all optional parameters
        # results = RolesV1Api(api_client).delete_bulk_roles_v1(new_rolebulkdeleterequest)
        print("The response of RolesV1Api->delete_bulk_roles_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling RolesV1Api->delete_bulk_roles_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        RolesV1Api(api_client).delete_metadata_from_role_by_key_and_value_v1(id=id, attribute_key=attribute_key, attribute_value=attribute_value)
        # Below is a request that includes all optional parameters
        # RolesV1Api(api_client).delete_metadata_from_role_by_key_and_value_v1(id, attribute_key, attribute_value)
    except Exception as e:
        print("Exception when calling RolesV1Api->delete_metadata_from_role_by_key_and_value_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        RolesV1Api(api_client).delete_role_v1(id=id)
        # Below is a request that includes all optional parameters
        # RolesV1Api(api_client).delete_role_v1(id)
    except Exception as e:
        print("Exception when calling RolesV1Api->delete_role_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = RolesV1Api(api_client).get_bulk_update_status_by_id_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = RolesV1Api(api_client).get_bulk_update_status_by_id_v1(id)
        print("The response of RolesV1Api->get_bulk_update_status_by_id_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling RolesV1Api->get_bulk_update_status_by_id_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = RolesV1Api(api_client).get_bulk_update_status_v1()
        # Below is a request that includes all optional parameters
        # results = RolesV1Api(api_client).get_bulk_update_status_v1()
        print("The response of RolesV1Api->get_bulk_update_status_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling RolesV1Api->get_bulk_update_status_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = RolesV1Api(api_client).get_role_assigned_identities_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = RolesV1Api(api_client).get_role_assigned_identities_v1(id, limit, offset, count, filters, sorters)
        print("The response of RolesV1Api->get_role_assigned_identities_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling RolesV1Api->get_role_assigned_identities_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = RolesV1Api(api_client).get_role_entitlements_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = RolesV1Api(api_client).get_role_entitlements_v1(id, limit, offset, count, filters, sorters, x_sail_point_experimental)
        print("The response of RolesV1Api->get_role_entitlements_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling RolesV1Api->get_role_entitlements_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = RolesV1Api(api_client).get_role_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = RolesV1Api(api_client).get_role_v1(id)
        print("The response of RolesV1Api->get_role_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling RolesV1Api->get_role_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = RolesV1Api(api_client).list_roles_v1()
        # Below is a request that includes all optional parameters
        # results = RolesV1Api(api_client).list_roles_v1(for_subadmin, limit, offset, count, filters, sorters, for_segment_ids, include_unsegmented)
        print("The response of RolesV1Api->list_roles_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling RolesV1Api->list_roles_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = RolesV1Api(api_client).patch_role_v1(id=id, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = RolesV1Api(api_client).patch_role_v1(id, new_jsonpatchoperation)
        print("The response of RolesV1Api->patch_role_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling RolesV1Api->patch_role_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = RolesV1Api(api_client).search_roles_by_filter_v1()
        # Below is a request that includes all optional parameters
        # results = RolesV1Api(api_client).search_roles_by_filter_v1(for_subadmin, limit, offset, count, sorters, for_segment_ids, include_unsegmented, new_rolelistfilterdto)
        print("The response of RolesV1Api->search_roles_by_filter_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling RolesV1Api->search_roles_by_filter_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = RolesV1Api(api_client).update_attribute_key_and_value_to_role_v1(id=id, attribute_key=attribute_key, attribute_value=attribute_value)
        # Below is a request that includes all optional parameters
        # results = RolesV1Api(api_client).update_attribute_key_and_value_to_role_v1(id, attribute_key, attribute_value)
        print("The response of RolesV1Api->update_attribute_key_and_value_to_role_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling RolesV1Api->update_attribute_key_and_value_to_role_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = RolesV1Api(api_client).update_roles_metadata_by_filter_v1(rolemetadatabulkupdatebyfilterrequest=new_rolemetadatabulkupdatebyfilterrequest)
        # Below is a request that includes all optional parameters
        # results = RolesV1Api(api_client).update_roles_metadata_by_filter_v1(new_rolemetadatabulkupdatebyfilterrequest)
        print("The response of RolesV1Api->update_roles_metadata_by_filter_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling RolesV1Api->update_roles_metadata_by_filter_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    rolemetadatabulkupdatebyidrequest = '''sailpoint.roles_v1.Rolemetadatabulkupdatebyidrequest()''' # Rolemetadatabulkupdatebyidrequest | 

    try:
        # Bulk-update roles' metadata by id
        new_rolemetadatabulkupdatebyidrequest = Rolemetadatabulkupdatebyidrequest.from_json(rolemetadatabulkupdatebyidrequest)
        results = RolesV1Api(api_client).update_roles_metadata_by_ids_v1(rolemetadatabulkupdatebyidrequest=new_rolemetadatabulkupdatebyidrequest)
        # Below is a request that includes all optional parameters
        # results = RolesV1Api(api_client).update_roles_metadata_by_ids_v1(new_rolemetadatabulkupdatebyidrequest)
        print("The response of RolesV1Api->update_roles_metadata_by_ids_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling RolesV1Api->update_roles_metadata_by_ids_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = RolesV1Api(api_client).update_roles_metadata_by_query_v1(rolemetadatabulkupdatebyqueryrequest=new_rolemetadatabulkupdatebyqueryrequest)
        # Below is a request that includes all optional parameters
        # results = RolesV1Api(api_client).update_roles_metadata_by_query_v1(new_rolemetadatabulkupdatebyqueryrequest)
        print("The response of RolesV1Api->update_roles_metadata_by_query_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling RolesV1Api->update_roles_metadata_by_query_v1: %s\n" % e)
```
