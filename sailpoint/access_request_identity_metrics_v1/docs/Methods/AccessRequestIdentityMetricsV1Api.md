...
slug: /tools/sdk/python/v1/methods/access-request-identity-metrics
tags: ['SDK', 'Software Development Kit', 'Access_Request_Identity_Metrics', 'Access_Request_Identity_Metrics']
---

# sailpoint.access_request_identity_metrics_v1.AccessRequestIdentityMetricsV1Api
...
from sailpoint.access_request_identity_metrics_v1.api_client import ApiClient
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AccessRequestIdentityMetricsV1Api(api_client).get_access_request_identity_metrics_v1(identity_id=identity_id, requested_object_id=requested_object_id, type=type)
        # Below is a request that includes all optional parameters
        # results = AccessRequestIdentityMetricsV1Api(api_client).get_access_request_identity_metrics_v1(identity_id, requested_object_id, type)
