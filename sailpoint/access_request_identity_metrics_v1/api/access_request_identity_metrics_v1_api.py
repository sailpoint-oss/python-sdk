...
from sailpoint.access_request_identity_metrics_v1.api_client import ApiClient, RequestSerialized
from sailpoint.access_request_identity_metrics_v1.api_response import ApiResponse
from sailpoint.access_request_identity_metrics_v1.rest import RESTResponseType
...
class AccessRequestIdentityMetricsV1Api:
    ...
    @validate_call
    def get_access_request_identity_metrics_v1(
        self,
        ...
        _param = self._get_access_request_identity_metrics_v1_serialize(
    ...
    @validate_call
    def get_access_request_identity_metrics_v1_with_http_info(
        self,
        identity_id: Annotated[StrictStr, Field(description="Manager's identity ID.")],
        requested_object_id: Annotated[StrictStr, Field(description="Requested access item's ID.")],
        type: Annotated[StrictStr, Field(description="Requested access item's type.")],
    ...
    @validate_call
    def get_access_request_identity_metrics_v1_without_preload_content(
        self,
        identity_id: Annotated[StrictStr, Field(description="Manager's identity ID.")],
        requested_object_id: Annotated[StrictStr, Field(description="Requested access item's ID.")],
        type: Annotated[StrictStr, Field(description="Requested access item's type.")],
    ...
    def _get_access_request_identity_metrics_v1_serialize(
        self,
        identity_id,
        requested_object_id,
        type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/access-request-identity-metrics/v1/{identityId}/requested-objects/{requestedObjectId}/type/{type}',
