...
slug: /tools/sdk/python/v1/methods/o-auth-clients
tags: ['SDK', 'Software Development Kit', 'OAuth_Clients', 'OAuth_Clients']
---

# sailpoint.oauth_clients_v1.OAuthClientsV1Api
...
from sailpoint.oauth_clients_v1.api_client import ApiClient
from sailpoint.oauth_clients_v1.models.createoauthclientrequest import Createoauthclientrequest
from sailpoint.oauth_clients_v1.models.createoauthclientresponse import Createoauthclientresponse
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = OAuthClientsV1Api(api_client).create_oauth_client_v1(createoauthclientrequest=new_createoauthclientrequest)
        # Below is a request that includes all optional parameters
        # results = OAuthClientsV1Api(api_client).create_oauth_client_v1(new_createoauthclientrequest)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        OAuthClientsV1Api(api_client).delete_oauth_client_v1(id=id)
        # Below is a request that includes all optional parameters
        # OAuthClientsV1Api(api_client).delete_oauth_client_v1(id)
    except Exception as e:
        print("Exception when calling OAuthClientsV1Api->delete_oauth_client_v1: %s\n" % e)
```
...
from sailpoint.oauth_clients_v1.api.o_auth_clients_v1_api import OAuthClientsV1Api
from sailpoint.oauth_clients_v1.api_client import ApiClient
from sailpoint.oauth_clients_v1.models.getoauthclientresponse import Getoauthclientresponse
from sailpoint.configuration import Configuration
configuration = Configuration()
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = OAuthClientsV1Api(api_client).get_oauth_client_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = OAuthClientsV1Api(api_client).get_oauth_client_v1(id)
        print("The response of OAuthClientsV1Api->get_oauth_client_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling OAuthClientsV1Api->get_oauth_client_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = OAuthClientsV1Api(api_client).list_oauth_clients_v1()
        # Below is a request that includes all optional parameters
        # results = OAuthClientsV1Api(api_client).list_oauth_clients_v1(filters)
        print("The response of OAuthClientsV1Api->list_oauth_clients_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling OAuthClientsV1Api->list_oauth_clients_v1: %s\n" % e)
```
...
from sailpoint.oauth_clients_v1.api_client import ApiClient
from sailpoint.oauth_clients_v1.models.getoauthclientresponse import Getoauthclientresponse
from sailpoint.oauth_clients_v1.models.jsonpatchoperation import Jsonpatchoperation
from sailpoint.configuration import Configuration
configuration = Configuration()
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = OAuthClientsV1Api(api_client).patch_oauth_client_v1(id=id, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = OAuthClientsV1Api(api_client).patch_oauth_client_v1(id, new_jsonpatchoperation)
        print("The response of OAuthClientsV1Api->patch_oauth_client_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling OAuthClientsV1Api->patch_oauth_client_v1: %s\n" % e)
```
