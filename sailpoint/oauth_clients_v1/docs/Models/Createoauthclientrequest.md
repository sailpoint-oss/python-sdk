---
id: createoauthclientrequest
title: Createoauthclientrequest
pagination_label: Createoauthclientrequest
sidebar_label: Createoauthclientrequest
sidebar_class_name: pythonsdk
keywords: ['python', 'Python', 'sdk', 'Createoauthclientrequest', 'Createoauthclientrequest'] 
slug: /tools/sdk/python/v1/models/createoauthclientrequest
...
**grant_types** | [**[]Granttype**](granttype) | A list of OAuth 2.0 grant types this API Client can be used with | [required]
**access_type** | [**Accesstype**](accesstype) |  | [required]
**type** | [**Clienttype**](clienttype) |  | [optional] 
