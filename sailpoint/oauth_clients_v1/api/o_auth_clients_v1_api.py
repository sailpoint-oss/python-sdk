...
from sailpoint.oauth_clients_v1.api_client import ApiClient, RequestSerialized
from sailpoint.oauth_clients_v1.api_response import ApiResponse
from sailpoint.oauth_clients_v1.rest import RESTResponseType
...
class OAuthClientsV1Api:
    ...
    def _create_oauth_client_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/oauth-clients/v1',
    ...
    def delete_oauth_client_v1(
        ...
        _param = self._delete_oauth_client_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_oauth_client_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The OAuth client id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_oauth_client_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The OAuth client id")],
        _request_timeout: Union[
            None,
    ...
    def _delete_oauth_client_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/oauth-clients/v1/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_oauth_client_v1(
        ...
        _param = self._get_oauth_client_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_oauth_client_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The OAuth client id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_oauth_client_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The OAuth client id")],
        _request_timeout: Union[
            None,
    ...
    def _get_oauth_client_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_oauth_clients_v1(
        ...
        _param = self._list_oauth_clients_v1_serialize(
            filters=filters,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def list_oauth_clients_v1_with_http_info(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **lastUsed**: *le, isnull*")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def list_oauth_clients_v1_without_preload_content(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **lastUsed**: *le, isnull*")] = None,
        _request_timeout: Union[
            None,
    ...
    def _list_oauth_clients_v1_serialize(
        self,
        filters,
        _request_auth,
        _content_type,
