...
from sailpoint.password_policies.api_response import ApiResponse, T as ApiResponseT
import sailpoint.password_policies.models
from sailpoint.password_policies import rest
from sailpoint.password_policies.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.password_policies.models, klass)
