...
slug: /tools/sdk/python/v1/methods/machine-identities
tags: ['SDK', 'Software Development Kit', 'Machine_Identities', 'Machine_Identities']
---

# sailpoint.machine_identities_v1.MachineIdentitiesV1Api
...
from sailpoint.machine_identities_v1.api_client import ApiClient
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = MachineIdentitiesV1Api(api_client).create_machine_identity_v1(machineidentityrequest=new_machineidentityrequest)
        # Below is a request that includes all optional parameters
        # results = MachineIdentitiesV1Api(api_client).create_machine_identity_v1(new_machineidentityrequest, x_sail_point_experimental)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        MachineIdentitiesV1Api(api_client).delete_machine_identity_v1(id=id)
        # Below is a request that includes all optional parameters
        # MachineIdentitiesV1Api(api_client).delete_machine_identity_v1(id, x_sail_point_experimental)
    except Exception as e:
        print("Exception when calling MachineIdentitiesV1Api->delete_machine_identity_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = MachineIdentitiesV1Api(api_client).get_machine_identity_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = MachineIdentitiesV1Api(api_client).get_machine_identity_v1(id, x_sail_point_experimental)
        print("The response of MachineIdentitiesV1Api->get_machine_identity_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling MachineIdentitiesV1Api->get_machine_identity_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = MachineIdentitiesV1Api(api_client).list_machine_identities_v1()
        # Below is a request that includes all optional parameters
        # results = MachineIdentitiesV1Api(api_client).list_machine_identities_v1(filters, sorters, x_sail_point_experimental, count, limit, offset)
        print("The response of MachineIdentitiesV1Api->list_machine_identities_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling MachineIdentitiesV1Api->list_machine_identities_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = MachineIdentitiesV1Api(api_client).list_machine_identity_user_entitlements_v1()
        # Below is a request that includes all optional parameters
        # results = MachineIdentitiesV1Api(api_client).list_machine_identity_user_entitlements_v1(filters, sorters, x_sail_point_experimental, count, limit, offset)
        print("The response of MachineIdentitiesV1Api->list_machine_identity_user_entitlements_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling MachineIdentitiesV1Api->list_machine_identity_user_entitlements_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    machineidentityaggregationrequest = '''sailpoint.machine_identities_v1.Machineidentityaggregationrequest()''' # Machineidentityaggregationrequest | 
    x_sail_point_experimental = 'true' # str | Use this header to enable this experimental API. (optional) (default to 'true') # str | Use this header to enable this experimental API. (optional) (default to 'true')

    try:
        # Start machine identity aggregation
        new_machineidentityaggregationrequest = Machineidentityaggregationrequest.from_json(machineidentityaggregationrequest)
        results = MachineIdentitiesV1Api(api_client).start_machine_identity_aggregation_v1(source_id=source_id, machineidentityaggregationrequest=new_machineidentityaggregationrequest)
        # Below is a request that includes all optional parameters
        # results = MachineIdentitiesV1Api(api_client).start_machine_identity_aggregation_v1(source_id, new_machineidentityaggregationrequest, x_sail_point_experimental)
        print("The response of MachineIdentitiesV1Api->start_machine_identity_aggregation_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling MachineIdentitiesV1Api->start_machine_identity_aggregation_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = MachineIdentitiesV1Api(api_client).update_machine_identity_v1(id=id, request_body=new_request_body)
        # Below is a request that includes all optional parameters
        # results = MachineIdentitiesV1Api(api_client).update_machine_identity_v1(id, new_request_body, x_sail_point_experimental)
        print("The response of MachineIdentitiesV1Api->update_machine_identity_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling MachineIdentitiesV1Api->update_machine_identity_v1: %s\n" % e)
```
