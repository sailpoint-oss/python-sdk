...
slug: /tools/sdk/python/v1/methods/segments
tags: ['SDK', 'Software Development Kit', 'Segments', 'Segments']
---

# sailpoint.segments_v1.SegmentsV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SegmentsV1Api(api_client).create_segment_v1(segment=new_segment)
        # Below is a request that includes all optional parameters
        # results = SegmentsV1Api(api_client).create_segment_v1(new_segment)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        SegmentsV1Api(api_client).delete_segment_v1(id=id)
        # Below is a request that includes all optional parameters
        # SegmentsV1Api(api_client).delete_segment_v1(id)
    except Exception as e:
        print("Exception when calling SegmentsV1Api->delete_segment_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SegmentsV1Api(api_client).get_segment_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SegmentsV1Api(api_client).get_segment_v1(id)
        print("The response of SegmentsV1Api->get_segment_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SegmentsV1Api->get_segment_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SegmentsV1Api(api_client).list_segments_v1()
        # Below is a request that includes all optional parameters
        # results = SegmentsV1Api(api_client).list_segments_v1(limit, offset, count)
        print("The response of SegmentsV1Api->list_segments_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SegmentsV1Api->list_segments_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SegmentsV1Api(api_client).patch_segment_v1(id=id, request_body=new_request_body)
        # Below is a request that includes all optional parameters
        # results = SegmentsV1Api(api_client).patch_segment_v1(id, new_request_body)
        print("The response of SegmentsV1Api->patch_segment_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SegmentsV1Api->patch_segment_v1: %s\n" % e)
```
