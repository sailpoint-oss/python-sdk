...
from sailpoint.connector_customizers.api_response import ApiResponse, T as ApiResponseT
import sailpoint.connector_customizers.models
from sailpoint.connector_customizers import rest
from sailpoint.connector_customizers.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.connector_customizers.models, klass)
