...
keywords: ['python', 'Python', 'sdk', 'Roleminingsessionresponse', 'Roleminingsessionresponse'] 
slug: /tools/sdk/python/v1/models/roleminingsessionresponse
...
status=sailpoint.iai_role_mining_v1.models.role_mining_session_status.Role Mining Session Status(
                    state = 'CREATED', ),
email_recipient_id='',
created_by=,
identity_count=39,
