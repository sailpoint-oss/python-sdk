...
class Jsonpatchoperationrolemining(BaseModel):
    """
    ...
    value: Optional[JsonpatchoperationroleminingValue] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Jsonpatchoperationrolemining from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Jsonpatchoperationrolemining from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "op": obj.get("op"),
            "path": obj.get("path"),
            "value": JsonpatchoperationroleminingValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
