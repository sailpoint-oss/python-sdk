...
class TestEntitlementrequestconfig(unittest.TestCase):
    """Entitlementrequestconfigv1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Entitlementrequestconfigv1:
        """Test Entitlementrequestconfigv1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Entitlementrequestconfigv1`
        """
        model = Entitlementrequestconfigv1()
        if include_optional:
            return Entitlementrequestconfigv1(
