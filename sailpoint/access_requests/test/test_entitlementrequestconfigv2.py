...
class TestEntitlementrequestconfigv2(unittest.TestCase):
    """Entitlementrequestconfigv2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Entitlementrequestconfigv2:
        """Test Entitlementrequestconfigv2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Entitlementrequestconfigv2`
        """
        model = Entitlementrequestconfigv2()
        if include_optional:
            return Entitlementrequestconfigv2(
    ...
    def testEntitlementrequestconfigv2(self):
        """Test Entitlementrequestconfigv2"""
