...
class TestAccessrequestconfigv2(unittest.TestCase):
    """Accessrequestconfigv2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Accessrequestconfigv2:
        """Test Accessrequestconfigv2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Accessrequestconfigv2`
        """
        model = Accessrequestconfigv2()
        if include_optional:
    ...
    def testAccessrequestconfigv2(self):
        """Test Accessrequestconfigv2"""
