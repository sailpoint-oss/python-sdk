...
class TestEntitlementRequestConfig2(unittest.TestCase):
    """EntitlementRequestConfig2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntitlementRequestConfig2:
        """Test EntitlementRequestConfig2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntitlementRequestConfig2`
        """
        model = EntitlementRequestConfig2()
        if include_optional:
            return EntitlementRequestConfig2(
    ...
    def testEntitlementRequestConfig2(self):
        """Test EntitlementRequestConfig2"""
