...
class TestAccessRequestConfig2(unittest.TestCase):
    """AccessRequestConfig2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessRequestConfig2:
        """Test AccessRequestConfig2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessRequestConfig2`
        """
        model = AccessRequestConfig2()
        if include_optional:
    ...
    def testAccessRequestConfig2(self):
        """Test AccessRequestConfig2"""
