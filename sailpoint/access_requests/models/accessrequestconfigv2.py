...
class Accessrequestconfigv2(BaseModel):
    """
    ...
    request_on_behalf_of_config: Optional[Requestonbehalfofconfigv2] = Field(default=None, alias="requestOnBehalfOfConfig")
    entitlement_request_config: Optional[Entitlementrequestconfigv2] = Field(default=None, alias="entitlementRequestConfig")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Accessrequestconfigv2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Accessrequestconfigv2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "requestOnBehalfOfConfig": Requestonbehalfofconfigv2.from_dict(obj["requestOnBehalfOfConfig"]) if obj.get("requestOnBehalfOfConfig") is not None else None,
            "entitlementRequestConfig": Entitlementrequestconfigv2.from_dict(obj["entitlementRequestConfig"]) if obj.get("entitlementRequestConfig") is not None else None,
