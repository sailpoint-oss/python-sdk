...
from sailpoint.access_requests.api_response import ApiResponse, T as ApiResponseT
import sailpoint.access_requests.models
from sailpoint.access_requests import rest
from sailpoint.access_requests.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.access_requests.models, klass)
