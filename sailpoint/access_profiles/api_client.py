...
from sailpoint.access_profiles.api_response import ApiResponse, T as ApiResponseT
import sailpoint.access_profiles.models
from sailpoint.access_profiles import rest
from sailpoint.access_profiles.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.access_profiles.models, klass)
