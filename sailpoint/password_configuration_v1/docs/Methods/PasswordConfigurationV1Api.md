...
slug: /tools/sdk/python/v1/methods/password-configuration
tags: ['SDK', 'Software Development Kit', 'Password_Configuration', 'Password_Configuration']
---

# sailpoint.password_configuration_v1.PasswordConfigurationV1Api
...
from sailpoint.password_configuration_v1.api_client import ApiClient
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = PasswordConfigurationV1Api(api_client).create_password_org_config_v1(passwordorgconfig=new_passwordorgconfig)
        # Below is a request that includes all optional parameters
        # results = PasswordConfigurationV1Api(api_client).create_password_org_config_v1(new_passwordorgconfig)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = PasswordConfigurationV1Api(api_client).get_password_org_config_v1()
        # Below is a request that includes all optional parameters
        # results = PasswordConfigurationV1Api(api_client).get_password_org_config_v1()
        print("The response of PasswordConfigurationV1Api->get_password_org_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling PasswordConfigurationV1Api->get_password_org_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Update password org config
        new_passwordorgconfig = Passwordorgconfig.from_json(passwordorgconfig)
        results = PasswordConfigurationV1Api(api_client).put_password_org_config_v1(passwordorgconfig=new_passwordorgconfig)
        # Below is a request that includes all optional parameters
        # results = PasswordConfigurationV1Api(api_client).put_password_org_config_v1(new_passwordorgconfig)
        print("The response of PasswordConfigurationV1Api->put_password_org_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling PasswordConfigurationV1Api->put_password_org_config_v1: %s\n" % e)
```
