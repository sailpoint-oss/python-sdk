...
from sailpoint.sod_policies.api_response import ApiResponse, T as ApiResponseT
import sailpoint.sod_policies.models
from sailpoint.sod_policies import rest
from sailpoint.sod_policies.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.sod_policies.models, klass)
