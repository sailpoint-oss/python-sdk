...
class LifecycleApproverReference(BaseModel):
    """
    LifecycleApproverReference
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Approver reference type.")
    id: Optional[StrictStr] = Field(default=None, description="Identifier of the approver.")
    name: Optional[StrictStr] = Field(default=None, description="Display name of the approver.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LifecycleApproverReference from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LifecycleApproverReference from a dict"""
        if obj is None:
            return None
