...
class LifecycleActionSubmitComment(BaseModel):
    """
    LifecycleActionSubmitComment
    """ # noqa: E501
    comment: Annotated[str, Field(strict=True, max_length=1000)] = Field(description="Free-text comment submitted with the lifecycle action request.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LifecycleActionSubmitComment from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LifecycleActionSubmitComment from a dict"""
        if obj is None:
            return None
