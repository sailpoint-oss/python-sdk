...
class TestLifecycleOwnerReference(unittest.TestCase):
    """LifecycleOwnerReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LifecycleOwnerReference:
        """Test LifecycleOwnerReference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LifecycleOwnerReference`
        """
        model = LifecycleOwnerReference()
        if include_optional:
            return LifecycleOwnerReference(
                type = 'IDENTITY',
    ...
    def testLifecycleOwnerReference(self):
        """Test LifecycleOwnerReference"""
