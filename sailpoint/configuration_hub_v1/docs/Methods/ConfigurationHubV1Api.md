...
slug: /tools/sdk/python/v1/methods/configuration-hub
tags: ['SDK', 'Software Development Kit', 'Configuration_Hub', 'Configuration_Hub']
---

# sailpoint.configuration_hub_v1.ConfigurationHubV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConfigurationHubV1Api(api_client).create_deploy_v1(deployrequest=new_deployrequest)
        # Below is a request that includes all optional parameters
        # results = ConfigurationHubV1Api(api_client).create_deploy_v1(new_deployrequest)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConfigurationHubV1Api(api_client).create_object_mapping_v1(source_org=source_org, objectmappingrequest=new_objectmappingrequest)
        # Below is a request that includes all optional parameters
        # results = ConfigurationHubV1Api(api_client).create_object_mapping_v1(source_org, new_objectmappingrequest)
        print("The response of ConfigurationHubV1Api->create_object_mapping_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->create_object_mapping_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConfigurationHubV1Api(api_client).create_object_mappings_v1(source_org=source_org, objectmappingbulkcreaterequest=new_objectmappingbulkcreaterequest)
        # Below is a request that includes all optional parameters
        # results = ConfigurationHubV1Api(api_client).create_object_mappings_v1(source_org, new_objectmappingbulkcreaterequest)
        print("The response of ConfigurationHubV1Api->create_object_mappings_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->create_object_mappings_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConfigurationHubV1Api(api_client).create_scheduled_action_v1(scheduledactionpayload=new_scheduledactionpayload)
        # Below is a request that includes all optional parameters
        # results = ConfigurationHubV1Api(api_client).create_scheduled_action_v1(new_scheduledactionpayload)
        print("The response of ConfigurationHubV1Api->create_scheduled_action_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->create_scheduled_action_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConfigurationHubV1Api(api_client).create_uploaded_configuration_v1(data=data, name=name)
        # Below is a request that includes all optional parameters
        # results = ConfigurationHubV1Api(api_client).create_uploaded_configuration_v1(data, name)
        print("The response of ConfigurationHubV1Api->create_uploaded_configuration_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->create_uploaded_configuration_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        ConfigurationHubV1Api(api_client).delete_backup_v1(id=id)
        # Below is a request that includes all optional parameters
        # ConfigurationHubV1Api(api_client).delete_backup_v1(id)
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->delete_backup_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        ConfigurationHubV1Api(api_client).delete_draft_v1(id=id)
        # Below is a request that includes all optional parameters
        # ConfigurationHubV1Api(api_client).delete_draft_v1(id)
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->delete_draft_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        ConfigurationHubV1Api(api_client).delete_object_mapping_v1(source_org=source_org, object_mapping_id=object_mapping_id)
        # Below is a request that includes all optional parameters
        # ConfigurationHubV1Api(api_client).delete_object_mapping_v1(source_org, object_mapping_id)
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->delete_object_mapping_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        ConfigurationHubV1Api(api_client).delete_scheduled_action_v1(id=id)
        # Below is a request that includes all optional parameters
        # ConfigurationHubV1Api(api_client).delete_scheduled_action_v1(id)
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->delete_scheduled_action_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        ConfigurationHubV1Api(api_client).delete_uploaded_configuration_v1(id=id)
        # Below is a request that includes all optional parameters
        # ConfigurationHubV1Api(api_client).delete_uploaded_configuration_v1(id)
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->delete_uploaded_configuration_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConfigurationHubV1Api(api_client).get_deploy_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = ConfigurationHubV1Api(api_client).get_deploy_v1(id)
        print("The response of ConfigurationHubV1Api->get_deploy_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->get_deploy_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConfigurationHubV1Api(api_client).get_object_mappings_v1(source_org=source_org)
        # Below is a request that includes all optional parameters
        # results = ConfigurationHubV1Api(api_client).get_object_mappings_v1(source_org)
        print("The response of ConfigurationHubV1Api->get_object_mappings_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->get_object_mappings_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConfigurationHubV1Api(api_client).get_uploaded_configuration_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = ConfigurationHubV1Api(api_client).get_uploaded_configuration_v1(id)
        print("The response of ConfigurationHubV1Api->get_uploaded_configuration_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->get_uploaded_configuration_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConfigurationHubV1Api(api_client).list_backups_v1()
        # Below is a request that includes all optional parameters
        # results = ConfigurationHubV1Api(api_client).list_backups_v1(filters)
        print("The response of ConfigurationHubV1Api->list_backups_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->list_backups_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConfigurationHubV1Api(api_client).list_deploys_v1()
        # Below is a request that includes all optional parameters
        # results = ConfigurationHubV1Api(api_client).list_deploys_v1()
        print("The response of ConfigurationHubV1Api->list_deploys_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->list_deploys_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConfigurationHubV1Api(api_client).list_drafts_v1()
        # Below is a request that includes all optional parameters
        # results = ConfigurationHubV1Api(api_client).list_drafts_v1(filters)
        print("The response of ConfigurationHubV1Api->list_drafts_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->list_drafts_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConfigurationHubV1Api(api_client).list_scheduled_actions_v1()
        # Below is a request that includes all optional parameters
        # results = ConfigurationHubV1Api(api_client).list_scheduled_actions_v1()
        print("The response of ConfigurationHubV1Api->list_scheduled_actions_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->list_scheduled_actions_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConfigurationHubV1Api(api_client).list_uploaded_configurations_v1()
        # Below is a request that includes all optional parameters
        # results = ConfigurationHubV1Api(api_client).list_uploaded_configurations_v1(filters)
        print("The response of ConfigurationHubV1Api->list_uploaded_configurations_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->list_uploaded_configurations_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConfigurationHubV1Api(api_client).update_object_mappings_v1(source_org=source_org, objectmappingbulkpatchrequest=new_objectmappingbulkpatchrequest)
        # Below is a request that includes all optional parameters
        # results = ConfigurationHubV1Api(api_client).update_object_mappings_v1(source_org, new_objectmappingbulkpatchrequest)
        print("The response of ConfigurationHubV1Api->update_object_mappings_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->update_object_mappings_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConfigurationHubV1Api(api_client).update_scheduled_action_v1(id=id, jsonpatch=new_jsonpatch)
        # Below is a request that includes all optional parameters
        # results = ConfigurationHubV1Api(api_client).update_scheduled_action_v1(id, new_jsonpatch)
        print("The response of ConfigurationHubV1Api->update_scheduled_action_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConfigurationHubV1Api->update_scheduled_action_v1: %s\n" % e)
```
