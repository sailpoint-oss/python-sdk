...
from sailpoint.machine_account_classify.api_response import ApiResponse, T as ApiResponseT
import sailpoint.machine_account_classify.models
from sailpoint.machine_account_classify import rest
from sailpoint.machine_account_classify.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.machine_account_classify.models, klass)
