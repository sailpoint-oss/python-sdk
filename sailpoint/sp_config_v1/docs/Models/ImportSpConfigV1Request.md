...
slug: /tools/sdk/python/v1/models/import-sp-config-v1-request
...
```python
from sailpoint.sp_config_v1.models.import_sp_config_v1_request import ImportSpConfigV1Request

import_sp_config_v1_request = ImportSpConfigV1Request(
data=bytes(b'blah'),
options=sailpoint.sp_config_v1.models.import_options.Import Options(
                    exclude_types = [
                        'SOURCE'
                        ], 
                    include_types = [
