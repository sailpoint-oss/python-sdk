...
slug: /tools/sdk/python/v1/models/spconfigexportresults
...
options=sailpoint.sp_config_v1.models.export_options.Export Options(
                    exclude_types = [
                        'SOURCE'
                        ], 
                    include_types = [
...
objects=[
                    sailpoint.sp_config_v1.models.config_object_for_export_and_import.Config Object for Export and Import(
                        version = 1, 
                        self = sailpoint.sp_config_v1.models.self_import_export_dto.Self Import Export Dto(
                            type = 'SOURCE', 
