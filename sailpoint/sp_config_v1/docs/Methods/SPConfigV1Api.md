...
slug: /tools/sdk/python/v1/methods/sp-config
tags: ['SDK', 'Software Development Kit', 'SP_Config', 'SP_Config']
---

# sailpoint.sp_config_v1.SPConfigV1Api
...
from sailpoint.sp_config_v1.api_client import ApiClient
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SPConfigV1Api(api_client).export_sp_config_v1(exportpayload=new_exportpayload)
        # Below is a request that includes all optional parameters
        # results = SPConfigV1Api(api_client).export_sp_config_v1(new_exportpayload)
        print("The response of SPConfigV1Api->export_sp_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SPConfigV1Api->export_sp_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SPConfigV1Api(api_client).get_sp_config_export_status_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SPConfigV1Api(api_client).get_sp_config_export_status_v1(id)
        print("The response of SPConfigV1Api->get_sp_config_export_status_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SPConfigV1Api->get_sp_config_export_status_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SPConfigV1Api(api_client).get_sp_config_export_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SPConfigV1Api(api_client).get_sp_config_export_v1(id)
        print("The response of SPConfigV1Api->get_sp_config_export_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SPConfigV1Api->get_sp_config_export_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SPConfigV1Api(api_client).get_sp_config_import_status_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SPConfigV1Api(api_client).get_sp_config_import_status_v1(id)
        print("The response of SPConfigV1Api->get_sp_config_import_status_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SPConfigV1Api->get_sp_config_import_status_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SPConfigV1Api(api_client).get_sp_config_import_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SPConfigV1Api(api_client).get_sp_config_import_v1(id)
        print("The response of SPConfigV1Api->get_sp_config_import_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SPConfigV1Api->get_sp_config_import_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    options = '''sailpoint.sp_config_v1.Importoptions()''' # Importoptions |  (optional)

    try:
        # Initiates configuration objects import job
        
        results = SPConfigV1Api(api_client).import_sp_config_v1(data=data)
        # Below is a request that includes all optional parameters
        # results = SPConfigV1Api(api_client).import_sp_config_v1(data, preview, options)
        print("The response of SPConfigV1Api->import_sp_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SPConfigV1Api->import_sp_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SPConfigV1Api(api_client).list_sp_config_objects_v1()
        # Below is a request that includes all optional parameters
        # results = SPConfigV1Api(api_client).list_sp_config_objects_v1()
        print("The response of SPConfigV1Api->list_sp_config_objects_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SPConfigV1Api->list_sp_config_objects_v1: %s\n" % e)
```
