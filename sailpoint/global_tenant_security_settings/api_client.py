...
from sailpoint.global_tenant_security_settings.api_response import ApiResponse, T as ApiResponseT
import sailpoint.global_tenant_security_settings.models
from sailpoint.global_tenant_security_settings import rest
from sailpoint.global_tenant_security_settings.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.global_tenant_security_settings.models, klass)
