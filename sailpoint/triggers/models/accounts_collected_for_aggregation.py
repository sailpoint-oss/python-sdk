...
class AccountsCollectedForAggregation(BaseModel):
    ...
    status: StrictStr = Field(description="The overall status of the collection.")
    ...
    errors: Optional[List[StrictStr]] = Field(description="A list of errors that occurred during the collection.")
    warnings: Optional[List[StrictStr]] = Field(description="A list of warnings that occurred during the collection.")
