---
id: access-request-dynamic-approver-requested-items-inner-form
...
keywords: ['python', 'Python', 'sdk', 'AccessRequestDynamicApproverRequestedItemsInnerForm', 'AccessRequestDynamicApproverRequestedItemsInnerForm'] 
slug: /tools/sdk/python/triggers/models/access-request-dynamic-approver-requested-items-inner-form
tags: ['SDK', 'Software Development Kit', 'AccessRequestDynamicApproverRequestedItemsInnerForm', 'AccessRequestDynamicApproverRequestedItemsInnerForm']
---
...
access_request_dynamic_approver_requested_items_inner_form = AccessRequestDynamicApproverRequestedItemsInnerForm(
