...
class TestSODViolationReopenedPayload(unittest.TestCase):
    """SODViolationReopenedPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SODViolationReopenedPayload:
        """Test SODViolationReopenedPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SODViolationReopenedPayload`
        """
        model = SODViolationReopenedPayload()
        if include_optional:
            return SODViolationReopenedPayload(
    ...
    def testSODViolationReopenedPayload(self):
        """Test SODViolationReopenedPayload"""
