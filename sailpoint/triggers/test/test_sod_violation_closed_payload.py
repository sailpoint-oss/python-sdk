...
class TestSODViolationClosedPayload(unittest.TestCase):
    """SODViolationClosedPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SODViolationClosedPayload:
        """Test SODViolationClosedPayload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SODViolationClosedPayload`
        """
        model = SODViolationClosedPayload()
        if include_optional:
            return SODViolationClosedPayload(
    ...
    def testSODViolationClosedPayload(self):
        """Test SODViolationClosedPayload"""
