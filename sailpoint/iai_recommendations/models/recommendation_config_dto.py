...
class RecommendationConfigDto(BaseModel):
    ...
    peer_group_percentage_threshold: Optional[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(default=None, description="The percent value that the recommendation calculation must surpass to produce a YES recommendation", alias="peerGroupPercentageThreshold")
