...
from sailpoint.iai_recommendations.api_response import ApiResponse, T as ApiResponseT
import sailpoint.iai_recommendations.models
from sailpoint.iai_recommendations import rest
from sailpoint.iai_recommendations.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.iai_recommendations.models, klass)
