# sailpoint.org-config
Use these APIs to interact with the Identity Security Cloud platform to achieve repeatable, automated processes with greater scalability. We encourage you to join the SailPoint Developer Community forum at https://developer.sailpoint.com/discuss to connect with other developers using our APIs.

The `sailpoint.org_config` package is automatically generated by the [OpenAPI Generator](https://openapi-generator.tech) project:
...
In your own code, to use this library to connect and interact with sailpoint.org-config,
you can run the following:

```python

import sailpoint.org_config
from sailpoint.org_config.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to https://sailpoint.api.identitynow.com
# See configuration.py for a list of all supported configuration parameters.
configuration = sailpoint.org_config.Configuration(
...
with sailpoint.org_config.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = sailpoint.org_config.OrgConfigApi(api_client)
...
------------ | ------------- | ------------- | -------------
*OrgConfigApi* | [**get_org_config_v1**](sailpoint/org_config/docs/OrgConfigApi.md#get_org_config_v1) | **GET** /org-config/v1 | Get org config settings
*OrgConfigApi* | [**get_valid_time_zones_v1**](sailpoint/org_config/docs/OrgConfigApi.md#get_valid_time_zones_v1) | **GET** /org-config/v1/valid-time-zones | Get valid time zones
*OrgConfigApi* | [**patch_org_config_v1**](sailpoint/org_config/docs/OrgConfigApi.md#patch_org_config_v1) | **PATCH** /org-config/v1 | Patch org config
