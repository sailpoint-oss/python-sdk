...
from sailpoint.role_insights_v1.api_client import ApiClient, RequestSerialized
from sailpoint.role_insights_v1.api_response import ApiResponse
from sailpoint.role_insights_v1.rest import RESTResponseType
...
class RoleInsightsV1Api:
    ...
    @validate_call
    def create_role_insight_requests_v1(
        self,
        ...
        """ # noqa: E501
        warnings.warn("POST /role-insights/v1/requests is deprecated.", DeprecationWarning)

        _param = self._create_role_insight_requests_v1_serialize(
    ...
    @validate_call
    def create_role_insight_requests_v1_with_http_info(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_role_insight_requests_v1_without_preload_content(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_role_insight_requests_v1_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/role-insights/v1/requests',
    ...
    @validate_call
    def download_role_insights_entitlements_changes_v1(
        self,
        ...
        _param = self._download_role_insights_entitlements_changes_v1_serialize(
    ...
    @validate_call
    def download_role_insights_entitlements_changes_v1_with_http_info(
        self,
        insight_id: Annotated[StrictStr, Field(description="The role insight id")],
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **identitiesWithAccess**  The default sort is **identitiesWithAccess** in descending order.")] = None,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **name**: *sw*  **description**: *sw*")] = None,
    ...
    @validate_call
    def download_role_insights_entitlements_changes_v1_without_preload_content(
        self,
        insight_id: Annotated[StrictStr, Field(description="The role insight id")],
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **identitiesWithAccess**  The default sort is **identitiesWithAccess** in descending order.")] = None,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **name**: *sw*  **description**: *sw*")] = None,
    ...
    def _download_role_insights_entitlements_changes_v1_serialize(
        self,
        insight_id,
        sorters,
        filters,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/role-insights/v1/{insightId}/entitlement-changes/download',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_entitlement_changes_identities_v1(
        self,
        insight_id: Annotated[StrictStr, Field(description="The role insight id")],
        ...
        _param = self._get_entitlement_changes_identities_v1_serialize(
            insight_id=insight_id,
    ...
    @validate_call
    def get_entitlement_changes_identities_v1_with_http_info(
        self,
        insight_id: Annotated[StrictStr, Field(description="The role insight id")],
        entitlement_id: Annotated[StrictStr, Field(description="The entitlement id")],
        has_entitlement: Annotated[Optional[StrictBool], Field(description="Identity has this entitlement or not")] = None,
    ...
    @validate_call
    def get_entitlement_changes_identities_v1_without_preload_content(
        self,
        insight_id: Annotated[StrictStr, Field(description="The role insight id")],
        entitlement_id: Annotated[StrictStr, Field(description="The entitlement id")],
        has_entitlement: Annotated[Optional[StrictBool], Field(description="Identity has this entitlement or not")] = None,
    ...
    def _get_entitlement_changes_identities_v1_serialize(
        self,
        insight_id,
        entitlement_id,
        has_entitlement,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/role-insights/v1/{insightId}/entitlement-changes/{entitlementId}/identities',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_role_insight_v1(
        ...
        _param = self._get_role_insight_v1_serialize(
            insight_id=insight_id,
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_role_insight_v1_with_http_info(
        self,
        insight_id: Annotated[StrictStr, Field(description="The role insight id")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_role_insight_v1_without_preload_content(
        self,
        insight_id: Annotated[StrictStr, Field(description="The role insight id")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    def _get_role_insight_v1_serialize(
        self,
        insight_id,
        x_sail_point_experimental,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/role-insights/v1/{insightId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_role_insights_current_entitlements_v1(
        self,
        insight_id: Annotated[StrictStr, Field(description="The role insight id")],
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **name**: *sw*  **description**: *sw*")] = None,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        ...
        _param = self._get_role_insights_current_entitlements_v1_serialize(
            insight_id=insight_id,
            filters=filters,
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_role_insights_current_entitlements_v1_with_http_info(
        self,
        insight_id: Annotated[StrictStr, Field(description="The role insight id")],
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **name**: *sw*  **description**: *sw*")] = None,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
    ...
    @validate_call
    def get_role_insights_current_entitlements_v1_without_preload_content(
        self,
        insight_id: Annotated[StrictStr, Field(description="The role insight id")],
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **name**: *sw*  **description**: *sw*")] = None,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
    ...
    def _get_role_insights_current_entitlements_v1_serialize(
        self,
        insight_id,
        filters,
        x_sail_point_experimental,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/role-insights/v1/{insightId}/current-entitlements',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_role_insights_entitlements_changes_v1(
        self,
        insight_id: Annotated[StrictStr, Field(description="The role insight id")],
        ...
        _param = self._get_role_insights_entitlements_changes_v1_serialize(
            insight_id=insight_id,
            sorters=sorters,
            filters=filters,
            x_sail_point_experimental=x_sail_point_experimental,
    ...
    @validate_call
    def get_role_insights_entitlements_changes_v1_with_http_info(
        self,
        insight_id: Annotated[StrictStr, Field(description="The role insight id")],
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **identitiesWithAccess, name**")] = None,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **name**: *sw*  **description**: *sw*")] = None,
    ...
    @validate_call
    def get_role_insights_entitlements_changes_v1_without_preload_content(
        self,
        insight_id: Annotated[StrictStr, Field(description="The role insight id")],
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **identitiesWithAccess, name**")] = None,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **name**: *sw*  **description**: *sw*")] = None,
    ...
    def _get_role_insights_entitlements_changes_v1_serialize(
        self,
        insight_id,
        sorters,
        filters,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/role-insights/v1/{insightId}/entitlement-changes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_role_insights_requests_v1(
        self,
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /role-insights/v1/requests/{id} is deprecated.", DeprecationWarning)

        _param = self._get_role_insights_requests_v1_serialize(
            id=id,
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_role_insights_requests_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The role insights request id")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_role_insights_requests_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The role insights request id")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    def _get_role_insights_requests_v1_serialize(
        self,
        id,
        x_sail_point_experimental,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/role-insights/v1/requests/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_role_insights_summary_v1(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_role_insights_summary_v1_serialize(
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_role_insights_summary_v1_with_http_info(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_role_insights_summary_v1_without_preload_content(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_role_insights_summary_v1_serialize(
        self,
        x_sail_point_experimental,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/role-insights/v1/summary',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_role_insights_v1(
        ...
        _param = self._get_role_insights_v1_serialize(
            offset=offset,
            limit=limit,
            count=count,
            sorters=sorters,
    ...
    @validate_call
    def get_role_insights_v1_with_http_info(
        self,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def get_role_insights_v1_without_preload_content(
        self,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _get_role_insights_v1_serialize(
        self,
        offset,
        limit,
        count,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/role-insights/v1',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
