...
> send_identity_verification_account_token(x_sail_point_experimental, id, send_account_verification_request)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    x_sail_point_experimental = 'true' # str | Use this header to enable this experimental API. (default to 'true')
    id = 'ef38f94347e94562b5bb8424a56397d8' # str | Identity ID
    send_account_verification_request = sailpoint.v2024.SendAccountVerificationRequest() # SendAccountVerificationRequest | 

    try:
        # Send password reset email
        api_instance.send_identity_verification_account_token(x_sail_point_experimental, id, send_account_verification_request)
    except Exception as e:
...
> TaskStatus start_identities_invite(x_sail_point_experimental, invite_identities_request)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    api_instance = sailpoint.v2024.IdentitiesApi(api_client)
    x_sail_point_experimental = 'true' # str | Use this header to enable this experimental API. (default to 'true')
    invite_identities_request = sailpoint.v2024.InviteIdentitiesRequest() # InviteIdentitiesRequest | 

    try:
        # Invite identities to register
        api_response = api_instance.start_identities_invite(x_sail_point_experimental, invite_identities_request)
