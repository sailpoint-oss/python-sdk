...
keywords: ['python', 'Python', 'sdk', 'TemplateDtoSlackTemplate', 'V2024TemplateDtoSlackTemplate'] 
slug: /tools/sdk/python/v2024/models/template-dto-slack-template
...
```python
from sailpoint.v2024.models.template_dto_slack_template import TemplateDtoSlackTemplate
