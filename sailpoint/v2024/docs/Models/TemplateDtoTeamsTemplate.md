...
keywords: ['python', 'Python', 'sdk', 'TemplateDtoTeamsTemplate', 'V2024TemplateDtoTeamsTemplate'] 
slug: /tools/sdk/python/v2024/models/template-dto-teams-template
...
```python
from sailpoint.v2024.models.template_dto_teams_template import TemplateDtoTeamsTemplate
