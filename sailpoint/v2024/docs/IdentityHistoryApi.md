...
> List[IdentityCompareResponse] compare_identity_snapshots(id, x_sail_point_experimental, snapshot1=snapshot1, snapshot2=snapshot2, access_item_types=access_item_types, limit=limit, offset=offset, count=count)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    api_instance = sailpoint.v2024.IdentityHistoryApi(api_client)
    ...
    try:
        # Gets a difference of count for each access item types for the given identity between 2 snapshots
        api_response = api_instance.compare_identity_snapshots(id, x_sail_point_experimental, snapshot1=snapshot1, snapshot2=snapshot2, access_item_types=access_item_types, limit=limit, offset=offset, count=count)
...
> List[AccessItemDiff] compare_identity_snapshots_access_type(id, access_type, x_sail_point_experimental, access_associated=access_associated, snapshot1=snapshot1, snapshot2=snapshot2, limit=limit, offset=offset, count=count)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets a list of differences of specific accessType for the given identity between 2 snapshots
        api_response = api_instance.compare_identity_snapshots_access_type(id, access_type, x_sail_point_experimental, access_associated=access_associated, snapshot1=snapshot1, snapshot2=snapshot2, limit=limit, offset=offset, count=count)
...
> IdentityHistoryResponse get_historical_identity(id, x_sail_point_experimental)
...
> List[GetHistoricalIdentityEvents200ResponseInner] get_historical_identity_events(id, x_sail_point_experimental, var_from=var_from, event_types=event_types, access_item_types=access_item_types, limit=limit, offset=offset, count=count)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    try:
        # Lists all events for the given identity
        api_response = api_instance.get_historical_identity_events(id, x_sail_point_experimental, var_from=var_from, event_types=event_types, access_item_types=access_item_types, limit=limit, offset=offset, count=count)
...
> IdentityHistoryResponse get_identity_snapshot(id, var_date, x_sail_point_experimental)
...
> List[MetricResponse] get_identity_snapshot_summary(id, x_sail_point_experimental, before=before, interval=interval, time_zone=time_zone, limit=limit, offset=offset, count=count)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets the summary for the event count for a specific identity
        api_response = api_instance.get_identity_snapshot_summary(id, x_sail_point_experimental, before=before, interval=interval, time_zone=time_zone, limit=limit, offset=offset, count=count)
...
> str get_identity_start_date(id, x_sail_point_experimental)
...
> List[IdentityListItem] list_historical_identities(x_sail_point_experimental, starts_with_query=starts_with_query, is_deleted=is_deleted, is_active=is_active, limit=limit, offset=offset)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    try:
        # Lists all the identities
        api_response = api_instance.list_historical_identities(x_sail_point_experimental, starts_with_query=starts_with_query, is_deleted=is_deleted, is_active=is_active, limit=limit, offset=offset)
...
> List[ListIdentityAccessItems200ResponseInner] list_identity_snapshot_access_items(id, var_date, x_sail_point_experimental, type=type)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets the list of identity access items at a given date filterd by item type
        api_response = api_instance.list_identity_snapshot_access_items(id, var_date, x_sail_point_experimental, type=type)
...
> List[IdentitySnapshotSummaryResponse] list_identity_snapshots(id, x_sail_point_experimental, start=start, interval=interval, limit=limit, offset=offset, count=count)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    try:
        # Lists all the snapshots for the identity
        api_response = api_instance.list_identity_snapshots(id, x_sail_point_experimental, start=start, interval=interval, limit=limit, offset=offset, count=count)
