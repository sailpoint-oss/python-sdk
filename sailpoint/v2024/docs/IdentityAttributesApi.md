...
> IdentityAttribute create_identity_attribute(x_sail_point_experimental, identity_attribute)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    api_instance = sailpoint.v2024.IdentityAttributesApi(api_client)
    x_sail_point_experimental = 'true' # str | Use this header to enable this experimental API. (default to 'true')
    identity_attribute = sailpoint.v2024.IdentityAttribute() # IdentityAttribute | 

    try:
        # Create Identity Attribute
        api_response = api_instance.create_identity_attribute(x_sail_point_experimental, identity_attribute)
...
> delete_identity_attribute(name, x_sail_point_experimental)
...
> delete_identity_attributes_in_bulk(x_sail_point_experimental, identity_attribute_names)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    api_instance = sailpoint.v2024.IdentityAttributesApi(api_client)
    x_sail_point_experimental = 'true' # str | Use this header to enable this experimental API. (default to 'true')
    identity_attribute_names = sailpoint.v2024.IdentityAttributeNames() # IdentityAttributeNames | 

    try:
        # Bulk delete Identity Attributes
        api_instance.delete_identity_attributes_in_bulk(x_sail_point_experimental, identity_attribute_names)
    except Exception as e:
...
> IdentityAttribute get_identity_attribute(name, x_sail_point_experimental)
...
> List[IdentityAttribute] list_identity_attributes(x_sail_point_experimental, include_system=include_system, include_silent=include_silent, searchable_only=searchable_only, count=count)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    try:
        # List Identity Attributes
        api_response = api_instance.list_identity_attributes(x_sail_point_experimental, include_system=include_system, include_silent=include_silent, searchable_only=searchable_only, count=count)
...
> IdentityAttribute put_identity_attribute(name, x_sail_point_experimental, identity_attribute)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    try:
        # Update Identity Attribute
        api_response = api_instance.put_identity_attribute(name, x_sail_point_experimental, identity_attribute)
