...
# **create_workgroup**
> WorkgroupDto create_workgroup(x_sail_point_experimental, workgroup_dto)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    api_instance = sailpoint.v2024.GovernanceGroupsApi(api_client)
    x_sail_point_experimental = 'true' # str | Use this header to enable this experimental API. (default to 'true')
    workgroup_dto = sailpoint.v2024.WorkgroupDto() # WorkgroupDto | 

    try:
        # Create a new Governance Group.
        api_response = api_instance.create_workgroup(x_sail_point_experimental, workgroup_dto)
...
# **delete_workgroup**
> delete_workgroup(id, x_sail_point_experimental)
...
> List[WorkgroupMemberDeleteItem] delete_workgroup_members(workgroup_id, x_sail_point_experimental, identity_preview_response_identity)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    try:
        # Remove members from Governance Group
        api_response = api_instance.delete_workgroup_members(workgroup_id, x_sail_point_experimental, identity_preview_response_identity)
 ...
 **x_sail_point_experimental** | **str**| Use this header to enable this experimental API. | [default to &#39;true&#39;]
 **identity_preview_response_identity** | [**List[IdentityPreviewResponseIdentity]**](IdentityPreviewResponseIdentity.md)| List of identities to be removed from  a Governance Group members list. | 
...
> List[WorkgroupDeleteItem] delete_workgroups_in_bulk(x_sail_point_experimental, workgroup_bulk_delete_request)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete Governance Group(s)
        api_response = api_instance.delete_workgroups_in_bulk(x_sail_point_experimental, workgroup_bulk_delete_request)
...
# **get_workgroup**
> WorkgroupDto get_workgroup(id, x_sail_point_experimental)
...
# **list_connections**
> List[WorkgroupConnectionDto] list_connections(workgroup_id, x_sail_point_experimental, offset=offset, limit=limit, count=count, sorters=sorters)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    try:
        # List connections for Governance Group
        api_response = api_instance.list_connections(workgroup_id, x_sail_point_experimental, offset=offset, limit=limit, count=count, sorters=sorters)
...
> List[ListWorkgroupMembers200ResponseInner] list_workgroup_members(workgroup_id, x_sail_point_experimental, offset=offset, limit=limit, count=count, sorters=sorters)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    try:
        # List Governance Group Members
        api_response = api_instance.list_workgroup_members(workgroup_id, x_sail_point_experimental, offset=offset, limit=limit, count=count, sorters=sorters)
...
# **list_workgroups**
> List[WorkgroupDto] list_workgroups(x_sail_point_experimental, offset=offset, limit=limit, count=count, filters=filters, sorters=sorters)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    try:
        # List Governance Groups
        api_response = api_instance.list_workgroups(x_sail_point_experimental, offset=offset, limit=limit, count=count, filters=filters, sorters=sorters)
...
# **patch_workgroup**
> WorkgroupDto patch_workgroup(id, x_sail_point_experimental, json_patch_operation=json_patch_operation)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a Governance Group
        api_response = api_instance.patch_workgroup(id, x_sail_point_experimental, json_patch_operation=json_patch_operation)
...
> List[WorkgroupMemberAddItem] update_workgroup_members(workgroup_id, x_sail_point_experimental, identity_preview_response_identity)
...
with sailpoint.v2024.ApiClient(configuration) as api_client:
    ...
    try:
        # Add members to Governance Group
        api_response = api_instance.update_workgroup_members(workgroup_id, x_sail_point_experimental, identity_preview_response_identity)
 ...
 **workgroup_id** | **str**| ID of the Governance Group. | 
 **x_sail_point_experimental** | **str**| Use this header to enable this experimental API. | [default to &#39;true&#39;]
 **identity_preview_response_identity** | [**List[IdentityPreviewResponseIdentity]**](IdentityPreviewResponseIdentity.md)| List of identities to be added to a Governance Group members list. | 
