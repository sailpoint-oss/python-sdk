...
class TestProvisioningConfig1(unittest.TestCase):
    """ProvisioningConfig1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProvisioningConfig1:
        """Test ProvisioningConfig1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProvisioningConfig1`
        """
        model = ProvisioningConfig1()
        if include_optional:
            return ProvisioningConfig1(
...
', ),
    ...
    def testProvisioningConfig1(self):
        """Test ProvisioningConfig1"""
