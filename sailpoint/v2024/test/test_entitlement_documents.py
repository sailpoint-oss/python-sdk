...
class TestEntitlementDocuments(unittest.TestCase):
    """EntitlementDocuments unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntitlementDocuments:
        """Test EntitlementDocuments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntitlementDocuments`
        """
        model = EntitlementDocuments()
        if include_optional:
            return EntitlementDocuments(
    ...
    def testEntitlementDocuments(self):
        """Test EntitlementDocuments"""
