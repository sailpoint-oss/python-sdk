...
class TestEntitlement1(unittest.TestCase):
    """Entitlement1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Entitlement1:
        """Test Entitlement1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Entitlement1`
        """
        model = Entitlement1()
        if include_optional:
            return Entitlement1(
