...
class TestAccessProfileDocuments(unittest.TestCase):
    """AccessProfileDocuments unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessProfileDocuments:
        """Test AccessProfileDocuments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessProfileDocuments`
        """
        model = AccessProfileDocuments()
        if include_optional:
            return AccessProfileDocuments(
    ...
    def testAccessProfileDocuments(self):
        """Test AccessProfileDocuments"""
