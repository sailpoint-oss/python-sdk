...
class TestAccessRequestAdminItemStatusSodViolationContext(unittest.TestCase):
    """AccessRequestAdminItemStatusSodViolationContext unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccessRequestAdminItemStatusSodViolationContext:
        """Test AccessRequestAdminItemStatusSodViolationContext
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccessRequestAdminItemStatusSodViolationContext`
        """
        model = AccessRequestAdminItemStatusSodViolationContext()
        if include_optional:
            return AccessRequestAdminItemStatusSodViolationContext(
                state = 'SUCCESS',
    ...
    def testAccessRequestAdminItemStatusSodViolationContext(self):
        """Test AccessRequestAdminItemStatusSodViolationContext"""
