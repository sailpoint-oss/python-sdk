...
class TestManualWorkItemDetails1(unittest.TestCase):
    """ManualWorkItemDetails1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManualWorkItemDetails1:
        """Test ManualWorkItemDetails1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManualWorkItemDetails1`
        """
        model = ManualWorkItemDetails1()
        if include_optional:
            return ManualWorkItemDetails1(
                forwarded = True,
    ...
    def testManualWorkItemDetails1(self):
        """Test ManualWorkItemDetails1"""
