...
class TestProvisioningConfig1PlanInitializerScript(unittest.TestCase):
    """ProvisioningConfig1PlanInitializerScript unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProvisioningConfig1PlanInitializerScript:
        ...
        """
        model = ProvisioningConfig1PlanInitializerScript()
        if include_optional:
            return ProvisioningConfig1PlanInitializerScript(
...
'
    ...
    def testProvisioningConfig1PlanInitializerScript(self):
        """Test ProvisioningConfig1PlanInitializerScript"""
