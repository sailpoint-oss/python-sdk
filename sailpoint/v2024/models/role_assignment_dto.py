...
class RoleAssignmentDto(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "role": BaseReferenceDto1.from_dict(obj.get("role")) if obj.get("role") is not None else None,
            "comments": obj.get("comments"),
            "assignmentSource": obj.get("assignmentSource"),
            "assigner": BaseReferenceDto1.from_dict(obj.get("assigner")) if obj.get("assigner") is not None else None,
            "assignedDimensions": [BaseReferenceDto1.from_dict(_item) for _item in obj.get("assignedDimensions")] if obj.get("assignedDimensions") is not None else None,
