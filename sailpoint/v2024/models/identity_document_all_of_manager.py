...
class IdentityDocumentAllOfManager(BaseModel):
    """
    Identity's manager.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of identity's manager.")
    name: Optional[StrictStr] = Field(default=None, description="Name of identity's manager.")
    display_name: Optional[StrictStr] = Field(default=None, description="Display name of identity's manager.", alias="displayName")
