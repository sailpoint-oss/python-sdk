...
class PasswordPolicyHoldersDtoAttributesIdentityAttrInner(BaseModel):
    """
    PasswordPolicyHoldersDtoAttributesIdentityAttrInner
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Attribute's name")
    value: Optional[StrictStr] = Field(default=None, description="Attribute's value")
