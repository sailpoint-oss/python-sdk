...
class IdentityPreviewRequest(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.identity_attribute_config:
            for _item in self.identity_attribute_config:
                if _item:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "identityAttributeConfig": [IdentityAttributeConfig.from_dict(_item) for _item in obj.get("identityAttributeConfig")] if obj.get("identityAttributeConfig") is not None else None
        })
        return _obj
