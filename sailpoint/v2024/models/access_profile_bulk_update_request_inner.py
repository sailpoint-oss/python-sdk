...
class AccessProfileBulkUpdateRequestInner(BaseModel):
    """
    Access Profile's basic details.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Access Profile ID.")
    requestable: Optional[StrictBool] = Field(default=None, description="Access Profile is requestable or not.")
    __properties: ClassVar[List[str]] = ["id", "requestable"]
