...
class RoleDocumentAllOfEntitlements1(BaseModel):
    """
    ...
    source_schema_object_type: Optional[StrictStr] = Field(default=None, description="Schema objectType.", alias="sourceSchemaObjectType")
    hash: Optional[StrictStr] = Field(default=None, description="Read-only calculated hash value of an entitlement.")
    __properties: ClassVar[List[str]] = ["hasPermissions", "description", "attribute", "value", "schema", "privileged", "id", "name", "sourceSchemaObjectType", "hash"]
