...
class ProvisioningConfig1(BaseModel):
    ...
    managed_resource_refs: Optional[List[ProvisioningConfig1ManagedResourceRefsInner]] = Field(default=None, description="References to sources for the Service Desk integration template.  May only be specified if universalManager is false.", alias="managedResourceRefs")
    plan_initializer_script: Optional[ProvisioningConfig1PlanInitializerScript] = Field(default=None, alias="planInitializerScript")
