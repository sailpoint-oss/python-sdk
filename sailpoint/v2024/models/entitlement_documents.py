...
class EntitlementDocuments(BaseModel):
    """
    ...
    pod: Optional[StrictStr] = Field(default=None, description="Name of the pod.")
    org: Optional[StrictStr] = Field(default=None, description="Name of the tenant.")
    type: Optional[DocumentType] = Field(default=None, alias="_type")
    type: Optional[DocumentType] = None
    version: Optional[StrictStr] = Field(default=None, description="Version number.", alias="_version")
    __properties: ClassVar[List[str]] = ["id", "name", "modified", "synced", "displayName", "source", "segments", "segmentCount", "requestable", "cloudGoverned", "created", "privileged", "tags", "attribute", "value", "sourceSchemaObjectType", "schema", "hash", "attributes", "truncatedAttributes", "containsDataAccess", "manuallyUpdatedFields", "permissions", "pod", "org", "_type", "type", "_version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EntitlementDocuments from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EntitlementDocuments from a dict"""
        if obj is None:
            return None
