...
class ApprovalStatusDto1(BaseModel):
    """
    ApprovalStatusDto1
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errorMessages": [ErrorMessageDto1.from_dict(_item) for _item in obj["errorMessages"]] if obj.get("errorMessages") is not None else None,
