...
class SedAssignmentResponse(BaseModel):
    """
    Sed Assignment Response
    """ # noqa: E501
    batch_id: Optional[StrictStr] = Field(default=None, description="BatchId that groups all the ids together", alias="batchId")
