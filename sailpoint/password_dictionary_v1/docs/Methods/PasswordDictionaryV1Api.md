...
slug: /tools/sdk/python/v1/methods/password-dictionary
tags: ['SDK', 'Software Development Kit', 'Password_Dictionary', 'Password_Dictionary']
---

# sailpoint.password_dictionary_v1.PasswordDictionaryV1Api
...
------------- | ------------- | -------------
[**get-password-dictionary-v1**](#get-password-dictionary-v1) | **GET** `/password-dictionary/v1` | Get password dictionary
[**put-password-dictionary-v1**](#put-password-dictionary-v1) | **PUT** `/password-dictionary/v1` | Update password dictionary


## get-password-dictionary-v1
...
401 | Unauthorized - Returned if there is no authorization header, or if the JWT token is expired. | GetPasswordDictionaryV1401Response |  -  |
403 | Forbidden - Returned if the user you are running as, doesn&#39;t have access to this end-point. | Errorresponsedto |  -  |
404 | Not Found - returned if the request URL refers to a resource or object that does not exist | Errorresponsedto |  -  |
429 | Too Many Requests - Returned in response to too many requests in a given period of time - rate limited. The Retry-After header in the response includes how long to wait before trying again. | GetPasswordDictionaryV1429Response |  -  |
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = PasswordDictionaryV1Api(api_client).get_password_dictionary_v1()
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        PasswordDictionaryV1Api(api_client).put_password_dictionary_v1()
        # Below is a request that includes all optional parameters
        # PasswordDictionaryV1Api(api_client).put_password_dictionary_v1(file)
    except Exception as e:
        print("Exception when calling PasswordDictionaryV1Api->put_password_dictionary_v1: %s\n" % e)
```
