...
from sailpoint.password_dictionary_v1.api_client import ApiClient, RequestSerialized
from sailpoint.password_dictionary_v1.api_response import ApiResponse
from sailpoint.password_dictionary_v1.rest import RESTResponseType
...
class PasswordDictionaryV1Api:
    ...
    @validate_call
    def get_password_dictionary_v1(
        self,
        ...
        _param = self._get_password_dictionary_v1_serialize(
    ...
    @validate_call
    def get_password_dictionary_v1_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_password_dictionary_v1_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_password_dictionary_v1_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/password-dictionary/v1',
    ...
    @validate_call
    def put_password_dictionary_v1(
        self,
        ...
        _param = self._put_password_dictionary_v1_serialize(
            file=file,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def put_password_dictionary_v1_with_http_info(
        self,
        file: Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def put_password_dictionary_v1_without_preload_content(
        self,
        file: Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]] = None,
        _request_timeout: Union[
            None,
    ...
    def _put_password_dictionary_v1_serialize(
        self,
        file,
        _request_auth,
        _content_type,
