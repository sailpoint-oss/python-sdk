...
from sailpoint.segments.api_response import ApiResponse, T as ApiResponseT
import sailpoint.segments.models
from sailpoint.segments import rest
from sailpoint.segments.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.segments.models, klass)
