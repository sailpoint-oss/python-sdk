...
from sailpoint.password_sync_groups.api_response import ApiResponse, T as ApiResponseT
import sailpoint.password_sync_groups.models
from sailpoint.password_sync_groups import rest
from sailpoint.password_sync_groups.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.password_sync_groups.models, klass)
