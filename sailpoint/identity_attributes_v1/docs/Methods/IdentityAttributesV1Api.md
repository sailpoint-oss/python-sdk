...
slug: /tools/sdk/python/v1/methods/identity-attributes
tags: ['SDK', 'Software Development Kit', 'Identity_Attributes', 'Identity_Attributes']
---

# sailpoint.identity_attributes_v1.IdentityAttributesV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = IdentityAttributesV1Api(api_client).create_identity_attribute_v1(identityattribute2=new_identityattribute2)
        # Below is a request that includes all optional parameters
        # results = IdentityAttributesV1Api(api_client).create_identity_attribute_v1(new_identityattribute2)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        IdentityAttributesV1Api(api_client).delete_identity_attribute_v1(name=name)
        # Below is a request that includes all optional parameters
        # IdentityAttributesV1Api(api_client).delete_identity_attribute_v1(name)
    except Exception as e:
        print("Exception when calling IdentityAttributesV1Api->delete_identity_attribute_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    identityattributenames = '''sailpoint.identity_attributes_v1.Identityattributenames()''' # Identityattributenames | 

    try:
        # Bulk delete identity attributes
        new_identityattributenames = Identityattributenames.from_json(identityattributenames)
        IdentityAttributesV1Api(api_client).delete_identity_attributes_in_bulk_v1(identityattributenames=new_identityattributenames)
        # Below is a request that includes all optional parameters
        # IdentityAttributesV1Api(api_client).delete_identity_attributes_in_bulk_v1(new_identityattributenames)
    except Exception as e:
        print("Exception when calling IdentityAttributesV1Api->delete_identity_attributes_in_bulk_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = IdentityAttributesV1Api(api_client).get_identity_attribute_v1(name=name)
        # Below is a request that includes all optional parameters
        # results = IdentityAttributesV1Api(api_client).get_identity_attribute_v1(name)
        print("The response of IdentityAttributesV1Api->get_identity_attribute_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling IdentityAttributesV1Api->get_identity_attribute_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = IdentityAttributesV1Api(api_client).list_identity_attributes_v1()
        # Below is a request that includes all optional parameters
        # results = IdentityAttributesV1Api(api_client).list_identity_attributes_v1(include_system, include_silent, searchable_only, count)
        print("The response of IdentityAttributesV1Api->list_identity_attributes_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling IdentityAttributesV1Api->list_identity_attributes_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Update identity attribute
        new_identityattribute2 = Identityattribute2.from_json(identityattribute2)
        results = IdentityAttributesV1Api(api_client).put_identity_attribute_v1(name=name, identityattribute2=new_identityattribute2)
        # Below is a request that includes all optional parameters
        # results = IdentityAttributesV1Api(api_client).put_identity_attribute_v1(name, new_identityattribute2)
        print("The response of IdentityAttributesV1Api->put_identity_attribute_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling IdentityAttributesV1Api->put_identity_attribute_v1: %s\n" % e)
```
