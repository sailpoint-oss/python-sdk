# sailpoint.auth-profile
Use these APIs to interact with the Identity Security Cloud platform to achieve repeatable, automated processes with greater scalability. We encourage you to join the SailPoint Developer Community forum at https://developer.sailpoint.com/discuss to connect with other developers using our APIs.

The `sailpoint.auth_profile` package is automatically generated by the [OpenAPI Generator](https://openapi-generator.tech) project:
...
In your own code, to use this library to connect and interact with sailpoint.auth-profile,
you can run the following:

```python

import sailpoint.auth_profile
from sailpoint.auth_profile.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to https://sailpoint.api.identitynow.com
# See configuration.py for a list of all supported configuration parameters.
configuration = sailpoint.auth_profile.Configuration(
...
------------ | ------------- | ------------- | -------------
*AuthProfileApi* | [**get_profile_config_list_v1**](sailpoint/auth_profile/docs/AuthProfileApi.md#get_profile_config_list_v1) | **GET** /auth-profiles/v1 | Get list of auth profiles
*AuthProfileApi* | [**get_profile_config_v1**](sailpoint/auth_profile/docs/AuthProfileApi.md#get_profile_config_v1) | **GET** /auth-profiles/v1/{id} | Get auth profile
*AuthProfileApi* | [**patch_profile_config_v1**](sailpoint/auth_profile/docs/AuthProfileApi.md#patch_profile_config_v1) | **PATCH** /auth-profiles/v1/{id} | Patch a specified auth profile
