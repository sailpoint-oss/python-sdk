...
from sailpoint.scheduled_search.api_response import ApiResponse, T as ApiResponseT
import sailpoint.scheduled_search.models
from sailpoint.scheduled_search import rest
from sailpoint.scheduled_search.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.scheduled_search.models, klass)
