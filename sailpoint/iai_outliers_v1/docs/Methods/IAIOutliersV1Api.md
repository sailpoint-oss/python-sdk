...
slug: /tools/sdk/python/v1/methods/iai-outliers
tags: ['SDK', 'Software Development Kit', 'IAI_Outliers', 'IAI_Outliers']
---

# sailpoint.iai_outliers_v1.IAIOutliersV1Api
...
```python
from sailpoint.iai_outliers_v1.api.iai_outliers_v1_api import IAIOutliersV1Api
from sailpoint.iai_outliers_v1.api_client import ApiClient
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = IAIOutliersV1Api(api_client).export_outliers_zip_v1()
        # Below is a request that includes all optional parameters
        # results = IAIOutliersV1Api(api_client).export_outliers_zip_v1(type, x_sail_point_experimental)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = IAIOutliersV1Api(api_client).get_identity_outlier_snapshots_v1()
        # Below is a request that includes all optional parameters
        # results = IAIOutliersV1Api(api_client).get_identity_outlier_snapshots_v1(limit, offset, type, filters, sorters, x_sail_point_experimental)
        print("The response of IAIOutliersV1Api->get_identity_outlier_snapshots_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling IAIOutliersV1Api->get_identity_outlier_snapshots_v1: %s\n" % e)
```
...
from sailpoint.iai_outliers_v1.api.iai_outliers_v1_api import IAIOutliersV1Api
from sailpoint.iai_outliers_v1.api_client import ApiClient
from sailpoint.iai_outliers_v1.models.outlier import Outlier
from sailpoint.configuration import Configuration
configuration = Configuration()
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = IAIOutliersV1Api(api_client).get_identity_outliers_v1()
        # Below is a request that includes all optional parameters
        # results = IAIOutliersV1Api(api_client).get_identity_outliers_v1(limit, offset, count, type, filters, sorters, x_sail_point_experimental)
        print("The response of IAIOutliersV1Api->get_identity_outliers_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling IAIOutliersV1Api->get_identity_outliers_v1: %s\n" % e)
```
...
from sailpoint.iai_outliers_v1.api.iai_outliers_v1_api import IAIOutliersV1Api
from sailpoint.iai_outliers_v1.api_client import ApiClient
from sailpoint.iai_outliers_v1.models.latestoutliersummary import Latestoutliersummary
from sailpoint.configuration import Configuration
configuration = Configuration()
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = IAIOutliersV1Api(api_client).get_latest_identity_outlier_snapshots_v1()
        # Below is a request that includes all optional parameters
        # results = IAIOutliersV1Api(api_client).get_latest_identity_outlier_snapshots_v1(type, x_sail_point_experimental)
        print("The response of IAIOutliersV1Api->get_latest_identity_outlier_snapshots_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling IAIOutliersV1Api->get_latest_identity_outlier_snapshots_v1: %s\n" % e)
```
...
from sailpoint.iai_outliers_v1.api.iai_outliers_v1_api import IAIOutliersV1Api
from sailpoint.iai_outliers_v1.api_client import ApiClient
from sailpoint.iai_outliers_v1.models.outlierfeaturesummary import Outlierfeaturesummary
from sailpoint.configuration import Configuration
configuration = Configuration()
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = IAIOutliersV1Api(api_client).get_outlier_contributing_feature_summary_v1(outlier_feature_id=outlier_feature_id)
        # Below is a request that includes all optional parameters
        # results = IAIOutliersV1Api(api_client).get_outlier_contributing_feature_summary_v1(outlier_feature_id, x_sail_point_experimental)
        print("The response of IAIOutliersV1Api->get_outlier_contributing_feature_summary_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling IAIOutliersV1Api->get_outlier_contributing_feature_summary_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = IAIOutliersV1Api(api_client).get_peer_group_outliers_contributing_features_v1(outlier_id=outlier_id)
        # Below is a request that includes all optional parameters
        # results = IAIOutliersV1Api(api_client).get_peer_group_outliers_contributing_features_v1(outlier_id, limit, offset, count, include_translation_messages, sorters, x_sail_point_experimental)
        print("The response of IAIOutliersV1Api->get_peer_group_outliers_contributing_features_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling IAIOutliersV1Api->get_peer_group_outliers_contributing_features_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        IAIOutliersV1Api(api_client).ignore_identity_outliers_v1(request_body=new_request_body)
        # Below is a request that includes all optional parameters
        # IAIOutliersV1Api(api_client).ignore_identity_outliers_v1(new_request_body, x_sail_point_experimental)
    except Exception as e:
        print("Exception when calling IAIOutliersV1Api->ignore_identity_outliers_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = IAIOutliersV1Api(api_client).list_outliers_contributing_feature_access_items_v1(outlier_id=outlier_id, contributing_feature_name=contributing_feature_name)
        # Below is a request that includes all optional parameters
        # results = IAIOutliersV1Api(api_client).list_outliers_contributing_feature_access_items_v1(outlier_id, contributing_feature_name, limit, offset, count, access_type, sorters, x_sail_point_experimental)
        print("The response of IAIOutliersV1Api->list_outliers_contributing_feature_access_items_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling IAIOutliersV1Api->list_outliers_contributing_feature_access_items_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Iai identity outliers unignore
        new_request_body = RequestBody.from_json(request_body)
        IAIOutliersV1Api(api_client).un_ignore_identity_outliers_v1(request_body=new_request_body)
        # Below is a request that includes all optional parameters
        # IAIOutliersV1Api(api_client).un_ignore_identity_outliers_v1(new_request_body, x_sail_point_experimental)
    except Exception as e:
        print("Exception when calling IAIOutliersV1Api->un_ignore_identity_outliers_v1: %s\n" % e)
```
