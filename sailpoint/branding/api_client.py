...
from sailpoint.branding.api_response import ApiResponse, T as ApiResponseT
import sailpoint.branding.models
from sailpoint.branding import rest
from sailpoint.branding.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.branding.models, klass)
