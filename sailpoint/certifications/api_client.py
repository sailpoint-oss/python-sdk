...
from sailpoint.certifications.api_response import ApiResponse, T as ApiResponseT
import sailpoint.certifications.models
from sailpoint.certifications import rest
from sailpoint.certifications.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.certifications.models, klass)
