...
from sailpoint.notifications.api_response import ApiResponse, T as ApiResponseT
import sailpoint.notifications.models
from sailpoint.notifications import rest
from sailpoint.notifications.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.notifications.models, klass)
