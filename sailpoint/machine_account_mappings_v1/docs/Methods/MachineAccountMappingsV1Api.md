...
slug: /tools/sdk/python/v1/methods/machine-account-mappings
tags: ['SDK', 'Software Development Kit', 'Machine_Account_Mappings', 'Machine_Account_Mappings']
---

# sailpoint.machine_account_mappings_v1.MachineAccountMappingsV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = MachineAccountMappingsV1Api(api_client).create_machine_account_mappings_v1(source_id=source_id, attributemappings=new_attributemappings)
        # Below is a request that includes all optional parameters
        # results = MachineAccountMappingsV1Api(api_client).create_machine_account_mappings_v1(source_id, new_attributemappings)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        MachineAccountMappingsV1Api(api_client).delete_machine_account_mappings_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # MachineAccountMappingsV1Api(api_client).delete_machine_account_mappings_v1(source_id)
    except Exception as e:
        print("Exception when calling MachineAccountMappingsV1Api->delete_machine_account_mappings_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = MachineAccountMappingsV1Api(api_client).list_machine_account_mappings_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = MachineAccountMappingsV1Api(api_client).list_machine_account_mappings_v1(source_id, limit, offset)
        print("The response of MachineAccountMappingsV1Api->list_machine_account_mappings_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling MachineAccountMappingsV1Api->list_machine_account_mappings_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Update source's machine account mappings
        new_attributemappings = Attributemappings.from_json(attributemappings)
        results = MachineAccountMappingsV1Api(api_client).set_machine_account_mappings_v1(source_id=source_id, attributemappings=new_attributemappings)
        # Below is a request that includes all optional parameters
        # results = MachineAccountMappingsV1Api(api_client).set_machine_account_mappings_v1(source_id, new_attributemappings)
        print("The response of MachineAccountMappingsV1Api->set_machine_account_mappings_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling MachineAccountMappingsV1Api->set_machine_account_mappings_v1: %s\n" % e)
```
