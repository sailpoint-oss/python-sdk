...
from sailpoint.machine_account_mappings_v1.api_client import ApiClient, RequestSerialized
from sailpoint.machine_account_mappings_v1.api_response import ApiResponse
from sailpoint.machine_account_mappings_v1.rest import RESTResponseType
...
class MachineAccountMappingsV1Api:
    ...
    @validate_call
    def list_machine_account_mappings_v1(
        self,
        source_id: Annotated[StrictStr, Field(description="Source ID")],
        ...
        _param = self._list_machine_account_mappings_v1_serialize(
            source_id=source_id,
            limit=limit,
            offset=offset,
            _request_auth=_request_auth,
    ...
    @validate_call
    def list_machine_account_mappings_v1_with_http_info(
        self,
        source_id: Annotated[StrictStr, Field(description="Source ID")],
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def list_machine_account_mappings_v1_without_preload_content(
        self,
        source_id: Annotated[StrictStr, Field(description="Source ID")],
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _list_machine_account_mappings_v1_serialize(
        self,
        source_id,
        limit,
        offset,
