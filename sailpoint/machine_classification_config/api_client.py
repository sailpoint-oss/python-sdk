...
from sailpoint.machine_classification_config.api_response import ApiResponse, T as ApiResponseT
import sailpoint.machine_classification_config.models
from sailpoint.machine_classification_config import rest
from sailpoint.machine_classification_config.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.machine_classification_config.models, klass)
