...
slug: /tools/sdk/python/iai-access-request-recommendations/models/error-response-dto
...
messages=[
                    sailpoint.iai_access_request_recommendations.models.error_message_dto.Error Message Dto(
                        locale = 'en-US', 
