...
from sailpoint.ui_metadata.api_response import ApiResponse, T as ApiResponseT
import sailpoint.ui_metadata.models
from sailpoint.ui_metadata import rest
from sailpoint.ui_metadata.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.ui_metadata.models, klass)
