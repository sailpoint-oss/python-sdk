...
from sailpoint.work_reassignment_v1.api_client import ApiClient, RequestSerialized
from sailpoint.work_reassignment_v1.api_response import ApiResponse
from sailpoint.work_reassignment_v1.rest import RESTResponseType
...
class WorkReassignmentV1Api:
    ...
    def _create_reassignment_configuration_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/reassignment-configurations/v1',
    ...
    def delete_reassignment_configuration_v1(
        ...
        _param = self._delete_reassignment_configuration_v1_serialize(
    ...
    def _delete_reassignment_configuration_v1_serialize(
        self,
        identity_id,
        config_type,
        x_sail_point_experimental,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/reassignment-configurations/v1/{identityId}/{configType}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_evaluate_reassignment_configuration_v1(
        ...
        _param = self._get_evaluate_reassignment_configuration_v1_serialize(
            identity_id=identity_id,
            config_type=config_type,
    ...
    def _get_evaluate_reassignment_configuration_v1_serialize(
        self,
        identity_id,
        config_type,
        exclusion_filters,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/reassignment-configurations/v1/{identityId}/evaluate/{configType}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_reassignment_config_types_v1(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_reassignment_config_types_v1_serialize(
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_reassignment_config_types_v1_with_http_info(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_reassignment_config_types_v1_without_preload_content(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_reassignment_config_types_v1_serialize(
        self,
        x_sail_point_experimental,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/reassignment-configurations/v1/types',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_reassignment_configuration_v1(
        self,
        identity_id: Annotated[StrictStr, Field(description="unique identity id")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
        ...
        _param = self._get_reassignment_configuration_v1_serialize(
            identity_id=identity_id,
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_reassignment_configuration_v1_with_http_info(
        self,
        identity_id: Annotated[StrictStr, Field(description="unique identity id")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_reassignment_configuration_v1_without_preload_content(
        self,
        identity_id: Annotated[StrictStr, Field(description="unique identity id")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    def _get_reassignment_configuration_v1_serialize(
        self,
        identity_id,
        x_sail_point_experimental,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/reassignment-configurations/v1/{identityId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_tenant_config_configuration_v1(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_tenant_config_configuration_v1_serialize(
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_tenant_config_configuration_v1_with_http_info(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_tenant_config_configuration_v1_without_preload_content(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_tenant_config_configuration_v1_serialize(
        self,
        x_sail_point_experimental,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/reassignment-configurations/v1/tenant-config',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
