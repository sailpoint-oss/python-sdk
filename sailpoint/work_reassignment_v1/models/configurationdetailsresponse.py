...
class Configurationdetailsresponse(BaseModel):
    ...
    target_identity: Optional[Identity2] = Field(default=None, alias="targetIdentity")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "targetIdentity": Identity2.from_dict(obj["targetIdentity"]) if obj.get("targetIdentity") is not None else None,
