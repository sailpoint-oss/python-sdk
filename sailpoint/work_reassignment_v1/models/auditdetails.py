...
class Auditdetails(BaseModel):
    ...
    created_by: Optional[Identity2] = Field(default=None, alias="createdBy")
    modified: Optional[datetime] = Field(default=None, description="Last modified date and time for the record")
    modified_by: Optional[Identity2] = Field(default=None, alias="modifiedBy")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "createdBy": Identity2.from_dict(obj["createdBy"]) if obj.get("createdBy") is not None else None,
            "modified": obj.get("modified"),
            "modifiedBy": Identity2.from_dict(obj["modifiedBy"]) if obj.get("modifiedBy") is not None else None
        })
        return _obj
