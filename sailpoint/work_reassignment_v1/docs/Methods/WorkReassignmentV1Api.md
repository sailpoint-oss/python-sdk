...
slug: /tools/sdk/python/v1/methods/work-reassignment
tags: ['SDK', 'Software Development Kit', 'Work_Reassignment', 'Work_Reassignment']
---

# sailpoint.work_reassignment_v1.WorkReassignmentV1Api
...
```python
from sailpoint.work_reassignment_v1.api.work_reassignment_v1_api import WorkReassignmentV1Api
from sailpoint.work_reassignment_v1.api_client import ApiClient
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = WorkReassignmentV1Api(api_client).create_reassignment_configuration_v1(configurationitemrequest=new_configurationitemrequest)
        # Below is a request that includes all optional parameters
        # results = WorkReassignmentV1Api(api_client).create_reassignment_configuration_v1(new_configurationitemrequest, x_sail_point_experimental)
...
with ApiClient(configuration) as api_client:
    ...
    config_type = sailpoint.work_reassignment_v1.Configtypeenum() # Configtypeenum |  # Configtypeenum | 
    x_sail_point_experimental = 'true' # str | Use this header to enable this experimental API. (optional) (default to 'true') # str | Use this header to enable this experimental API. (optional) (default to 'true')

    try:
        # Delete reassignment configuration
        
        WorkReassignmentV1Api(api_client).delete_reassignment_configuration_v1(identity_id=identity_id, config_type=config_type)
        # Below is a request that includes all optional parameters
        # WorkReassignmentV1Api(api_client).delete_reassignment_configuration_v1(identity_id, config_type, x_sail_point_experimental)
    except Exception as e:
        print("Exception when calling WorkReassignmentV1Api->delete_reassignment_configuration_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    identity_id = '2c91808781a71ddb0181b9090b5c504e' # str | unique identity id # str | unique identity id
    config_type = sailpoint.work_reassignment_v1.Configtypeenum() # Configtypeenum | Reassignment work type # Configtypeenum | Reassignment work type
    ...
    try:
        ...
        results = WorkReassignmentV1Api(api_client).get_evaluate_reassignment_configuration_v1(identity_id=identity_id, config_type=config_type)
        # Below is a request that includes all optional parameters
        # results = WorkReassignmentV1Api(api_client).get_evaluate_reassignment_configuration_v1(identity_id, config_type, exclusion_filters, x_sail_point_experimental)
        print("The response of WorkReassignmentV1Api->get_evaluate_reassignment_configuration_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkReassignmentV1Api->get_evaluate_reassignment_configuration_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = WorkReassignmentV1Api(api_client).get_reassignment_config_types_v1()
        # Below is a request that includes all optional parameters
        # results = WorkReassignmentV1Api(api_client).get_reassignment_config_types_v1(x_sail_point_experimental)
        print("The response of WorkReassignmentV1Api->get_reassignment_config_types_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkReassignmentV1Api->get_reassignment_config_types_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = WorkReassignmentV1Api(api_client).get_reassignment_configuration_v1(identity_id=identity_id)
        # Below is a request that includes all optional parameters
        # results = WorkReassignmentV1Api(api_client).get_reassignment_configuration_v1(identity_id, x_sail_point_experimental)
        print("The response of WorkReassignmentV1Api->get_reassignment_configuration_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkReassignmentV1Api->get_reassignment_configuration_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = WorkReassignmentV1Api(api_client).get_tenant_config_configuration_v1()
        # Below is a request that includes all optional parameters
        # results = WorkReassignmentV1Api(api_client).get_tenant_config_configuration_v1(x_sail_point_experimental)
        print("The response of WorkReassignmentV1Api->get_tenant_config_configuration_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkReassignmentV1Api->get_tenant_config_configuration_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = WorkReassignmentV1Api(api_client).list_reassignment_configurations_v1()
        # Below is a request that includes all optional parameters
        # results = WorkReassignmentV1Api(api_client).list_reassignment_configurations_v1(x_sail_point_experimental)
        print("The response of WorkReassignmentV1Api->list_reassignment_configurations_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkReassignmentV1Api->list_reassignment_configurations_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Update reassignment configuration
        new_configurationitemrequest = Configurationitemrequest.from_json(configurationitemrequest)
        results = WorkReassignmentV1Api(api_client).put_reassignment_config_v1(identity_id=identity_id, configurationitemrequest=new_configurationitemrequest)
        # Below is a request that includes all optional parameters
        # results = WorkReassignmentV1Api(api_client).put_reassignment_config_v1(identity_id, new_configurationitemrequest, x_sail_point_experimental)
        print("The response of WorkReassignmentV1Api->put_reassignment_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkReassignmentV1Api->put_reassignment_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    tenantconfigurationrequest = '''sailpoint.work_reassignment_v1.Tenantconfigurationrequest()''' # Tenantconfigurationrequest | 
    x_sail_point_experimental = 'true' # str | Use this header to enable this experimental API. (optional) (default to 'true') # str | Use this header to enable this experimental API. (optional) (default to 'true')

    try:
        # Update tenant-wide reassignment configuration settings
        new_tenantconfigurationrequest = Tenantconfigurationrequest.from_json(tenantconfigurationrequest)
        results = WorkReassignmentV1Api(api_client).put_tenant_configuration_v1(tenantconfigurationrequest=new_tenantconfigurationrequest)
        # Below is a request that includes all optional parameters
        # results = WorkReassignmentV1Api(api_client).put_tenant_configuration_v1(new_tenantconfigurationrequest, x_sail_point_experimental)
        print("The response of WorkReassignmentV1Api->put_tenant_configuration_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling WorkReassignmentV1Api->put_tenant_configuration_v1: %s\n" % e)
```
