...
from sailpoint.public_identities_config.api_response import ApiResponse, T as ApiResponseT
import sailpoint.public_identities_config.models
from sailpoint.public_identities_config import rest
from sailpoint.public_identities_config.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.public_identities_config.models, klass)
