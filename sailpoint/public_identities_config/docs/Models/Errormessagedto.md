...
slug: /tools/sdk/python/public-identities-config/models/errormessagedto
...
```python
from sailpoint.public_identities_config.models.errormessagedto import Errormessagedto
