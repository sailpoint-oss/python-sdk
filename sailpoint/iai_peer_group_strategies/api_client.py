...
from sailpoint.iai_peer_group_strategies.api_response import ApiResponse, T as ApiResponseT
import sailpoint.iai_peer_group_strategies.models
from sailpoint.iai_peer_group_strategies import rest
from sailpoint.iai_peer_group_strategies.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.iai_peer_group_strategies.models, klass)
