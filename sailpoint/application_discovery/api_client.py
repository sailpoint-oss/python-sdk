...
from sailpoint.application_discovery.api_response import ApiResponse, T as ApiResponseT
import sailpoint.application_discovery.models
from sailpoint.application_discovery import rest
from sailpoint.application_discovery.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.application_discovery.models, klass)
