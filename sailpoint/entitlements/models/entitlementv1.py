...
class Entitlementv1(BaseModel):
    ...
    privileged: Optional[StrictBool] = Field(default=False, description="True if the entitlementv1 is privileged")
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "attribute", "value", "sourceSchemaObjectType", "description", "privileged", "cloudGoverned", "requestable", "owner", "additionalOwners", "manuallyUpdatedFields", "accessModelMetadata", "created", "modified", "source", "attributes", "segments", "directPermissions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Entitlementv1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Entitlementv1 from a dict"""
        if obj is None:
            return None
