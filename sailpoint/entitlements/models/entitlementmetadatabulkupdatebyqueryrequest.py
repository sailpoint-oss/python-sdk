...
class Entitlementmetadatabulkupdatebyqueryrequest(BaseModel):
    """
    ...
    """ # noqa: E501
    query: Dict[str, Any] = Field(description="The search query selecting the entitlements to update.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Entitlementmetadatabulkupdatebyqueryrequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Entitlementmetadatabulkupdatebyqueryrequest from a dict"""
        if obj is None:
            return None
