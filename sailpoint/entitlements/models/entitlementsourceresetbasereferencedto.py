...
class Entitlementsourceresetbasereferencedto(BaseModel):
    """
    Entitlementsourceresetbasereferencedto
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="The DTO type")
    id: Optional[StrictStr] = Field(default=None, description="The task ID of the object to which this reference applies")
