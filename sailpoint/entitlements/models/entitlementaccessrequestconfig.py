...
class Entitlementaccessrequestconfig(BaseModel):
    ...
    require_end_date: Optional[StrictBool] = Field(default=False, description="If true, then remove date or sunset date is required in access request of the entitlementv1.", alias="requireEndDate")
