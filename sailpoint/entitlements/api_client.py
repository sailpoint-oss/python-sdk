...
from sailpoint.entitlements.api_response import ApiResponse, T as ApiResponseT
import sailpoint.entitlements.models
from sailpoint.entitlements import rest
from sailpoint.entitlements.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.entitlements.models, klass)
