...
class Applicationdiscoveryresponse(BaseModel):
    """
    ...
    type: Optional[StrictStr] = Field(default=None, description="Type of task for app discovery")
    unique_name: Optional[StrictStr] = Field(default=None, description="Name of the task for app discovery", alias="uniqueName")
    description: Optional[StrictStr] = Field(default=None, description="Description of the app discovery aggregation")
    parent_name: Optional[StrictStr] = Field(default=None, description="Name of the parent of the task for app discovery", alias="parentName")
    launcher: Optional[StrictStr] = Field(default=None, description="Service to execute app discovery")
    target: Optional[ApplicationdiscoveryresponseTarget] = None
    created: Optional[datetime] = Field(default=None, description="Creation date of app discovery task")
    modified: Optional[datetime] = Field(default=None, description="Last modification date of app discovery task")
    launched: Optional[datetime] = Field(default=None, description="Launch date of app discovery task")
    completed: Optional[datetime] = Field(default=None, description="Completion date of app discovery task")
    task_definition_summary: Optional[Taskdefinitionsummary] = Field(default=None, alias="taskDefinitionSummary")
    completion_status: Optional[StrictStr] = Field(default=None, description="Completion status of app discovery task", alias="completionStatus")
    messages: Optional[List[Taskstatusmessage]] = Field(default=None, description="Messages associated with the app discovery task")
    returns: Optional[List[Taskreturndetails]] = Field(default=None, description="Return values associated with the app discovery task")
    attributes: Optional[Dict[str, Any]] = Field(default=None, description="Attributes of the app discovery task")
    progress: Optional[StrictStr] = Field(default=None, description="Current progress of aggregation")
    percent_complete: Optional[StrictInt] = Field(default=None, description="Current percentage completion of app discovery task", alias="percentComplete")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Applicationdiscoveryresponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Applicationdiscoveryresponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "target": ApplicationdiscoveryresponseTarget.from_dict(obj["target"]) if obj.get("target") is not None else None,
