...
from sailpoint.application_discovery_v1.api_client import ApiClient, RequestSerialized
from sailpoint.application_discovery_v1.api_response import ApiResponse
from sailpoint.application_discovery_v1.rest import RESTResponseType
...
class ApplicationDiscoveryV1Api:
    ...
    @validate_call
    def get_discovered_applications_v1(
        self,
    ...
    ) -> List[GetDiscoveredApplicationsV1200ResponseInner]:
        ...
        _param = self._get_discovered_applications_v1_serialize(
            limit=limit,
            offset=offset,
            detail=detail,
            filter=filter,
    ...
    @validate_call
    def get_discovered_applications_v1_with_http_info(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        detail: Annotated[Optional[StrictStr], Field(description="Determines whether slim, or increased level of detail is provided for each discovered application in the returned list. SLIM is the default behavior.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[GetDiscoveredApplicationsV1200ResponseInner]]:
        """Get discovered applications for tenant
    ...
    @validate_call
    def get_discovered_applications_v1_without_preload_content(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        detail: Annotated[Optional[StrictStr], Field(description="Determines whether slim, or increased level of detail is provided for each discovered application in the returned list. SLIM is the default behavior.")] = None,
    ...
    def _get_discovered_applications_v1_serialize(
        self,
        limit,
        offset,
        detail,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/discovered-applications/v1',
    ...
    @validate_call
    def get_manual_discover_applications_csv_template_v1(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._get_manual_discover_applications_csv_template_v1_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_manual_discover_applications_csv_template_v1_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_manual_discover_applications_csv_template_v1_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_manual_discover_applications_csv_template_v1_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/manual-discover-applications-template/v1',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def send_manual_discover_applications_csv_template_v1(
        self,
        ...
        _param = self._send_manual_discover_applications_csv_template_v1_serialize(
            file=file,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def send_manual_discover_applications_csv_template_v1_with_http_info(
        self,
        file: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="The CSV file to upload containing `application_name` and `description` columns. Each row represents an application to be discovered.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def send_manual_discover_applications_csv_template_v1_without_preload_content(
        self,
        file: Annotated[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]], Field(description="The CSV file to upload containing `application_name` and `description` columns. Each row represents an application to be discovered.")],
        _request_timeout: Union[
            None,
    ...
    def _send_manual_discover_applications_csv_template_v1_serialize(
        self,
        file,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/manual-discover-applications/v1',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _start_application_discovery_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/sources/v1/{sourceId}/discover-applications',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
