...
from sailpoint.managed_clusters.api_response import ApiResponse, T as ApiResponseT
import sailpoint.managed_clusters.models
from sailpoint.managed_clusters import rest
from sailpoint.managed_clusters.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.managed_clusters.models, klass)
