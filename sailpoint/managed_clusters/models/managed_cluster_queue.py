...
class ManagedClusterQueue(BaseModel):
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="ManagedCluster queue name")
    region: Optional[StrictStr] = Field(default=None, description="ManagedCluster queue aws region")
