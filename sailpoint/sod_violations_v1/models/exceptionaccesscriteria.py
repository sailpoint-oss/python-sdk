...
class Exceptionaccesscriteria(BaseModel):
    ...
    """ # noqa: E501
    left_criteria: Optional[Exceptioncriteria] = Field(default=None, alias="leftCriteria")
    right_criteria: Optional[Exceptioncriteria] = Field(default=None, alias="rightCriteria")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leftCriteria": Exceptioncriteria.from_dict(obj["leftCriteria"]) if obj.get("leftCriteria") is not None else None,
            "rightCriteria": Exceptioncriteria.from_dict(obj["rightCriteria"]) if obj.get("rightCriteria") is not None else None
        })
        return _obj
