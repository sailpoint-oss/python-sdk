...
from sailpoint.role_propagation.api_response import ApiResponse, T as ApiResponseT
import sailpoint.role_propagation.models
from sailpoint.role_propagation import rest
from sailpoint.role_propagation.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.role_propagation.models, klass)
