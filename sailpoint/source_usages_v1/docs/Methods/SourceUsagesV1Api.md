...
slug: /tools/sdk/python/v1/methods/source-usages
tags: ['SDK', 'Software Development Kit', 'Source_Usages', 'Source_Usages']
---

# sailpoint.source_usages_v1.SourceUsagesV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourceUsagesV1Api(api_client).get_status_by_source_id_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = SourceUsagesV1Api(api_client).get_status_by_source_id_v1(source_id)
...
### Return type
[**List[Sourceusage]**](../models/sourceusage)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SourceUsagesV1Api(api_client).get_usages_by_source_id_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = SourceUsagesV1Api(api_client).get_usages_by_source_id_v1(source_id, limit, offset, count, sorters)
        print("The response of SourceUsagesV1Api->get_usages_by_source_id_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SourceUsagesV1Api->get_usages_by_source_id_v1: %s\n" % e)
```
