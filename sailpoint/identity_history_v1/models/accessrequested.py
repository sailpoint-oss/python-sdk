...
class Accessrequested(BaseModel):
    ...
    Accessrequested
    """ # noqa: E501
    access_request: Accessrequestresponse2 = Field(alias="accessRequest")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accessRequest": Accessrequestresponse2.from_dict(obj["accessRequest"]) if obj.get("accessRequest") is not None else None,
