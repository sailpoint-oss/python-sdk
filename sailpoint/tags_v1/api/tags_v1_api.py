...
from sailpoint.tags_v1.api_client import ApiClient, RequestSerialized
from sailpoint.tags_v1.api_response import ApiResponse
from sailpoint.tags_v1.rest import RESTResponseType
...
class TagsV1Api:
    ...
    def create_tag_v1(
        ...
        _param = self._create_tag_v1_serialize(
            tag2=tag2,
    ...
    @validate_call
    def create_tag_v1_with_http_info(
        self,
        tag2: Tag2,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_tag_v1_without_preload_content(
        self,
        tag2: Tag2,
        _request_timeout: Union[
            None,
    ...
    def delete_tag_by_id_v1(
        ...
        _param = self._delete_tag_by_id_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_tag_by_id_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the object reference to delete.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_tag_by_id_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the object reference to delete.")],
        _request_timeout: Union[
            None,
    ...
    def _delete_tag_by_id_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def get_tag_by_id_v1(
        ...
        _param = self._get_tag_by_id_v1_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_tag_by_id_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the object reference to retrieve.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_tag_by_id_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The ID of the object reference to retrieve.")],
        _request_timeout: Union[
            None,
    ...
    def _get_tag_by_id_v1_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def list_tags_v1(
        ...
        _param = self._list_tags_v1_serialize(
            limit=limit,
            offset=offset,
            count=count,
            filters=filters,
    ...
    @validate_call
    def list_tags_v1_with_http_info(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def list_tags_v1_without_preload_content(
        self,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        count: Annotated[Optional[StrictBool], Field(description="If *true* it will populate the *X-Total-Count* response header with the number of results that would be returned if *limit* and *offset* were ignored.  Since requesting a total count can have a performance impact, it is recommended not to send **count=true** if that value will not be used.  See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
