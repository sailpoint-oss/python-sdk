...
slug: /tools/sdk/python/v1/methods/tags
tags: ['SDK', 'Software Development Kit', 'Tags', 'Tags']
---

# sailpoint.tags_v1.TagsV1Api
...
```python
from sailpoint.tags_v1.api.tags_v1_api import TagsV1Api
from sailpoint.tags_v1.api_client import ApiClient
from sailpoint.tags_v1.models.tag2 import Tag2
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = TagsV1Api(api_client).create_tag_v1(tag2=new_tag2)
        # Below is a request that includes all optional parameters
        # results = TagsV1Api(api_client).create_tag_v1(new_tag2)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        TagsV1Api(api_client).delete_tag_by_id_v1(id=id)
        # Below is a request that includes all optional parameters
        # TagsV1Api(api_client).delete_tag_by_id_v1(id)
    except Exception as e:
        print("Exception when calling TagsV1Api->delete_tag_by_id_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = TagsV1Api(api_client).get_tag_by_id_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = TagsV1Api(api_client).get_tag_by_id_v1(id)
        print("The response of TagsV1Api->get_tag_by_id_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling TagsV1Api->get_tag_by_id_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = TagsV1Api(api_client).list_tags_v1()
        # Below is a request that includes all optional parameters
        # results = TagsV1Api(api_client).list_tags_v1(limit, offset, count, filters, sorters)
        print("The response of TagsV1Api->list_tags_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling TagsV1Api->list_tags_v1: %s\n" % e)
```
