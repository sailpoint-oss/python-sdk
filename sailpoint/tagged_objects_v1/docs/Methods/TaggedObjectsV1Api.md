...
slug: /tools/sdk/python/v1/methods/tagged-objects
tags: ['SDK', 'Software Development Kit', 'Tagged_Objects', 'Tagged_Objects']
---

# sailpoint.tagged_objects_v1.TaggedObjectsV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        TaggedObjectsV1Api(api_client).delete_tagged_object_v1(type=type, id=id)
        # Below is a request that includes all optional parameters
        # TaggedObjectsV1Api(api_client).delete_tagged_object_v1(type, id)
...
with ApiClient(configuration) as api_client:
    bulkremovetaggedobject = '''sailpoint.tagged_objects_v1.Bulkremovetaggedobject()''' # Bulkremovetaggedobject | Supported object types are ACCESS_PROFILE, APPLICATION, CAMPAIGN, ENTITLEMENT, IDENTITY, ROLE, SOD_POLICY, SOURCE.

    try:
        # Remove tags from multiple objects
        new_bulkremovetaggedobject = Bulkremovetaggedobject.from_json(bulkremovetaggedobject)
        TaggedObjectsV1Api(api_client).delete_tags_to_many_object_v1(bulkremovetaggedobject=new_bulkremovetaggedobject)
        # Below is a request that includes all optional parameters
        # TaggedObjectsV1Api(api_client).delete_tags_to_many_object_v1(new_bulkremovetaggedobject)
    except Exception as e:
        print("Exception when calling TaggedObjectsV1Api->delete_tags_to_many_object_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = TaggedObjectsV1Api(api_client).get_tagged_object_v1(type=type, id=id)
        # Below is a request that includes all optional parameters
        # results = TaggedObjectsV1Api(api_client).get_tagged_object_v1(type, id)
        print("The response of TaggedObjectsV1Api->get_tagged_object_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling TaggedObjectsV1Api->get_tagged_object_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = TaggedObjectsV1Api(api_client).list_tagged_objects_by_type_v1(type=type)
        # Below is a request that includes all optional parameters
        # results = TaggedObjectsV1Api(api_client).list_tagged_objects_by_type_v1(type, limit, offset, count, filters)
        print("The response of TaggedObjectsV1Api->list_tagged_objects_by_type_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling TaggedObjectsV1Api->list_tagged_objects_by_type_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = TaggedObjectsV1Api(api_client).list_tagged_objects_v1()
        # Below is a request that includes all optional parameters
        # results = TaggedObjectsV1Api(api_client).list_tagged_objects_v1(limit, offset, count, filters)
        print("The response of TaggedObjectsV1Api->list_tagged_objects_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling TaggedObjectsV1Api->list_tagged_objects_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    taggedobject = '''sailpoint.tagged_objects_v1.Taggedobject()''' # Taggedobject | 

    try:
        # Update tagged object
        new_taggedobject = Taggedobject.from_json(taggedobject)
        results = TaggedObjectsV1Api(api_client).put_tagged_object_v1(type=type, id=id, taggedobject=new_taggedobject)
        # Below is a request that includes all optional parameters
        # results = TaggedObjectsV1Api(api_client).put_tagged_object_v1(type, id, new_taggedobject)
        print("The response of TaggedObjectsV1Api->put_tagged_object_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling TaggedObjectsV1Api->put_tagged_object_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Add tag to object
        new_taggedobject = Taggedobject.from_json(taggedobject)
        TaggedObjectsV1Api(api_client).set_tag_to_object_v1(taggedobject=new_taggedobject)
        # Below is a request that includes all optional parameters
        # TaggedObjectsV1Api(api_client).set_tag_to_object_v1(new_taggedobject)
    except Exception as e:
        print("Exception when calling TaggedObjectsV1Api->set_tag_to_object_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    bulkaddtaggedobject = '''sailpoint.tagged_objects_v1.Bulkaddtaggedobject()''' # Bulkaddtaggedobject | Supported object types are ACCESS_PROFILE, APPLICATION, CAMPAIGN, ENTITLEMENT, IDENTITY, ROLE, SOD_POLICY, SOURCE.

    try:
        # Tag multiple objects
        new_bulkaddtaggedobject = Bulkaddtaggedobject.from_json(bulkaddtaggedobject)
        results = TaggedObjectsV1Api(api_client).set_tags_to_many_objects_v1(bulkaddtaggedobject=new_bulkaddtaggedobject)
        # Below is a request that includes all optional parameters
        # results = TaggedObjectsV1Api(api_client).set_tags_to_many_objects_v1(new_bulkaddtaggedobject)
        print("The response of TaggedObjectsV1Api->set_tags_to_many_objects_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling TaggedObjectsV1Api->set_tags_to_many_objects_v1: %s\n" % e)
```
