...
from sailpoint.mfa_configuration.api_response import ApiResponse, T as ApiResponseT
import sailpoint.mfa_configuration.models
from sailpoint.mfa_configuration import rest
from sailpoint.mfa_configuration.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.mfa_configuration.models, klass)
