...
from sailpoint.configuration_hub.api_response import ApiResponse, T as ApiResponseT
import sailpoint.configuration_hub.models
from sailpoint.configuration_hub import rest
from sailpoint.configuration_hub.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.configuration_hub.models, klass)
