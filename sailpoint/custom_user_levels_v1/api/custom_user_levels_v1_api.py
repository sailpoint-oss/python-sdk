...
from sailpoint.custom_user_levels_v1.api_client import ApiClient, RequestSerialized
from sailpoint.custom_user_levels_v1.api_response import ApiResponse
from sailpoint.custom_user_levels_v1.rest import RESTResponseType
...
class CustomUserLevelsV1Api:
    ...
    def _create_custom_user_level_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/authorization/v1/custom-user-levels',
    ...
    def delete_user_level_v1(
        ...
        _param = self._delete_user_level_v1_serialize(
            id=id,
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_user_level_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the user level.")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def delete_user_level_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the user level.")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    def _delete_user_level_v1_serialize(
        self,
        id,
        x_sail_point_experimental,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/authorization/v1/custom-user-levels/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_user_level_v1(
        ...
        _param = self._get_user_level_v1_serialize(
            id=id,
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_user_level_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the user level.")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_user_level_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the user level.")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    def _get_user_level_v1_serialize(
        self,
        id,
        x_sail_point_experimental,
        _request_auth,
    ...
    @validate_call
    def list_all_authorization_right_sets_v1(
        self,
        ...
        _param = self._list_all_authorization_right_sets_v1_serialize(
            x_sail_point_experimental=x_sail_point_experimental,
            filters=filters,
            sorters=sorters,
            limit=limit,
    ...
    @validate_call
    def list_all_authorization_right_sets_v1_with_http_info(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **category**: *eq*")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **id, name, category**")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def list_all_authorization_right_sets_v1_without_preload_content(
        self,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **category**: *eq*")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **id, name, category**")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _list_all_authorization_right_sets_v1_serialize(
        self,
        x_sail_point_experimental,
        filters,
        sorters,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/authorization/v1/authorization-assignable-right-sets',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def list_user_level_identities_v1(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the user level.")],
        ...
        _param = self._list_user_level_identities_v1_serialize(
            id=id,
            x_sail_point_experimental=x_sail_point_experimental,
            count=count,
            sorters=sorters,
    ...
    @validate_call
    def list_user_level_identities_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the user level.")],
        count: Annotated[Optional[StrictBool], Field(description="If true, X-Total-Count header with the the total number of identities for this user level will be included in the response.")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **displayName**")] = None,
    ...
    @validate_call
    def list_user_level_identities_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the user level.")],
        count: Annotated[Optional[StrictBool], Field(description="If true, X-Total-Count header with the the total number of identities for this user level will be included in the response.")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **displayName**")] = None,
    ...
    def _list_user_level_identities_v1_serialize(
        self,
        id,
        x_sail_point_experimental,
        count,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/authorization/v1/user-levels/{id}/identities',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_user_levels_v1(
        ...
        _param = self._list_user_levels_v1_serialize(
            x_sail_point_experimental=x_sail_point_experimental,
    ...
    @validate_call
    def list_user_levels_v1_with_http_info(
        self,
        detail_level: Annotated[Optional[StrictStr], Field(description="Specifies the level of detail for the user levels.")] = None,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **name**: *co*    **owner**: *co*    **status**: *eq*  **description**: *co*")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **name, created, description, status, owner**")] = None,
    ...
    @validate_call
    def list_user_levels_v1_without_preload_content(
        self,
        detail_level: Annotated[Optional[StrictStr], Field(description="Specifies the level of detail for the user levels.")] = None,
        filters: Annotated[Optional[StrictStr], Field(description="Filter results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#filtering-results)  Filtering is supported for the following fields and operators:  **name**: *co*    **owner**: *co*    **status**: *eq*  **description**: *co*")] = None,
        sorters: Annotated[Optional[StrictStr], Field(description="Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **name, created, description, status, owner**")] = None,
    ...
    def _list_user_levels_v1_serialize(
        self,
        x_sail_point_experimental,
        detail_level,
        filters,
    ...
    @validate_call
    def publish_custom_user_level_v1(
        self,
        ...
        _param = self._publish_custom_user_level_v1_serialize(
            id=id,
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def publish_custom_user_level_v1_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the user level to publish.")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def publish_custom_user_level_v1_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the user level to publish.")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    def _publish_custom_user_level_v1_serialize(
        self,
        id,
        x_sail_point_experimental,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/authorization/v1/custom-user-levels/{id}/publish',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def show_user_level_counts_v1(
        ...
        _param = self._show_user_level_counts_v1_serialize(
    ...
    @validate_call
    def show_user_level_counts_v1_with_http_info(
        self,
        request_body: Annotated[List[StrictStr], Field(description="List of user level ids. Max 50 identifiers can be passed in a single request.")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def show_user_level_counts_v1_without_preload_content(
        self,
        request_body: Annotated[List[StrictStr], Field(description="List of user level ids. Max 50 identifiers can be passed in a single request.")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    def _show_user_level_counts_v1_serialize(
        self,
        request_body,
        x_sail_point_experimental,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/authorization/v1/user-levels/get-identity-count',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
