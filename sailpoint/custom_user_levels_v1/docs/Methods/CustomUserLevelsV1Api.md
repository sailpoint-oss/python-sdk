...
slug: /tools/sdk/python/v1/methods/custom-user-levels
tags: ['SDK', 'Software Development Kit', 'Custom_User_Levels', 'Custom_User_Levels']
---

# sailpoint.custom_user_levels_v1.CustomUserLevelsV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CustomUserLevelsV1Api(api_client).create_custom_user_level_v1(userlevelrequest=new_userlevelrequest)
        # Below is a request that includes all optional parameters
        # results = CustomUserLevelsV1Api(api_client).create_custom_user_level_v1(new_userlevelrequest, x_sail_point_experimental)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        CustomUserLevelsV1Api(api_client).delete_user_level_v1(id=id)
        # Below is a request that includes all optional parameters
        # CustomUserLevelsV1Api(api_client).delete_user_level_v1(id, x_sail_point_experimental)
    except Exception as e:
        print("Exception when calling CustomUserLevelsV1Api->delete_user_level_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CustomUserLevelsV1Api(api_client).get_user_level_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = CustomUserLevelsV1Api(api_client).get_user_level_v1(id, x_sail_point_experimental)
        print("The response of CustomUserLevelsV1Api->get_user_level_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CustomUserLevelsV1Api->get_user_level_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CustomUserLevelsV1Api(api_client).list_all_authorization_right_sets_v1()
        # Below is a request that includes all optional parameters
        # results = CustomUserLevelsV1Api(api_client).list_all_authorization_right_sets_v1(x_sail_point_experimental, filters, sorters, limit, offset)
        print("The response of CustomUserLevelsV1Api->list_all_authorization_right_sets_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CustomUserLevelsV1Api->list_all_authorization_right_sets_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CustomUserLevelsV1Api(api_client).list_user_level_identities_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = CustomUserLevelsV1Api(api_client).list_user_level_identities_v1(id, x_sail_point_experimental, count, sorters, limit, offset)
        print("The response of CustomUserLevelsV1Api->list_user_level_identities_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CustomUserLevelsV1Api->list_user_level_identities_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CustomUserLevelsV1Api(api_client).list_user_levels_v1()
        # Below is a request that includes all optional parameters
        # results = CustomUserLevelsV1Api(api_client).list_user_levels_v1(x_sail_point_experimental, detail_level, filters, sorters, limit, offset)
        print("The response of CustomUserLevelsV1Api->list_user_levels_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CustomUserLevelsV1Api->list_user_levels_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CustomUserLevelsV1Api(api_client).publish_custom_user_level_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = CustomUserLevelsV1Api(api_client).publish_custom_user_level_v1(id, x_sail_point_experimental)
        print("The response of CustomUserLevelsV1Api->publish_custom_user_level_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CustomUserLevelsV1Api->publish_custom_user_level_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CustomUserLevelsV1Api(api_client).show_user_level_counts_v1(request_body=new_request_body)
        # Below is a request that includes all optional parameters
        # results = CustomUserLevelsV1Api(api_client).show_user_level_counts_v1(new_request_body, x_sail_point_experimental)
        print("The response of CustomUserLevelsV1Api->show_user_level_counts_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CustomUserLevelsV1Api->show_user_level_counts_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CustomUserLevelsV1Api(api_client).update_user_level_v1(id=id, jsonpatch=new_jsonpatch)
        # Below is a request that includes all optional parameters
        # results = CustomUserLevelsV1Api(api_client).update_user_level_v1(id, new_jsonpatch, x_sail_point_experimental)
        print("The response of CustomUserLevelsV1Api->update_user_level_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CustomUserLevelsV1Api->update_user_level_v1: %s\n" % e)
```
