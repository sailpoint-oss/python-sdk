...
from sailpoint.password_management.api_response import ApiResponse, T as ApiResponseT
import sailpoint.password_management.models
from sailpoint.password_management import rest
from sailpoint.password_management.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.password_management.models, klass)
