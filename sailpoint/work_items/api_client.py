...
from sailpoint.work_items.api_response import ApiResponse, T as ApiResponseT
import sailpoint.work_items.models
from sailpoint.work_items import rest
from sailpoint.work_items.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.work_items.models, klass)
