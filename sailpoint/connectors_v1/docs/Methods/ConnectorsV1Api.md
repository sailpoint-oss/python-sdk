...
slug: /tools/sdk/python/v1/methods/connectors
tags: ['SDK', 'Software Development Kit', 'Connectors', 'Connectors']
---

# sailpoint.connectors_v1.ConnectorsV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConnectorsV1Api(api_client).create_custom_connector_v1(v3createconnectordto=new_v3createconnectordto)
        # Below is a request that includes all optional parameters
        # results = ConnectorsV1Api(api_client).create_custom_connector_v1(new_v3createconnectordto)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        ConnectorsV1Api(api_client).delete_custom_connector_v1(script_name=script_name)
        # Below is a request that includes all optional parameters
        # ConnectorsV1Api(api_client).delete_custom_connector_v1(script_name)
    except Exception as e:
        print("Exception when calling ConnectorsV1Api->delete_custom_connector_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConnectorsV1Api(api_client).get_connector_correlation_config_v1(script_name=script_name)
        # Below is a request that includes all optional parameters
        # results = ConnectorsV1Api(api_client).get_connector_correlation_config_v1(script_name)
        print("The response of ConnectorsV1Api->get_connector_correlation_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConnectorsV1Api->get_connector_correlation_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConnectorsV1Api(api_client).get_connector_list_v1()
        # Below is a request that includes all optional parameters
        # results = ConnectorsV1Api(api_client).get_connector_list_v1(filters, limit, offset, count, locale)
        print("The response of ConnectorsV1Api->get_connector_list_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConnectorsV1Api->get_connector_list_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConnectorsV1Api(api_client).get_connector_source_config_v1(script_name=script_name)
        # Below is a request that includes all optional parameters
        # results = ConnectorsV1Api(api_client).get_connector_source_config_v1(script_name)
        print("The response of ConnectorsV1Api->get_connector_source_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConnectorsV1Api->get_connector_source_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConnectorsV1Api(api_client).get_connector_source_template_v1(script_name=script_name)
        # Below is a request that includes all optional parameters
        # results = ConnectorsV1Api(api_client).get_connector_source_template_v1(script_name)
        print("The response of ConnectorsV1Api->get_connector_source_template_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConnectorsV1Api->get_connector_source_template_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConnectorsV1Api(api_client).get_connector_translations_v1(script_name=script_name, locale=locale)
        # Below is a request that includes all optional parameters
        # results = ConnectorsV1Api(api_client).get_connector_translations_v1(script_name, locale)
        print("The response of ConnectorsV1Api->get_connector_translations_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConnectorsV1Api->get_connector_translations_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConnectorsV1Api(api_client).get_connector_v1(script_name=script_name)
        # Below is a request that includes all optional parameters
        # results = ConnectorsV1Api(api_client).get_connector_v1(script_name, locale)
        print("The response of ConnectorsV1Api->get_connector_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConnectorsV1Api->get_connector_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConnectorsV1Api(api_client).put_connector_correlation_config_v1(script_name=script_name, file=file)
        # Below is a request that includes all optional parameters
        # results = ConnectorsV1Api(api_client).put_connector_correlation_config_v1(script_name, file)
        print("The response of ConnectorsV1Api->put_connector_correlation_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConnectorsV1Api->put_connector_correlation_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConnectorsV1Api(api_client).put_connector_source_config_v1(script_name=script_name, file=file)
        # Below is a request that includes all optional parameters
        # results = ConnectorsV1Api(api_client).put_connector_source_config_v1(script_name, file)
        print("The response of ConnectorsV1Api->put_connector_source_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConnectorsV1Api->put_connector_source_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConnectorsV1Api(api_client).put_connector_source_template_v1(script_name=script_name, file=file)
        # Below is a request that includes all optional parameters
        # results = ConnectorsV1Api(api_client).put_connector_source_template_v1(script_name, file)
        print("The response of ConnectorsV1Api->put_connector_source_template_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConnectorsV1Api->put_connector_source_template_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ConnectorsV1Api(api_client).put_connector_translations_v1(script_name=script_name, locale=locale)
        # Below is a request that includes all optional parameters
        # results = ConnectorsV1Api(api_client).put_connector_translations_v1(script_name, locale)
        print("The response of ConnectorsV1Api->put_connector_translations_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConnectorsV1Api->put_connector_translations_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    script_name = 'aScriptName' # str | The scriptName value of the connector. ScriptName is the unique id generated at connector creation. # str | The scriptName value of the connector. ScriptName is the unique id generated at connector creation.
    jsonpatchoperation = '''[sailpoint.connectors_v1.Jsonpatchoperation()]''' # List[Jsonpatchoperation] | A list of connector detail update operations 

    try:
        # Update connector by script name
        new_jsonpatchoperation = Jsonpatchoperation.from_json(jsonpatchoperation)
        results = ConnectorsV1Api(api_client).update_connector_v1(script_name=script_name, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = ConnectorsV1Api(api_client).update_connector_v1(script_name, new_jsonpatchoperation)
        print("The response of ConnectorsV1Api->update_connector_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ConnectorsV1Api->update_connector_v1: %s\n" % e)
```
