...
class Identityattributeconfig(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.attribute_transforms:
            for _item_attribute_transforms in self.attribute_transforms:
                if _item_attribute_transforms:
                    _items.append(_item_attribute_transforms.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attributeTransforms": [Identityattributetransform.from_dict(_item) for _item in obj["attributeTransforms"]] if obj.get("attributeTransforms") is not None else None
        })
        return _obj
