...
*VendorConnectorMapppingApi* | [**get_vendor_connector_mappings**](sailpoint/v3/docs/VendorConnectorMapppingApi.md#get_vendor_connector_mappings) | **GET** /vendor-connector-mappings | List Vendor Connector Mappings
