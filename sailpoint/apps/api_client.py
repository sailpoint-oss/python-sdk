...
from sailpoint.apps.api_response import ApiResponse, T as ApiResponseT
import sailpoint.apps.models
from sailpoint.apps import rest
from sailpoint.apps.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.apps.models, klass)
