...
from sailpoint.launchers.api_response import ApiResponse, T as ApiResponseT
import sailpoint.launchers.models
from sailpoint.launchers import rest
from sailpoint.launchers.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.launchers.models, klass)
