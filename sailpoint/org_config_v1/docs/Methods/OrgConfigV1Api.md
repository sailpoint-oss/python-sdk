...
slug: /tools/sdk/python/v1/methods/org-config
tags: ['SDK', 'Software Development Kit', 'Org_Config', 'Org_Config']
---

# sailpoint.org_config_v1.OrgConfigV1Api
...
```python
from sailpoint.org_config_v1.api.org_config_v1_api import OrgConfigV1Api
from sailpoint.org_config_v1.api_client import ApiClient
from sailpoint.org_config_v1.models.orgconfig import Orgconfig
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = OrgConfigV1Api(api_client).get_org_config_v1()
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = OrgConfigV1Api(api_client).get_valid_time_zones_v1()
        # Below is a request that includes all optional parameters
        # results = OrgConfigV1Api(api_client).get_valid_time_zones_v1(x_sail_point_experimental, limit, offset, count)
        print("The response of OrgConfigV1Api->get_valid_time_zones_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling OrgConfigV1Api->get_valid_time_zones_v1: %s\n" % e)
```
...
from sailpoint.org_config_v1.api.org_config_v1_api import OrgConfigV1Api
from sailpoint.org_config_v1.api_client import ApiClient
from sailpoint.org_config_v1.models.jsonpatchoperation import Jsonpatchoperation
from sailpoint.org_config_v1.models.orgconfig import Orgconfig
from sailpoint.configuration import Configuration
configuration = Configuration()
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = OrgConfigV1Api(api_client).patch_org_config_v1(jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = OrgConfigV1Api(api_client).patch_org_config_v1(new_jsonpatchoperation)
        print("The response of OrgConfigV1Api->patch_org_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling OrgConfigV1Api->patch_org_config_v1: %s\n" % e)
```
