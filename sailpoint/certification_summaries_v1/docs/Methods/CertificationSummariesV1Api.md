...
slug: /tools/sdk/python/v1/methods/certification-summaries
tags: ['SDK', 'Software Development Kit', 'Certification_Summaries', 'Certification_Summaries']
---

# sailpoint.certification_summaries_v1.CertificationSummariesV1Api
...
### Return type
[**List[Accesssummary]**](../models/accesssummary)
...
401 | Unauthorized - Returned if there is no authorization header, or if the JWT token is expired. | GetIdentityDecisionSummaryV1401Response |  -  |
403 | Forbidden - Returned if the user you are running as, doesn&#39;t have access to this end-point. | Errorresponsedto |  -  |
404 | Not Found - returned if the request URL refers to a resource or object that does not exist | Errorresponsedto |  -  |
429 | Too Many Requests - Returned in response to too many requests in a given period of time - rate limited. The Retry-After header in the response includes how long to wait before trying again. | GetIdentityDecisionSummaryV1429Response |  -  |
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CertificationSummariesV1Api(api_client).get_identity_access_summaries_v1(id=id, type=type)
        # Below is a request that includes all optional parameters
        # results = CertificationSummariesV1Api(api_client).get_identity_access_summaries_v1(id, type, limit, offset, count, filters, sorters)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CertificationSummariesV1Api(api_client).get_identity_decision_summary_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = CertificationSummariesV1Api(api_client).get_identity_decision_summary_v1(id, filters)
        print("The response of CertificationSummariesV1Api->get_identity_decision_summary_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationSummariesV1Api->get_identity_decision_summary_v1: %s\n" % e)
```
...
### Return type
[**List[Certificationidentitysummary]**](../models/certificationidentitysummary)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CertificationSummariesV1Api(api_client).get_identity_summaries_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = CertificationSummariesV1Api(api_client).get_identity_summaries_v1(id, limit, offset, count, filters, sorters)
        print("The response of CertificationSummariesV1Api->get_identity_summaries_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationSummariesV1Api->get_identity_summaries_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = CertificationSummariesV1Api(api_client).get_identity_summary_v1(id=id, identity_summary_id=identity_summary_id)
        # Below is a request that includes all optional parameters
        # results = CertificationSummariesV1Api(api_client).get_identity_summary_v1(id, identity_summary_id)
        print("The response of CertificationSummariesV1Api->get_identity_summary_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling CertificationSummariesV1Api->get_identity_summary_v1: %s\n" % e)
```
