...
from sailpoint.service_desk_integration.api_response import ApiResponse, T as ApiResponseT
import sailpoint.service_desk_integration.models
from sailpoint.service_desk_integration import rest
from sailpoint.service_desk_integration.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.service_desk_integration.models, klass)
