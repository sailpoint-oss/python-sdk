...
slug: /tools/sdk/python/v1/methods/lifecycle-states
tags: ['SDK', 'Software Development Kit', 'Lifecycle_States', 'Lifecycle_States']
---

# sailpoint.lifecycle_states_v1.LifecycleStatesV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = LifecycleStatesV1Api(api_client).create_lifecycle_state_v1(identity_profile_id=identity_profile_id, lifecyclestate=new_lifecyclestate)
        # Below is a request that includes all optional parameters
        # results = LifecycleStatesV1Api(api_client).create_lifecycle_state_v1(identity_profile_id, new_lifecyclestate)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = LifecycleStatesV1Api(api_client).delete_lifecycle_state_v1(identity_profile_id=identity_profile_id, lifecycle_state_id=lifecycle_state_id)
        # Below is a request that includes all optional parameters
        # results = LifecycleStatesV1Api(api_client).delete_lifecycle_state_v1(identity_profile_id, lifecycle_state_id)
        print("The response of LifecycleStatesV1Api->delete_lifecycle_state_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling LifecycleStatesV1Api->delete_lifecycle_state_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = LifecycleStatesV1Api(api_client).get_lifecycle_state_v1(identity_profile_id=identity_profile_id, lifecycle_state_id=lifecycle_state_id)
        # Below is a request that includes all optional parameters
        # results = LifecycleStatesV1Api(api_client).get_lifecycle_state_v1(identity_profile_id, lifecycle_state_id)
        print("The response of LifecycleStatesV1Api->get_lifecycle_state_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling LifecycleStatesV1Api->get_lifecycle_state_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = LifecycleStatesV1Api(api_client).get_lifecycle_states_v1(identity_profile_id=identity_profile_id)
        # Below is a request that includes all optional parameters
        # results = LifecycleStatesV1Api(api_client).get_lifecycle_states_v1(identity_profile_id, limit, offset, count, sorters)
        print("The response of LifecycleStatesV1Api->get_lifecycle_states_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling LifecycleStatesV1Api->get_lifecycle_states_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    set_lifecycle_state_v1_request = '''sailpoint.lifecycle_states_v1.SetLifecycleStateV1Request()''' # SetLifecycleStateV1Request | 

    try:
        # Set lifecycle state
        new_set_lifecycle_state_v1_request = SetLifecycleStateV1Request.from_json(set_lifecycle_state_v1_request)
        results = LifecycleStatesV1Api(api_client).set_lifecycle_state_v1(identity_id=identity_id, set_lifecycle_state_v1_request=new_set_lifecycle_state_v1_request)
        # Below is a request that includes all optional parameters
        # results = LifecycleStatesV1Api(api_client).set_lifecycle_state_v1(identity_id, new_set_lifecycle_state_v1_request)
        print("The response of LifecycleStatesV1Api->set_lifecycle_state_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling LifecycleStatesV1Api->set_lifecycle_state_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = LifecycleStatesV1Api(api_client).update_lifecycle_states_v1(identity_profile_id=identity_profile_id, lifecycle_state_id=lifecycle_state_id, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = LifecycleStatesV1Api(api_client).update_lifecycle_states_v1(identity_profile_id, lifecycle_state_id, new_jsonpatchoperation)
        print("The response of LifecycleStatesV1Api->update_lifecycle_states_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling LifecycleStatesV1Api->update_lifecycle_states_v1: %s\n" % e)
```
