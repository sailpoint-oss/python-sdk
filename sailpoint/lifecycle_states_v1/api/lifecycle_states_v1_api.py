...
from sailpoint.lifecycle_states_v1.api_client import ApiClient, RequestSerialized
from sailpoint.lifecycle_states_v1.api_response import ApiResponse
from sailpoint.lifecycle_states_v1.rest import RESTResponseType
...
class LifecycleStatesV1Api:
    ...
    def _create_lifecycle_state_v1_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/identity-profiles/v1/{identity-profile-id}/lifecycle-states',
    ...
    def delete_lifecycle_state_v1(
        ...
        _param = self._delete_lifecycle_state_v1_serialize(
            identity_profile_id=identity_profile_id,
    ...
    @validate_call
    def delete_lifecycle_state_v1_with_http_info(
        self,
        identity_profile_id: Annotated[StrictStr, Field(description="Identity profile ID.")],
        lifecycle_state_id: Annotated[StrictStr, Field(description="Lifecycle state ID.")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_lifecycle_state_v1_without_preload_content(
        self,
        identity_profile_id: Annotated[StrictStr, Field(description="Identity profile ID.")],
        lifecycle_state_id: Annotated[StrictStr, Field(description="Lifecycle state ID.")],
        _request_timeout: Union[
    ...
    def _delete_lifecycle_state_v1_serialize(
        self,
        identity_profile_id,
        lifecycle_state_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/identity-profiles/v1/{identity-profile-id}/lifecycle-states/{lifecycle-state-id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_lifecycle_state_v1(
        ...
        _param = self._get_lifecycle_state_v1_serialize(
            identity_profile_id=identity_profile_id,
            lifecycle_state_id=lifecycle_state_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_lifecycle_state_v1_with_http_info(
        self,
        identity_profile_id: Annotated[StrictStr, Field(description="Identity profile ID.")],
        lifecycle_state_id: Annotated[StrictStr, Field(description="Lifecycle state ID.")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_lifecycle_state_v1_without_preload_content(
        self,
        identity_profile_id: Annotated[StrictStr, Field(description="Identity profile ID.")],
        lifecycle_state_id: Annotated[StrictStr, Field(description="Lifecycle state ID.")],
        _request_timeout: Union[
    ...
    def _get_lifecycle_state_v1_serialize(
        self,
        identity_profile_id,
        lifecycle_state_id,
        _request_auth,
    ...
    def get_lifecycle_states_v1(
        ...
        :type count: bool
        :param sorters: Sort results using the standard syntax described in [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters#sorting-results)  Sorting is supported for the following fields: **name, priority, created, modified**
        :type sorters: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_lifecycle_states_v1_serialize(
            identity_profile_id=identity_profile_id,
            limit=limit,
            offset=offset,
            count=count,
    ...
    @validate_call
    def get_lifecycle_states_v1_with_http_info(
        self,
        identity_profile_id: Annotated[StrictStr, Field(description="Identity profile ID.")],
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def get_lifecycle_states_v1_without_preload_content(
        self,
        identity_profile_id: Annotated[StrictStr, Field(description="Identity profile ID.")],
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _get_lifecycle_states_v1_serialize(
        self,
        identity_profile_id,
        limit,
        offset,
    ...
    def set_lifecycle_state_v1(
        ...
        :param set_lifecycle_state_v1_request: (required)
        :type set_lifecycle_state_v1_request: SetLifecycleStateV1Request
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._set_lifecycle_state_v1_serialize(
            identity_id=identity_id,
            set_lifecycle_state_v1_request=set_lifecycle_state_v1_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def set_lifecycle_state_v1_with_http_info(
        self,
        identity_id: Annotated[StrictStr, Field(description="ID of the identity to update.")],
        set_lifecycle_state_v1_request: SetLifecycleStateV1Request,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SetLifecycleStateV1200Response]:
        """Set lifecycle state
    ...
    @validate_call
    def set_lifecycle_state_v1_without_preload_content(
        self,
        identity_id: Annotated[StrictStr, Field(description="ID of the identity to update.")],
        set_lifecycle_state_v1_request: SetLifecycleStateV1Request,
        _request_timeout: Union[
    ...
    def _set_lifecycle_state_v1_serialize(
        self,
        identity_id,
        set_lifecycle_state_v1_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if set_lifecycle_state_v1_request is not None:
            _body_params = set_lifecycle_state_v1_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/identities/v1/{identity-id}/set-lifecycle-state',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def update_lifecycle_states_v1(
        self,
        identity_profile_id: Annotated[StrictStr, Field(description="Identity profile ID.")],
        lifecycle_state_id: Annotated[StrictStr, Field(description="Lifecycle state ID.")],
    ...
    @validate_call
    def update_lifecycle_states_v1_with_http_info(
        self,
        identity_profile_id: Annotated[StrictStr, Field(description="Identity profile ID.")],
        lifecycle_state_id: Annotated[StrictStr, Field(description="Lifecycle state ID.")],
        jsonpatchoperation: Annotated[List[Jsonpatchoperation], Field(description="A list of lifecycle state update operations according to the [JSON Patch](https://tools.ietf.org/html/rfc6902) standard.  The following fields can be updated: * enabled * description * accountActions * accessProfileIds * emailNotificationOption * accessActionConfiguration * priority ")],
    ...
    @validate_call
    def update_lifecycle_states_v1_without_preload_content(
        self,
        identity_profile_id: Annotated[StrictStr, Field(description="Identity profile ID.")],
        lifecycle_state_id: Annotated[StrictStr, Field(description="Lifecycle state ID.")],
        jsonpatchoperation: Annotated[List[Jsonpatchoperation], Field(description="A list of lifecycle state update operations according to the [JSON Patch](https://tools.ietf.org/html/rfc6902) standard.  The following fields can be updated: * enabled * description * accountActions * accessProfileIds * emailNotificationOption * accessActionConfiguration * priority ")],
    ...
    def _update_lifecycle_states_v1_serialize(
        self,
        identity_profile_id,
        lifecycle_state_id,
        jsonpatchoperation,
