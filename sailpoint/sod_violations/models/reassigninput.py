...
class Reassigninput(BaseModel):
    ...
    """ # noqa: E501
    assignee_id: StrictStr = Field(description="The unique identifier of the identity or governance group receiving the violation.", alias="assigneeId")
    assignee_type: StrictStr = Field(description="The type of assignee receiving the violation.", alias="assigneeType")
    __properties: ClassVar[List[str]] = ["assigneeId", "assigneeType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Reassigninput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Reassigninput from a dict"""
        if obj is None:
            return None
