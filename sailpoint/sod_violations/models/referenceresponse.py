...
class Referenceresponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="The unique identifier of the referenced object.")
    name: Optional[StrictStr] = Field(default=None, description="Optional display name when metadata resolves. Omitted when unknown or not resolvable.")
    type: StrictStr = Field(description="The type of the referenced object.")
