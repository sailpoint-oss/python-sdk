...
from sailpoint.sod_violations.api_response import ApiResponse, T as ApiResponseT
import sailpoint.sod_violations.models
from sailpoint.sod_violations import rest
from sailpoint.sod_violations.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.sod_violations.models, klass)
