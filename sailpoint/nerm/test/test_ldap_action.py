...
class TestLdapAction(unittest.TestCase):
    """LdapAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LdapAction:
        """Test LdapAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LdapAction`
        """
        model = LdapAction()
        if include_optional:
            return LdapAction(
