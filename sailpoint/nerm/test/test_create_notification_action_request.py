...
class TestCreateNotificationActionRequest(unittest.TestCase):
    """CreateNotificationActionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateNotificationActionRequest:
        ...
        # uncomment below to create an instance of `CreateNotificationActionRequest`
        """
        model = CreateNotificationActionRequest()
        if include_optional:
            return CreateNotificationActionRequest(
    ...
    def testCreateNotificationActionRequest(self):
        """Test CreateNotificationActionRequest"""
