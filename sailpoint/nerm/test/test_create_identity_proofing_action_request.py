...
class TestCreateIdentityProofingActionRequest(unittest.TestCase):
    """CreateIdentityProofingActionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateIdentityProofingActionRequest:
        """Test CreateIdentityProofingActionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateIdentityProofingActionRequest`
        """
        model = CreateIdentityProofingActionRequest()
        if include_optional:
            return CreateIdentityProofingActionRequest(
    ...
    def testCreateIdentityProofingActionRequest(self):
        """Test CreateIdentityProofingActionRequest"""
