...
class TestWorkflowActionPerformers(unittest.TestCase):
    """WorkflowActionPerformers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkflowActionPerformers:
        """Test WorkflowActionPerformers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkflowActionPerformers`
        """
        model = WorkflowActionPerformers()
        if include_optional:
            return WorkflowActionPerformers(
    ...
    def testWorkflowActionPerformers(self):
        """Test WorkflowActionPerformers"""
