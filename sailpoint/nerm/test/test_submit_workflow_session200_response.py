...
class TestSubmitWorkflowSession200Response(unittest.TestCase):
    """SubmitWorkflowSession200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubmitWorkflowSession200Response:
        """Test SubmitWorkflowSession200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubmitWorkflowSession200Response`
        """
        model = SubmitWorkflowSession200Response()
        if include_optional:
    ...
    def testSubmitWorkflowSession200Response(self):
        """Test SubmitWorkflowSession200Response"""
