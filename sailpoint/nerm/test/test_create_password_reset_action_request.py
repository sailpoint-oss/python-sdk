...
class TestCreatePasswordResetActionRequest(unittest.TestCase):
    """CreatePasswordResetActionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePasswordResetActionRequest:
        """Test CreatePasswordResetActionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatePasswordResetActionRequest`
        """
        model = CreatePasswordResetActionRequest()
        if include_optional:
            return CreatePasswordResetActionRequest(
    ...
    def testCreatePasswordResetActionRequest(self):
        """Test CreatePasswordResetActionRequest"""
