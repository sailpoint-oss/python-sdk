...
class TestContributorsAction(unittest.TestCase):
    """ContributorsAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ContributorsAction:
        """Test ContributorsAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContributorsAction`
        """
        model = ContributorsAction()
        if include_optional:
            return ContributorsAction(
    ...
    def testContributorsAction(self):
        """Test ContributorsAction"""
