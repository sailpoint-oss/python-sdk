...
class TestCreateAttributeRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreateAttributeRequest:
        """Test CreateAttributeRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateAttributeRequest`
        """
        model = CreateAttributeRequest()
        if include_optional:
