...
class TestFulfillmentAction(unittest.TestCase):
    """FulfillmentAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FulfillmentAction:
        ...
        # uncomment below to create an instance of `FulfillmentAction`
        """
    ...
    def testFulfillmentAction(self):
        """Test FulfillmentAction"""
