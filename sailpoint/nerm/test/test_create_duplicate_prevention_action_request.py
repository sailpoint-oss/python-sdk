...
class TestCreateDuplicatePreventionActionRequest(unittest.TestCase):
    """CreateDuplicatePreventionActionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateDuplicatePreventionActionRequest:
        """Test CreateDuplicatePreventionActionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateDuplicatePreventionActionRequest`
        """
        model = CreateDuplicatePreventionActionRequest()
        if include_optional:
            return CreateDuplicatePreventionActionRequest(
    ...
    def testCreateDuplicatePreventionActionRequest(self):
        """Test CreateDuplicatePreventionActionRequest"""
