...
class TestSubmitRoleProfilesRequest(unittest.TestCase):
    """SubmitRoleProfilesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubmitRoleProfilesRequest:
        ...
        # uncomment below to create an instance of `SubmitRoleProfilesRequest`
        """
        model = SubmitRoleProfilesRequest()
        if include_optional:
            return SubmitRoleProfilesRequest(
                role_profiles = [
    ...
    def testSubmitRoleProfilesRequest(self):
        """Test SubmitRoleProfilesRequest"""
