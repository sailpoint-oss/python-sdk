...
class TestPermission1(unittest.TestCase):
    """Permission1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Permission1:
        """Test Permission1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Permission1`
        """
        model = Permission1()
        if include_optional:
            return Permission1(
