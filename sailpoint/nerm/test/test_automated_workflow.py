...
class TestAutomatedWorkflow(unittest.TestCase):
    """AutomatedWorkflow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutomatedWorkflow:
        """Test AutomatedWorkflow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutomatedWorkflow`
        """
    ...
    def testAutomatedWorkflow(self):
        """Test AutomatedWorkflow"""
