...
class TestSystemRolePermission1(unittest.TestCase):
    """SystemRolePermission1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemRolePermission1:
        """Test SystemRolePermission1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemRolePermission1`
        """
        model = SystemRolePermission1()
        if include_optional:
            return SystemRolePermission1(
    ...
    def testSystemRolePermission1(self):
        """Test SystemRolePermission1"""
