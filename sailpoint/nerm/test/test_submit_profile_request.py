...
class TestSubmitProfileRequest(unittest.TestCase):
    """SubmitProfileRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubmitProfileRequest:
        """Test SubmitProfileRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubmitProfileRequest`
        """
        model = SubmitProfileRequest()
        if include_optional:
    ...
    def testSubmitProfileRequest(self):
        """Test SubmitProfileRequest"""
