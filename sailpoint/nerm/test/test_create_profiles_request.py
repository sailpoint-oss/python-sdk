...
class TestCreateProfilesRequest(unittest.TestCase):
    """CreateProfilesRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateProfilesRequest:
        """Test CreateProfilesRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateProfilesRequest`
        """
        model = CreateProfilesRequest()
        if include_optional:
    ...
    def testCreateProfilesRequest(self):
        """Test CreateProfilesRequest"""
