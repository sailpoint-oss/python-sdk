...
class TestPageElement1(unittest.TestCase):
    """PageElement1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PageElement1:
        """Test PageElement1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PageElement1`
        """
        model = PageElement1()
        if include_optional:
            return PageElement1(
