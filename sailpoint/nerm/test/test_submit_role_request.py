...
class TestSubmitRoleRequest(unittest.TestCase):
    """SubmitRoleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubmitRoleRequest:
        """Test SubmitRoleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubmitRoleRequest`
        """
        model = SubmitRoleRequest()
        if include_optional:
    ...
    def testSubmitRoleRequest(self):
        """Test SubmitRoleRequest"""
