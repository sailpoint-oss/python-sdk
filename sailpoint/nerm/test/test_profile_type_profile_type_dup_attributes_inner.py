...
class TestProfileTypeProfileTypeDupAttributesInner(unittest.TestCase):
    """ProfileTypeProfileTypeDupAttributesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProfileTypeProfileTypeDupAttributesInner:
        """Test ProfileTypeProfileTypeDupAttributesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProfileTypeProfileTypeDupAttributesInner`
        """
        model = ProfileTypeProfileTypeDupAttributesInner()
        if include_optional:
            return ProfileTypeProfileTypeDupAttributesInner(
    ...
    def testProfileTypeProfileTypeDupAttributesInner(self):
        """Test ProfileTypeProfileTypeDupAttributesInner"""
