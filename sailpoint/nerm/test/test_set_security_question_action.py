...
class TestSetSecurityQuestionAction(unittest.TestCase):
    """SetSecurityQuestionAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SetSecurityQuestionAction:
        """Test SetSecurityQuestionAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SetSecurityQuestionAction`
        """
        model = SetSecurityQuestionAction()
        if include_optional:
            return SetSecurityQuestionAction(
    ...
    def testSetSecurityQuestionAction(self):
        """Test SetSecurityQuestionAction"""
