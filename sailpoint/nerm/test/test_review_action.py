...
class TestReviewAction(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReviewAction:
        """Test ReviewAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewAction`
        """
        model = ReviewAction()
        if include_optional:
            return ReviewAction(
