...
class TestCreateLoginWorkflowRequest(unittest.TestCase):
    """CreateLoginWorkflowRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateLoginWorkflowRequest:
        """Test CreateLoginWorkflowRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateLoginWorkflowRequest`
        """
        model = CreateLoginWorkflowRequest()
        if include_optional:
            return CreateLoginWorkflowRequest(
    ...
    def testCreateLoginWorkflowRequest(self):
        """Test CreateLoginWorkflowRequest"""
