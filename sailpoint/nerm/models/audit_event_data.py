...
class AuditEventData(BaseModel):
    ...
    AuditEventData
    """ # noqa: E501
    profile_id: Optional[StrictStr] = Field(default=None, description="The profile id associated with the event")
    workflow_id: Optional[StrictStr] = Field(default=None, description="The workflow id associated with the event")
