...
class CreateProfilePage200Response(BaseModel):
    """
    CreateProfilePage200Response
    """ # noqa: E501
    page: Optional[Pages] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateProfilePage200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateProfilePage200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "page": Pages.from_dict(obj["page"]) if obj.get("page") is not None else None
        })
        return _obj
