...
class SubmitRolesRequest(BaseModel):
    """
    SubmitRolesRequest
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubmitRolesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubmitRolesRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "roles": [Role1.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None
        })
        return _obj
