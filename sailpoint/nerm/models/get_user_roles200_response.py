...
class GetUserRoles200Response(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["user_roles", "_metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user_roles": [UserRole.from_dict(_item) for _item in obj["user_roles"]] if obj.get("user_roles") is not None else None,
