...
class Search200Response(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.audit_events:
            for _item_audit_events in self.audit_events:
                if _item_audit_events:
                    _items.append(_item_audit_events.to_dict())
            _dict['audit_events'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "audit_events": [AuditEvent.from_dict(_item) for _item in obj["audit_events"]] if obj.get("audit_events") is not None else None
        })
        return _obj
