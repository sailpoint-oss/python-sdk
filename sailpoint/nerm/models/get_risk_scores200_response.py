...
class GetRiskScores200Response(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["risk_scores", "_metadata"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.risk_scores:
            for _item_risk_scores in self.risk_scores:
                if _item_risk_scores:
                    _items.append(_item_risk_scores.to_dict())
            _dict['risk_scores'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "risk_scores": [RiskScore.from_dict(_item) for _item in obj["risk_scores"]] if obj.get("risk_scores") is not None else None,
