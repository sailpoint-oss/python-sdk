...
class GetUserProfiles200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["user_profiles", "_metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetUserProfiles200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetUserProfiles200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "user_profiles": [UserProfile.from_dict(_item) for _item in obj["user_profiles"]] if obj.get("user_profiles") is not None else None,
