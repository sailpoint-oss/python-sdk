...
class Role1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uid", "type", "name", "groups"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['NeprofileRole', 'NeaccessRole']):
            warnings.warn(f"must be one of enum values ('NeprofileRole', 'NeaccessRole') unknown value: {value}")
        return value
