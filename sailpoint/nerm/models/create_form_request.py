...
class CreateFormRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["forms"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateFormRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateFormRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "forms": [Forms.from_dict(_item) for _item in obj["forms"]] if obj.get("forms") is not None else None
        })
        return _obj
