...
class CreateProfilesRequest(BaseModel):
    ...
    """ # noqa: E501
    profiles: Optional[List[Profile1]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateProfilesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateProfilesRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "profiles": [Profile1.from_dict(_item) for _item in obj["profiles"]] if obj.get("profiles") is not None else None
        })
        return _obj
