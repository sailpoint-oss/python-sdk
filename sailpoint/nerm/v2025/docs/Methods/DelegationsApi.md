...
# sailpoint.nerm.v2025.DelegationsApi
...
------------- | ------------- | ------------- | ------------- | ------------- 
  ...
  Query | include | **str** |   (optional) (default to '') | Include related resources body. For example, 'include=delegator,delegate'.
...
with ApiClient(configuration) as api_client:
    ...
    include = '' # str | Include related resources body. For example, 'include=delegator,delegate'. (optional) (default to '') # str | Include related resources body. For example, 'include=delegator,delegate'. (optional) (default to '')
    ...
    try:
        ...
        # results = DelegationsApi(api_client).delegations_get(delegate_id, delegator_id, expired, limit, offset, include)
...
with ApiClient(configuration) as api_client:
    id = '1246d8b3-ac29-4015-8154-dea4434a73fa' # str | ID of the object to retrieve, update, or delete # str | ID of the object to retrieve, update, or delete
    delegations_post_request = '''sailpoint.nerm.v2025.DelegationsPostRequest()''' # DelegationsPostRequest | 
