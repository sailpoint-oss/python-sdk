...
from sailpoint.nerm.v2025.api_response import ApiResponse, T as ApiResponseT
import sailpoint.nerm.v2025.models
from sailpoint.nerm.v2025 import rest
...
class ApiClient:
    ...
    def param_serialize(
        ...
        # request url
        if _host is None:
            url = self.configuration.nerm_base_url + '/v2025' + resource_path
        else:
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.nerm.v2025.models, klass)
