...
class TestDelegateUser(unittest.TestCase):
    """DelegateUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DelegateUser:
        """Test DelegateUser
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DelegateUser`
        """
        model = DelegateUser()
        if include_optional:
            return DelegateUser(
