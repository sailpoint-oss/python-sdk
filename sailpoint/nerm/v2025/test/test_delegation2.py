...
class TestDelegation2(unittest.TestCase):
    """Delegation2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Delegation2:
        """Test Delegation2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Delegation2`
        """
        model = Delegation2()
        if include_optional:
            return Delegation2(
