...
keywords: ['python', 'Python', 'sdk', 'SystemRolePermission', 'SystemRolePermission'] 
slug: /tools/sdk/python//models/system-role-permission
tags: ['SDK', 'Software Development Kit', 'SystemRolePermission', 'SystemRolePermission']
---
...
------------ | ------------- | ------------- | -------------
**id** | **str** | The id of the system role permission | [optional] [readonly] 
