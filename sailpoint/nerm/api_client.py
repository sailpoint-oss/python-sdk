...
from sailpoint.nerm.api_response import ApiResponse, T as ApiResponseT
import sailpoint.nerm.models
from sailpoint.nerm import rest
from sailpoint.nerm.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def param_serialize(
        ...
        # request url
        if _host is None:
            url = self.configuration.nerm_base_url + '/' + resource_path
        else:
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.nerm.models, klass)
