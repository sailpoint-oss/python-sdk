...
keywords: ['python', 'Python', 'sdk', 'Identity', 'Identity'] 
slug: /tools/sdk/python/v1/models/identity
...
manager_ref=sailpoint.identities_v1.models.identity_manager_ref.identity_managerRef(
                    type = 'IDENTITY', 
