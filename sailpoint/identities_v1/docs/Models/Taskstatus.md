...
launcher='sweep',
target=sailpoint.identities_v1.models.target.Target(
...
messages=[
                    sailpoint.identities_v1.models.task_status_message.Task Status Message(
                        type = 'INFO', 
                        localized_text = sailpoint.identities_v1.models.localized_message.Localized Message(
...
returns=[
                    sailpoint.identities_v1.models.task_return_details.Task Return Details(
                        name = 'label', 
...
task_definition_summary=sailpoint.identities_v1.models.task_definition_summary.Task Definition Summary(
