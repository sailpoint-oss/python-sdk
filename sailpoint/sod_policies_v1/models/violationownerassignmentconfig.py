...
class Violationownerassignmentconfig(BaseModel):
    ...
    def assignment_rule_validate_enum(cls, value):
        ...
        if value not in set(['MANAGER', 'STATIC']):
            warnings.warn(f"must be one of enum values ('MANAGER', 'STATIC') unknown value: {value}")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ownerRef": ViolationownerassignmentconfigOwnerRef.from_dict(obj["ownerRef"]) if obj.get("ownerRef") is not None else None
        })
        return _obj
