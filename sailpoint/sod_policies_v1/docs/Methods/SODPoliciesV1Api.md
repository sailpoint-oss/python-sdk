...
slug: /tools/sdk/python/v1/methods/sod-policies
tags: ['SDK', 'Software Development Kit', 'SOD_Policies', 'SOD_Policies']
---

# sailpoint.sod_policies_v1.SODPoliciesV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SODPoliciesV1Api(api_client).create_sod_policy_v1(sodpolicy=new_sodpolicy)
        # Below is a request that includes all optional parameters
        # results = SODPoliciesV1Api(api_client).create_sod_policy_v1(new_sodpolicy)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        SODPoliciesV1Api(api_client).delete_sod_policy_schedule_v1(id=id)
        # Below is a request that includes all optional parameters
        # SODPoliciesV1Api(api_client).delete_sod_policy_schedule_v1(id)
    except Exception as e:
        print("Exception when calling SODPoliciesV1Api->delete_sod_policy_schedule_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        SODPoliciesV1Api(api_client).delete_sod_policy_v1(id=id)
        # Below is a request that includes all optional parameters
        # SODPoliciesV1Api(api_client).delete_sod_policy_v1(id, logical)
    except Exception as e:
        print("Exception when calling SODPoliciesV1Api->delete_sod_policy_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SODPoliciesV1Api(api_client).get_custom_violation_report_v1(report_result_id=report_result_id, file_name=file_name)
        # Below is a request that includes all optional parameters
        # results = SODPoliciesV1Api(api_client).get_custom_violation_report_v1(report_result_id, file_name)
        print("The response of SODPoliciesV1Api->get_custom_violation_report_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SODPoliciesV1Api->get_custom_violation_report_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SODPoliciesV1Api(api_client).get_default_violation_report_v1(report_result_id=report_result_id)
        # Below is a request that includes all optional parameters
        # results = SODPoliciesV1Api(api_client).get_default_violation_report_v1(report_result_id)
        print("The response of SODPoliciesV1Api->get_default_violation_report_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SODPoliciesV1Api->get_default_violation_report_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SODPoliciesV1Api(api_client).get_sod_all_report_run_status_v1()
        # Below is a request that includes all optional parameters
        # results = SODPoliciesV1Api(api_client).get_sod_all_report_run_status_v1()
        print("The response of SODPoliciesV1Api->get_sod_all_report_run_status_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SODPoliciesV1Api->get_sod_all_report_run_status_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SODPoliciesV1Api(api_client).get_sod_policy_schedule_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SODPoliciesV1Api(api_client).get_sod_policy_schedule_v1(id)
        print("The response of SODPoliciesV1Api->get_sod_policy_schedule_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SODPoliciesV1Api->get_sod_policy_schedule_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SODPoliciesV1Api(api_client).get_sod_policy_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SODPoliciesV1Api(api_client).get_sod_policy_v1(id)
        print("The response of SODPoliciesV1Api->get_sod_policy_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SODPoliciesV1Api->get_sod_policy_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SODPoliciesV1Api(api_client).get_sod_violation_report_run_status_v1(report_result_id=report_result_id)
        # Below is a request that includes all optional parameters
        # results = SODPoliciesV1Api(api_client).get_sod_violation_report_run_status_v1(report_result_id)
        print("The response of SODPoliciesV1Api->get_sod_violation_report_run_status_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SODPoliciesV1Api->get_sod_violation_report_run_status_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SODPoliciesV1Api(api_client).get_sod_violation_report_status_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SODPoliciesV1Api(api_client).get_sod_violation_report_status_v1(id)
        print("The response of SODPoliciesV1Api->get_sod_violation_report_status_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SODPoliciesV1Api->get_sod_violation_report_status_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SODPoliciesV1Api(api_client).list_sod_policies_v1()
        # Below is a request that includes all optional parameters
        # results = SODPoliciesV1Api(api_client).list_sod_policies_v1(limit, offset, count, filters, sorters)
        print("The response of SODPoliciesV1Api->list_sod_policies_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SODPoliciesV1Api->list_sod_policies_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SODPoliciesV1Api(api_client).patch_sod_policy_v1(id=id, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = SODPoliciesV1Api(api_client).patch_sod_policy_v1(id, new_jsonpatchoperation)
        print("The response of SODPoliciesV1Api->patch_sod_policy_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SODPoliciesV1Api->patch_sod_policy_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    sodpolicyschedule = '''sailpoint.sod_policies_v1.Sodpolicyschedule()''' # Sodpolicyschedule | 

    try:
        # Update sod policy schedule
        new_sodpolicyschedule = Sodpolicyschedule.from_json(sodpolicyschedule)
        results = SODPoliciesV1Api(api_client).put_policy_schedule_v1(id=id, sodpolicyschedule=new_sodpolicyschedule)
        # Below is a request that includes all optional parameters
        # results = SODPoliciesV1Api(api_client).put_policy_schedule_v1(id, new_sodpolicyschedule)
        print("The response of SODPoliciesV1Api->put_policy_schedule_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SODPoliciesV1Api->put_policy_schedule_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Update sod policy by id
        new_sodpolicy = Sodpolicy.from_json(sodpolicy)
        results = SODPoliciesV1Api(api_client).put_sod_policy_v1(id=id, sodpolicy=new_sodpolicy)
        # Below is a request that includes all optional parameters
        # results = SODPoliciesV1Api(api_client).put_sod_policy_v1(id, new_sodpolicy)
        print("The response of SODPoliciesV1Api->put_sod_policy_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SODPoliciesV1Api->put_sod_policy_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SODPoliciesV1Api(api_client).start_evaluate_sod_policy_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SODPoliciesV1Api(api_client).start_evaluate_sod_policy_v1(id)
        print("The response of SODPoliciesV1Api->start_evaluate_sod_policy_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SODPoliciesV1Api->start_evaluate_sod_policy_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SODPoliciesV1Api(api_client).start_sod_all_policies_for_org_v1()
        # Below is a request that includes all optional parameters
        # results = SODPoliciesV1Api(api_client).start_sod_all_policies_for_org_v1(new_multipolicyrequest)
        print("The response of SODPoliciesV1Api->start_sod_all_policies_for_org_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SODPoliciesV1Api->start_sod_all_policies_for_org_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SODPoliciesV1Api(api_client).start_sod_policy_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SODPoliciesV1Api(api_client).start_sod_policy_v1(id)
        print("The response of SODPoliciesV1Api->start_sod_policy_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SODPoliciesV1Api->start_sod_policy_v1: %s\n" % e)
```
