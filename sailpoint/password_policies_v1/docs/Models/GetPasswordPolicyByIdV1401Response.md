...
keywords: ['python', 'Python', 'sdk', 'GetPasswordPolicyByIdV1401Response', 'GetPasswordPolicyByIdV1401Response'] 
slug: /tools/sdk/python/v1/models/get-password-policy-by-id-v1401-response
...
```python
from sailpoint.password_policies_v1.models.get_password_policy_by_id_v1401_response import GetPasswordPolicyByIdV1401Response

get_password_policy_by_id_v1401_response = GetPasswordPolicyByIdV1401Response(
