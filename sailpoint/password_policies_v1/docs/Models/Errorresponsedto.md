...
```python
from sailpoint.password_policies_v1.models.errorresponsedto import Errorresponsedto

errorresponsedto = Errorresponsedto(
detail_code='400.1 Bad Request Content',
tracking_id='e7eab60924f64aa284175b9fa3309599',
messages=[
                    sailpoint.password_policies_v1.models.error_message_dto.Error Message Dto(
                        locale = 'en-US', 
