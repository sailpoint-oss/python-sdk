...
from sailpoint.auth_profile.api_response import ApiResponse, T as ApiResponseT
import sailpoint.auth_profile.models
from sailpoint.auth_profile import rest
from sailpoint.auth_profile.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.auth_profile.models, klass)
