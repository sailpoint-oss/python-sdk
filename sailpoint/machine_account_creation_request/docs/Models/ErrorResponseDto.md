...
slug: /tools/sdk/python/machine-account-creation-request/models/error-response-dto
...
messages=[
                    sailpoint.machine_account_creation_request.models.error_message_dto.Error Message Dto(
                        locale = 'en-US', 
