...
from sailpoint.machine_account_creation_request.api_response import ApiResponse, T as ApiResponseT
import sailpoint.machine_account_creation_request.models
from sailpoint.machine_account_creation_request import rest
from sailpoint.machine_account_creation_request.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.machine_account_creation_request.models, klass)
