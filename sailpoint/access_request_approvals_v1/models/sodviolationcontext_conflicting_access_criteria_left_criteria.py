...
class SodviolationcontextConflictingAccessCriteriaLeftCriteria(BaseModel):
    ...
    """ # noqa: E501
    criteria_list: Optional[List[Sodexemptcriteria]] = Field(default=None, alias="criteriaList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "criteriaList": [Sodexemptcriteria.from_dict(_item) for _item in obj["criteriaList"]] if obj.get("criteriaList") is not None else None
        })
        return _obj
