...
from sailpoint.role_propagation_v1.api_client import ApiClient, RequestSerialized
from sailpoint.role_propagation_v1.api_response import ApiResponse
from sailpoint.role_propagation_v1.rest import RESTResponseType
...
class RolePropagationV1Api:
    ...
    @validate_call
    def cancel_role_propagation_v1(
        self,
        ...
        _param = self._cancel_role_propagation_v1_serialize(
    ...
    @validate_call
    def cancel_role_propagation_v1_with_http_info(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def cancel_role_propagation_v1_without_preload_content(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _cancel_role_propagation_v1_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/role-propagation/v1/terminate',
    ...
    @validate_call
    def get_ongoing_role_propagation_v1(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_ongoing_role_propagation_v1_serialize(
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_ongoing_role_propagation_v1_with_http_info(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_ongoing_role_propagation_v1_without_preload_content(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_ongoing_role_propagation_v1_serialize(
        self,
        x_sail_point_experimental,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/role-propagation/v1/is-running',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_role_propagation_config_v1(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
        ...
        _param = self._get_role_propagation_config_v1_serialize(
            x_sail_point_experimental=x_sail_point_experimental,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_role_propagation_config_v1_with_http_info(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_role_propagation_config_v1_without_preload_content(
        self,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_role_propagation_config_v1_serialize(
        self,
        x_sail_point_experimental,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/role-propagation-config/v1',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_role_propagation_status_v1(
        self,
        ...
        _param = self._get_role_propagation_status_v1_serialize(
    ...
    @validate_call
    def get_role_propagation_status_v1_with_http_info(
        self,
        role_propagation_id: Annotated[StrictStr, Field(description="The ID of the role propagation process to retrieve the status for.")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_role_propagation_status_v1_without_preload_content(
        self,
        role_propagation_id: Annotated[StrictStr, Field(description="The ID of the role propagation process to retrieve the status for.")],
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    def _get_role_propagation_status_v1_serialize(
        self,
        role_propagation_id,
        x_sail_point_experimental,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/role-propagation/v1/{rolePropagationId}/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def start_role_propagation_v1(
        ...
        _param = self._start_role_propagation_v1_serialize(
    ...
    @validate_call
    def start_role_propagation_v1_with_http_info(
        self,
        skip_role_refresh: Annotated[Optional[StrictBool], Field(description="When true, the role refresh is not performed. Keeping it false is recommended.")] = None,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def start_role_propagation_v1_without_preload_content(
        self,
        skip_role_refresh: Annotated[Optional[StrictBool], Field(description="When true, the role refresh is not performed. Keeping it false is recommended.")] = None,
        x_sail_point_experimental: Annotated[Optional[StrictStr], Field(description="Use this header to enable this experimental API.")] = None,
        _request_timeout: Union[
    ...
    def _start_role_propagation_v1_serialize(
        self,
        skip_role_refresh,
        x_sail_point_experimental,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/role-propagation/v1',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
