...
slug: /tools/sdk/python/account-aggregations/models/error-message-dto
...
```python
from sailpoint.account_aggregations.models.error_message_dto import ErrorMessageDto
