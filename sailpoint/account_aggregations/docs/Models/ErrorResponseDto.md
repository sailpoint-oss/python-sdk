...
slug: /tools/sdk/python/account-aggregations/models/error-response-dto
...
```python
from sailpoint.account_aggregations.models.error_response_dto import ErrorResponseDto

error_response_dto = ErrorResponseDto(
detail_code='400.1 Bad Request Content',
tracking_id='e7eab60924f64aa284175b9fa3309599',
messages=[
                    sailpoint.account_aggregations.models.error_message_dto.Error Message Dto(
                        locale = 'en-US', 
