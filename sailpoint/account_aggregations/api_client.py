...
from sailpoint.account_aggregations.api_response import ApiResponse, T as ApiResponseT
import sailpoint.account_aggregations.models
from sailpoint.account_aggregations import rest
from sailpoint.account_aggregations.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.account_aggregations.models, klass)
