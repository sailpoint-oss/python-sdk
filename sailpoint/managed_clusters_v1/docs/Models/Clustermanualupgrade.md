...
keywords: ['python', 'Python', 'sdk', 'Clustermanualupgrade', 'Clustermanualupgrade'] 
slug: /tools/sdk/python/v1/models/clustermanualupgrade
...
clustermanualupgrade = Clustermanualupgrade(
jobs=[
                    sailpoint.managed_clusters_v1.models.clustermanualupgrade_jobs_inner.clustermanualupgrade_jobs_inner(
