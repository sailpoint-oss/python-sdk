...
slug: /tools/sdk/python/custom-password-instructions/models/error-response-dto
...
messages=[
                    sailpoint.custom_password_instructions.models.error_message_dto.Error Message Dto(
                        locale = 'en-US', 
