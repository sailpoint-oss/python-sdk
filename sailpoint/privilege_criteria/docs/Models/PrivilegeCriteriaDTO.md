...
slug: /tools/sdk/python/privilege-criteria/models/privilege-criteria-dto
...
operator='AND',
groups=[
                    sailpoint.privilege_criteria.models.privilege_criteria_dto_groups_inner.PrivilegeCriteriaDTO_groups_inner(
                        operator = 'AND', 
                        criteria_items = [
