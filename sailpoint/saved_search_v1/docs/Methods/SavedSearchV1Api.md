...
slug: /tools/sdk/python/v1/methods/saved-search
tags: ['SDK', 'Software Development Kit', 'Saved_Search', 'Saved_Search']
---

# sailpoint.saved_search_v1.SavedSearchV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SavedSearchV1Api(api_client).create_saved_search_v1(create_saved_search_v1_request=new_create_saved_search_v1_request)
        # Below is a request that includes all optional parameters
        # results = SavedSearchV1Api(api_client).create_saved_search_v1(new_create_saved_search_v1_request)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        SavedSearchV1Api(api_client).delete_saved_search_v1(id=id)
        # Below is a request that includes all optional parameters
        # SavedSearchV1Api(api_client).delete_saved_search_v1(id)
    except Exception as e:
        print("Exception when calling SavedSearchV1Api->delete_saved_search_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    id = '2c91808568c529c60168cca6f90c1313' # str | ID of the requested document. # str | ID of the requested document.
    searcharguments = '''sailpoint.saved_search_v1.Searcharguments()''' # Searcharguments | When saved search execution is triggered by a scheduled search, *scheduleId* will specify the ID of the triggering scheduled search.  If *scheduleId* is not specified (when execution is triggered by a UI test), the *owner* and *recipients* arguments must be provided. 

    try:
        # Execute a saved search by id
        new_searcharguments = Searcharguments.from_json(searcharguments)
        SavedSearchV1Api(api_client).execute_saved_search_v1(id=id, searcharguments=new_searcharguments)
        # Below is a request that includes all optional parameters
        # SavedSearchV1Api(api_client).execute_saved_search_v1(id, new_searcharguments)
    except Exception as e:
        print("Exception when calling SavedSearchV1Api->execute_saved_search_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SavedSearchV1Api(api_client).get_saved_search_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = SavedSearchV1Api(api_client).get_saved_search_v1(id)
        print("The response of SavedSearchV1Api->get_saved_search_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SavedSearchV1Api->get_saved_search_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = SavedSearchV1Api(api_client).list_saved_searches_v1()
        # Below is a request that includes all optional parameters
        # results = SavedSearchV1Api(api_client).list_saved_searches_v1(offset, limit, count, filters)
        print("The response of SavedSearchV1Api->list_saved_searches_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SavedSearchV1Api->list_saved_searches_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    id = '2c91808568c529c60168cca6f90c1313' # str | ID of the requested document. # str | ID of the requested document.
    savedsearch = '''sailpoint.saved_search_v1.Savedsearch()''' # Savedsearch | The saved search to persist.

    try:
        # Updates an existing saved search 
        new_savedsearch = Savedsearch.from_json(savedsearch)
        results = SavedSearchV1Api(api_client).put_saved_search_v1(id=id, savedsearch=new_savedsearch)
        # Below is a request that includes all optional parameters
        # results = SavedSearchV1Api(api_client).put_saved_search_v1(id, new_savedsearch)
        print("The response of SavedSearchV1Api->put_saved_search_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling SavedSearchV1Api->put_saved_search_v1: %s\n" % e)
```
