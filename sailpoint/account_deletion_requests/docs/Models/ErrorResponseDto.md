...
slug: /tools/sdk/python/account-deletion-requests/models/error-response-dto
...
messages=[
                    sailpoint.account_deletion_requests.models.error_message_dto.Error Message Dto(
                        locale = 'en-US', 
