...
from sailpoint.account_deletion_requests.api_response import ApiResponse, T as ApiResponseT
import sailpoint.account_deletion_requests.models
from sailpoint.account_deletion_requests import rest
from sailpoint.account_deletion_requests.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.account_deletion_requests.models, klass)
