...
slug: /tools/sdk/python/v1/methods/entitlements
tags: ['SDK', 'Software Development Kit', 'Entitlements', 'Entitlements']
---

# sailpoint.entitlements_v1.EntitlementsV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = EntitlementsV1Api(api_client).create_access_model_metadata_for_entitlement_v1(id=id, attribute_key=attribute_key, attribute_value=attribute_value)
        # Below is a request that includes all optional parameters
        # results = EntitlementsV1Api(api_client).create_access_model_metadata_for_entitlement_v1(id, attribute_key, attribute_value)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        EntitlementsV1Api(api_client).delete_access_model_metadata_from_entitlement_v1(id=id, attribute_key=attribute_key, attribute_value=attribute_value)
        # Below is a request that includes all optional parameters
        # EntitlementsV1Api(api_client).delete_access_model_metadata_from_entitlement_v1(id, attribute_key, attribute_value)
    except Exception as e:
        print("Exception when calling EntitlementsV1Api->delete_access_model_metadata_from_entitlement_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = EntitlementsV1Api(api_client).get_entitlement_request_config_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = EntitlementsV1Api(api_client).get_entitlement_request_config_v1(id)
        print("The response of EntitlementsV1Api->get_entitlement_request_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling EntitlementsV1Api->get_entitlement_request_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = EntitlementsV1Api(api_client).get_entitlement_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = EntitlementsV1Api(api_client).get_entitlement_v1(id)
        print("The response of EntitlementsV1Api->get_entitlement_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling EntitlementsV1Api->get_entitlement_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = EntitlementsV1Api(api_client).import_entitlements_by_source_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = EntitlementsV1Api(api_client).import_entitlements_by_source_v1(id, csv_file)
        print("The response of EntitlementsV1Api->import_entitlements_by_source_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling EntitlementsV1Api->import_entitlements_by_source_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = EntitlementsV1Api(api_client).list_entitlement_children_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = EntitlementsV1Api(api_client).list_entitlement_children_v1(id, limit, offset, count, search_after, sorters, filters)
        print("The response of EntitlementsV1Api->list_entitlement_children_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling EntitlementsV1Api->list_entitlement_children_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = EntitlementsV1Api(api_client).list_entitlement_parents_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = EntitlementsV1Api(api_client).list_entitlement_parents_v1(id, limit, offset, count, search_after, sorters, filters)
        print("The response of EntitlementsV1Api->list_entitlement_parents_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling EntitlementsV1Api->list_entitlement_parents_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = EntitlementsV1Api(api_client).list_entitlements_by_account_v1(account_id=account_id)
        # Below is a request that includes all optional parameters
        # results = EntitlementsV1Api(api_client).list_entitlements_by_account_v1(account_id, limit, offset, count, search_after, sorters)
        print("The response of EntitlementsV1Api->list_entitlements_by_account_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling EntitlementsV1Api->list_entitlements_by_account_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = EntitlementsV1Api(api_client).list_entitlements_v1()
        # Below is a request that includes all optional parameters
        # results = EntitlementsV1Api(api_client).list_entitlements_v1(segmented_for_identity, for_segment_ids, include_unsegmented, offset, limit, count, search_after, sorters, filters)
        print("The response of EntitlementsV1Api->list_entitlements_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling EntitlementsV1Api->list_entitlements_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = EntitlementsV1Api(api_client).patch_entitlement_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = EntitlementsV1Api(api_client).patch_entitlement_v1(id, new_jsonpatchoperation)
        print("The response of EntitlementsV1Api->patch_entitlement_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling EntitlementsV1Api->patch_entitlement_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    entitlementrequestconfig = '''sailpoint.entitlements_v1.Entitlementrequestconfig()''' # Entitlementrequestconfig | 

    try:
        # Replace entitlement request config
        new_entitlementrequestconfig = Entitlementrequestconfig.from_json(entitlementrequestconfig)
        results = EntitlementsV1Api(api_client).put_entitlement_request_config_v1(id=id, entitlementrequestconfig=new_entitlementrequestconfig)
        # Below is a request that includes all optional parameters
        # results = EntitlementsV1Api(api_client).put_entitlement_request_config_v1(id, new_entitlementrequestconfig)
        print("The response of EntitlementsV1Api->put_entitlement_request_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling EntitlementsV1Api->put_entitlement_request_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = EntitlementsV1Api(api_client).reset_source_entitlements_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = EntitlementsV1Api(api_client).reset_source_entitlements_v1(id)
        print("The response of EntitlementsV1Api->reset_source_entitlements_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling EntitlementsV1Api->reset_source_entitlements_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    entitlementbulkupdaterequest = '''sailpoint.entitlements_v1.Entitlementbulkupdaterequest()''' # Entitlementbulkupdaterequest | 

    try:
        # Bulk update an entitlement list
        new_entitlementbulkupdaterequest = Entitlementbulkupdaterequest.from_json(entitlementbulkupdaterequest)
        EntitlementsV1Api(api_client).update_entitlements_in_bulk_v1(entitlementbulkupdaterequest=new_entitlementbulkupdaterequest)
        # Below is a request that includes all optional parameters
        # EntitlementsV1Api(api_client).update_entitlements_in_bulk_v1(new_entitlementbulkupdaterequest)
    except Exception as e:
        print("Exception when calling EntitlementsV1Api->update_entitlements_in_bulk_v1: %s\n" % e)
```
