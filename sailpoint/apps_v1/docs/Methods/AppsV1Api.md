...
slug: /tools/sdk/python/v1/methods/apps
tags: ['SDK', 'Software Development Kit', 'Apps', 'Apps']
---

# sailpoint.apps_v1.AppsV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AppsV1Api(api_client).create_source_app_v1(sourceappcreatedto=new_sourceappcreatedto)
        # Below is a request that includes all optional parameters
        # results = AppsV1Api(api_client).create_source_app_v1(new_sourceappcreatedto, x_sail_point_experimental)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AppsV1Api(api_client).delete_access_profiles_from_source_app_by_bulk_v1(id=id, request_body=new_request_body)
        # Below is a request that includes all optional parameters
        # results = AppsV1Api(api_client).delete_access_profiles_from_source_app_by_bulk_v1(id, new_request_body, limit, x_sail_point_experimental)
        print("The response of AppsV1Api->delete_access_profiles_from_source_app_by_bulk_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling AppsV1Api->delete_access_profiles_from_source_app_by_bulk_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AppsV1Api(api_client).delete_source_app_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = AppsV1Api(api_client).delete_source_app_v1(id, x_sail_point_experimental)
        print("The response of AppsV1Api->delete_source_app_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling AppsV1Api->delete_source_app_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AppsV1Api(api_client).get_source_app_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = AppsV1Api(api_client).get_source_app_v1(id, x_sail_point_experimental)
        print("The response of AppsV1Api->get_source_app_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling AppsV1Api->get_source_app_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AppsV1Api(api_client).list_access_profiles_for_source_app_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = AppsV1Api(api_client).list_access_profiles_for_source_app_v1(id, limit, offset, filters, x_sail_point_experimental)
        print("The response of AppsV1Api->list_access_profiles_for_source_app_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling AppsV1Api->list_access_profiles_for_source_app_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AppsV1Api(api_client).list_all_source_app_v1()
        # Below is a request that includes all optional parameters
        # results = AppsV1Api(api_client).list_all_source_app_v1(limit, count, offset, sorters, filters, x_sail_point_experimental)
        print("The response of AppsV1Api->list_all_source_app_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling AppsV1Api->list_all_source_app_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AppsV1Api(api_client).list_all_user_apps_v1(filters=filters)
        # Below is a request that includes all optional parameters
        # results = AppsV1Api(api_client).list_all_user_apps_v1(filters, limit, count, offset, x_sail_point_experimental)
        print("The response of AppsV1Api->list_all_user_apps_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling AppsV1Api->list_all_user_apps_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AppsV1Api(api_client).list_assigned_source_app_v1()
        # Below is a request that includes all optional parameters
        # results = AppsV1Api(api_client).list_assigned_source_app_v1(limit, count, offset, sorters, filters, x_sail_point_experimental)
        print("The response of AppsV1Api->list_assigned_source_app_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling AppsV1Api->list_assigned_source_app_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AppsV1Api(api_client).list_available_accounts_for_user_app_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = AppsV1Api(api_client).list_available_accounts_for_user_app_v1(id, limit, count, x_sail_point_experimental)
        print("The response of AppsV1Api->list_available_accounts_for_user_app_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling AppsV1Api->list_available_accounts_for_user_app_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AppsV1Api(api_client).list_available_source_apps_v1()
        # Below is a request that includes all optional parameters
        # results = AppsV1Api(api_client).list_available_source_apps_v1(limit, count, offset, sorters, filters, x_sail_point_experimental)
        print("The response of AppsV1Api->list_available_source_apps_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling AppsV1Api->list_available_source_apps_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AppsV1Api(api_client).list_owned_user_apps_v1()
        # Below is a request that includes all optional parameters
        # results = AppsV1Api(api_client).list_owned_user_apps_v1(limit, count, offset, filters, x_sail_point_experimental)
        print("The response of AppsV1Api->list_owned_user_apps_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling AppsV1Api->list_owned_user_apps_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AppsV1Api(api_client).patch_source_app_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = AppsV1Api(api_client).patch_source_app_v1(id, x_sail_point_experimental, new_jsonpatchoperation)
        print("The response of AppsV1Api->patch_source_app_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling AppsV1Api->patch_source_app_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    x_sail_point_experimental = 'true' # str | Use this header to enable this experimental API. (optional) (default to 'true') # str | Use this header to enable this experimental API. (optional) (default to 'true')
    jsonpatchoperation = '''[sailpoint.apps_v1.Jsonpatchoperation()]''' # List[Jsonpatchoperation] |  (optional)

    try:
        # Patch user app by id
        
        results = AppsV1Api(api_client).patch_user_app_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = AppsV1Api(api_client).patch_user_app_v1(id, x_sail_point_experimental, new_jsonpatchoperation)
        print("The response of AppsV1Api->patch_user_app_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling AppsV1Api->patch_user_app_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    x_sail_point_experimental = 'true' # str | Use this header to enable this experimental API. (optional) (default to 'true') # str | Use this header to enable this experimental API. (optional) (default to 'true')
    sourceappbulkupdaterequest = '''sailpoint.apps_v1.Sourceappbulkupdaterequest()''' # Sourceappbulkupdaterequest |  (optional)

    try:
        # Bulk update source apps
        
        AppsV1Api(api_client).update_source_apps_in_bulk_v1()
        # Below is a request that includes all optional parameters
        # AppsV1Api(api_client).update_source_apps_in_bulk_v1(x_sail_point_experimental, new_sourceappbulkupdaterequest)
    except Exception as e:
        print("Exception when calling AppsV1Api->update_source_apps_in_bulk_v1: %s\n" % e)
```
