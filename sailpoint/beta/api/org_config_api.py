...
class OrgConfigApi:
    ...
    @validate_arguments
    def get_org_config_with_http_info(self,
    ...
    @validate_arguments
    def patch_org_config(self, json_patch_operation: Annotated[
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.patch_org_config_with_http_info(json_patch_operation,
                                                    **kwargs)  # noqa: E501

    @validate_arguments
    def patch_org_config_with_http_info(self, json_patch_operation: Annotated[
        conlist(JsonPatchOperation),
        Field(
            ...,
            description=
