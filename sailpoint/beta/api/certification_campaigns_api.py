...
class CertificationCampaignsApi:
    ...
    def complete_campaign(
        ...
        _param = self._complete_campaign_serialize(
            id=id,
            complete_campaign_options=complete_campaign_options,
    ...
    def _complete_campaign_serialize(
        ...
        if complete_campaign_options is not None:
            _body_params = complete_campaign_options
    ...
    def _delete_campaigns_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if delete_campaigns_request is not None:
            _body_params = delete_campaigns_request
