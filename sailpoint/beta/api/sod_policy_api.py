...
class SODPolicyApi:
    ...
    @validate_arguments
    def download_custom_violation_report(self, report_result_id: Annotated[
        StrictStr,
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.download_custom_violation_report_with_http_info(
            report_result_id, file_name, **kwargs)  # noqa: E501

    @validate_arguments
    def download_custom_violation_report_with_http_info(
    ...
    @validate_arguments
    def download_default_violation_report(self, report_result_id: Annotated[
        StrictStr,
        Field(..., description="The ID of the report reference to download.")],
                                          **kwargs) -> bytearray:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.download_default_violation_report_with_http_info(
            report_result_id, **kwargs)  # noqa: E501

    @validate_arguments
    def download_default_violation_report_with_http_info(
            self, report_result_id: Annotated[
                StrictStr,
                Field(
                    ...,
    ...
    def patch_sod_policy(self, id: Annotated[
        ...
        >>> thread = api.patch_sod_policy(id, request_body, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.patch_sod_policy_with_http_info(id, request_body,
                                                    **kwargs)  # noqa: E501
    ...
    def patch_sod_policy_with_http_info(self, id: Annotated[
        ...
        >>> thread = api.patch_sod_policy_with_http_info(id, request_body, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def run_sod_all_policies_for_org(
            self,
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.run_sod_all_policies_for_org_with_http_info(
            multi_policy_request, **kwargs)  # noqa: E501

    @validate_arguments
    def run_sod_all_policies_for_org_with_http_info(
            self,
            multi_policy_request: Optional[MultiPolicyRequest] = None,
            **kwargs) -> ApiResponse:  # noqa: E501
        """Runs all policies for org  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'"
                                   " to method run_sod_all_policies_for_org" %
                                   _key)
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def run_sod_policy(self, id: Annotated[
        StrictStr,
    ...
    @validate_arguments
    def run_sod_policy_with_http_info(self, id: Annotated[
        StrictStr,
        Field(..., description="The SOD policy ID to run.")],
                                      **kwargs) -> ApiResponse:  # noqa: E501
        """Runs SOD policy violation report  # noqa: E501
    ...
    @validate_arguments
    def update_policy_schedule(self, id: Annotated[
        StrictStr,
        Field(...,
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.update_policy_schedule_with_http_info(
            id, sod_policy_schedule, **kwargs)  # noqa: E501

    @validate_arguments
    def update_policy_schedule_with_http_info(self, id: Annotated[
        StrictStr,
        Field(...,
              description="The ID of the SOD policy to update its schedule."
    ...
    @validate_arguments
    def update_sod_policy(self, id: Annotated[
        StrictStr,
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.update_sod_policy_with_http_info(id, sod_policy,
                                                     **kwargs)  # noqa: E501

    @validate_arguments
    def update_sod_policy_with_http_info(
            self, id: Annotated[
                StrictStr,
                Field(..., description="The ID of the SOD policy to update.")],
            sod_policy: SodPolicy, **kwargs) -> ApiResponse:  # noqa: E501
        """Update SOD policy by ID  # noqa: E501
