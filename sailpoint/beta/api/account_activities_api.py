...
class AccountActivitiesApi:
    ...
    def get_account_activity(
            ...
            **kwargs) -> CancelableAccountActivity:  # noqa: E501
    ...
    def list_account_activities(
        ...
        Annotated[
            ...
            type: Annotated[
                Optional[StrictStr],
                Field(description="The type of account activity.")] = None,
            limit:
        Annotated[
        ...
        Annotated[
            ...
            **kwargs) -> List[CancelableAccountActivity]:  # noqa: E501
        ...
        return self.list_account_activities_with_http_info(
            requested_for, requested_by, regarding_identity, type, limit,
            offset, count, filters, sorters, **kwargs)  # noqa: E501
    ...
    def list_account_activities_with_http_info(
        ...
        _all_params = [
            'requested_for', 'requested_by', 'regarding_identity', 'type',
            'limit', 'offset', 'count', 'filters', 'sorters'
        ]
        _all_params.extend([
            'async_req', '_return_http_data_only', '_preload_content',
            '_request_timeout', '_request_auth', '_content_type', '_headers'
