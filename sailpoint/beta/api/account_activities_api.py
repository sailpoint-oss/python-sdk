...
class AccountActivitiesApi:
    ...
    def get_account_activity_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CancelableAccountActivity]:
        """Get Account Activity
    ...
    def list_account_activities(
        ...
        type: Annotated[Optional[StrictStr], Field(description="The type of account activity.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[CancelableAccountActivity]:
    ...
    def list_account_activities_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[CancelableAccountActivity]]:
        """List Account Activities
