...
class ApprovalsApi:
    ...
    def patch_approval(
        ...
        :param approval_dto: (required)
        :type approval_dto: ApprovalDto
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._patch_approval_serialize(
            approval_dto=approval_dto,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def patch_approval_with_http_info(
        self,
        approval_dto: ApprovalDto,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def patch_approval_without_preload_content(
        self,
        approval_dto: ApprovalDto,
        _request_timeout: Union[
            None,
    ...
    def _patch_approval_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if approval_dto is not None:
            _body_params = approval_dto
