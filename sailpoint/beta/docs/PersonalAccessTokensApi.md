...
with beta.ApiClient(configuration) as api_client:
    ...
    api_instance = beta.PersonalAccessTokensApi(api_client)
    create_personal_access_token_request = beta.CreatePersonalAccessTokenRequest() # CreatePersonalAccessTokenRequest | Name and scope of personal access token.
