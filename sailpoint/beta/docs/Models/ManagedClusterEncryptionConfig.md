...
keywords: ['python', 'Python', 'sdk', 'ManagedClusterEncryptionConfig', 'BetaManagedClusterEncryptionConfig'] 
slug: /tools/sdk/python/beta/models/managed-cluster-encryption-config
