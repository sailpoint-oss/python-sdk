...
keywords: ['python', 'Python', 'sdk', 'RoleMiningPotentialRole', 'BetaRoleMiningPotentialRole'] 
...
identity_distribution=[
                    sailpoint.beta.models.role_mining_identity_distribution.Role Mining Identity Distribution(
