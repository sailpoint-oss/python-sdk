# sailpoint.beta.DiscoveredApplicationsApi

All URIs are relative to *https://sailpoint.api.identitynow.com/beta*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_discovered_applications**](DiscoveredApplicationsApi.md#get_discovered_applications) | **GET** /discovered-applications | Retrieve discovered applications for tenant
...
with sailpoint.beta.ApiClient(configuration) as api_client:
    ...
    api_instance = sailpoint.beta.DiscoveredApplicationsApi(api_client)
    ...
    try:
        ...
        print("The response of DiscoveredApplicationsApi->get_discovered_applications:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DiscoveredApplicationsApi->get_discovered_applications: %s\n" % e)
```
