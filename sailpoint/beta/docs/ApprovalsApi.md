...
------------- | ------------- | -------------
[**get_approval**](ApprovalsApi.md#get_approval) | **GET** /generic-approvals/{id} | Get Approval
...
with sailpoint.beta.ApiClient(configuration) as api_client:
    ...
    id = '38453251-6be2-5f8f-df93-5ce19e295837' # str | ID of the approval that to be returned.
...
------------- | ------------- | ------------- | -------------
 **id** | **str**| ID of the approval that to be returned. | 
