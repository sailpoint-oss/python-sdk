...
[**download_custom_violation_report**](SODPolicyApi.md#download_custom_violation_report) | **GET** /sod-violation-report/{reportResultId}/download/{fileName} | Download custom violation report
[**download_default_violation_report**](SODPolicyApi.md#download_default_violation_report) | **GET** /sod-violation-report/{reportResultId}/download | Download violation report
...
[**run_sod_all_policies_for_org**](SODPolicyApi.md#run_sod_all_policies_for_org) | **POST** /sod-violation-report/run | Runs all policies for org
[**run_sod_policy**](SODPolicyApi.md#run_sod_policy) | **POST** /sod-policies/{id}/violation-report/run | Runs SOD policy violation report
[**update_policy_schedule**](SODPolicyApi.md#update_policy_schedule) | **PUT** /sod-policies/{id}/schedule | Update SOD Policy schedule
[**update_sod_policy**](SODPolicyApi.md#update_sod_policy) | **PUT** /sod-policies/{id} | Update SOD policy by ID
...
with beta.ApiClient(configuration) as api_client:
    ...
    api_instance = beta.SODPolicyApi(api_client)
...
# **download_custom_violation_report**
> bytearray download_custom_violation_report(report_result_id, file_name)
...
with beta.ApiClient(configuration) as api_client:
    ...
    try:
        # Download custom violation report
        api_response = api_instance.download_custom_violation_report(report_result_id, file_name)
        print("The response of SODPolicyApi->download_custom_violation_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SODPolicyApi->download_custom_violation_report: %s\n" % e)
```
...
# **download_default_violation_report**
> bytearray download_default_violation_report(report_result_id)
...
with beta.ApiClient(configuration) as api_client:
    ...
    try:
        # Download violation report
        api_response = api_instance.download_default_violation_report(report_result_id)
        print("The response of SODPolicyApi->download_default_violation_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SODPolicyApi->download_default_violation_report: %s\n" % e)
```
...
# **run_sod_all_policies_for_org**
> ReportResultReference run_sod_all_policies_for_org(multi_policy_request=multi_policy_request)
...
with beta.ApiClient(configuration) as api_client:
    ...
    try:
        # Runs all policies for org
        api_response = api_instance.run_sod_all_policies_for_org(multi_policy_request=multi_policy_request)
        print("The response of SODPolicyApi->run_sod_all_policies_for_org:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SODPolicyApi->run_sod_all_policies_for_org: %s\n" % e)
```
...
# **run_sod_policy**
> ReportResultReference run_sod_policy(id)
...
with beta.ApiClient(configuration) as api_client:
    ...
    try:
        # Runs SOD policy violation report
        api_response = api_instance.run_sod_policy(id)
        print("The response of SODPolicyApi->run_sod_policy:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SODPolicyApi->run_sod_policy: %s\n" % e)
```
...
> SodPolicySchedule update_policy_schedule(id, sod_policy_schedule)
...
with beta.ApiClient(configuration) as api_client:
    ...
    sod_policy_schedule = beta.SodPolicySchedule() # SodPolicySchedule | 

    try:
        # Update SOD Policy schedule
        api_response = api_instance.update_policy_schedule(id, sod_policy_schedule)
        print("The response of SODPolicyApi->update_policy_schedule:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SODPolicyApi->update_policy_schedule: %s\n" % e)
```
...
# **update_sod_policy**
> SodPolicy update_sod_policy(id, sod_policy)
...
with beta.ApiClient(configuration) as api_client:
    ...
    try:
        # Update SOD policy by ID
        api_response = api_instance.update_sod_policy(id, sod_policy)
        print("The response of SODPolicyApi->update_sod_policy:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling SODPolicyApi->update_sod_policy: %s\n" % e)
```
