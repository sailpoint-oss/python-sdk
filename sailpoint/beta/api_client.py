...
from sailpoint.beta.api_response import ApiResponse, T as ApiResponseT
import sailpoint.beta.models
from sailpoint.beta import rest
from sailpoint.beta.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.beta.models, klass)
