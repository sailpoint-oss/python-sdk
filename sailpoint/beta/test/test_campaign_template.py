...
from beta.models.campaign_template import CampaignTemplate  # noqa: E501
    ...
    def make_instance(self, include_optional) -> CampaignTemplate:
        ...
        if include_optional:
            return CampaignTemplate(
                ...
                scheduled = False,
                owner_ref = beta.models.campaign_template_owner_ref.CampaignTemplate_ownerRef(
                    id = '2c918086676d3e0601677611dbde220f', 
                    type = 'IDENTITY', 
                    name = 'Mister Manager', 
                    email = 'mr.manager@example.com', ),
                deadline_duration = 'P2W',
                campaign = beta.models.campaign.Campaign()
            )
        else:
            return CampaignTemplate(
                name = 'Manager Campaign Template',
