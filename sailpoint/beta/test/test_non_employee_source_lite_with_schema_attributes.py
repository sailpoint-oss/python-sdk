...
from beta.models.non_employee_source_lite_with_schema_attributes import NonEmployeeSourceLiteWithSchemaAttributes  # noqa: E501
    ...
    def make_instance(
        ...
        if include_optional:
            return NonEmployeeSourceLiteWithSchemaAttributes(
                ...
                schema_attributes = [
                    beta.models.non_employee_schema_attribute.NonEmployeeSchemaAttribute(
