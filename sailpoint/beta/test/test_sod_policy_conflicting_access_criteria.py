...
from beta.models.sod_policy_conflicting_access_criteria import SodPolicyConflictingAccessCriteria  # noqa: E501
    ...
    def make_instance(self,
        ...
        if include_optional:
            return SodPolicyConflictingAccessCriteria(
                left_criteria = beta.models.access_criteria.AccessCriteria(
                    name = 'money-in', 
                ...
                right_criteria = beta.models.access_criteria.AccessCriteria(
                    name = 'money-in', 
                    criteria_list = [{type=ENTITLEMENT, id=2c9180866166b5b0016167c32ef31a66, name=Administrator}, {type=ENTITLEMENT, id=2c9180866166b5b0016167c32ef31a67, name=Administrator}], )
            )
        else:
