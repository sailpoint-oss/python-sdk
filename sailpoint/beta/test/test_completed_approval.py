    ...
    def make_instance(self, include_optional) -> CompletedApproval:
        ...
        if include_optional:
            return CompletedApproval(
                ...
                reviewed_by = beta.models.completed_approval_reviewed_by.CompletedApproval_reviewedBy(
                    type = 'IDENTITY', 
                ...
                requester_comment = beta.models.comment_dto.CommentDto(
                    ...
                    author = beta.models.comment_dto_author.CommentDto_author(
                        ...
                        name = 'Adam Kennedy', ), 
                    created = '2017-07-11T18:45:37.098Z', ),
                reviewer_comment = beta.models.completed_approval_reviewer_comment.CompletedApproval_reviewerComment(),
