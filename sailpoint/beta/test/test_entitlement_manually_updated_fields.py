...
class TestEntitlementManuallyUpdatedFields(unittest.TestCase):
    """EntitlementManuallyUpdatedFields unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntitlementManuallyUpdatedFields:
        ...
        """
        model = EntitlementManuallyUpdatedFields()
        if include_optional:
            return EntitlementManuallyUpdatedFields(
                display_name = True,
                description = True
            )
        else:
    ...
    def testEntitlementManuallyUpdatedFields(self):
        """Test EntitlementManuallyUpdatedFields"""
