...
from beta.models.non_employee_source_request_body import NonEmployeeSourceRequestBody  # noqa: E501
    ...
    def make_instance(self, include_optional) -> NonEmployeeSourceRequestBody:
        ...
        if include_optional:
            return NonEmployeeSourceRequestBody(
                ...
                owner = beta.models.non_employee_idn_user_request.NonEmployeeIdnUserRequest(
                    id = '2c91808570313110017040b06f344ec9', ),
                management_workgroup = '123299',
                approvers = [
                    beta.models.non_employee_idn_user_request.NonEmployeeIdnUserRequest(
                        id = '2c91808570313110017040b06f344ec9', )
                    ],
                account_managers = [
                    beta.models.non_employee_idn_user_request.NonEmployeeIdnUserRequest(
