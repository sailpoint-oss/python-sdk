...
class TestAccessRequestPostApprovalRequestedFor(unittest.TestCase):
    ...
    def make_instance(
        ...
        # uncomment below to create an instance of `AccessRequestPostApprovalRequestedFor`
        """
        model = AccessRequestPostApprovalRequestedFor()  # noqa: E501
        if include_optional:
            return AccessRequestPostApprovalRequestedFor(
                type = IDENTITY,
    ...
    def testAccessRequestPostApprovalRequestedFor(self):
        """Test AccessRequestPostApprovalRequestedFor"""
