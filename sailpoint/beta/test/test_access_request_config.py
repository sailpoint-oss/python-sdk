...
class TestAccessRequestConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AccessRequestConfig:
        ...
        """
        model = AccessRequestConfig()  # noqa: E501
        if include_optional:
            return AccessRequestConfig(
                approvals_must_be_external = True,
                auto_approval_enabled = True,
                request_on_behalf_of_config = beta.models.request_on_behalf_of_config.RequestOnBehalfOfConfig(
                    allow_request_on_behalf_of_anyone_by_anyone = True, 
                    allow_request_on_behalf_of_employee_by_manager = True, ),
                approval_reminder_and_escalation_config = beta.models.approval_reminder_and_escalation_config.ApprovalReminderAndEscalationConfig(
                ...
                entitlement_request_config = beta.models.entitlement_request_config_1.EntitlementRequestConfig_1(
