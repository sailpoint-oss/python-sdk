...
from beta.models.field_details import FieldDetails  # noqa: E501


class TestFieldDetails(unittest.TestCase):
    """FieldDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FieldDetails:
        """Test FieldDetails
