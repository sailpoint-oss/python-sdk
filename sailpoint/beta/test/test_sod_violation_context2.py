...
class TestSodViolationContext2(unittest.TestCase):
    """SodViolationContext2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SodViolationContext2:
        """Test SodViolationContext2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SodViolationContext2`
        """
        model = SodViolationContext2()
        if include_optional:
            return SodViolationContext2(
    ...
    def testSodViolationContext2(self):
        """Test SodViolationContext2"""
