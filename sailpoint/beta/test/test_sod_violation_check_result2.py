...
class TestSodViolationCheckResult2(unittest.TestCase):
    """SodViolationCheckResult2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SodViolationCheckResult2:
        """Test SodViolationCheckResult2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SodViolationCheckResult2`
        """
        model = SodViolationCheckResult2()
        if include_optional:
            return SodViolationCheckResult2(
    ...
    def testSodViolationCheckResult2(self):
        """Test SodViolationCheckResult2"""
