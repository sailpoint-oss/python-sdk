...
from beta.models.role_mining_potential_role_edit_entitlements import RoleMiningPotentialRoleEditEntitlements  # noqa: E501
...
class TestRoleMiningPotentialRoleEditEntitlements(unittest.TestCase):
    ...
    def make_instance(
            self, include_optional) -> RoleMiningPotentialRoleEditEntitlements:
