...
from beta.models.role_mining_potential_role_export_response import RoleMiningPotentialRoleExportResponse  # noqa: E501
...
class TestRoleMiningPotentialRoleExportResponse(unittest.TestCase):
    ...
    def make_instance(
            self, include_optional) -> RoleMiningPotentialRoleExportResponse:
