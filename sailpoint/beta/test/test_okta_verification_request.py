...
class TestOktaVerificationRequest(unittest.TestCase):
    """OktaVerificationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OktaVerificationRequest:
        ...
        """
        model = OktaVerificationRequest()
        if include_optional:
            return OktaVerificationRequest(
    ...
    def testOktaVerificationRequest(self):
        """Test OktaVerificationRequest"""
