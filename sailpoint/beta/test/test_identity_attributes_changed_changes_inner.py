...
from beta.models.identity_attributes_changed_changes_inner import IdentityAttributesChangedChangesInner  # noqa: E501
...
class TestIdentityAttributesChangedChangesInner(unittest.TestCase):
    ...
    def make_instance(
            self, include_optional) -> IdentityAttributesChangedChangesInner:
