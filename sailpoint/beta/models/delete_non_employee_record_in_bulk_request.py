...
class DeleteNonEmployeeRecordInBulkRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeleteNonEmployeeRecordInBulkRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeleteNonEmployeeRecordInBulkRequest:
        """Create an instance of DeleteNonEmployeeRecordInBulkRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeleteNonEmployeeRecordInBulkRequest.parse_obj(obj)

        _obj = DeleteNonEmployeeRecordInBulkRequest.parse_obj({
            "ids": obj.get("ids")
        })
        return _obj
