...
class ManagedClientStatus(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManagedClientStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ManagedClientStatus:
        """Create an instance of ManagedClientStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManagedClientStatus.parse_obj(obj)

        _obj = ManagedClientStatus.parse_obj({
            "body": obj.get("body"),
