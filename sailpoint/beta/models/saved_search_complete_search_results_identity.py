...
class SavedSearchCompleteSearchResultsIdentity(BaseModel):
    """
    A table of identities that match the search criteria.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SavedSearchCompleteSearchResultsIdentity:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SavedSearchCompleteSearchResultsIdentity:
        """Create an instance of SavedSearchCompleteSearchResultsIdentity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SavedSearchCompleteSearchResultsIdentity.parse_obj(obj)

        _obj = SavedSearchCompleteSearchResultsIdentity.parse_obj({
            "count": obj.get("count"),
            "noun": obj.get("noun"),
