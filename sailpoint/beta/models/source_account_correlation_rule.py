...
class SourceAccountCorrelationRule(BaseModel):
    """
    Reference to a Rule that can do COMPLEX correlation, should only be used when accountCorrelationConfig can't be used.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SourceAccountCorrelationRule:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SourceAccountCorrelationRule:
        """Create an instance of SourceAccountCorrelationRule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SourceAccountCorrelationRule.parse_obj(obj)

        _obj = SourceAccountCorrelationRule.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
