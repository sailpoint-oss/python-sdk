...
class PublicIdentityAttributeConfig(BaseModel):
    ...
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="the key of the attribute")
    name: Optional[StrictStr] = Field(default=None, description="the display name of the attribute")
