...
class IdentitySummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IdentitySummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IdentitySummary:
        """Create an instance of IdentitySummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IdentitySummary.parse_obj(obj)

        _obj = IdentitySummary.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
