...
class StatusResponse(BaseModel):
    ...
    status: Optional[StrictStr] = Field(None, description="The status of the health check.")
    ...
    details: Optional[Dict[str, Any]] = Field(None, description="The document contains the results of the health check. The schema of this document depends on the type of source used. ")
