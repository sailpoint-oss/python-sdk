...
class SodReportResultDto(BaseModel):
    """
    SOD policy violation report result.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SodReportResultDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SodReportResultDto:
        """Create an instance of SodReportResultDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SodReportResultDto.parse_obj(obj)

        _obj = SodReportResultDto.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
