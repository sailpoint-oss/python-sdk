...
class EventBridgeConfig(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventBridgeConfig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventBridgeConfig:
        """Create an instance of EventBridgeConfig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventBridgeConfig.parse_obj(obj)

        _obj = EventBridgeConfig.parse_obj({
            "aws_account": obj.get("awsAccount"),
