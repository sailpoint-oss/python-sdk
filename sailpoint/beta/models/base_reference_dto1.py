...
class BaseReferenceDto1(BaseModel):
    """
    BaseReferenceDto1
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseReferenceDto1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseReferenceDto1:
        """Create an instance of BaseReferenceDto1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BaseReferenceDto1.parse_obj(obj)

        _obj = BaseReferenceDto1.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
