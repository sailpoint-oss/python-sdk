...
class Schedule(BaseModel):
    ...
    expiration: Optional[datetime] = Field(None, description="Specifies the time after which this schedule will no longer occur.")
    time_zone_id: Optional[StrictStr] = Field(None, alias="timeZoneId", description="The time zone to use when running the schedule. For instance, if the schedule is scheduled to run at 1AM, and this field is set to \"CST\", the schedule will run at 1AM CST.")
    __properties = ["type", "months", "days", "hours", "expiration", "timeZoneId"]
