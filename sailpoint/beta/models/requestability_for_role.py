...
class RequestabilityForRole(BaseModel):
    ...
    approval_schemes: Optional[conlist(ApprovalSchemeForRole)] = Field(None, alias="approvalSchemes", description="List describing the steps in approving the request")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RequestabilityForRole:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RequestabilityForRole:
        """Create an instance of RequestabilityForRole from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RequestabilityForRole.parse_obj(obj)

        _obj = RequestabilityForRole.parse_obj({
            ...
            "approval_schemes": [ApprovalSchemeForRole.from_dict(_item) for _item in obj.get("approvalSchemes")] if obj.get("approvalSchemes") is not None else None
        })
        return _obj
