...
class CompleteCampaignOptions(BaseModel):
    """
    ...
    def auto_complete_action_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompleteCampaignOptions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CompleteCampaignOptions:
        """Create an instance of CompleteCampaignOptions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CompleteCampaignOptions.parse_obj(obj)

        _obj = CompleteCampaignOptions.parse_obj({
