...
class AccountCorrelatedIdentity(BaseModel):
    """
    The identity that the account correlated with.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountCorrelatedIdentity:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountCorrelatedIdentity:
        """Create an instance of AccountCorrelatedIdentity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccountCorrelatedIdentity.parse_obj(obj)

        _obj = AccountCorrelatedIdentity.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
