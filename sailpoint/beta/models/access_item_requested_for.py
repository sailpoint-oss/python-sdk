...
class AccessItemRequestedFor(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccessItemRequestedFor:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccessItemRequestedFor:
        """Create an instance of AccessItemRequestedFor from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccessItemRequestedFor.parse_obj(obj)

        _obj = AccessItemRequestedFor.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
