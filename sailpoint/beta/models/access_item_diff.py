...
class AccessItemDiff(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccessItemDiff:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccessItemDiff:
        """Create an instance of AccessItemDiff from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccessItemDiff.parse_obj(obj)

        _obj = AccessItemDiff.parse_obj({
            "id": obj.get("id"),
