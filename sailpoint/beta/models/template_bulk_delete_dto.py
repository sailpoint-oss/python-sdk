...
class TemplateBulkDeleteDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TemplateBulkDeleteDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TemplateBulkDeleteDto:
        """Create an instance of TemplateBulkDeleteDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TemplateBulkDeleteDto.parse_obj(obj)

        _obj = TemplateBulkDeleteDto.parse_obj({
            "key": obj.get("key"),
