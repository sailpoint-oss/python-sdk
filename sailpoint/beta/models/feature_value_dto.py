...
class FeatureValueDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FeatureValueDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FeatureValueDto:
        """Create an instance of FeatureValueDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FeatureValueDto.parse_obj(obj)

        _obj = FeatureValueDto.parse_obj({
