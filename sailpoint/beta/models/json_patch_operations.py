...
class JsonPatchOperations(BaseModel):
    """
    ...
    path: StrictStr = Field(description="A string representing the target path to an element to be affected by the operation")
    value: Optional[JsonPatchOperationsValue] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "op": obj.get("op"),
            "path": obj.get("path"),
            "value": JsonPatchOperationsValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
