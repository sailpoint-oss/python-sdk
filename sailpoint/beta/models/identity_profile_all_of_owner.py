...
class IdentityProfileAllOfOwner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IdentityProfileAllOfOwner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IdentityProfileAllOfOwner:
        """Create an instance of IdentityProfileAllOfOwner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IdentityProfileAllOfOwner.parse_obj(obj)

        _obj = IdentityProfileAllOfOwner.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
