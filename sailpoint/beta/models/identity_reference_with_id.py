...
class IdentityReferenceWithId(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IdentityReferenceWithId:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IdentityReferenceWithId:
        """Create an instance of IdentityReferenceWithId from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IdentityReferenceWithId.parse_obj(obj)

        _obj = IdentityReferenceWithId.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id")
        })
        return _obj
