...
class ApprovalSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApprovalSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApprovalSummary:
        """Create an instance of ApprovalSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApprovalSummary.parse_obj(obj)

        _obj = ApprovalSummary.parse_obj({
