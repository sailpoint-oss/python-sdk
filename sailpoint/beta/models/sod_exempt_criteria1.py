...
class SodExemptCriteria1(BaseModel):
    """
    ...
    __properties = ["existing", "type", "id", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SodExemptCriteria1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SodExemptCriteria1:
        """Create an instance of SodExemptCriteria1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SodExemptCriteria1.parse_obj(obj)

        _obj = SodExemptCriteria1.parse_obj({
