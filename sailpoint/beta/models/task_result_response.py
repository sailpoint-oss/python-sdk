...
class TaskResultResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaskResultResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaskResultResponse:
        """Create an instance of TaskResultResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaskResultResponse.parse_obj(obj)

        _obj = TaskResultResponse.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
