...
class NonEmployeeApprovalSummary(BaseModel):
    ...
    """
    approved: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="The number of approved non-employee approval requests.")
    pending: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="The number of pending non-employee approval requests.")
    rejected: Optional[Union[StrictFloat, StrictInt]] = Field(None, description="The number of rejected non-employee approval requests.")
