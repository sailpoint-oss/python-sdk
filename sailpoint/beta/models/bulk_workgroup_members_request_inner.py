...
class BulkWorkgroupMembersRequestInner(BaseModel):
    """
    Identity's basic details.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BulkWorkgroupMembersRequestInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BulkWorkgroupMembersRequestInner:
