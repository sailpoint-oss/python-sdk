...
class IdentityDtoManagerRef(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IdentityDtoManagerRef:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IdentityDtoManagerRef:
        """Create an instance of IdentityDtoManagerRef from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IdentityDtoManagerRef.parse_obj(obj)

        _obj = IdentityDtoManagerRef.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
