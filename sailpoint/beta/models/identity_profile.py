...
class IdentityProfile(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "authoritativeSource": IdentityProfileAllOfAuthoritativeSource.from_dict(obj.get("authoritativeSource")) if obj.get("authoritativeSource") is not None else None,
            ...
            "identityAttributeConfig": IdentityAttributeConfig.from_dict(obj.get("identityAttributeConfig")) if obj.get("identityAttributeConfig") is not None else None,
            "identityExceptionReportReference": IdentityExceptionReportReference.from_dict(obj.get("identityExceptionReportReference")) if obj.get("identityExceptionReportReference") is not None else None,
