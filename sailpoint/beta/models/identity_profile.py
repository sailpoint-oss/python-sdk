...
class IdentityProfile(BaseModel):
    ...
    identity_exception_report_reference: Optional[IdentityExceptionReportReference] = Field(None, alias="identityExceptionReportReference")
    has_time_based_attr: Optional[StrictBool] = Field(True, alias="hasTimeBasedAttr", description="Indicates the value of requiresPeriodicRefresh attribute for the Identity Profile.")
    ...
    def from_dict(cls, obj: dict) -> IdentityProfile:
        ...
        _obj = IdentityProfile.parse_obj({
            ...
            "authoritative_source": IdentityProfileAllOfAuthoritativeSource.from_dict(obj.get("authoritativeSource")) if obj.get("authoritativeSource") is not None else None,
            ...
            "identity_exception_report_reference": IdentityExceptionReportReference.from_dict(obj.get("identityExceptionReportReference")) if obj.get("identityExceptionReportReference") is not None else None,
            "has_time_based_attr": obj.get("hasTimeBasedAttr") if obj.get("hasTimeBasedAttr") is not None else True
        })
        return _obj
