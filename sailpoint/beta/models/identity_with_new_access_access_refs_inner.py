...
class IdentityWithNewAccessAccessRefsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IdentityWithNewAccessAccessRefsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IdentityWithNewAccessAccessRefsInner:
        """Create an instance of IdentityWithNewAccessAccessRefsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IdentityWithNewAccessAccessRefsInner.parse_obj(obj)

        _obj = IdentityWithNewAccessAccessRefsInner.parse_obj({
            "type":
            obj.get("type"),
            "id":
            obj.get("id"),
