...
class ProvisioningCriteriaLevel1(BaseModel):
    ...
    children: Optional[conlist(ProvisioningCriteriaLevel2)] = Field(None, description="Array of child criteria. Required if the operation is AND or OR, otherwise it must be left null. A maximum of three levels of criteria are supported, including leaf nodes.")
    ...
    def from_dict(cls, obj: dict) -> ProvisioningCriteriaLevel1:
        ...
        _obj = ProvisioningCriteriaLevel1.parse_obj({
            ...
            "value": obj.get("value"),
            "children": [ProvisioningCriteriaLevel2.from_dict(_item) for _item in obj.get("children")] if obj.get("children") is not None else None
        })
        return _obj
