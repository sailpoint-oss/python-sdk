...
class RoleMiningSessionScopingMethod(BaseModel):
    """
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RoleMiningSessionScopingMethod:
        """Create an instance of RoleMiningSessionScopingMethod from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RoleMiningSessionScopingMethod.parse_obj(obj)

        _obj = RoleMiningSessionScopingMethod.parse_obj(
            {"state": obj.get("state")})
        return _obj
