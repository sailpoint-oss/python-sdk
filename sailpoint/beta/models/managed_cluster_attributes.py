...
class ManagedClusterAttributes(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManagedClusterAttributes:
    ...
    def to_dict(self):
        ...
        if self.keystore is None and "keystore" in self.__fields_set__:
            _dict['keystore'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> ManagedClusterAttributes:
