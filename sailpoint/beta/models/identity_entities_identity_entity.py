...
class IdentityEntitiesIdentityEntity(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IdentityEntitiesIdentityEntity:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IdentityEntitiesIdentityEntity:
        """Create an instance of IdentityEntitiesIdentityEntity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IdentityEntitiesIdentityEntity.parse_obj(obj)

        _obj = IdentityEntitiesIdentityEntity.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type")
        })
