...
class CreateFormDefinitionFileRequestRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls,
                  json_str: str) -> CreateFormDefinitionFileRequestRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateFormDefinitionFileRequestRequest:
        """Create an instance of CreateFormDefinitionFileRequestRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateFormDefinitionFileRequestRequest.parse_obj(obj)

        _obj = CreateFormDefinitionFileRequestRequest.parse_obj(
            {"file": obj.get("file")})
        return _obj
