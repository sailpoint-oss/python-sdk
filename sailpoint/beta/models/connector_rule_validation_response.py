...
class ConnectorRuleValidationResponse(BaseModel):
    """
    ConnectorRuleValidationResponse  # noqa: E501
    """
    state: StrictStr = Field(...)
    details: conlist(ConnectorRuleValidationResponseDetailsInner) = Field(...)
    __properties = ["state", "details"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConnectorRuleValidationResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConnectorRuleValidationResponse:
