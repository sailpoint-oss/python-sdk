...
class LoadAccountsTaskTaskReturnsInner(BaseModel):
    """
    LoadAccountsTaskTaskReturnsInner
    """ # noqa: E501
    display_label: Optional[StrictStr] = Field(default=None, description="The display label of the return value", alias="displayLabel")
    attribute_name: Optional[StrictStr] = Field(default=None, description="The attribute name of the return value", alias="attributeName")
