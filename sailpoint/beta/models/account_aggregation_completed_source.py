...
class AccountAggregationCompletedSource(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountAggregationCompletedSource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountAggregationCompletedSource:
        """Create an instance of AccountAggregationCompletedSource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccountAggregationCompletedSource.parse_obj(obj)

        _obj = AccountAggregationCompletedSource.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
