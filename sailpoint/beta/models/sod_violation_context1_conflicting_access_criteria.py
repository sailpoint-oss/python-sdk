...
class SodViolationContext1ConflictingAccessCriteria(BaseModel):
    ...
    left_criteria: Optional[
        SodViolationContext1ConflictingAccessCriteriaLeftCriteria] = Field(
    ...
    def from_json(
            cls,
            json_str: str) -> SodViolationContext1ConflictingAccessCriteria:
    ...
    @classmethod
    def from_dict(cls,
                  obj: dict) -> SodViolationContext1ConflictingAccessCriteria:
        ...
        _obj = SodViolationContext1ConflictingAccessCriteria.parse_obj({
            ...
            from_dict(obj.get("leftCriteria"))
            if obj.get("leftCriteria") is not None else None,
            "right_criteria":
            SodViolationContext1ConflictingAccessCriteriaLeftCriteria.
            from_dict(obj.get("rightCriteria"))
