...
class SodViolationContext1ConflictingAccessCriteria(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "leftCriteria": SodViolationContext1ConflictingAccessCriteriaLeftCriteria.from_dict(obj["leftCriteria"]) if obj.get("leftCriteria") is not None else None,
            "rightCriteria": SodViolationContext1ConflictingAccessCriteriaLeftCriteria.from_dict(obj["rightCriteria"]) if obj.get("rightCriteria") is not None else None
        })
        return _obj
