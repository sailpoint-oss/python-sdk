...
class SodViolationContext1ConflictingAccessCriteria(BaseModel):
    ...
    """ # noqa: E501
    left_criteria: Optional[SodViolationContext1ConflictingAccessCriteriaLeftCriteria] = Field(default=None, alias="leftCriteria")
    right_criteria: Optional[SodViolationContext1ConflictingAccessCriteriaLeftCriteria] = Field(default=None, alias="rightCriteria")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "leftCriteria": SodViolationContext1ConflictingAccessCriteriaLeftCriteria.from_dict(obj.get("leftCriteria")) if obj.get("leftCriteria") is not None else None,
            "rightCriteria": SodViolationContext1ConflictingAccessCriteriaLeftCriteria.from_dict(obj.get("rightCriteria")) if obj.get("rightCriteria") is not None else None
        })
        return _obj
