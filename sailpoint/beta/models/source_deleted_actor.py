...
class SourceDeletedActor(BaseModel):
    """
    The identity that deleted the source.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SourceDeletedActor:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SourceDeletedActor:
        """Create an instance of SourceDeletedActor from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SourceDeletedActor.parse_obj(obj)

        _obj = SourceDeletedActor.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
