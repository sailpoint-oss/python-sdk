...
class CertificationReference(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CertificationReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CertificationReference:
        """Create an instance of CertificationReference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CertificationReference.parse_obj(obj)

        _obj = CertificationReference.parse_obj({
            "type":
            obj.get("type"),
            "id":
            obj.get("id"),
