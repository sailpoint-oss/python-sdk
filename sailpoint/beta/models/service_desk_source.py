...
class ServiceDeskSource(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServiceDeskSource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServiceDeskSource:
        """Create an instance of ServiceDeskSource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServiceDeskSource.parse_obj(obj)

        _obj = ServiceDeskSource.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
