...
class AccountAttributesCreate(BaseModel):
    ...
    """
    attributes: AccountAttributesCreateAttributes = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountAttributesCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountAttributesCreate:
