...
class RoleMiningIdentity(BaseModel):
    ...
    name: Optional[StrictStr] = Field(None, description="Name of the identity")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RoleMiningIdentity:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RoleMiningIdentity:
        """Create an instance of RoleMiningIdentity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RoleMiningIdentity.parse_obj(obj)

        _obj = RoleMiningIdentity.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
