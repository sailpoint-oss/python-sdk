...
class MetricResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MetricResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MetricResponse:
        """Create an instance of MetricResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MetricResponse.parse_obj(obj)

        _obj = MetricResponse.parse_obj({
            "name": obj.get("name"),
            "value": obj.get("value")
        })
        return _obj
