...
class RoleInsightsRole(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RoleInsightsRole:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RoleInsightsRole:
        """Create an instance of RoleInsightsRole from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RoleInsightsRole.parse_obj(obj)

        _obj = RoleInsightsRole.parse_obj({
            "name": obj.get("name"),
            "id": obj.get("id"),
