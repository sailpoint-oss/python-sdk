...
class IdentityPreviewResponseIdentity(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IdentityPreviewResponseIdentity:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IdentityPreviewResponseIdentity:
        """Create an instance of IdentityPreviewResponseIdentity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IdentityPreviewResponseIdentity.parse_obj(obj)

        _obj = IdentityPreviewResponseIdentity.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
