...
class AccountUncorrelatedIdentity(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountUncorrelatedIdentity:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountUncorrelatedIdentity:
        """Create an instance of AccountUncorrelatedIdentity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccountUncorrelatedIdentity.parse_obj(obj)

        _obj = AccountUncorrelatedIdentity.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
