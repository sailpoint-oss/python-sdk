...
class ManagedClusterQueue(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManagedClusterQueue:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ManagedClusterQueue:
        """Create an instance of ManagedClusterQueue from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManagedClusterQueue.parse_obj(obj)

        _obj = ManagedClusterQueue.parse_obj({
            "name": obj.get("name"),
