...
class ManagedClusterRedis(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManagedClusterRedis:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ManagedClusterRedis:
        """Create an instance of ManagedClusterRedis from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManagedClusterRedis.parse_obj(obj)

        _obj = ManagedClusterRedis.parse_obj({
            "redis_host": obj.get("redisHost"),
