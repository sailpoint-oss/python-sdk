...
class Source(BaseModel):
    ...
    manager_correlation_rule: Optional[MultiHostSourcesManagerCorrelationRule] = Field(default=None, alias="managerCorrelationRule")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if manager_correlation_mapping (nullable) is None
        # and model_fields_set contains the field
        if self.manager_correlation_mapping is None and "manager_correlation_mapping" in self.model_fields_set:
            _dict['managerCorrelationMapping'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "managerCorrelationRule": MultiHostSourcesManagerCorrelationRule.from_dict(obj["managerCorrelationRule"]) if obj.get("managerCorrelationRule") is not None else None,
            ...
            "schemas": [MultiHostSourcesSchemasInner.from_dict(_item) for _item in obj["schemas"]] if obj.get("schemas") is not None else None,
            "passwordPolicies": [MultiHostSourcesPasswordPoliciesInner.from_dict(_item) for _item in obj["passwordPolicies"]] if obj.get("passwordPolicies") is not None else None,
