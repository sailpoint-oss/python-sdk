...
class SectionDetails(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SectionDetails:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SectionDetails:
        """Create an instance of SectionDetails from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SectionDetails.parse_obj(obj)

        _obj = SectionDetails.parse_obj({
            "name": obj.get("name"),
            "label": obj.get("label"),
