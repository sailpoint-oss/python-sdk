...
class SelfImportExportDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SelfImportExportDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SelfImportExportDto:
        """Create an instance of SelfImportExportDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SelfImportExportDto.parse_obj(obj)

        _obj = SelfImportExportDto.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
