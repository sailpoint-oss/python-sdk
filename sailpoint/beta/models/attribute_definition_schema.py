...
class AttributeDefinitionSchema(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeDefinitionSchema:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeDefinitionSchema:
        """Create an instance of AttributeDefinitionSchema from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AttributeDefinitionSchema.parse_obj(obj)

        _obj = AttributeDefinitionSchema.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
