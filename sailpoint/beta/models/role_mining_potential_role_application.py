...
class RoleMiningPotentialRoleApplication(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RoleMiningPotentialRoleApplication:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RoleMiningPotentialRoleApplication:
        """Create an instance of RoleMiningPotentialRoleApplication from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RoleMiningPotentialRoleApplication.parse_obj(obj)

        _obj = RoleMiningPotentialRoleApplication.parse_obj({
            "id":
            obj.get("id"),
            "name":
            obj.get("name")
