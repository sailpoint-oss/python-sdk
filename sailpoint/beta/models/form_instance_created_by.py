...
class FormInstanceCreatedBy(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FormInstanceCreatedBy:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FormInstanceCreatedBy:
        """Create an instance of FormInstanceCreatedBy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FormInstanceCreatedBy.parse_obj(obj)

        _obj = FormInstanceCreatedBy.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
