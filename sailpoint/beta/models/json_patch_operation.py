...
class JsonPatchOperation(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JsonPatchOperation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JsonPatchOperation:
        """Create an instance of JsonPatchOperation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JsonPatchOperation.parse_obj(obj)

        _obj = JsonPatchOperation.parse_obj({
            "op":
            obj.get("op"),
            "path":
            obj.get("path"),
