...
class ResourceObject(BaseModel):
    ...
    identity: Optional[StrictStr] = Field(
        None, description="Native identity of the object in the Source.")
    ...
    name: Optional[StrictStr] = Field(
        None, description="Display name for this object.")
    object_type: Optional[StrictStr] = Field(None,
                                             alias="objectType",
    ...
    missing: Optional[conlist(StrictStr)] = Field(
        None,
        description=
    ...
    attributes: Optional[Dict[str, Any]] = Field(
        None, description="Attributes of this ResourceObject.")
