...
class OwnerReferenceDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OwnerReferenceDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OwnerReferenceDto:
        """Create an instance of OwnerReferenceDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OwnerReferenceDto.parse_obj(obj)

        _obj = OwnerReferenceDto.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type")
        })
