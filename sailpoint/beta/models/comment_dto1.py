...
class CommentDto1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommentDto1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommentDto1:
        """Create an instance of CommentDto1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommentDto1.parse_obj(obj)

        _obj = CommentDto1.parse_obj({
            "comment": obj.get("comment"),
            "author": CommentDto1Author.from_dict(obj.get("author")) if obj.get("author") is not None else None,
