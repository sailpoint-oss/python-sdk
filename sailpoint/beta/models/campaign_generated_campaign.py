...
class CampaignGeneratedCampaign(BaseModel):
    ...
    modified: Optional[StrictStr] = Field(None, description="The date and time the campaign was last modified.")
    deadline: Optional[StrictStr] = Field(None, description="The date and time when the campaign must be finished by.")
    ...
    def from_dict(cls, obj: dict) -> CampaignGeneratedCampaign:
        ...
        _obj = CampaignGeneratedCampaign.parse_obj({
            ...
            "type": obj.get("type"),
            "campaign_owner": CampaignGeneratedCampaignCampaignOwner.from_dict(obj.get("campaignOwner")) if obj.get("campaignOwner") is not None else None,
