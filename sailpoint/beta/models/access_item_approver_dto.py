...
class AccessItemApproverDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccessItemApproverDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccessItemApproverDto:
        """Create an instance of AccessItemApproverDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccessItemApproverDto.parse_obj(obj)

        _obj = AccessItemApproverDto.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
