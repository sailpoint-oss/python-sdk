...
class RoleMiningSessionResponse(BaseModel):
    ...
    prescribed_prune_threshold: Optional[StrictInt] = Field(None, alias="prescribedPruneThreshold", description="The computed (or prescribed) prune threshold for this session")
    prune_threshold: Optional[StrictInt] = Field(None, alias="pruneThreshold", description="The prune threshold to be used for this role mining session")
    potential_role_count: Optional[StrictInt] = Field(None, alias="potentialRoleCount", description="The number of potential roles")
    potential_roles_ready_count: Optional[StrictInt] = Field(None, alias="potentialRolesReadyCount", description="The number of potential roles which have completed processing")
    status: Optional[RoleMiningSessionStatus] = None
    id: Optional[StrictStr] = Field(None, description="Session Id for this role mining session")
    created_date: Optional[datetime] = Field(None, alias="createdDate", description="The date-time when this role mining session was created.")
    modified_date: Optional[datetime] = Field(None, alias="modifiedDate", description="The date-time when this role mining session was completed.")
    type: Optional[RoleMiningRoleType] = None
    __properties = ["scope", "minNumIdentitiesInPotentialRole", "prescribedPruneThreshold", "pruneThreshold", "potentialRoleCount", "potentialRolesReadyCount", "status", "id", "createdDate", "modifiedDate", "type"]
