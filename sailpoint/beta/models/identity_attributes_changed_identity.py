...
class IdentityAttributesChangedIdentity(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IdentityAttributesChangedIdentity:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IdentityAttributesChangedIdentity:
        """Create an instance of IdentityAttributesChangedIdentity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IdentityAttributesChangedIdentity.parse_obj(obj)

        _obj = IdentityAttributesChangedIdentity.parse_obj({
            "type":
            obj.get("type"),
            "id":
            obj.get("id"),
