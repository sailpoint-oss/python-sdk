...
class CommentDto1Author(BaseModel):
    """
    CommentDto1Author
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CommentDto1Author:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CommentDto1Author:
        """Create an instance of CommentDto1Author from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CommentDto1Author.parse_obj(obj)

        _obj = CommentDto1Author.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
