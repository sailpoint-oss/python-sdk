...
class ListCompleteWorkflowLibrary200ResponseInner(BaseModel):
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if not isinstance(v, WorkflowLibraryAction):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `WorkflowLibraryAction`"
            )
        else:
            return v
        ...
        if not isinstance(v, WorkflowLibraryTrigger):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `WorkflowLibraryTrigger`"
            )
        else:
            return v
        ...
        if not isinstance(v, WorkflowLibraryOperator):
            error_messages.append(
                f"Error! Input type `{type(v)}` is not `WorkflowLibraryOperator`"
            )
        else:
            return v
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when setting the actual_instance in ListCompleteWorkflowLibrary200ResponseInner with anyOf schemas: WorkflowLibraryAction, WorkflowLibraryOperator, WorkflowLibraryTrigger. Details: "
                + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[WorkflowLibraryAction] = None
        try:
            instance.actual_instance = WorkflowLibraryAction.from_json(
                json_str)
            return instance
        ...
        # anyof_schema_2_validator: Optional[WorkflowLibraryTrigger] = None
        try:
            instance.actual_instance = WorkflowLibraryTrigger.from_json(
                json_str)
            return instance
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # anyof_schema_3_validator: Optional[WorkflowLibraryOperator] = None
        try:
            instance.actual_instance = WorkflowLibraryOperator.from_json(
                json_str)
            return instance
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError(
                "No match found when deserializing the JSON string into ListCompleteWorkflowLibrary200ResponseInner with anyOf schemas: WorkflowLibraryAction, WorkflowLibraryOperator, WorkflowLibraryTrigger. Details: "
                + ", ".join(error_messages))
        else:
            return instance
