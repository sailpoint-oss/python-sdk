...
class ListCompleteWorkflowLibrary200ResponseInner(BaseModel):
    ...
    if TYPE_CHECKING:
        actual_instance: Union[WorkflowLibraryAction, WorkflowLibraryOperator, WorkflowLibraryTrigger]
    else:
        actual_instance: Any
    any_of_schemas: List[str] = Field(LISTCOMPLETEWORKFLOWLIBRARY200RESPONSEINNER_ANY_OF_SCHEMAS, const=True)
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListCompleteWorkflowLibrary200ResponseInner:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> ListCompleteWorkflowLibrary200ResponseInner:
