...
class AccessItemRequestedForDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccessItemRequestedForDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccessItemRequestedForDto:
        """Create an instance of AccessItemRequestedForDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccessItemRequestedForDto.parse_obj(obj)

        _obj = AccessItemRequestedForDto.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
