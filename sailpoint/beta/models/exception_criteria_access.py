...
class ExceptionCriteriaAccess(BaseModel):
    ...
    existing: Optional[StrictBool] = Field(None, description="Whether the subject identity already had that access or not")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExceptionCriteriaAccess:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExceptionCriteriaAccess:
