...
class RecommendationResponseDto(BaseModel):
    ...
    """
    response: Optional[conlist(RecommendationResponse)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecommendationResponseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecommendationResponseDto:
