...
class IdentityExceptionReportReference1(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IdentityExceptionReportReference1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IdentityExceptionReportReference1:
        """Create an instance of IdentityExceptionReportReference1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IdentityExceptionReportReference1.parse_obj(obj)

        _obj = IdentityExceptionReportReference1.parse_obj({
            "task_result_id":
