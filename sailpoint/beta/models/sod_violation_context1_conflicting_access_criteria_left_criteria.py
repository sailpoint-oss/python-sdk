...
class SodViolationContext1ConflictingAccessCriteriaLeftCriteria(BaseModel):
    ...
    """ # noqa: E501
    criteria_list: Optional[List[SodExemptCriteria1]] = Field(default=None, alias="criteriaList")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "criteriaList": [SodExemptCriteria1.from_dict(_item) for _item in obj.get("criteriaList")] if obj.get("criteriaList") is not None else None
        })
        return _obj
