...
class SourceManagementWorkgroup(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SourceManagementWorkgroup:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SourceManagementWorkgroup:
        """Create an instance of SourceManagementWorkgroup from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SourceManagementWorkgroup.parse_obj(obj)

        _obj = SourceManagementWorkgroup.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
