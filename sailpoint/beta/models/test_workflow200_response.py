...
class TestWorkflow200Response(BaseModel):
    """
    ...
    __properties = ["workflowExecutionId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestWorkflow200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestWorkflow200Response:
        """Create an instance of TestWorkflow200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TestWorkflow200Response.parse_obj(obj)

        _obj = TestWorkflow200Response.parse_obj({
