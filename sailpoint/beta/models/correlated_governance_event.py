...
class CorrelatedGovernanceEvent(BaseModel):
  ...
  # noqa: E501
    ...
    type: Optional[StrictStr] = Field(
        default=None, description="The type of governance event.")
