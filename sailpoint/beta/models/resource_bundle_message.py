...
class ResourceBundleMessage(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResourceBundleMessage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResourceBundleMessage:
        """Create an instance of ResourceBundleMessage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResourceBundleMessage.parse_obj(obj)

        _obj = ResourceBundleMessage.parse_obj({
            "key": obj.get("key"),
