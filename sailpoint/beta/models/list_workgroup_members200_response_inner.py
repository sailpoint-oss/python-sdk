...
class ListWorkgroupMembers200ResponseInner(BaseModel):
  ...
  # noqa: E501
    type: Optional[StrictStr] = Field(
        default=None, description="Workgroup member identity DTO type.")
    id: Optional[StrictStr] = Field(
        default=None, description="Workgroup member identity ID.")
    name: Optional[StrictStr] = Field(
        default=None, description="Workgroup member identity display name.")
