...
class SodViolationContextCheckCompleted2(BaseModel):
    """
    ...
    violation_check_result: Optional[SodViolationCheckResult2] = Field(default=None, alias="violationCheckResult")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SodViolationContextCheckCompleted2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SodViolationContextCheckCompleted2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "state": obj.get("state"),
            "uuid": obj.get("uuid"),
            "violationCheckResult": SodViolationCheckResult2.from_dict(obj["violationCheckResult"]) if obj.get("violationCheckResult") is not None else None
        })
        return _obj
