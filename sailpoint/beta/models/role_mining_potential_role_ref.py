...
class RoleMiningPotentialRoleRef(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RoleMiningPotentialRoleRef:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RoleMiningPotentialRoleRef:
        """Create an instance of RoleMiningPotentialRoleRef from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RoleMiningPotentialRoleRef.parse_obj(obj)

        _obj = RoleMiningPotentialRoleRef.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name")
        })
        return _obj
