...
class ApprovalInfoResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApprovalInfoResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApprovalInfoResponse:
        """Create an instance of ApprovalInfoResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApprovalInfoResponse.parse_obj(obj)

        _obj = ApprovalInfoResponse.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
