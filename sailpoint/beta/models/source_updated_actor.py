...
class SourceUpdatedActor(BaseModel):
    ...
    id: Optional[StrictStr] = Field(
        None, description="ID of identity who updated the source.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SourceUpdatedActor:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SourceUpdatedActor:
        """Create an instance of SourceUpdatedActor from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SourceUpdatedActor.parse_obj(obj)

        _obj = SourceUpdatedActor.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
