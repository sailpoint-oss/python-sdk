...
class AccessProfileRef(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccessProfileRef:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccessProfileRef:
        """Create an instance of AccessProfileRef from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccessProfileRef.parse_obj(obj)

        _obj = AccessProfileRef.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "name": obj.get("name")
        })
