...
class BaseCommonDto1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseCommonDto1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseCommonDto1:
        """Create an instance of BaseCommonDto1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BaseCommonDto1.parse_obj(obj)

        _obj = BaseCommonDto1.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
