...
class AccessRequestDynamicApprover1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccessRequestDynamicApprover1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccessRequestDynamicApprover1:
        """Create an instance of AccessRequestDynamicApprover1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccessRequestDynamicApprover1.parse_obj(obj)

        _obj = AccessRequestDynamicApprover1.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type")
        })
