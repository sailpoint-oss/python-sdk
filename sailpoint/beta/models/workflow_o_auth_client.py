...
class WorkflowOAuthClient(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkflowOAuthClient:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkflowOAuthClient:
        """Create an instance of WorkflowOAuthClient from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkflowOAuthClient.parse_obj(obj)

        _obj = WorkflowOAuthClient.parse_obj({
            "id": obj.get("id"),
