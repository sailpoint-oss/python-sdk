...
class CompleteInvocation(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompleteInvocation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CompleteInvocation:
        """Create an instance of CompleteInvocation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CompleteInvocation.parse_obj(obj)

        _obj = CompleteInvocation.parse_obj({
