...
class FullcampaignAllOfRoleCompositionCampaignInfo(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "remediatorRef": FullcampaignAllOfRoleCompositionCampaignInfoRemediatorRef.from_dict(obj.get("remediatorRef")) if obj.get("remediatorRef") is not None else None,
            "query": obj.get("query"),
