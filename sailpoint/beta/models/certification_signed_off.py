...
class CertificationSignedOff(BaseModel):
    ...
    """
    certification: CertificationSignedOffCertification = Field(...)
    __properties = ["certification"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CertificationSignedOff:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CertificationSignedOff:
