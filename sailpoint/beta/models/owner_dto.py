...
class OwnerDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OwnerDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OwnerDto:
        """Create an instance of OwnerDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OwnerDto.parse_obj(obj)

        _obj = OwnerDto.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
