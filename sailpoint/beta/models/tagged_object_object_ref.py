...
class TaggedObjectObjectRef(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaggedObjectObjectRef:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaggedObjectObjectRef:
        """Create an instance of TaggedObjectObjectRef from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaggedObjectObjectRef.parse_obj(obj)

        _obj = TaggedObjectObjectRef.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
