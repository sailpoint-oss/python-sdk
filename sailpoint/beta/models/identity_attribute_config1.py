...
class IdentityAttributeConfig1(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attributeTransforms": [IdentityAttributeTransform1.from_dict(_item) for _item in obj["attributeTransforms"]] if obj.get("attributeTransforms") is not None else None
        })
        return _obj
