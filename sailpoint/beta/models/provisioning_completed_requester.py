...
class ProvisioningCompletedRequester(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProvisioningCompletedRequester:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProvisioningCompletedRequester:
        """Create an instance of ProvisioningCompletedRequester from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProvisioningCompletedRequester.parse_obj(obj)

        _obj = ProvisioningCompletedRequester.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
