...
class SodRecipient(BaseModel):
  ...
  # noqa: E501
    type: Optional[StrictStr] = Field(
        default=None, description="SOD policy recipient DTO type.")
    id: Optional[StrictStr] = Field(
        default=None, description="SOD policy recipient's identity ID.")
    name: Optional[StrictStr] = Field(
        default=None, description="SOD policy recipient's display name.")
