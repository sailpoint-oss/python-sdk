...
class SourceManagerCorrelationRule(BaseModel):
    """
    Reference to the ManagerCorrelationRule, only used when a simple filter isn't sufficient.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SourceManagerCorrelationRule:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SourceManagerCorrelationRule:
        """Create an instance of SourceManagerCorrelationRule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SourceManagerCorrelationRule.parse_obj(obj)

        _obj = SourceManagerCorrelationRule.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
