...
class CreatePersonalAccessTokenResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreatePersonalAccessTokenResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreatePersonalAccessTokenResponse:
