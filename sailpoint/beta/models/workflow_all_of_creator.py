...
class WorkflowAllOfCreator(BaseModel):
  ...
  # noqa: E501
    type: Optional[StrictStr] = Field(
        default=None, description="Workflow creator's DTO type.")
    id: Optional[StrictStr] = Field(
        default=None, description="Workflow creator's identity ID.")
    name: Optional[StrictStr] = Field(
        default=None, description="Workflow creator's display name.")
