...
class AccessProfileUsageUsedByInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccessProfileUsageUsedByInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccessProfileUsageUsedByInner:
        """Create an instance of AccessProfileUsageUsedByInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccessProfileUsageUsedByInner.parse_obj(obj)

        _obj = AccessProfileUsageUsedByInner.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
