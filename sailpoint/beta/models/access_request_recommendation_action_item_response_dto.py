...
class AccessRequestRecommendationActionItemResponseDto(BaseModel):
    ...
    """
    identity_id: Optional[StrictStr] = Field(None, alias="identityId", description="The identity ID taking the action.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccessRequestRecommendationActionItemResponseDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccessRequestRecommendationActionItemResponseDto:
        """Create an instance of AccessRequestRecommendationActionItemResponseDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccessRequestRecommendationActionItemResponseDto.parse_obj(obj)
