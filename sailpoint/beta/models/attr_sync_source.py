...
class AttrSyncSource(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttrSyncSource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttrSyncSource:
        """Create an instance of AttrSyncSource from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AttrSyncSource.parse_obj(obj)

        _obj = AttrSyncSource.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
