...
class BeforeProvisioningRuleDto(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BeforeProvisioningRuleDto:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BeforeProvisioningRuleDto:
        """Create an instance of BeforeProvisioningRuleDto from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BeforeProvisioningRuleDto.parse_obj(obj)

        _obj = BeforeProvisioningRuleDto.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
