...
class CompletedApproval(BaseModel):
    ...
    requested_for: Optional[AccessItemRequestedForDto] = Field(None, alias="requestedFor")
    reviewed_by: Optional[CompletedApprovalReviewedBy] = Field(None, alias="reviewedBy")
    ...
    remove_date_update_requested: Optional[StrictBool] = Field(None, alias="removeDateUpdateRequested", description="If true, then the request was to change the remove date or sunset date.")
    ...
    __properties = ["id", "name", "created", "modified", "requestCreated", "requestType", "requester", "requestedFor", "reviewedBy", "owner", "requestedObject", "requesterComment", "reviewerComment", "previousReviewersComments", "forwardHistory", "commentRequiredWhenRejected", "state", "removeDate", "removeDateUpdateRequested", "currentRemoveDate", "sodViolationContext"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompletedApproval:
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.current_remove_date is None and "current_remove_date" in self.__fields_set__:
            _dict['currentRemoveDate'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> CompletedApproval:
        """Create an instance of CompletedApproval from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CompletedApproval.parse_obj(obj)

        _obj = CompletedApproval.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            ...
            "reviewed_by": CompletedApprovalReviewedBy.from_dict(obj.get("reviewedBy")) if obj.get("reviewedBy") is not None else None,
