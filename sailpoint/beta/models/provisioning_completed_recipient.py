...
class ProvisioningCompletedRecipient(BaseModel):
    """
    Reference to the identity who is the target of the provisioning request.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProvisioningCompletedRecipient:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProvisioningCompletedRecipient:
        """Create an instance of ProvisioningCompletedRecipient from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProvisioningCompletedRecipient.parse_obj(obj)

        _obj = ProvisioningCompletedRecipient.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
