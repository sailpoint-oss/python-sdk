...
class MfaConfig(BaseModel):
    ...
    enabled: Optional[StrictBool] = Field(
        None, description="If MFA method is enabled.")
    ...
    __properties = ["enabled", "host", "accessKey", "identityAttribute"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MfaConfig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MfaConfig:
        """Create an instance of MfaConfig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MfaConfig.parse_obj(obj)

        _obj = MfaConfig.parse_obj({
            "enabled":
            obj.get("enabled"),
            "host":
            obj.get("host"),
