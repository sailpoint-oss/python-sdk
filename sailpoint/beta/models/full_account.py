...
class FullAccount(BaseModel):
    ...
    authoritative: Optional[StrictBool] = Field(None, description="Whether this account belongs to an authoritative source")
    system_account: Optional[StrictBool] = Field(None, alias="systemAccount", description="Whether this account is for the IdentityNow source")
    uncorrelated: Optional[StrictBool] = Field(None, description="True if this account is not correlated to an identity")
    features: Optional[StrictStr] = Field(None, description="A string list containing the owning source's features")
    __properties = ["id", "name", "created", "modified", "uuid", "nativeIdentity", "description", "disabled", "locked", "manuallyCorrelated", "hasEntitlements", "sourceId", "sourceName", "identityId", "attributes", "authoritative", "systemAccount", "uncorrelated", "features"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FullAccount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FullAccount:
        """Create an instance of FullAccount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FullAccount.parse_obj(obj)

        _obj = FullAccount.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
