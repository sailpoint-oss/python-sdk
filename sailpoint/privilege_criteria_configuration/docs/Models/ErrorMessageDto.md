...
slug: /tools/sdk/python/privilege-criteria-configuration/models/error-message-dto
...
```python
from sailpoint.privilege_criteria_configuration.models.error_message_dto import ErrorMessageDto
