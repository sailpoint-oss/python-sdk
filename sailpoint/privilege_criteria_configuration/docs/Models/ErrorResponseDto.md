...
slug: /tools/sdk/python/privilege-criteria-configuration/models/error-response-dto
...
```python
from sailpoint.privilege_criteria_configuration.models.error_response_dto import ErrorResponseDto

error_response_dto = ErrorResponseDto(
detail_code='400.1 Bad Request Content',
tracking_id='e7eab60924f64aa284175b9fa3309599',
messages=[
                    sailpoint.privilege_criteria_configuration.models.error_message_dto.Error Message Dto(
                        locale = 'en-US', 
