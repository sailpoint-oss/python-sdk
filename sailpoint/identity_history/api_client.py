...
from sailpoint.identity_history.api_response import ApiResponse, T as ApiResponseT
import sailpoint.identity_history.models
from sailpoint.identity_history import rest
from sailpoint.identity_history.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.identity_history.models, klass)
