...
slug: /tools/sdk/python/v1/methods/approvals
tags: ['SDK', 'Software Development Kit', 'Approvals', 'Approvals']
---

# sailpoint.approvals_v1.ApprovalsV1Api
...
```python
from sailpoint.approvals_v1.api.approvals_v1_api import ApprovalsV1Api
from sailpoint.approvals_v1.api_client import ApiClient
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ApprovalsV1Api(api_client).approve_approval_in_bulk_v1(bulkapproverequestdto=new_bulkapproverequestdto)
        # Below is a request that includes all optional parameters
        # results = ApprovalsV1Api(api_client).approve_approval_in_bulk_v1(new_bulkapproverequestdto)
...
with ApiClient(configuration) as api_client:
    ...
    approvalapproverequest = '''sailpoint.approvals_v1.Approvalapproverequest()''' # Approvalapproverequest |  (optional)

    try:
        # Post Approvals Approve
        
        results = ApprovalsV1Api(api_client).approve_approval_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = ApprovalsV1Api(api_client).approve_approval_v1(id, new_approvalapproverequest)
        print("The response of ApprovalsV1Api->approve_approval_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ApprovalsV1Api->approve_approval_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    approvalcancelrequest = '''sailpoint.approvals_v1.Approvalcancelrequest()''' # Approvalcancelrequest |  (optional)

    try:
        # Post Approval Cancel
        
        ApprovalsV1Api(api_client).cancel_approval_by_id_v1(id=id)
        # Below is a request that includes all optional parameters
        # ApprovalsV1Api(api_client).cancel_approval_by_id_v1(id, new_approvalcancelrequest)
    except Exception as e:
        print("Exception when calling ApprovalsV1Api->cancel_approval_by_id_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    bulkcancelrequestdto = '''sailpoint.approvals_v1.Bulkcancelrequestdto()''' # Bulkcancelrequestdto | 

    try:
        # Post Bulk Cancel Approvals
        new_bulkcancelrequestdto = Bulkcancelrequestdto.from_json(bulkcancelrequestdto)
        results = ApprovalsV1Api(api_client).cancel_approval_v1(bulkcancelrequestdto=new_bulkcancelrequestdto)
        # Below is a request that includes all optional parameters
        # results = ApprovalsV1Api(api_client).cancel_approval_v1(new_bulkcancelrequestdto)
        print("The response of ApprovalsV1Api->cancel_approval_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ApprovalsV1Api->cancel_approval_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        ApprovalsV1Api(api_client).delete_approval_config_request_v1(id=id, scope=scope)
        # Below is a request that includes all optional parameters
        # ApprovalsV1Api(api_client).delete_approval_config_request_v1(id, scope)
    except Exception as e:
        print("Exception when calling ApprovalsV1Api->delete_approval_config_request_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ApprovalsV1Api(api_client).get_approval_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = ApprovalsV1Api(api_client).get_approval_v1(id)
        print("The response of ApprovalsV1Api->get_approval_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ApprovalsV1Api->get_approval_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ApprovalsV1Api(api_client).get_approvals_config_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = ApprovalsV1Api(api_client).get_approvals_config_v1(id)
        print("The response of ApprovalsV1Api->get_approvals_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ApprovalsV1Api->get_approvals_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ApprovalsV1Api(api_client).get_approvals_v1()
        # Below is a request that includes all optional parameters
        # results = ApprovalsV1Api(api_client).get_approvals_v1(mine, requester_id, requestee_id, approver_id, count, count_only, include_comments, include_approvers, include_reassignment_history, include_batch_info, filters, limit, offset)
        print("The response of ApprovalsV1Api->get_approvals_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ApprovalsV1Api->get_approvals_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    bulkreassignrequestdto = '''sailpoint.approvals_v1.Bulkreassignrequestdto()''' # Bulkreassignrequestdto | 

    try:
        # Post Bulk Reassign Approvals
        new_bulkreassignrequestdto = Bulkreassignrequestdto.from_json(bulkreassignrequestdto)
        results = ApprovalsV1Api(api_client).move_approval_v1(bulkreassignrequestdto=new_bulkreassignrequestdto)
        # Below is a request that includes all optional parameters
        # results = ApprovalsV1Api(api_client).move_approval_v1(new_bulkreassignrequestdto)
        print("The response of ApprovalsV1Api->move_approval_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ApprovalsV1Api->move_approval_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    id = 'ACCESS_REQUEST_APPROVAL' # str | The ID defined by the scope field, where [[id]]:[[scope]] is the following [[roleID]]:ROLE [[entitlementID]]:ENTITLEMENT [[accessProfileID]]:ACCESS_PROFILE ENTITLEMENT_DESCRIPTIONS:APPROVAL_TYPE ACCESS_REQUEST_APPROVAL:APPROVAL_TYPE ACCOUNT_CREATE_APPROVAL_REQUEST:APPROVAL_TYPE ACCOUNT_DELETE_APPROVAL_REQUEST:APPROVAL_TYPE MACHINE_ACCOUNT_CREATE_APPROVAL_REQUEST:APPROVAL_TYPE MACHINE_ACCOUNT_DELETE_APPROVAL_REQUEST:APPROVAL_TYPE [[tenantID]]:TENANT [[domainObjectID]]:DOMAIN_OBJECT # str | The ID defined by the scope field, where [[id]]:[[scope]] is the following [[roleID]]:ROLE [[entitlementID]]:ENTITLEMENT [[accessProfileID]]:ACCESS_PROFILE ENTITLEMENT_DESCRIPTIONS:APPROVAL_TYPE ACCESS_REQUEST_APPROVAL:APPROVAL_TYPE ACCOUNT_CREATE_APPROVAL_REQUEST:APPROVAL_TYPE ACCOUNT_DELETE_APPROVAL_REQUEST:APPROVAL_TYPE MACHINE_ACCOUNT_CREATE_APPROVAL_REQUEST:APPROVAL_TYPE MACHINE_ACCOUNT_DELETE_APPROVAL_REQUEST:APPROVAL_TYPE [[tenantID]]:TENANT [[domainObjectID]]:DOMAIN_OBJECT
    scope = 'APPROVAL_TYPE' # str | The scope of the field, where [[id]]:[[scope]] is the following [[roleID]]:ROLE [[entitlementID]]:ENTITLEMENT [[accessProfileID]]:ACCESS_PROFILE ENTITLEMENT_DESCRIPTIONS:APPROVAL_TYPE ACCESS_REQUEST_APPROVAL:APPROVAL_TYPE ACCOUNT_CREATE_APPROVAL_REQUEST:APPROVAL_TYPE ACCOUNT_DELETE_APPROVAL_REQUEST:APPROVAL_TYPE MACHINE_ACCOUNT_CREATE_APPROVAL_REQUEST:APPROVAL_TYPE MACHINE_ACCOUNT_DELETE_APPROVAL_REQUEST:APPROVAL_TYPE [[tenantID]]:TENANT [[domainObjectID]]:DOMAIN_OBJECT # str | The scope of the field, where [[id]]:[[scope]] is the following [[roleID]]:ROLE [[entitlementID]]:ENTITLEMENT [[accessProfileID]]:ACCESS_PROFILE ENTITLEMENT_DESCRIPTIONS:APPROVAL_TYPE ACCESS_REQUEST_APPROVAL:APPROVAL_TYPE ACCOUNT_CREATE_APPROVAL_REQUEST:APPROVAL_TYPE ACCOUNT_DELETE_APPROVAL_REQUEST:APPROVAL_TYPE MACHINE_ACCOUNT_CREATE_APPROVAL_REQUEST:APPROVAL_TYPE MACHINE_ACCOUNT_DELETE_APPROVAL_REQUEST:APPROVAL_TYPE [[tenantID]]:TENANT [[domainObjectID]]:DOMAIN_OBJECT
    approvalconfig = '''sailpoint.approvals_v1.Approvalconfig()''' # Approvalconfig | 

    try:
        # Put Approval Config
        new_approvalconfig = Approvalconfig.from_json(approvalconfig)
        results = ApprovalsV1Api(api_client).put_approvals_config_v1(id=id, scope=scope, approvalconfig=new_approvalconfig)
        # Below is a request that includes all optional parameters
        # results = ApprovalsV1Api(api_client).put_approvals_config_v1(id, scope, new_approvalconfig)
        print("The response of ApprovalsV1Api->put_approvals_config_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ApprovalsV1Api->put_approvals_config_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    bulkrejectrequestdto = '''sailpoint.approvals_v1.Bulkrejectrequestdto()''' # Bulkrejectrequestdto | 

    try:
        # Post Bulk Reject Approvals
        new_bulkrejectrequestdto = Bulkrejectrequestdto.from_json(bulkrejectrequestdto)
        results = ApprovalsV1Api(api_client).reject_approval_in_bulk_v1(bulkrejectrequestdto=new_bulkrejectrequestdto)
        # Below is a request that includes all optional parameters
        # results = ApprovalsV1Api(api_client).reject_approval_in_bulk_v1(new_bulkrejectrequestdto)
        print("The response of ApprovalsV1Api->reject_approval_in_bulk_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ApprovalsV1Api->reject_approval_in_bulk_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    approvalrejectrequest = '''sailpoint.approvals_v1.Approvalrejectrequest()''' # Approvalrejectrequest |  (optional)

    try:
        # Post Approvals Reject
        
        ApprovalsV1Api(api_client).reject_approval_v1(id=id)
        # Below is a request that includes all optional parameters
        # ApprovalsV1Api(api_client).reject_approval_v1(id, new_approvalrejectrequest)
    except Exception as e:
        print("Exception when calling ApprovalsV1Api->reject_approval_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    approvalattributesrequest = '''sailpoint.approvals_v1.Approvalattributesrequest()''' # Approvalattributesrequest | 

    try:
        # Post Approvals Attributes
        new_approvalattributesrequest = Approvalattributesrequest.from_json(approvalattributesrequest)
        results = ApprovalsV1Api(api_client).update_approvals_attributes_v1(id=id, approvalattributesrequest=new_approvalattributesrequest)
        # Below is a request that includes all optional parameters
        # results = ApprovalsV1Api(api_client).update_approvals_attributes_v1(id, new_approvalattributesrequest)
        print("The response of ApprovalsV1Api->update_approvals_attributes_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ApprovalsV1Api->update_approvals_attributes_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    approvalcommentsrequest = '''sailpoint.approvals_v1.Approvalcommentsrequest()''' # Approvalcommentsrequest | 

    try:
        # Post Approvals Comments
        new_approvalcommentsrequest = Approvalcommentsrequest.from_json(approvalcommentsrequest)
        results = ApprovalsV1Api(api_client).update_approvals_comments_v1(id=id, approvalcommentsrequest=new_approvalcommentsrequest)
        # Below is a request that includes all optional parameters
        # results = ApprovalsV1Api(api_client).update_approvals_comments_v1(id, new_approvalcommentsrequest)
        print("The response of ApprovalsV1Api->update_approvals_comments_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling ApprovalsV1Api->update_approvals_comments_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    approvalreassignrequest = '''sailpoint.approvals_v1.Approvalreassignrequest()''' # Approvalreassignrequest | 

    try:
        # Post Approvals Reassign
        new_approvalreassignrequest = Approvalreassignrequest.from_json(approvalreassignrequest)
        ApprovalsV1Api(api_client).update_approvals_reassign_v1(id=id, approvalreassignrequest=new_approvalreassignrequest)
        # Below is a request that includes all optional parameters
        # ApprovalsV1Api(api_client).update_approvals_reassign_v1(id, new_approvalreassignrequest)
    except Exception as e:
        print("Exception when calling ApprovalsV1Api->update_approvals_reassign_v1: %s\n" % e)
```
