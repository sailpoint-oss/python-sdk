...
from sailpoint.v3.api_response import ApiResponse, T as ApiResponseT
import sailpoint.v3.models
from sailpoint.v3 import rest
from sailpoint.v3.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def param_serialize(
        ...
        # request url
        if _host is None:
            url = self.configuration.base_url + '/v3' + resource_path
        else:
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.v3.models, klass)
