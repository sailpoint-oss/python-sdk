...
class TestRoleDocuments(unittest.TestCase):
    """RoleDocuments unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoleDocuments:
        """Test RoleDocuments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoleDocuments`
        """
        model = RoleDocuments()
        if include_optional:
