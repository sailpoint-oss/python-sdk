...
from v3.models.public_identity import PublicIdentity  # noqa: E501
...
class TestPublicIdentity(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PublicIdentity:
        ...
        """
        model = PublicIdentity()  # noqa: E501
        if include_optional:
            return PublicIdentity(
                ...
                status = 'Active',
                manager = v3.models.identity_reference.IdentityReference(
                    type = 'IDENTITY', 
                    id = '2c9180a46faadee4016fb4e018c20639', 
                    name = 'Thomas Edison', ),
                attributes = [
                    v3.models.identity_attribute.IdentityAttribute(
                        key = 'country', 
                        name = 'Country', 
                        value = 'US', )
                    ]
