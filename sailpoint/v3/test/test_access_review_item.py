...
from v3.models.access_review_item import AccessReviewItem  # noqa: E501
...
class TestAccessReviewItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AccessReviewItem:
        ...
        """
        model = AccessReviewItem()  # noqa: E501
        if include_optional:
            return AccessReviewItem(
                access_summary = v3.models.access_summary.AccessSummary(
                ...
                identity_summary = v3.models.certification_identity_summary.CertificationIdentitySummary(
