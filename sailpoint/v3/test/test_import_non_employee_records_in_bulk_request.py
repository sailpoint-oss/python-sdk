...
from sailpoint.v3.models.import_non_employee_records_in_bulk_request import ImportNonEmployeeRecordsInBulkRequest  # noqa: E501
...
class TestImportNonEmployeeRecordsInBulkRequest(unittest.TestCase):
    ...
    def make_instance(
            self, include_optional) -> ImportNonEmployeeRecordsInBulkRequest:
