...
class TestSodPolicyRequest(unittest.TestCase):
    """SodPolicyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SodPolicyRequest:
        """Test SodPolicyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SodPolicyRequest`
        """
        model = SodPolicyRequest()
        if include_optional:
            return SodPolicyRequest(
