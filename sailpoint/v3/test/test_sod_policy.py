...
from v3.models.sod_policy import SodPolicy  # noqa: E501
    ...
    def make_instance(self, include_optional) -> SodPolicy:
        ...
        if include_optional:
            return SodPolicy(
                ...
                violation_owner_assignment_config = v3.models.violation_owner_assignment_config.ViolationOwnerAssignmentConfig(
