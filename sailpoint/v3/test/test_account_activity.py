...
class TestAccountActivity(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AccountActivity:
        ...
        """
        model = AccountActivity()  # noqa: E501
        if include_optional:
            return AccountActivity(
                ...
                type = 'appRequest',
                requester_identity_summary = v3.models.identity_summary.IdentitySummary(
                    id = 'ff80818155fe8c080155fe8d925b0316', 
                    name = 'SailPoint Services', 
                    identity_id = 'c15b9f5cca5a4e9599eaa0e64fa921bd', 
                    completed = True, ),
                target_identity_summary = v3.models.identity_summary.IdentitySummary(
                    id = 'ff80818155fe8c080155fe8d925b0316', 
                    name = 'SailPoint Services', 
                    identity_id = 'c15b9f5cca5a4e9599eaa0e64fa921bd', 
                    completed = True, ),
                ...
                items = [
                    v3.models.account_activity_item.AccountActivityItem(
