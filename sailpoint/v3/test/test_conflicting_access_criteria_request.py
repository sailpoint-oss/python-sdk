...
class TestConflictingAccessCriteriaRequest(unittest.TestCase):
    """ConflictingAccessCriteriaRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConflictingAccessCriteriaRequest:
        """Test ConflictingAccessCriteriaRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConflictingAccessCriteriaRequest`
        """
        model = ConflictingAccessCriteriaRequest()
        if include_optional:
            return ConflictingAccessCriteriaRequest(
    ...
    def testConflictingAccessCriteriaRequest(self):
        """Test ConflictingAccessCriteriaRequest"""
