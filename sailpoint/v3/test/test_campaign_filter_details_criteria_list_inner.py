...
from v3.models.campaign_filter_details_criteria_list_inner import CampaignFilterDetailsCriteriaListInner  # noqa: E501
...
class TestCampaignFilterDetailsCriteriaListInner(unittest.TestCase):
    ...
    def make_instance(
            self, include_optional) -> CampaignFilterDetailsCriteriaListInner:
