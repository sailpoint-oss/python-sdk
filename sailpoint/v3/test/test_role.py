...
from v3.models.role import Role  # noqa: E501
        ...
        if include_optional:
            return Role(
                ...
                owner = v3.models.owner_reference.OwnerReference(
                    ...
                    name = 'support', ),
                access_profiles = [
                    v3.models.access_profile_ref.AccessProfileRef(
                        id = 'ff808081751e6e129f1518161919ecca', 
                        type = 'ACCESS_PROFILE', 
                        name = 'Access Profile 2567', )
                    ],
                membership = v3.models.role_membership_selector.RoleMembershipSelector(
                    type = 'IDENTITY_LIST', 
                ...
                enabled = True,
                requestable = True,
                access_request_config = v3.models.requestability_for_role.RequestabilityForRole(
