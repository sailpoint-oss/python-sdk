...
from v3.models.provisioning_criteria_level2 import ProvisioningCriteriaLevel2  # noqa: E501
    ...
    def make_instance(self, include_optional) -> ProvisioningCriteriaLevel2:
        ...
        if include_optional:
            return ProvisioningCriteriaLevel2(
                ...
                children = [
                    v3.models.provisioning_criteria_level3.ProvisioningCriteriaLevel3(
                        operation = 'EQUALS', 
                        attribute = 'email', 
                        value = 'carlee.cert1c9f9b6fd@mailinator.com', )
                    ]
