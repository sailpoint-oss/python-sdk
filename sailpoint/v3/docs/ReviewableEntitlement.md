...
**has_permissions** | **bool** | Indicates if the entitlement has permissions | [optional] 
**is_permission** | **bool** | Indicates if the entitlement is a representation of an account permission | [optional] 
**revocable** | **bool** | Indicates whether the entitlement can be revoked | [optional] 
