...
provisioning_config_plan_initializer_script_from_dict = ProvisioningConfigPlanInitializerScript.from_dict(provisioning_config_plan_initializer_script_dict)
```
