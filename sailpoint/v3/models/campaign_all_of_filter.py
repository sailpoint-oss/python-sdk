...
class CampaignAllOfFilter(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CampaignAllOfFilter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CampaignAllOfFilter:
        """Create an instance of CampaignAllOfFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CampaignAllOfFilter.parse_obj(obj)

        _obj = CampaignAllOfFilter.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "name": obj.get("name")
        })
