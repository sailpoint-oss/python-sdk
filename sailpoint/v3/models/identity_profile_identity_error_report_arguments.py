...
class IdentityProfileIdentityErrorReportArguments(BaseModel):
    ...
    """
    authoritative_source: StrictStr = Field(..., alias="authoritativeSource", description="Source Id to be checked on errors of identity profiles aggregation")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IdentityProfileIdentityErrorReportArguments:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IdentityProfileIdentityErrorReportArguments:
        ...
        _obj = IdentityProfileIdentityErrorReportArguments.parse_obj({
            "authoritative_source": obj.get("authoritativeSource"),
