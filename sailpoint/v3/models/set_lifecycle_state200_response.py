...
class SetLifecycleState200Response(BaseModel):
    ...
    """ # noqa: E501
    account_activity_id: Optional[StrictStr] = Field(default=None, description="The ID of the IdentityRequest object that was generated when the workflow launches", alias="accountActivityId")
