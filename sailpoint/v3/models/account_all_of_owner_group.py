...
class AccountAllOfOwnerGroup(BaseModel):
    """
    ...
    id: Optional[StrictStr] = Field(default=None, description="ID of the governance group")
    name: Optional[StrictStr] = Field(default=None, description="Human-readable display name of the governance group")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['GOVERNANCE_GROUP']):
            raise ValueError("must be one of enum values ('GOVERNANCE_GROUP')")
        return value
