...
class NestedAggregation(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NestedAggregation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NestedAggregation:
        """Create an instance of NestedAggregation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NestedAggregation.parse_obj(obj)

        _obj = NestedAggregation.parse_obj({
            "name": obj.get("name"),
            "type": obj.get("type")
        })
        return _obj
