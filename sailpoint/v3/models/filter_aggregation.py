...
class FilterAggregation(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FilterAggregation:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FilterAggregation:
        """Create an instance of FilterAggregation from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilterAggregation.parse_obj(obj)

        _obj = FilterAggregation.parse_obj({
            "name": obj.get("name"),
            "type": obj.get("type"),
            "field": obj.get("field"),
            "value": obj.get("value")
