...
class SodExemptCriteria(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SodExemptCriteria:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SodExemptCriteria:
        """Create an instance of SodExemptCriteria from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SodExemptCriteria.parse_obj(obj)

        _obj = SodExemptCriteria.parse_obj({
