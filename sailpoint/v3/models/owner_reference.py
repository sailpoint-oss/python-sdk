...
class OwnerReference(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OwnerReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OwnerReference:
        """Create an instance of OwnerReference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OwnerReference.parse_obj(obj)

        _obj = OwnerReference.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
