...
class AccountActivityDocuments(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "action", "created", "modified", "synced", "stage", "status", "requester", "recipient", "trackingNumber", "errors", "warnings", "approvals", "originalRequests", "expansionItems", "accountRequests", "sources", "pod", "org", "_type", "type", "_version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountActivityDocuments from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountActivityDocuments from a dict"""
        if obj is None:
            return None
