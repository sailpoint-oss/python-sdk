...
class CompletedApproval(BaseModel):
    ...
    requested_for: Optional[BaseReferenceDto] = Field(None,
                                                      alias="requestedFor")
    ...
    def from_dict(cls, obj: dict) -> CompletedApproval:
        ...
        _obj = CompletedApproval.parse_obj({
            ...
            obj.get("requestType"),
            "requester":
            BaseReferenceDto.from_dict(obj.get("requester"))
            if obj.get("requester") is not None else None,
            "requested_for":
            BaseReferenceDto.from_dict(obj.get("requestedFor"))
            if obj.get("requestedFor") is not None else None,
            "reviewed_by":
            BaseReferenceDto.from_dict(obj.get("reviewedBy"))
