...
class EntitlementSummary(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EntitlementSummary:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EntitlementSummary:
        """Create an instance of EntitlementSummary from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EntitlementSummary.parse_obj(obj)

        _obj = EntitlementSummary.parse_obj({
            "id":
            obj.get("id"),
            "name":
            obj.get("name"),
