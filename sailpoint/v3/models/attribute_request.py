...
class AttributeRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeRequest:
        """Create an instance of AttributeRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AttributeRequest.parse_obj(obj)

        _obj = AttributeRequest.parse_obj({
            "name": obj.get("name"),
            "op": obj.get("op"),
            "value": obj.get("value")
        })
