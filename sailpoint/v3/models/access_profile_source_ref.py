...
class AccessProfileSourceRef(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccessProfileSourceRef:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccessProfileSourceRef:
        """Create an instance of AccessProfileSourceRef from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccessProfileSourceRef.parse_obj(obj)

        _obj = AccessProfileSourceRef.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "name": obj.get("name")
        })
