...
class SodPolicyRead(BaseModel):
    ...
    conflicting_access_criteria: Optional[SodPolicyReadAllOfConflictingAccessCriteria] = Field(default=None, alias="conflictingAccessCriteria")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SodPolicyRead from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SodPolicyRead from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "conflictingAccessCriteria": SodPolicyReadAllOfConflictingAccessCriteria.from_dict(obj["conflictingAccessCriteria"]) if obj.get("conflictingAccessCriteria") is not None else None
        })
        return _obj
