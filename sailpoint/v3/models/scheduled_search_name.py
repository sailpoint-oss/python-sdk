...
class ScheduledSearchName(BaseModel):
    """
    ScheduledSearchName
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ScheduledSearchName:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ScheduledSearchName:
        """Create an instance of ScheduledSearchName from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ScheduledSearchName.parse_obj(obj)

        _obj = ScheduledSearchName.parse_obj({
            "name": obj.get("name"),
