...
class BaseEntitlement(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseEntitlement:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseEntitlement:
        """Create an instance of BaseEntitlement from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BaseEntitlement.parse_obj(obj)

        _obj = BaseEntitlement.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
