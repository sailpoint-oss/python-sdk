...
class AccountsAsyncResult(BaseModel):
    """
    Accounts async response containing details on started async process  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountsAsyncResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountsAsyncResult:
