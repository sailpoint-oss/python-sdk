...
class CompletedApprovalReviewerComment(BaseModel):
    """
    The approval's reviewer's comment.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompletedApprovalReviewerComment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CompletedApprovalReviewerComment:
