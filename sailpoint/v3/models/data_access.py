...
class DataAccess(BaseModel):
    ...
    """
    policies: Optional[conlist(DataAccessPoliciesInner)] = Field(None, description="List of classification policies that apply to resources the entitlement \\ groups has access to")
    categories: Optional[conlist(DataAccessCategoriesInner)] = Field(None, description="List of classification categories that apply to resources the entitlement \\ groups has access to")
    impact_score: Optional[DataAccessImpactScore] = Field(None, alias="impactScore")
    ...
    def from_dict(cls, obj: dict) -> DataAccess:
        ...
        _obj = DataAccess.parse_obj({
            ...
            "impact_score": DataAccessImpactScore.from_dict(obj.get("impactScore")) if obj.get("impactScore") is not None else None
        })
        return _obj
