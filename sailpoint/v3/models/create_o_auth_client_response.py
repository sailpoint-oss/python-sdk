...
class CreateOAuthClientResponse(BaseModel):
    ...
    business_name: StrictStr = Field(..., alias="businessName", description="The name of the business the API Client should belong to")
    homepage_url: StrictStr = Field(..., alias="homepageUrl", description="The homepage URL associated with the owner of the API Client")
    ...
    redirect_uris: conlist(StrictStr) = Field(..., alias="redirectUris", description="A list of the approved redirect URIs used with the authorization_code flow")
    ...
    __properties = ["id", "secret", "businessName", "homepageUrl", "name", "description", "accessTokenValiditySeconds", "refreshTokenValiditySeconds", "redirectUris", "grantTypes", "accessType", "type", "internal", "enabled", "strongAuthSupported", "claimsSupported", "created", "modified", "scope"]
