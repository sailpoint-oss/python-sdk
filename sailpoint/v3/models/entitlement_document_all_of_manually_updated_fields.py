...
class EntitlementDocumentAllOfManuallyUpdatedFields(BaseModel):
    """
    Indicates whether the entitlement's display name and/or description have been manually updated.
    """ # noqa: E501
    description: Optional[StrictBool] = Field(default=False, alias="DESCRIPTION")
    display_name: Optional[StrictBool] = Field(default=False, alias="DISPLAY_NAME")
