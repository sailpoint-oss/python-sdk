...
class ListCampaignFilters200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "items": [CampaignFilterDetails.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None,
            "count": obj.get("count")
        })
        return _obj
