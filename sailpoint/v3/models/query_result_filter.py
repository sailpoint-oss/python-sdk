...
class QueryResultFilter(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QueryResultFilter:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QueryResultFilter:
        """Create an instance of QueryResultFilter from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QueryResultFilter.parse_obj(obj)

        _obj = QueryResultFilter.parse_obj({
