...
class AccessProfileDocuments(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["description", "created", "modified", "synced", "enabled", "requestable", "requestCommentsRequired", "owner", "id", "name", "source", "entitlements", "entitlementCount", "segments", "segmentCount", "tags", "apps", "pod", "org", "_type", "type", "_version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessProfileDocuments from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessProfileDocuments from a dict"""
        if obj is None:
            return None
