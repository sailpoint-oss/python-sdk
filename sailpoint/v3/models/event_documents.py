...
class EventDocuments(BaseModel):
    """
    EventDocuments
    """ # noqa: E501
    ...
    version: Optional[StrictStr] = Field(default=None, alias="_version")
    __properties: ClassVar[List[str]] = ["id", "name", "created", "synced", "action", "type", "actor", "target", "stack", "trackingNumber", "ipAddress", "details", "attributes", "objects", "operation", "status", "technicalName", "pod", "org", "_type", "_version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EventDocuments from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EventDocuments from a dict"""
        if obj is None:
            return None
