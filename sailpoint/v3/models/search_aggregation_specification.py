...
class SearchAggregationSpecification(BaseModel):
    ...
    sub_aggregation: Optional[SubSearchAggregationSpecification] = Field(None, alias="subAggregation")
    ...
    def from_dict(cls, obj: dict) -> SearchAggregationSpecification:
        ...
        _obj = SearchAggregationSpecification.parse_obj({
            ...
            "sub_aggregation": SubSearchAggregationSpecification.from_dict(obj.get("subAggregation")) if obj.get("subAggregation") is not None else None
        })
        return _obj
