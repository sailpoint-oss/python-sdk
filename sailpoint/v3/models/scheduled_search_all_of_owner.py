...
class ScheduledSearchAllOfOwner(BaseModel):
    """
    The owner of the scheduled search  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ScheduledSearchAllOfOwner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ScheduledSearchAllOfOwner:
        """Create an instance of ScheduledSearchAllOfOwner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ScheduledSearchAllOfOwner.parse_obj(obj)

        _obj = ScheduledSearchAllOfOwner.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id")
        })
        return _obj
