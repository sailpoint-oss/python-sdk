...
class FederationProtocolDetails(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["role", "entityId"]
    ...
    def role_validate_enum(cls, value):
        ...
        if value not in ('SAML_IDP', 'SAML_SP'):
            raise ValueError("must be one of enum values ('SAML_IDP', 'SAML_SP')")
        return value
