...
class DeleteVendorConnectorMapping200Response(BaseModel):
    """
    DeleteVendorConnectorMapping200Response
    """ # noqa: E501
    count: Optional[StrictInt] = Field(default=None, description="The number of vendor connector mappings successfully deleted.")
