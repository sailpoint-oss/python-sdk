...
class Campaign(BaseModel):
    ...
    source_owner_campaign_info: Optional[
        CampaignAllOfSourceOwnerCampaignInfo] = Field(
            None, alias="sourceOwnerCampaignInfo")
    search_campaign_info: Optional[CampaignAllOfSearchCampaignInfo] = Field(
        None, alias="searchCampaignInfo")
    role_composition_campaign_info: Optional[
        CampaignAllOfRoleCompositionCampaignInfo] = Field(
    ...
    def from_dict(cls, obj: dict) -> Campaign:
        ...
        _obj = Campaign.parse_obj({
            ...
            obj.get("modified"),
            "filter":
            CampaignAllOfFilter.from_dict(obj.get("filter"))
            ...
            "sources_with_orphan_entitlements": [
                CampaignAllOfSourcesWithOrphanEntitlements.from_dict(_item)
