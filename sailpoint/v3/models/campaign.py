...
class Campaign(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "sourceOwnerCampaignInfo": CampaignAllOfSourceOwnerCampaignInfo.from_dict(obj.get("sourceOwnerCampaignInfo")) if obj.get("sourceOwnerCampaignInfo") is not None else None,
            "searchCampaignInfo": CampaignAllOfSearchCampaignInfo.from_dict(obj.get("searchCampaignInfo")) if obj.get("searchCampaignInfo") is not None else None,
            "roleCompositionCampaignInfo": CampaignAllOfRoleCompositionCampaignInfo.from_dict(obj.get("roleCompositionCampaignInfo")) if obj.get("roleCompositionCampaignInfo") is not None else None,
            "sourcesWithOrphanEntitlements": [CampaignAllOfSourcesWithOrphanEntitlements.from_dict(_item) for _item in obj.get("sourcesWithOrphanEntitlements")] if obj.get("sourcesWithOrphanEntitlements") is not None else None,
