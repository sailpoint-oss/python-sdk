...
class Account(BaseModel):
  ...
  # noqa: E501
    ...
    source_owner: Optional[BaseReferenceDto] = Field(default=None,
                                                     alias="sourceOwner")
    __properties: ClassVar[List[str]] = [
        ...
        "manuallyCorrelated", "hasEntitlements", "identity", "sourceOwner"
    ]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "identity":
            BaseReferenceDto.from_dict(obj.get("identity"))
            if obj.get("identity") is not None else None,
            "sourceOwner":
            BaseReferenceDto.from_dict(obj.get("sourceOwner"))
            if obj.get("sourceOwner") is not None else None
        })
        return _obj
