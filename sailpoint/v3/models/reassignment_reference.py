...
class ReassignmentReference(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ReassignmentReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReassignmentReference:
        """Create an instance of ReassignmentReference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReassignmentReference.parse_obj(obj)

        _obj = ReassignmentReference.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type")
        })
        return _obj
