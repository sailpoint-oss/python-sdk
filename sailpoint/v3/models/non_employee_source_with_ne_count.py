...
class NonEmployeeSourceWithNECount(BaseModel):
    ...
    non_employee_count: Optional[StrictInt] = Field(None, alias="nonEmployeeCount", description="Number of non-employee records associated with this source.")
    __properties = ["id", "sourceId", "name", "description", "approvers", "accountManagers", "modified", "created", "nonEmployeeCount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NonEmployeeSourceWithNECount:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NonEmployeeSourceWithNECount:
        """Create an instance of NonEmployeeSourceWithNECount from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NonEmployeeSourceWithNECount.parse_obj(obj)

        _obj = NonEmployeeSourceWithNECount.parse_obj({
            "id": obj.get("id"),
