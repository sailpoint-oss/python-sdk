...
class SearchIdentityReference(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchIdentityReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SearchIdentityReference:
        """Create an instance of SearchIdentityReference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SearchIdentityReference.parse_obj(obj)

        _obj = SearchIdentityReference.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "type": obj.get("type")
        })
