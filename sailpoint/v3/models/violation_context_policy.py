...
class ViolationContextPolicy(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ViolationContextPolicy:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ViolationContextPolicy:
        """Create an instance of ViolationContextPolicy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ViolationContextPolicy.parse_obj(obj)

        _obj = ViolationContextPolicy.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
