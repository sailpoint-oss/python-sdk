...
class AccessSummaryAccess(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccessSummaryAccess:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccessSummaryAccess:
        """Create an instance of AccessSummaryAccess from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AccessSummaryAccess.parse_obj(obj)

        _obj = AccessSummaryAccess.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
