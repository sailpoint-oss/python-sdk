...
class SearchScheduleRecipientsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchScheduleRecipientsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SearchScheduleRecipientsInner:
        """Create an instance of SearchScheduleRecipientsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SearchScheduleRecipientsInner.parse_obj(obj)

        _obj = SearchScheduleRecipientsInner.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id")
        })
        return _obj
