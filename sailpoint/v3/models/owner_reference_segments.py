...
class OwnerReferenceSegments(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OwnerReferenceSegments:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OwnerReferenceSegments:
        """Create an instance of OwnerReferenceSegments from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OwnerReferenceSegments.parse_obj(obj)

        _obj = OwnerReferenceSegments.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id"),
            "name": obj.get("name")
        })
