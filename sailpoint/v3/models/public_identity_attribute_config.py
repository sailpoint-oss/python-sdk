...
class PublicIdentityAttributeConfig(BaseModel):
    ...
    name: Optional[StrictStr] = Field(None, description="The attribute display name")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PublicIdentityAttributeConfig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PublicIdentityAttributeConfig:
        """Create an instance of PublicIdentityAttributeConfig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PublicIdentityAttributeConfig.parse_obj(obj)

        _obj = PublicIdentityAttributeConfig.parse_obj({
            "key": obj.get("key"),
            "name": obj.get("name")
        })
        return _obj
