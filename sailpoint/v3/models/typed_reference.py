...
class TypedReference(BaseModel):
    """
    A typed reference to the object.   # noqa: E501
    """
    type: DtoType = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TypedReference:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TypedReference:
        """Create an instance of TypedReference from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TypedReference.parse_obj(obj)

        _obj = TypedReference.parse_obj({
            "type": obj.get("type"),
            "id": obj.get("id")
        })
        return _obj
