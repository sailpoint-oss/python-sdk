...
class ProvisioningPolicy(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProvisioningPolicy:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProvisioningPolicy:
        """Create an instance of ProvisioningPolicy from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProvisioningPolicy.parse_obj(obj)

        _obj = ProvisioningPolicy.parse_obj({
            "name":
            obj.get("name"),
            "description":
            obj.get("description"),
