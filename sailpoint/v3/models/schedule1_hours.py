...
class Schedule1Hours(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Schedule1Hours:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Schedule1Hours:
        """Create an instance of Schedule1Hours from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Schedule1Hours.parse_obj(obj)

        _obj = Schedule1Hours.parse_obj({
            "type": obj.get("type"),
