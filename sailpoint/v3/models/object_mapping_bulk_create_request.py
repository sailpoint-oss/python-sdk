...
class ObjectMappingBulkCreateRequest(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.new_object_mappings:
            for _item in self.new_object_mappings:
                if _item:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "newObjectMappings": [ObjectMappingRequest.from_dict(_item) for _item in obj.get("newObjectMappings")] if obj.get("newObjectMappings") is not None else None
        })
        return _obj
