...
class VendorConnectorMappingsApi:
    ...
    @validate_call
    def create_vendor_connector_mapping(
        self,
        ...
        _param = self._create_vendor_connector_mapping_serialize(
            vendor_connector_mapping=vendor_connector_mapping,
    ...
    @validate_call
    def create_vendor_connector_mapping_with_http_info(
        self,
        vendor_connector_mapping: VendorConnectorMapping,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_vendor_connector_mapping_without_preload_content(
        self,
        vendor_connector_mapping: VendorConnectorMapping,
        _request_timeout: Union[
            None,
    ...
    def _create_vendor_connector_mapping_serialize(
        self,
        ...
        if vendor_connector_mapping is not None:
            _body_params = vendor_connector_mapping
    ...
    @validate_call
    def delete_vendor_connector_mapping(
        self,
        vendor_connector_mapping: VendorConnectorMapping,
        _request_timeout: Union[
            None,
        ...
        _param = self._delete_vendor_connector_mapping_serialize(
            vendor_connector_mapping=vendor_connector_mapping,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def delete_vendor_connector_mapping_with_http_info(
        self,
        vendor_connector_mapping: VendorConnectorMapping,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_vendor_connector_mapping_without_preload_content(
        self,
        vendor_connector_mapping: VendorConnectorMapping,
        _request_timeout: Union[
            None,
    ...
    def _delete_vendor_connector_mapping_serialize(
        self,
        vendor_connector_mapping,
        _request_auth,
        _content_type,
