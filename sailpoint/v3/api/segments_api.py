...
class SegmentsApi:
    ...
    def create_segment(
        ...
        _param = self._create_segment_serialize(segment=segment,
    ...
    def delete_segment(
        ...
        _param = self._delete_segment_serialize(id=id,
                                                _request_auth=_request_auth,
                                                _content_type=_content_type,
                                                _headers=_headers,
                                                _host_index=_host_index)
    ...
    def get_segment(
        ...
        _param = self._get_segment_serialize(id=id,
                                             _request_auth=_request_auth,
                                             _content_type=_content_type,
                                             _headers=_headers,
                                             _host_index=_host_index)
    ...
    def list_segments(
        ...
        _param = self._list_segments_serialize(limit=limit,
                                               offset=offset,
                                               count=count,
                                               _request_auth=_request_auth,
                                               _content_type=_content_type,
    ...
    def patch_segment(
        self,
        id: Annotated[StrictStr,
                      Field(description="The segment ID to modify.")],
        ...
        _param = self._patch_segment_serialize(id=id,
