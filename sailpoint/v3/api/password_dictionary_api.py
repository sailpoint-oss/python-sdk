...
class PasswordDictionaryApi:
    ...
    @validate_arguments
    def get_password_dictionary(self, **kwargs) -> str:  # noqa: E501
        ...
        >>> thread = api.get_password_dictionary(async_req=True)
        >>> result = thread.get()
    ...
    def get_password_dictionary_with_http_info(
        ...
        >>> thread = api.get_password_dictionary_with_http_info(async_req=True)
        >>> result = thread.get()
    ...
    def update_password_dictionary(self,
        ...
        >>> thread = api.update_password_dictionary(file, async_req=True)
        >>> result = thread.get()
    ...
    def update_password_dictionary_with_http_info(
        ...
        >>> thread = api.update_password_dictionary_with_http_info(file, async_req=True)
        >>> result = thread.get()
