...
class PasswordManagementApi:
    ...
    @validate_arguments
    def get_password_change_status(self, id : Annotated[StrictStr, Field(..., description="Password change request ID")], **kwargs) -> PasswordStatus:  # noqa: E501
        ...
        return self.get_password_change_status_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_password_change_status_with_http_info(self, id : Annotated[StrictStr, Field(..., description="Password change request ID")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get Password Change Request Status  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_password_change_status" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def set_password(self, password_change_request : PasswordChangeRequest, **kwargs) -> PasswordChangeResponse:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return self.set_password_with_http_info(password_change_request, **kwargs)  # noqa: E501

    @validate_arguments
    def set_password_with_http_info(self, password_change_request : PasswordChangeRequest, **kwargs) -> ApiResponse:  # noqa: E501
        """Set Identity's Password  # noqa: E501
