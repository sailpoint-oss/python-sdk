...
class AuthUserApi:
    ...
    def get_auth_user(self,
        ...
        >>> thread = api.get_auth_user(id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_auth_user_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
    ...
    def get_auth_user_with_http_info(self, id: Annotated[
        ...
        >>> thread = api.get_auth_user_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(AuthUser, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def patch_auth_user(self, id: Annotated[
        ...
        >>> thread = api.patch_auth_user(id, json_patch_operation, async_req=True)
        >>> result = thread.get()
    ...
    def patch_auth_user_with_http_info(self, id: Annotated[
        ...
        >>> thread = api.patch_auth_user_with_http_info(id, json_patch_operation, async_req=True)
        >>> result = thread.get()
