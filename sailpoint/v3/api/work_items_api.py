...
class WorkItemsApi:
    ...
    def get_count_completed_work_items_with_http_info(
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(WorkItemsCount, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def get_work_item(self, id: Annotated[
        ...
        >>> thread = api.get_work_item(id, async_req=True)
        >>> result = thread.get()
    ...
    def get_work_item_with_http_info(self, id: Annotated[
        ...
        >>> thread = api.get_work_item_with_http_info(id, async_req=True)
        >>> result = thread.get()
    ...
    def get_work_items_summary_with_http_info(
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(WorkItemsSummary, status_code(int), headers(HTTPHeaderDict))
        """
