...
slug: /tools/sdk/python/search-attribute-configuration/models/error-response-dto
...
messages=[
                    sailpoint.search_attribute_configuration.models.error_message_dto.Error Message Dto(
                        locale = 'en-US', 
