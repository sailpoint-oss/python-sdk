...
from sailpoint.connector_rule_management.api_response import ApiResponse, T as ApiResponseT
import sailpoint.connector_rule_management.models
from sailpoint.connector_rule_management import rest
from sailpoint.connector_rule_management.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.connector_rule_management.models, klass)
