...
slug: /tools/sdk/python/connector-rule-management/models/error-response-dto
...
messages=[
                    sailpoint.connector_rule_management.models.error_message_dto.Error Message Dto(
                        locale = 'en-US', 
