...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = ReportsDataExtractionApi(api_client).start_report_v1(report_details=new_report_details)
        # Below is a request that includes all optional parameters
        # results = ReportsDataExtractionApi(api_client).start_report_v1(new_report_details)
