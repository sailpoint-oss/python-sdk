...
from sailpoint.reports_data_extraction.api_response import ApiResponse, T as ApiResponseT
import sailpoint.reports_data_extraction.models
from sailpoint.reports_data_extraction import rest
from sailpoint.reports_data_extraction.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.reports_data_extraction.models, klass)
