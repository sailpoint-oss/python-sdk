...
class Lifecyclestatedeleted(BaseModel):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Deleted lifecycle state's DTO type.")
    id: Optional[StrictStr] = Field(default=None, description="Deleted lifecycle state ID.")
    name: Optional[StrictStr] = Field(default=None, description="Deleted lifecycle state's display name.")
