...
from sailpoint.lifecycle_states.api_response import ApiResponse, T as ApiResponseT
import sailpoint.lifecycle_states.models
from sailpoint.lifecycle_states import rest
from sailpoint.lifecycle_states.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sailpoint.lifecycle_states.models, klass)
