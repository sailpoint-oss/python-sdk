...
slug: /tools/sdk/python/v1/methods/non-employee-lifecycle-management
tags: ['SDK', 'Software Development Kit', 'Non_Employee_Lifecycle_Management', 'Non_Employee_Lifecycle_Management']
---

# sailpoint.non_employee_lifecycle_management_v1.NonEmployeeLifecycleManagementV1Api
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NonEmployeeLifecycleManagementV1Api(api_client).approve_non_employee_request_v1(id=id, nonemployeeapprovaldecision=new_nonemployeeapprovaldecision)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).approve_non_employee_request_v1(id, new_nonemployeeapprovaldecision)
...
with ApiClient(configuration) as api_client:
    nonemployeerequestbody = '''sailpoint.non_employee_lifecycle_management_v1.Nonemployeerequestbody()''' # Nonemployeerequestbody | Non-Employee record creation request body.

    try:
        # Create non-employee record
        new_nonemployeerequestbody = Nonemployeerequestbody.from_json(nonemployeerequestbody)
        results = NonEmployeeLifecycleManagementV1Api(api_client).create_non_employee_record_v1(nonemployeerequestbody=new_nonemployeerequestbody)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).create_non_employee_record_v1(new_nonemployeerequestbody)
        print("The response of NonEmployeeLifecycleManagementV1Api->create_non_employee_record_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->create_non_employee_record_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    nonemployeerequestbody = '''sailpoint.non_employee_lifecycle_management_v1.Nonemployeerequestbody()''' # Nonemployeerequestbody | Non-Employee creation request body

    try:
        # Create non-employee request
        new_nonemployeerequestbody = Nonemployeerequestbody.from_json(nonemployeerequestbody)
        results = NonEmployeeLifecycleManagementV1Api(api_client).create_non_employee_request_v1(nonemployeerequestbody=new_nonemployeerequestbody)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).create_non_employee_request_v1(new_nonemployeerequestbody)
        print("The response of NonEmployeeLifecycleManagementV1Api->create_non_employee_request_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->create_non_employee_request_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    nonemployeeschemaattributebody = '''sailpoint.non_employee_lifecycle_management_v1.Nonemployeeschemaattributebody()''' # Nonemployeeschemaattributebody | 

    try:
        # Create a new schema attribute for non-employee source
        new_nonemployeeschemaattributebody = Nonemployeeschemaattributebody.from_json(nonemployeeschemaattributebody)
        results = NonEmployeeLifecycleManagementV1Api(api_client).create_non_employee_source_schema_attributes_v1(source_id=source_id, nonemployeeschemaattributebody=new_nonemployeeschemaattributebody)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).create_non_employee_source_schema_attributes_v1(source_id, new_nonemployeeschemaattributebody)
        print("The response of NonEmployeeLifecycleManagementV1Api->create_non_employee_source_schema_attributes_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->create_non_employee_source_schema_attributes_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    nonemployeesourcerequestbody = '''sailpoint.non_employee_lifecycle_management_v1.Nonemployeesourcerequestbody()''' # Nonemployeesourcerequestbody | Non-Employee source creation request body.

    try:
        # Create non-employee source
        new_nonemployeesourcerequestbody = Nonemployeesourcerequestbody.from_json(nonemployeesourcerequestbody)
        results = NonEmployeeLifecycleManagementV1Api(api_client).create_non_employee_source_v1(nonemployeesourcerequestbody=new_nonemployeesourcerequestbody)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).create_non_employee_source_v1(new_nonemployeesourcerequestbody)
        print("The response of NonEmployeeLifecycleManagementV1Api->create_non_employee_source_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->create_non_employee_source_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        NonEmployeeLifecycleManagementV1Api(api_client).delete_non_employee_record_v1(id=id)
        # Below is a request that includes all optional parameters
        # NonEmployeeLifecycleManagementV1Api(api_client).delete_non_employee_record_v1(id)
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->delete_non_employee_record_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    delete_non_employee_records_in_bulk_v1_request = '''sailpoint.non_employee_lifecycle_management_v1.DeleteNonEmployeeRecordsInBulkV1Request()''' # DeleteNonEmployeeRecordsInBulkV1Request | Non-Employee bulk delete request body.
    ...
    try:
        ...
        NonEmployeeLifecycleManagementV1Api(api_client).delete_non_employee_records_in_bulk_v1(delete_non_employee_records_in_bulk_v1_request=new_delete_non_employee_records_in_bulk_v1_request)
        # Below is a request that includes all optional parameters
        # NonEmployeeLifecycleManagementV1Api(api_client).delete_non_employee_records_in_bulk_v1(new_delete_non_employee_records_in_bulk_v1_request)
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->delete_non_employee_records_in_bulk_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        NonEmployeeLifecycleManagementV1Api(api_client).delete_non_employee_request_v1(id=id)
        # Below is a request that includes all optional parameters
        # NonEmployeeLifecycleManagementV1Api(api_client).delete_non_employee_request_v1(id)
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->delete_non_employee_request_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        NonEmployeeLifecycleManagementV1Api(api_client).delete_non_employee_schema_attribute_v1(attribute_id=attribute_id, source_id=source_id)
        # Below is a request that includes all optional parameters
        # NonEmployeeLifecycleManagementV1Api(api_client).delete_non_employee_schema_attribute_v1(attribute_id, source_id)
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->delete_non_employee_schema_attribute_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        NonEmployeeLifecycleManagementV1Api(api_client).delete_non_employee_source_schema_attributes_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # NonEmployeeLifecycleManagementV1Api(api_client).delete_non_employee_source_schema_attributes_v1(source_id)
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->delete_non_employee_source_schema_attributes_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        NonEmployeeLifecycleManagementV1Api(api_client).delete_non_employee_source_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # NonEmployeeLifecycleManagementV1Api(api_client).delete_non_employee_source_v1(source_id)
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->delete_non_employee_source_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        NonEmployeeLifecycleManagementV1Api(api_client).export_non_employee_records_v1(id=id)
        # Below is a request that includes all optional parameters
        # NonEmployeeLifecycleManagementV1Api(api_client).export_non_employee_records_v1(id)
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->export_non_employee_records_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        NonEmployeeLifecycleManagementV1Api(api_client).export_non_employee_source_schema_template_v1(id=id)
        # Below is a request that includes all optional parameters
        # NonEmployeeLifecycleManagementV1Api(api_client).export_non_employee_source_schema_template_v1(id)
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->export_non_employee_source_schema_template_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NonEmployeeLifecycleManagementV1Api(api_client).get_non_employee_approval_summary_v1(requested_for=requested_for)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).get_non_employee_approval_summary_v1(requested_for)
        print("The response of NonEmployeeLifecycleManagementV1Api->get_non_employee_approval_summary_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->get_non_employee_approval_summary_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NonEmployeeLifecycleManagementV1Api(api_client).get_non_employee_approval_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).get_non_employee_approval_v1(id, include_detail)
        print("The response of NonEmployeeLifecycleManagementV1Api->get_non_employee_approval_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->get_non_employee_approval_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NonEmployeeLifecycleManagementV1Api(api_client).get_non_employee_bulk_upload_status_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).get_non_employee_bulk_upload_status_v1(id)
        print("The response of NonEmployeeLifecycleManagementV1Api->get_non_employee_bulk_upload_status_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->get_non_employee_bulk_upload_status_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NonEmployeeLifecycleManagementV1Api(api_client).get_non_employee_record_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).get_non_employee_record_v1(id)
        print("The response of NonEmployeeLifecycleManagementV1Api->get_non_employee_record_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->get_non_employee_record_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NonEmployeeLifecycleManagementV1Api(api_client).get_non_employee_request_summary_v1(requested_for=requested_for)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).get_non_employee_request_summary_v1(requested_for)
        print("The response of NonEmployeeLifecycleManagementV1Api->get_non_employee_request_summary_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->get_non_employee_request_summary_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NonEmployeeLifecycleManagementV1Api(api_client).get_non_employee_request_v1(id=id)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).get_non_employee_request_v1(id)
        print("The response of NonEmployeeLifecycleManagementV1Api->get_non_employee_request_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->get_non_employee_request_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NonEmployeeLifecycleManagementV1Api(api_client).get_non_employee_schema_attribute_v1(attribute_id=attribute_id, source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).get_non_employee_schema_attribute_v1(attribute_id, source_id)
        print("The response of NonEmployeeLifecycleManagementV1Api->get_non_employee_schema_attribute_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->get_non_employee_schema_attribute_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NonEmployeeLifecycleManagementV1Api(api_client).get_non_employee_source_schema_attributes_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).get_non_employee_source_schema_attributes_v1(source_id)
        print("The response of NonEmployeeLifecycleManagementV1Api->get_non_employee_source_schema_attributes_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->get_non_employee_source_schema_attributes_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NonEmployeeLifecycleManagementV1Api(api_client).get_non_employee_source_v1(source_id=source_id)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).get_non_employee_source_v1(source_id)
        print("The response of NonEmployeeLifecycleManagementV1Api->get_non_employee_source_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->get_non_employee_source_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NonEmployeeLifecycleManagementV1Api(api_client).import_non_employee_records_in_bulk_v1(id=id, data=data)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).import_non_employee_records_in_bulk_v1(id, data)
        print("The response of NonEmployeeLifecycleManagementV1Api->import_non_employee_records_in_bulk_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->import_non_employee_records_in_bulk_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NonEmployeeLifecycleManagementV1Api(api_client).list_non_employee_approvals_v1()
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).list_non_employee_approvals_v1(requested_for, limit, offset, count, filters, sorters)
        print("The response of NonEmployeeLifecycleManagementV1Api->list_non_employee_approvals_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->list_non_employee_approvals_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NonEmployeeLifecycleManagementV1Api(api_client).list_non_employee_records_v1()
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).list_non_employee_records_v1(limit, offset, count, sorters, filters)
        print("The response of NonEmployeeLifecycleManagementV1Api->list_non_employee_records_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->list_non_employee_records_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NonEmployeeLifecycleManagementV1Api(api_client).list_non_employee_requests_v1(requested_for=requested_for)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).list_non_employee_requests_v1(requested_for, limit, offset, count, sorters, filters)
        print("The response of NonEmployeeLifecycleManagementV1Api->list_non_employee_requests_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->list_non_employee_requests_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NonEmployeeLifecycleManagementV1Api(api_client).list_non_employee_sources_v1()
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).list_non_employee_sources_v1(limit, offset, count, requested_for, non_employee_count, sorters)
        print("The response of NonEmployeeLifecycleManagementV1Api->list_non_employee_sources_v1:\n")
        for item in results:
            print(item.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->list_non_employee_sources_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = NonEmployeeLifecycleManagementV1Api(api_client).patch_non_employee_record_v1(id=id, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).patch_non_employee_record_v1(id, new_jsonpatchoperation)
        print("The response of NonEmployeeLifecycleManagementV1Api->patch_non_employee_record_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->patch_non_employee_record_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a schema attribute for non-employee source
        new_jsonpatchoperation = Jsonpatchoperation.from_json(jsonpatchoperation)
        results = NonEmployeeLifecycleManagementV1Api(api_client).patch_non_employee_schema_attribute_v1(attribute_id=attribute_id, source_id=source_id, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).patch_non_employee_schema_attribute_v1(attribute_id, source_id, new_jsonpatchoperation)
        print("The response of NonEmployeeLifecycleManagementV1Api->patch_non_employee_schema_attribute_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->patch_non_employee_schema_attribute_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    ...
    try:
        # Patch a non-employee source
        new_jsonpatchoperation = Jsonpatchoperation.from_json(jsonpatchoperation)
        results = NonEmployeeLifecycleManagementV1Api(api_client).patch_non_employee_source_v1(source_id=source_id, jsonpatchoperation=new_jsonpatchoperation)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).patch_non_employee_source_v1(source_id, new_jsonpatchoperation)
        print("The response of NonEmployeeLifecycleManagementV1Api->patch_non_employee_source_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->patch_non_employee_source_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    id = 'e136567de87e4d029e60b3c3c55db56d' # str | Non-Employee approval item id (UUID) # str | Non-Employee approval item id (UUID)
    nonemployeerejectapprovaldecision = '''sailpoint.non_employee_lifecycle_management_v1.Nonemployeerejectapprovaldecision()''' # Nonemployeerejectapprovaldecision | 

    try:
        # Reject a non-employee request
        new_nonemployeerejectapprovaldecision = Nonemployeerejectapprovaldecision.from_json(nonemployeerejectapprovaldecision)
        results = NonEmployeeLifecycleManagementV1Api(api_client).reject_non_employee_request_v1(id=id, nonemployeerejectapprovaldecision=new_nonemployeerejectapprovaldecision)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).reject_non_employee_request_v1(id, new_nonemployeerejectapprovaldecision)
        print("The response of NonEmployeeLifecycleManagementV1Api->reject_non_employee_request_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->reject_non_employee_request_v1: %s\n" % e)
```
...
with ApiClient(configuration) as api_client:
    id = 'ef38f94347e94562b5bb8424a56397d8' # str | Non-employee record id (UUID) # str | Non-employee record id (UUID)
    nonemployeerequestbody = '''sailpoint.non_employee_lifecycle_management_v1.Nonemployeerequestbody()''' # Nonemployeerequestbody | Non-employee record creation request body. Attributes are restricted by user type. Owner of source can update end date. Organization admins can update all available fields.

    try:
        # Update non-employee record
        new_nonemployeerequestbody = Nonemployeerequestbody.from_json(nonemployeerequestbody)
        results = NonEmployeeLifecycleManagementV1Api(api_client).update_non_employee_record_v1(id=id, nonemployeerequestbody=new_nonemployeerequestbody)
        # Below is a request that includes all optional parameters
        # results = NonEmployeeLifecycleManagementV1Api(api_client).update_non_employee_record_v1(id, new_nonemployeerequestbody)
        print("The response of NonEmployeeLifecycleManagementV1Api->update_non_employee_record_v1:\n")
        print(results.model_dump_json(by_alias=True, indent=4))
    except Exception as e:
        print("Exception when calling NonEmployeeLifecycleManagementV1Api->update_non_employee_record_v1: %s\n" % e)
```
