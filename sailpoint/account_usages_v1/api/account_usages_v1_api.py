...
from sailpoint.account_usages_v1.api_client import ApiClient, RequestSerialized
from sailpoint.account_usages_v1.api_response import ApiResponse
from sailpoint.account_usages_v1.rest import RESTResponseType
...
class AccountUsagesV1Api:
    ...
    @validate_call
    def get_usages_by_account_id_v1(
        self,
        account_id: Annotated[StrictStr, Field(description="ID of IDN account")],
        ...
        _param = self._get_usages_by_account_id_v1_serialize(
    ...
    @validate_call
    def get_usages_by_account_id_v1_with_http_info(
        self,
        account_id: Annotated[StrictStr, Field(description="ID of IDN account")],
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    @validate_call
    def get_usages_by_account_id_v1_without_preload_content(
        self,
        account_id: Annotated[StrictStr, Field(description="ID of IDN account")],
        limit: Annotated[Optional[Annotated[int, Field(le=250, strict=True, ge=0)]], Field(description="Max number of results to return. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
        offset: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Offset into the full result set. Usually specified with *limit* to paginate through the results. See [V3 API Standard Collection Parameters](https://developer.sailpoint.com/idn/api/standard-collection-parameters) for more information.")] = None,
    ...
    def _get_usages_by_account_id_v1_serialize(
        self,
        account_id,
        limit,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/account-usages/v1/{accountId}/summaries',
