...
slug: /tools/sdk/python/v1/methods/account-usages
tags: ['SDK', 'Software Development Kit', 'Account_Usages', 'Account_Usages']
---

# sailpoint.account_usages_v1.AccountUsagesV1Api
...
```python
from sailpoint.account_usages_v1.api.account_usages_v1_api import AccountUsagesV1Api
from sailpoint.account_usages_v1.api_client import ApiClient
...
with ApiClient(configuration) as api_client:
    ...
    try:
        ...
        results = AccountUsagesV1Api(api_client).get_usages_by_account_id_v1(account_id=account_id)
        # Below is a request that includes all optional parameters
        # results = AccountUsagesV1Api(api_client).get_usages_by_account_id_v1(account_id, limit, offset, count, sorters)
