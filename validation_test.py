...
class TestPythonSDK(unittest.TestCase):
    ...
    def test_v3_accounts(self):
        accounts = sailpoint.v3.AccountsApi(
            self.v3_api_client
    ...
    def test_list_transforms(self):
        transforms = sailpoint.v3.TransformsApi(
            self.v3_api_client
        ).list_transforms_with_http_info()
    ...
    def test_list_accounts_beta(self):
        accounts = sailpoint.beta.AccountsApi(
